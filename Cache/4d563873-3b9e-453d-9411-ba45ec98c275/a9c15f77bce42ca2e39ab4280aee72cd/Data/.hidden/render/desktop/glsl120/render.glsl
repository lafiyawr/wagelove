...
//sampler sampler Tweak_N104SmpSC 2:23
//sampler sampler Tweak_N10SmpSC 2:24
//sampler sampler Tweak_N8SmpSC 2:25
//sampler sampler baseTexSmpSC 2:26
//sampler sampler intensityTextureSmpSC 2:27
//sampler sampler renderTarget0SmpSC 2:28
//sampler sampler renderTarget1SmpSC 2:29
//sampler sampler renderTarget2SmpSC 2:30
//sampler sampler renderTarget3SmpSC 2:31
//sampler sampler sc_OITCommonSampler 2:34
//sampler sampler sc_ScreenTextureSmpSC 2:36
//texture texture2D Tweak_N10 2:0:2:24
//texture texture2D Tweak_N104 2:1:2:23
//texture texture2D Tweak_N8 2:2:2:25
//texture texture2D baseTex 2:3:2:26
//texture texture2D intensityTexture 2:4:2:27
//texture texture2D renderTarget0 2:5:2:28
//texture texture2D renderTarget1 2:6:2:29
//texture texture2D renderTarget2 2:7:2:30
//texture texture2D renderTarget3 2:8:2:31
...
uniform vec4 Tweak_N104Dims;
uniform vec4 Tweak_N10Dims;
...
uniform vec4 Tweak_N104Size;
uniform vec4 Tweak_N104View;
uniform mat3 Tweak_N104Transform;
uniform vec4 Tweak_N104UvMinMax;
uniform vec4 Tweak_N104BorderColor;
uniform vec4 Tweak_N10Size;
uniform vec4 Tweak_N10View;
...
uniform float Port_Speed_N026;
uniform float Port_SecondOffset_N026;
...
vec4 l9_12=sc_SampleTextureLevel(renderTarget1Dims.xy,renderTarget1Layout,renderTarget1GetStereoViewIndex(),l9_10,(int(SC_USE_UV_TRANSFORM_renderTarget1)!=0),renderTarget1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget1,SC_SOFTWARE_WRAP_MODE_V_renderTarget1),(int(SC_USE_UV_MIN_MAX_renderTarget1)!=0),renderTarget1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget1)!=0),renderTarget1BorderColor,0.0,renderTarget1);
vec4 l9_13=sc_SampleTextureLevel(renderTarget2Dims.xy,renderTarget2Layout,renderTarget2GetStereoViewIndex(),l9_10,(int(SC_USE_UV_TRANSFORM_renderTarget2)!=0),renderTarget2Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget2,SC_SOFTWARE_WRAP_MODE_V_renderTarget2),(int(SC_USE_UV_MIN_MAX_renderTarget2)!=0),renderTarget2UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget2)!=0),renderTarget2BorderColor,0.0,renderTarget2);
gParticle.Size=DecodeFloat16(vec2(l9_11.xy),true)*100.001;
gParticle.Mass=DecodeFloat16(vec2(l9_11.zw),true)*100.001;
gParticle.Counter_N3=DecodeFloat8(l9_12.x,true)*25.0;
gParticle.Tap_N2=DecodeFloat8(l9_12.y,true);
gParticle.Color.x=DecodeFloat8(l9_12.z,true);
gParticle.Color.y=DecodeFloat8(l9_12.w,true);
gParticle.Color.z=DecodeFloat8(l9_13.x,true);
gParticle.Color.w=DecodeFloat8(l9_13.y,true);
gParticle.Dead=DecodeFloat8(l9_13.z,true)*255.0;
...
float l9_13=length(l9_12);
vec3 l9_14;
if ((l9_13<0.03)||(Port_Import_N099<0.0001))
{
l9_14=vec3(0.0,1.0,0.0);
}
else
{
l9_14=normalize(gParticle.Velocity);
}
vec3 l9_15=normalize(sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][2].xyz);
vec3 l9_16=normalize(cross(l9_15,l9_14));
vec3 l9_17=normalize(cross(l9_16,l9_15));
vec4 l9_18=mat4(vec4(gParticle.Matrix[0],gParticle.Position.x),vec4(gParticle.Matrix[1],gParticle.Position.y),vec4(gParticle.Matrix[2],gParticle.Position.z),vec4(0.0,0.0,0.0,1.0))*vec4((l9_2-vec2(0.5))+clamp(Port_Import_N100,vec2(-0.5),vec2(0.5)),0.0,1.0);
varPos=(gParticle.Position+((-l9_16)*(gParticle.Size*l9_18.x)))+(l9_17*((gParticle.Size*l9_18.y)*max(l9_13*Port_Import_N099,1.0)));
varTangent=vec4(l9_17.x,l9_17.y,l9_17.z,varTangent.w);
varNormal=l9_15;
#if (UseViewSpaceDepthVariant&&((sc_OITDepthGatherPass||sc_OITCompositingPass)||sc_OITDepthBoundsPass))
{
vec4 l9_19=sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
varViewSpaceDepth=-l9_19.z;
sc_SetClipPosition(sc_ProjectionMatrixArray[sc_GetStereoViewIndex()]*l9_19);
}
#else
{
vec4 l9_20=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(varPos,1.0);
vec4 l9_21;
...
if (l9_8)
{
l9_12=overrideTimeElapsed;
}
else
{
l9_12=sc_Time.x;
}
float l9_13=l9_12-(l9_11*0.0502513);
float l9_14=fract(abs(((l9_11*0.00490643)+0.151235)+(floor((l9_13+20.0)*0.1)*4.32723)));
float l9_15=(float(((Interp_Particle_Index*((Interp_Particle_Index*1471343)+101146501))+1559861749)&2147483647)*4.65661e-10)*l9_10;
float l9_16=l9_9-l9_15;
vec4 l9_17;
if (floor(Interp_Particle_Tap_N2+0.5)!=0.0)
{
int l9_18=int(Port_SpriteCount_N026.x);
int l9_19=int(Port_SpriteCount_N026.y);
int l9_20=l9_18*l9_19;
int l9_21=int(float(Tweak_N114));
int l9_22=(l9_20<l9_21) ? l9_20 : l9_21;
int l9_23=int(floor(Interp_Particle_Counter_N3+0.5));
float l9_24=1.0/float(l9_19);
int l9_25=l9_23-(l9_22*(l9_23/l9_22));
int l9_26=l9_25/l9_18;
int l9_27;
...
#endif
l9_17=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_27,mod(vec2((1.0/float(l9_18))*(l9_7.x+float(l9_25-(l9_18*l9_26))),((1.0-l9_24)-(float(l9_26)*l9_24))+(l9_24*l9_7.y)),vec2(1.0)),(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
}
else
{
float l9_28=radians(l9_14*Port_Input1_N121);
float l9_29=sin(l9_28);
float l9_30=cos(l9_28);
vec2 l9_31=l9_7-Port_Center_N119;
vec2 l9_32=l9_7+vec2(l9_14);
vec2 l9_33=l9_32;
l9_33.x=floor(l9_32.x*10000.0)*0.0001;
vec2 l9_34=l9_33;
l9_34.y=floor(l9_32.y*10000.0)*0.0001;
float l9_35=snoise(l9_34*(Port_Scale_N123*0.5));
float l9_36=((Port_TimeA_N141+Port_TimeTransition_N141)+Port_TimeB_N141)+0.0001;
vec2 l9_37=vec2(mix(Port_ValueA_N141,Port_ValueB_N141,smoothstep(Port_TimeA_N141/l9_36,1.0-(Port_TimeB_N141/l9_36),abs((mod((l9_16/l9_36)+(floor(((l9_35*0.5)+0.5)*10000.0)*0.0001),1.0)*2.0)-1.0))));
vec2 l9_38=clamp(((((vec2(dot(vec2(l9_30,l9_29),l9_31),dot(vec2(-l9_29,l9_30),l9_31))+Port_Center_N119)-Port_Center_N130)*l9_37)+Port_Center_N130)+vec2(0.001),Port_Input1_N126+vec2(0.001),Port_Input2_N126+vec2(0.001))-vec2(0.001);
int l9_39;
...
#endif
float l9_40=l9_16*Port_FlowSpeed_N076;
float l9_41=fract(l9_40+0.5);
vec2 l9_42=((sc_SampleTextureBiasOrLevel(Tweak_N104Dims.xy,Tweak_N104Layout,l9_39,l9_38,(int(SC_USE_UV_TRANSFORM_Tweak_N104)!=0),Tweak_N104Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N104,SC_SOFTWARE_WRAP_MODE_V_Tweak_N104),(int(SC_USE_UV_MIN_MAX_Tweak_N104)!=0),Tweak_N104UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N104)!=0),Tweak_N104BorderColor,0.0,Tweak_N104)-vec4(0.5))*2.0).xy;
vec4 l9_43=sc_SampleTextureBiasOrLevel(Tweak_N8Dims.xy,Tweak_N8Layout,Tweak_N8GetStereoViewIndex(),l9_38+((l9_42*l9_41)*Port_FlowStrength_N076),(int(SC_USE_UV_TRANSFORM_Tweak_N8)!=0),Tweak_N8Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8),(int(SC_USE_UV_MIN_MAX_Tweak_N8)!=0),Tweak_N8UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N8)!=0),Tweak_N8BorderColor,0.0,Tweak_N8);
vec4 l9_44=sc_SampleTextureBiasOrLevel(Tweak_N8Dims.xy,Tweak_N8Layout,Tweak_N8GetStereoViewIndex(),l9_38+((l9_42*fract(l9_40+1.0))*Port_FlowStrength_N076),(int(SC_USE_UV_TRANSFORM_Tweak_N8)!=0),Tweak_N8Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N8,SC_SOFTWARE_WRAP_MODE_V_Tweak_N8),(int(SC_USE_UV_MIN_MAX_Tweak_N8)!=0),Tweak_N8UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N8)!=0),Tweak_N8BorderColor,0.0,Tweak_N8);
vec4 l9_45=mix(l9_43,l9_44,vec4(abs((0.5-l9_41)*2.0)));
vec2 l9_46=l9_7-Port_Center_N116;
int l9_47;
...
#endif
vec4 l9_48=sc_SampleTextureBiasOrLevel(Tweak_N10Dims.xy,Tweak_N10Layout,l9_47,clamp(((l9_46*l9_37)+Port_Center_N116)+vec2(0.001),Port_Input1_N122+vec2(0.001),Port_Input2_N122+vec2(0.001))-vec2(0.001),(int(SC_USE_UV_TRANSFORM_Tweak_N10)!=0),Tweak_N10Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N10,SC_SOFTWARE_WRAP_MODE_V_Tweak_N10),(int(SC_USE_UV_MIN_MAX_Tweak_N10)!=0),Tweak_N10UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N10)!=0),Tweak_N10BorderColor,0.0,Tweak_N10);
vec3 l9_49=l9_45.xyz;
vec3 l9_50=mix(l9_49,(vec3(1.0)-((vec3(1.0)-l9_49)*(vec3(1.0)-l9_48.xyz))).xyz,vec3(l9_48.w));
vec4 l9_51=vec4(l9_50.x,l9_50.y,l9_50.z,vec4(0.0).w);
l9_51.w=l9_45.w;
l9_17=l9_51;
}
vec4 l9_52=ngsPixelShader(l9_17);
vec4 l9_53;
#if (sc_ShaderComplexityAnalyzer)
{
l9_53=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_53=vec4(0.0);
...
#endif
l9_113=encodeDepth(((1.0-l9_111.x)*1000.0)+l9_114,l9_112);
}
#else
{
l9_113=0;
...
#endif
int l9_115=encodeDepth(viewSpaceDepth(),l9_112);
vec4 l9_116;
l9_116=l9_55*l9_55.w;
vec4 l9_117;
int l9_118=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_118<8)
{
int l9_119=l9_83[l9_118];
int l9_120=l9_115-l9_113;
bool l9_121=l9_119<l9_120;
bool l9_122;
if (l9_121)
{
l9_122=l9_83[l9_118]>0;
}
else
{
l9_122=l9_121;
...
if (l9_122)
{
vec3 l9_123=l9_116.xyz*(1.0-(float(l9_84[l9_118])*0.00392157));
