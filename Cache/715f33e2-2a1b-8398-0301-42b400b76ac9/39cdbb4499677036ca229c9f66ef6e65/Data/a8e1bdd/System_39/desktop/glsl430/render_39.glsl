...
//spec_const int NODE_46_DROPLIST_ITEM 66 0
...
//spec_const int sc_AmbientLightMode0 75 0
//spec_const int sc_AmbientLightMode1 76 0
//spec_const int sc_AmbientLightMode2 77 0
//spec_const int sc_AmbientLightMode_Constant 78 0
//spec_const int sc_AmbientLightMode_EnvironmentMap 79 0
//spec_const int sc_AmbientLightMode_FromCamera 80 0
//spec_const int sc_AmbientLightMode_SphericalHarmonics 81 0
//spec_const int sc_AmbientLightsCount 82 0
//spec_const int sc_DepthBufferMode 83 0
//spec_const int sc_DirectionalLightsCount 84 0
//spec_const int sc_EnvLightMode 85 0
//spec_const int sc_EnvmapDiffuseLayout 86 0
//spec_const int sc_EnvmapSpecularLayout 87 0
//spec_const int sc_LightEstimationSGCount 88 0
//spec_const int sc_MaxTextureImageUnits 89 0
//spec_const int sc_PointLightsCount 90 0
//spec_const int sc_RayTracedAoTextureLayout 91 0
//spec_const int sc_RayTracedDiffIndTextureLayout 92 0
//spec_const int sc_RayTracedReflectionTextureLayout 93 0
//spec_const int sc_RayTracedShadowTextureLayout 94 0
...
{
uvec3 l9_10=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_10.x,l9_10.y,l9_10.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_11=l9_4/vec3(dot(abs(l9_4),vec3(1.0)));
...
{
l9_19=uint(clamp(Port_Roughness_N042,0.0,1.0)*1000.0);
}
...
{
LightingComponents l9_38=accumulateLight(LightingComponents(l9_26,l9_27,l9_32,l9_31,l9_29,l9_28),LightProperties(sc_DirectionalLights[l9_37].direction,sc_DirectionalLights[l9_37].color.xyz,sc_DirectionalLights[l9_37].color.w*l9_18[(l9_30<3) ? l9_30 : 3]),l9_17,l9_4);
...
l9_48=l9_56+1;
LightingComponents l9_63=accumulateLight(LightingComponents(l9_42,l9_43,l9_47,l9_46,l9_45,l9_44),LightProperties(l9_58,sc_PointLights[l9_55].color.xyz,l9_62),l9_17,l9_4);
...
#endif
vec3 l9_69=vec3(1.0)-vec3(l9_68.x);
l9_65=l9_39*l9_69;
l9_64=l9_40*l9_69;
}
else
...
{
vec2 l9_71=calcPanoramicTexCoordsFromDir(l9_11,sc_EnvmapRotation.y);
vec4 l9_72;
...
{
l9_77=texture(sc_EnvmapDiffuseArrSC,sc_SamplingCoordsViewToGlobal(l9_75,sc_EnvmapDiffuseLayout,l9_76),-13.0);
}
#else
{
l9_77=texture(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_75,sc_EnvmapDiffuseLayout,l9_76).xy,-13.0);
}
#endif
l9_74=l9_77;
}
...
if (receivesRayTracedDiffuseIndirect)
{
vec4 l9_84=sampleRayTracedIndirectDiffuse();
l9_83=mix(l9_70,l9_84.xyz,vec3(l9_84.w));
}
else
{
l9_83=l9_70;
...
{
l9_86=l9_83+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_87=l9_83;
l9_87.x=l9_83.x+(1e-06*sc_AmbientLights[0].color.x);
l9_86=l9_87;
}
#endif
l9_85=l9_86;
...
{
l9_89=l9_85+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_90=l9_85;
l9_90.x=l9_85.x+(1e-06*sc_AmbientLights[1].color.x);
l9_89=l9_90;
}
#endif
l9_88=l9_89;
...
{
l9_92=l9_88+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_93=l9_88;
l9_93.x=l9_88.x+(1e-06*sc_AmbientLights[2].color.x);
l9_92=l9_93;
}
#endif
l9_91=l9_92;
...
{
vec3 l9_95;
l9_95=sc_LightEstimationData.ambientLight;
vec3 l9_96;
int l9_97=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_97<sc_LightEstimationSGCount)
{
float l9_98=dot(sc_LightEstimationData.sg[l9_97].axis,l9_11);
float l9_99=exp(-sc_LightEstimationData.sg[l9_97].sharpness);
float l9_100=l9_99*l9_99;
float l9_101=1.0/sc_LightEstimationData.sg[l9_97].sharpness;
float l9_102=(1.0+(2.0*l9_100))-l9_101;
float l9_103=sqrt(1.0-l9_102);
float l9_104=0.36000001*l9_98;
float l9_105=(1.0/(4.0*0.36000001))*l9_103;
float l9_106=l9_104+l9_105;
float l9_107;
if (step(abs(l9_104),l9_105)>0.5)
{
l9_107=(l9_106*l9_106)/l9_103;
}
else
{
l9_107=clamp(l9_98,0.0,1.0);
}
l9_96=l9_95+((((sc_LightEstimationData.sg[l9_97].color/vec3(sc_LightEstimationData.sg[l9_97].sharpness))*6.2831855)*((l9_102*l9_107)+(((l9_99-l9_100)*l9_101)-l9_100)))/vec3(3.1415927));
l9_95=l9_96;
l9_97++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_109=clamp(pow(Port_Roughness_N042,0.66666669),0.0,1.0)*5.0;
vec2 l9_110=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_11,reflect(-l9_4,l9_11),Port_Roughness_N042),sc_EnvmapRotation.y);
vec4 l9_111;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_112=floor(l9_109);
float l9_113=ceil(l9_109);
l9_111=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_110,sc_EnvmapSpecularSize.xy,l9_112),sc_EnvmapSpecularGetStereoViewIndex(),l9_112),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_110,sc_EnvmapSpecularSize.xy,l9_113),sc_EnvmapSpecularGetStereoViewIndex(),l9_113),vec4(l9_109-l9_112));
}
#else
{
l9_111=sc_EnvmapSpecularSampleViewIndexLevel(l9_110,sc_EnvmapSpecularGetStereoViewIndex(),l9_109);
}
#endif
vec3 l9_114=((l9_111.xyz*(1.0/l9_111.w))*sc_EnvmapExposure)+vec3(1e-06);
vec3 l9_115;
if (receivesRayTracedReflections)
{
vec4 l9_116=sampleRayTracedReflections();
l9_115=mix(l9_114,l9_116.xyz,vec3(l9_116.w));
}
else
{
l9_115=l9_114;
}
l9_108=vec3(0.0)+(l9_115*envBRDFApprox(l9_17,abs(dot(l9_11,l9_4))));
}
#else
{
l9_108=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_118=clamp(Port_Roughness_N042*Port_Roughness_N042,0.0099999998,1.0);
vec3 l9_119;
l9_119=sc_LightEstimationData.ambientLight*l9_15;
int l9_120=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
...
vec3 l9_122=reflect(-l9_4,l9_11);
float l9_123=dot(l9_11,l9_4);
...
l9_132=vec3(0.0);
l9_131=vec3(0.0);
l9_130=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_16,vec3(Port_Opacity_N042));
l9_129=1.0;
}
#else
{
...
if (receivesRayTracedAo)
{
l9_134=l9_16*(l9_132+(l9_131*vec3(1.0-sampleRayTracedAo())));
}
else
{
l9_134=l9_16*(l9_132+(l9_131*l9_13));
}
vec3 l9_135=l9_117*Port_SpecularAO_N042;
vec3 l9_136=l9_64+l9_135;
vec3 l9_137;
if (l9_133)
{
l9_137=l9_134*srgbToLinear(l9_129);
}
else
{
l9_137=l9_134;
}
vec3 l9_138=l9_137+l9_136;
vec3 l9_139=(l9_138+l9_12)+l9_130;
float l9_140=l9_139.x;
vec4 l9_141=vec4(l9_140,l9_139.yz,l9_129);
vec4 l9_142;
#if (sc_IsEditor)
{
vec4 l9_143=l9_141;
l9_143.x=l9_140+((l9_13.x*Port_SpecularAO_N042.x)*9.9999997e-06);
l9_142=l9_143;
}
#else
{
...
{
vec3 l9_145=l9_142.xyz*1.8;
vec3 l9_146=(l9_142.xyz*(l9_145+vec3(1.4)))/((l9_142.xyz*(l9_145+vec3(0.5)))+vec3(1.5));
l9_144=vec4(l9_146.x,l9_146.y,l9_146.z,l9_142.w);
}
#else
{
l9_144=l9_142;
...
#endif
float l9_147=linearToSrgb(l9_144.x);
float l9_148=linearToSrgb(l9_144.y);
float l9_149=linearToSrgb(l9_144.z);
vec3 l9_150=vec3(l9_147,l9_148,l9_149);
vec4 l9_151=vec4(l9_150.x,l9_150.y,l9_150.z,l9_144.w);
vec4 l9_152=max(l9_151,vec4(0.0));
vec4 l9_153;
#if (sc_RenderAlphaToColor)
{
l9_153=vec4(l9_152.w);
}
#else
{
vec4 l9_154;
...
vec3 l9_156=mix(l9_155,definedBlend(l9_155,l9_152.xyz).xyz,vec3(l9_152.w));
...
{
float l9_159=l9_152.w;
l9_158=vec4(mix(vec3(1.0),l9_152.xyz,vec3(l9_159)),l9_159);
}
#else
{
vec4 l9_160;
...
{
float l9_161=l9_152.w;
float l9_162;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_162=clamp(l9_161,0.0,1.0);
}
#else
{
l9_162=l9_161;
...
#endif
l9_160=vec4(l9_152.xyz*l9_162,l9_162);
}
#else
{
l9_160=l9_152;
