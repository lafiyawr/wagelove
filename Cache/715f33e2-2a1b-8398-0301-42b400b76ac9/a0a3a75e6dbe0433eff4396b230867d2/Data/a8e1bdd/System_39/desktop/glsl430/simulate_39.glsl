...
int l9_5=sc_GetLocalInstanceID()/257;
...
float l9_21=max(Port_Import_N058,0.0099999998);
ssCalculateParticleSeed(gParticle,int(gParticle.CopyId));
float l9_23=floor(16.0);
gParticle.Position=(vec3(((floor(mod(gParticle.Index1DPerCopyF,l9_23))/16.0)*2.0)-1.0,((floor(gParticle.Index1DPerCopyF/l9_23)/16.0)*2.0)-1.0,0.0)*20.0)+vec3(1.0,1.0,0.0);
gParticle.Velocity=vec3(0.0);
...
gParticle.Quaternion=vec4(0.0,0.0,0.0,1.0);
tempGlobals=l9_20;
vec3 l9_24=N63_system_getParticleRandomVec3(true,true,true,0.0);
vec3 l9_25=N63_system_getParticleRandomVec3(true,true,true,150.0);
float l9_26=1.0-clamp(Port_Import_N043,0.0,1.0);
float l9_27;
if (l9_26<=0.0)
{
l9_27=0.0;
...
gParticle.Position=(((vec3(l9_31,l9_33,l9_35)*(l9_36/vec3(length(l9_36+vec3(9.9999997e-05)))))*Port_Import_N017)*Port_Import_N005)+Port_Import_N018;
tempGlobals=l9_20;
gParticle.Size=mix(Port_Import_N050*l9_21,Port_Import_N051*l9_21,ssGetParticleRandom(1,true,true,true,66.0,gParticle,20.0,tempGlobals.gTimeElapsed).x);
...
int l9_41=sc_GetLocalInstanceID()/257;
...
gParticle.Matrix=mat3(vfxModelMatrix[l9_43][0].xyz,vfxModelMatrix[l9_43][1].xyz,vfxModelMatrix[l9_43][2].xyz)*gParticle.Matrix;
...
vec3 l9_44=gParticle.Velocity;
float l9_45=length(l9_44);
vec3 l9_46;
if (l9_45<0.1)
{
l9_46=vec3(0.0,1.0,0.0);
}
else
{
l9_46=l9_44/vec3(l9_45);
}
vec3 l9_47=normalize(normalize(cross(l9_46,vec3(0.0,-1.0,0.0))));
float l9_48=radians(((l9_45*Port_Import_N070)*tempGlobals.gTimeDelta)*30.0);
float l9_49=sin(l9_48);
float l9_50=cos(l9_48);
float l9_51=1.0-l9_50;
float l9_52=l9_47.x;
float l9_53=l9_51*l9_52;
float l9_54=l9_47.y;
float l9_55=l9_53*l9_54;
float l9_56=l9_47.z;
float l9_57=l9_56*l9_49;
float l9_58=l9_51*l9_56;
float l9_59=l9_58*l9_52;
float l9_60=l9_54*l9_49;
float l9_61=l9_51*l9_54;
float l9_62=l9_61*l9_56;
float l9_63=l9_52*l9_49;
gParticle.Matrix=mat3(vec4(gParticle.Matrix[0].x,gParticle.Matrix[0].y,gParticle.Matrix[0].z,0.0).xyz,vec4(gParticle.Matrix[1].x,gParticle.Matrix[1].y,gParticle.Matrix[1].z,0.0).xyz,vec4(gParticle.Matrix[2].x,gParticle.Matrix[2].y,gParticle.Matrix[2].z,0.0).xyz)*mat3(vec3((l9_53*l9_52)+l9_50,l9_55-l9_57,l9_59+l9_60),vec3(l9_55+l9_57,(l9_61*l9_54)+l9_50,l9_62-l9_63),vec3(l9_59-l9_60,l9_62+l9_63,(l9_58*l9_56)+l9_50));
vec3 l9_64=abs(gParticle.Velocity*vec3(gParticle.Mass))/(vec3(l9_6*Port_Multiplier_N272)+vec3(1.234e-06));
gParticle.Force+=clamp((((vec3(Port_Import_N126)*vec3(Port_Import_N127))*vec3(Port_Import_N128))*((-gParticle.Velocity)*vec3(length(gParticle.Velocity))))*vec3(Port_Input4_N137),-l9_64,l9_64);
...
{
l9_65=gParticle.Force.x;
}
gParticle.Force.x=l9_65;
float l9_66;
...
{
l9_66=gParticle.Force.y;
}
gParticle.Force.y=l9_66;
float l9_67;
...
{
l9_67=gParticle.Force.z;
}
gParticle.Force.z=l9_67;
...
{
l9_68=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_68;
float l9_69;
...
{
l9_69=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_69;
float l9_70;
...
{
l9_70=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_70;
gParticle.Position+=(gParticle.Velocity*l9_6);
vec2 l9_71=vec2(3.0,1.0)/vec2(2048.0,vfxTargetSizeWrite.y);
int l9_72=vfxOffsetInstancesWrite+sc_GetLocalInstanceID();
float l9_73;
if (texture0.x<0.5)
{
l9_73=0.0;
...
sc_SetClipPosition(vec4(((vec2(l9_73,l9_74)+(vec2(float(l9_72%682),float(l9_72/682))*l9_71))*2.0)-vec2(1.0),1.0,1.0));
