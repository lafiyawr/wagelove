...
//spec_const int SC_DEVICE_CLASS 63 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 64 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 65 -1
//spec_const int intensityTextureLayout 66 0
//spec_const int renderTarget0Layout 67 0
//spec_const int renderTarget1Layout 68 0
//spec_const int renderTarget2Layout 69 0
//spec_const int renderTarget3Layout 70 0
//spec_const int sc_AmbientLightMode0 71 0
//spec_const int sc_AmbientLightMode1 72 0
//spec_const int sc_AmbientLightMode2 73 0
//spec_const int sc_AmbientLightMode_Constant 74 0
//spec_const int sc_AmbientLightMode_EnvironmentMap 75 0
//spec_const int sc_AmbientLightMode_FromCamera 76 0
//spec_const int sc_AmbientLightMode_SphericalHarmonics 77 0
//spec_const int sc_AmbientLightsCount 78 0
//spec_const int sc_DepthBufferMode 79 0
//spec_const int sc_DirectionalLightsCount 80 0
//spec_const int sc_EnvLightMode 81 0
//spec_const int sc_EnvmapDiffuseLayout 82 0
//spec_const int sc_EnvmapSpecularLayout 83 0
//spec_const int sc_LightEstimationSGCount 84 0
//spec_const int sc_MaxTextureImageUnits 85 0
//spec_const int sc_PointLightsCount 86 0
...
int l9_7=int(Port_SelectMode_N036);
float l9_8;
if (l9_7==0)
{
l9_8=mod(float(l9_5%257),float(l9_6));
}
else
{
l9_8=0.0;
...
if (l9_7==1)
{
int l9_10=((0^(int(float(l9_5^((l9_5*15299)+l9_5)))*30133))^631404)^(int(0.0*1000.0)*12113);
l9_9=floor(mix(0.0,float(l9_6),float(((l9_10*((l9_10*1471343)+101146501))+1559861749)&2147483647)*4.6566129e-10));
}
else
{
l9_9=l9_8;
...
if (l9_7==2)
{
l9_11=float(int(Tweak_N45));
}
else
{
l9_11=l9_9;
}
vec3 l9_12=ssSRGB_to_Linear(max(vec4(ssHue_to_RGB(l9_11/(numberMeshes+1.234e-06)),1.0).xyz,vec3(0.0)));
vec3 l9_13=normalize(normalize(varNormal));
vec3 l9_14=ssSRGB_to_Linear(Port_Emissive_N042);
vec3 l9_15;
#if (sc_SSAOEnabled)
{
...
#endif
vec3 l9_16=vec3(Port_Metallic_N042);
vec3 l9_17=mix(vec3(0.039999999),l9_12*Port_Metallic_N042,l9_16);
vec3 l9_18=mix(l9_12*(1.0-Port_Metallic_N042),vec3(0.0),l9_16);
SurfaceProperties l9_19=SurfaceProperties(l9_18,Port_Opacity_N042,l9_13,varPos,l9_4,Port_Metallic_N042,Port_Roughness_N042,l9_14,l9_15,Port_SpecularAO_N042,vec3(1.0),l9_17);
vec4 l9_20=vec4(1.0);
vec3 l9_21;
vec3 l9_22;
vec3 l9_23;
...
{
LightingComponents l9_40=accumulateLight(LightingComponents(l9_31,l9_30,l9_34,l9_33,l9_29,l9_28),LightProperties(sc_DirectionalLights[l9_39].direction,sc_DirectionalLights[l9_39].color.xyz,sc_DirectionalLights[l9_39].color.w*l9_20[(l9_32<3) ? l9_32 : 3]),l9_19,l9_4);
l9_34=l9_40.indirectDiffuse;
l9_33=l9_40.indirectSpecular;
l9_32++;
l9_31=l9_40.directDiffuse;
l9_30=l9_40.directSpecular;
l9_29=l9_40.emitted;
l9_28=l9_40.transmitted;
l9_39++;
continue;
}
else
...
l9_50=l9_58+1;
LightingComponents l9_65=accumulateLight(LightingComponents(l9_47,l9_46,l9_49,l9_48,l9_45,l9_44),LightProperties(l9_60,sc_PointLights[l9_57].color.xyz,l9_64),l9_19,l9_4);
...
{
vec2 l9_67=calcPanoramicTexCoordsFromDir(l9_13,sc_EnvmapRotation.y);
vec4 l9_68;
...
{
float l9_91=dot(sc_LightEstimationData.sg[l9_90].axis,l9_13);
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_102=clamp(pow(Port_Roughness_N042,0.66666669),0.0,1.0)*5.0;
vec2 l9_103=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_13,reflect(-l9_4,l9_13),Port_Roughness_N042),sc_EnvmapRotation.y);
vec4 l9_104;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
#endif
l9_101=vec3(0.0)+((((l9_104.xyz*(1.0/l9_104.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_19,abs(dot(l9_13,l9_4))));
}
#else
{
l9_101=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_108=clamp(Port_Roughness_N042*Port_Roughness_N042,0.0099999998,1.0);
vec3 l9_109;
l9_109=sc_LightEstimationData.ambientLight*l9_17;
int l9_110=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
...
vec3 l9_112=reflect(-l9_4,l9_13);
float l9_113=dot(l9_13,l9_4);
...
l9_122=vec3(0.0);
l9_121=vec3(0.0);
l9_120=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_18,vec3(Port_Opacity_N042));
l9_119=1.0;
}
#else
{
...
#endif
vec3 l9_124=l9_121*l9_15;
vec3 l9_125=l9_122+l9_124;
vec3 l9_126=l9_18*l9_125;
vec3 l9_127=l9_107*Port_SpecularAO_N042;
vec3 l9_128=l9_42+l9_127;
vec3 l9_129;
if (l9_123)
{
...
vec3 l9_131=(l9_130+l9_14)+l9_120;
...
{
vec4 l9_135=l9_133;
l9_135.x=l9_132+((l9_15.x*Port_SpecularAO_N042.x)*9.9999997e-06);
l9_134=l9_135;
}
#else
{
...
#endif
float l9_139=linearToSrgb(l9_136.x);
float l9_140=linearToSrgb(l9_136.y);
float l9_141=linearToSrgb(l9_136.z);
vec3 l9_142=vec3(l9_139,l9_140,l9_141);
vec4 l9_143=vec4(l9_142.x,l9_142.y,l9_142.z,l9_136.w);
vec4 l9_144=max(l9_143,vec4(0.0));
vec4 l9_145;
#if (sc_RenderAlphaToColor)
{
l9_145=vec4(l9_144.w);
}
#else
{
vec4 l9_146;
...
{
vec3 l9_147=sc_GetFramebufferColor().xyz;
vec3 l9_148=mix(l9_147,definedBlend(l9_147,l9_144.xyz).xyz,vec3(l9_144.w));
...
{
float l9_151=l9_144.w;
l9_150=vec4(mix(vec3(1.0),l9_144.xyz,vec3(l9_151)),l9_151);
}
#else
{
vec4 l9_152;
...
{
float l9_153=l9_144.w;
float l9_154;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_154=clamp(l9_153,0.0,1.0);
}
#else
{
l9_154=l9_153;
...
#endif
l9_152=vec4(l9_144.xyz*l9_154,l9_154);
}
#else
{
l9_152=l9_144;
