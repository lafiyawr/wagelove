...
//texture texture2D sc_RayTracedReflectionTexture 0:17:0:31
...
//}
//ubo int UserUniforms 0:39:4896 {
...
//float3 grainRotation 4576
//float knottyness 4592
//float scale 4596
//float4 lineColor 4608
//float roughness 4624
//float Port_Input0_N167 4628
//float Port_Import_N153 4632
//float Port_Input1_N154 4636
//float Port_Input0_N151 4640
//float2 Port_Center_N013 4704
//float2 Port_Center_N016 4712
//float2 Port_Center_N020 4720
//float Port_Value1_N001 4728
//float Port_Value3_N001 4732
//float3 Port_Import_N059 4752
//float2 Port_Scale_N081 4768
//float2 Port_Scale_N089 4776
//float2 Port_Scale_N094 4784
//float Port_Input1_N096 4792
//float Port_Input1_N157 4800
//float Port_Input0_N162 4804
//float Port_Input1_N166 4808
//float Port_Opacity_N176 4812
//float3 Port_Emissive_N176 4816
//float Port_Metallic_N176 4832
//float3 Port_AO_N176 4848
//float3 Port_SpecularAO_N176 4864
//float depthRef 4880
//}
...
//spec_const bool sc_RayTracedAoTextureHasSwappedViews 64 0
//spec_const bool sc_RayTracedDiffIndTextureHasSwappedViews 65 0
//spec_const bool sc_RayTracedReflectionTextureHasSwappedViews 66 0
//spec_const bool sc_RayTracedShadowTextureHasSwappedViews 67 0
...
//spec_const int sc_MaxTextureImageUnits 94 0
//spec_const int sc_PointLightsCount 95 0
//spec_const int sc_RayTracedAoTextureLayout 96 0
//spec_const int sc_RayTracedDiffIndTextureLayout 97 0
//spec_const int sc_RayTracedReflectionTextureLayout 98 0
//spec_const int sc_RayTracedShadowTextureLayout 99 0
...
constant bool sc_RayTracedAoTextureHasSwappedViews [[function_constant(64)]];
...
constant bool sc_RayTracedDiffIndTextureHasSwappedViews [[function_constant(65)]];
...
constant bool sc_RayTracedReflectionTextureHasSwappedViews [[function_constant(66)]];
...
constant bool sc_RayTracedShadowTextureHasSwappedViews [[function_constant(67)]];
...
constant int sc_MaxTextureImageUnits [[function_constant(94)]];
...
constant int sc_RayTracedAoTextureLayout [[function_constant(96)]];
...
constant int sc_RayTracedDiffIndTextureLayout [[function_constant(97)]];
...
constant int sc_RayTracedReflectionTextureLayout [[function_constant(98)]];
...
constant int sc_RayTracedShadowTextureLayout [[function_constant(99)]];
...
float4 baseColor;
float3 grainRotation;
float knottyness;
float scale;
float4 lineColor;
float roughness;
float Port_Input0_N167;
float Port_Import_N153;
float Port_Input1_N154;
float Port_Input0_N151;
float3 Port_Import_N010;
float3 Port_Import_N007;
float3 Port_Import_N012;
float2 Port_Center_N013;
float2 Port_Center_N016;
float2 Port_Center_N020;
float Port_Value1_N001;
float Port_Value3_N001;
float3 Port_Import_N057;
float3 Port_Import_N059;
float2 Port_Scale_N081;
float2 Port_Scale_N089;
float2 Port_Scale_N094;
float Port_Input1_N096;
float Port_Import_N156;
float Port_Input1_N157;
float Port_Input0_N162;
float Port_Input1_N166;
float Port_Opacity_N176;
float3 Port_Emissive_N176;
float Port_Metallic_N176;
float3 Port_AO_N176;
float3 Port_SpecularAO_N176;
float depthRef;
};
struct sc_Bone_t
{
...
Output_N98=param;
float Value_N153=0.0;
Value_N153=(*sc_set0.UserUniforms).Port_Import_N153;
float Output_N154=0.0;
Output_N154=Value_N153*(*sc_set0.UserUniforms).Port_Input1_N154;
float Output_N155=0.0;
Output_N155=Output_N154+Value_N153;
float3 Position_N6=float3(0.0);
Position_N6=Globals.SurfacePosition_ObjectSpace;
float3 Value_N10=float3(0.0);
Value_N10=Position_N6;
float2 Output1_N11=float2(0.0);
float Output2_N11=0.0;
float3 param_1=Value_N10;
float2 param_2=float2(param_1.xz);
float param_3=param_1.y;
Output1_N11=param_2;
Output2_N11=param_3;
float3 Output_N8=float3(0.0);
float3 param_4=(*sc_set0.UserUniforms).grainRotation;
Output_N8=param_4;
...
float Value2_N17=0.0;
float Value3_N17=0.0;
float3 param_5=Value_N12;
...
float2 param_9=Output1_N11;
float param_10=Value3_N17;
float2 param_11=(*sc_set0.UserUniforms).Port_Center_N013;
float l9_5=sin(radians(param_10));
float l9_6=cos(radians(param_10));
float2 param_12=param_9-param_11;
param_12=float2(dot(float2(l9_6,l9_5),param_12),dot(float2(-l9_5,l9_6),param_12))+param_11;
CoordsOut_N13=param_12;
float3 Output1_N14=float3(0.0);
Output1_N14=float3(CoordsOut_N13,Output2_N11);
float2 Output1_N15=float2(0.0);
float Output2_N15=0.0;
float3 param_13=Output1_N14;
float2 param_14=float2(param_13.xz);
float param_15=param_13.y;
Output1_N15=param_14;
Output2_N15=param_15;
float2 CoordsOut_N16=float2(0.0);
float2 param_16=Output1_N15;
float param_17=Value1_N17;
float2 param_18=(*sc_set0.UserUniforms).Port_Center_N016;
float l9_7=sin(radians(param_17));
float l9_8=cos(radians(param_17));
float2 param_19=param_16-param_18;
param_19=float2(dot(float2(l9_8,l9_7),param_19),dot(float2(-l9_7,l9_8),param_19))+param_18;
CoordsOut_N16=param_19;
float3 Output1_N18=float3(0.0);
Output1_N18=float3(Output2_N15,CoordsOut_N16);
float2 Output1_N19=float2(0.0);
float Output2_N19=0.0;
float3 param_20=Output1_N18;
float2 param_21=float2(param_20.xz);
float param_22=param_20.y;
Output1_N19=param_21;
Output2_N19=param_22;
float2 CoordsOut_N20=float2(0.0);
float2 param_23=Output1_N19;
float param_24=Value2_N17;
float2 param_25=(*sc_set0.UserUniforms).Port_Center_N020;
float l9_9=sin(radians(param_24));
float l9_10=cos(radians(param_24));
float2 param_26=param_23-param_25;
param_26=float2(dot(float2(l9_10,l9_9),param_26),dot(float2(-l9_9,l9_10),param_26))+param_25;
CoordsOut_N20=param_26;
float3 Output1_N21=float3(0.0);
Output1_N21=float3(CoordsOut_N20.x,Output2_N19,CoordsOut_N20.y);
float3 Export_N22=float3(0.0);
Export_N22=Output1_N21;
float2 Output_N56=float2(0.0);
Output_N56=float2(Export_N22.y,Export_N22.z);
float Output_N3=0.0;
float param_27=(*sc_set0.UserUniforms).knottyness;
Output_N3=param_27;
float3 Value_N1=float3(0.0);
Value_N1.x=(*sc_set0.UserUniforms).Port_Value1_N001;
Value_N1.y=Output_N3;
Value_N1.z=(*sc_set0.UserUniforms).Port_Value3_N001;
float3 Output_N171=float3(0.0);
float3 param_28=Value_N1;
float l9_11=dot(param_28,param_28);
float l9_12;
if (l9_11>0.0)
{
...
float l9_13=l9_12;
float3 param_29=param_28*l9_13;
Output_N171=param_29;
float3 Value_N57=float3(0.0);
Value_N57=Output_N171;
float2 Output_N58=float2(0.0);
Output_N58=float2(Value_N57.y,Value_N57.z);
float3 Value_N59=float3(0.0);
Value_N59=(*sc_set0.UserUniforms).Port_Import_N059;
float2 Output_N60=float2(0.0);
Output_N60=float2(Value_N59.y,Value_N59.z);
float2 Output_N79=float2(0.0);
Output_N79=(Output_N56*Output_N58)+Output_N60;
float Noise_N81=0.0;
float2 param_30=Output_N79;
float2 param_31=(*sc_set0.UserUniforms).Port_Scale_N081;
param_30.x=floor(param_30.x*10000.0)*9.9999997e-05;
param_30.y=floor(param_30.y*10000.0)*9.9999997e-05;
param_30*=(param_31*0.5);
float2 l9_14=param_30;
float param_32=(snoise(l9_14)*0.5)+0.5;
param_32=floor(param_32*10000.0)*9.9999997e-05;
Noise_N81=param_32;
float2 Output_N82=float2(0.0);
Output_N82=float2(Export_N22.z,Export_N22.x);
float2 Output_N83=float2(0.0);
Output_N83=float2(Value_N57.z,Value_N57.x);
float2 Output_N85=float2(0.0);
Output_N85=float2(Value_N59.z,Value_N59.x);
float2 Output_N86=float2(0.0);
Output_N86=(Output_N82*Output_N83)+Output_N85;
float Noise_N89=0.0;
float2 param_33=Output_N86;
float2 param_34=(*sc_set0.UserUniforms).Port_Scale_N089;
param_33.x=floor(param_33.x*10000.0)*9.9999997e-05;
param_33.y=floor(param_33.y*10000.0)*9.9999997e-05;
param_33*=(param_34*0.5);
float2 l9_15=param_33;
float param_35=(snoise(l9_15)*0.5)+0.5;
param_35=floor(param_35*10000.0)*9.9999997e-05;
Noise_N89=param_35;
float2 Output_N90=float2(0.0);
Output_N90=float2(Export_N22.x,Export_N22.y);
float2 Output_N91=float2(0.0);
Output_N91=float2(Value_N57.x,Value_N57.y);
float2 Output_N92=float2(0.0);
Output_N92=float2(Value_N59.x,Value_N59.y);
float2 Output_N93=float2(0.0);
Output_N93=(Output_N90*Output_N91)+Output_N92;
float Noise_N94=0.0;
float2 param_36=Output_N93;
float2 param_37=(*sc_set0.UserUniforms).Port_Scale_N094;
param_36.x=floor(param_36.x*10000.0)*9.9999997e-05;
param_36.y=floor(param_36.y*10000.0)*9.9999997e-05;
param_36*=(param_37*0.5);
float2 l9_16=param_36;
float param_38=(snoise(l9_16)*0.5)+0.5;
param_38=floor(param_38*10000.0)*9.9999997e-05;
Noise_N94=param_38;
float Output_N95=0.0;
Output_N95=(Noise_N81+Noise_N89)+Noise_N94;
float Output_N96=0.0;
Output_N96=Output_N95*(*sc_set0.UserUniforms).Port_Input1_N096;
float Export_N97=0.0;
Export_N97=Output_N96;
float Output_N179=0.0;
float param_39=(*sc_set0.UserUniforms).scale;
Output_N179=param_39;
float Output_N151=0.0;
Output_N151=((*sc_set0.UserUniforms).Port_Input0_N151*Export_N97)*Output_N179;
float Value_N156=0.0;
Value_N156=Output_N151;
float Output_N157=0.0;
Output_N157=Value_N156*(*sc_set0.UserUniforms).Port_Input1_N157;
float Output_N159=0.0;
Output_N159=3.1415927;
float Output_N160=0.0;
Output_N160=Output_N157*Output_N159;
float Output_N161=0.0;
Output_N161=sin(Output_N160);
float Output_N162=0.0;
Output_N162=(*sc_set0.UserUniforms).Port_Input0_N162*Value_N153;
float Output_N163=0.0;
Output_N163=Output_N161+Output_N162;
float Output_N164=0.0;
Output_N164=sin(Output_N163);
float Output_N165=0.0;
Output_N165=abs(Output_N164);
float Output_N166=0.0;
Output_N166=Output_N165*(*sc_set0.UserUniforms).Port_Input1_N166;
float Output_N167=0.0;
Output_N167=smoothstep((*sc_set0.UserUniforms).Port_Input0_N167,Output_N155,Output_N166);
float Export_N168=0.0;
Export_N168=Output_N167;
float4 Output_N99=float4(0.0);
Output_N99=Output_N98*float4(Export_N168);
float4 Output_N173=float4(0.0);
float4 param_40=(*sc_set0.UserUniforms).lineColor;
Output_N173=param_40;
float Output_N169=0.0;
Output_N169=1.0-Export_N168;
float4 Output_N174=float4(0.0);
Output_N174=Output_N173*float4(Output_N169);
float4 Output_N175=float4(0.0);
Output_N175=Output_N99+Output_N174;
float Output_N178=0.0;
float param_41=(*sc_set0.UserUniforms).roughness;
Output_N178=param_41;
float Output_N177=0.0;
Output_N177=Output_N169+Output_N178;
float4 Output_N176=float4(0.0);
float3 param_42=Output_N175.xyz;
float param_43=(*sc_set0.UserUniforms).Port_Opacity_N176;
float3 param_44=float3(Output_N177);
float3 param_45=(*sc_set0.UserUniforms).Port_Emissive_N176;
float param_46=(*sc_set0.UserUniforms).Port_Metallic_N176;
float param_47=Output_N177;
float3 param_48=(*sc_set0.UserUniforms).Port_AO_N176;
float3 param_49=(*sc_set0.UserUniforms).Port_SpecularAO_N176;
ssGlobals param_51=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_51.BumpedNormal=float3x3(float3(param_51.VertexTangent_WorldSpace),float3(param_51.VertexBinormal_WorldSpace),float3(param_51.VertexNormal_WorldSpace))*param_44;
}
float l9_17=param_43;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_17<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
{
float4 l9_41=param_54;
float4 l9_42=float4(0.0);
float4 l9_43=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_44=out.FragColor0;
float4 l9_45=l9_44;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_45.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_46=l9_45;
l9_43=l9_46;
}
...
{
float4 l9_47=gl_FragCoord;
float2 l9_48=l9_47.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_49=l9_48;
...
int l9_53=l9_52;
int l9_54=l9_53;
float3 l9_55=float3(l9_49,0.0);
int l9_56=l9_51;
int l9_57=l9_54;
if (l9_56==1)
{
l9_55.y=((2.0*l9_55.y)+float(l9_57))-1.0;
}
float2 l9_58=l9_55.xy;
l9_50=l9_58;
}
else
{
...
float2 l9_74=l9_70;
int l9_75=sc_ScreenTextureLayout_tmp;
int l9_76=l9_71;
float l9_77=l9_72;
float2 l9_78=l9_74;
int l9_79=l9_75;
...
float l9_85=l9_77;
float4 l9_86=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_84,bias(l9_85));
float4 l9_87=l9_86;
l9_73=l9_87;
float4 l9_88=l9_73;
float4 l9_89=l9_88;
...
l9_42=float4(l9_96.x,l9_96.y,l9_96.z,l9_42.w);
float3 l9_97=mix(l9_93,l9_42.xyz,float3(l9_41.w));
l9_42=float4(l9_97.x,l9_97.y,l9_97.z,l9_42.w);
l9_42.w=1.0;
float4 l9_98=l9_42;
param_54=l9_98;
}
...
{
float4 l9_99=param_54;
float4 l9_100=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_100=float4(mix(float3(1.0),l9_99.xyz,float3(l9_99.w)),l9_99.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_101=l9_99.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_101=fast::clamp(l9_101,0.0,1.0);
}
l9_100=float4(l9_99.xyz*l9_101,l9_101);
}
else
{
l9_100=l9_99;
...
float4 l9_102=l9_100;
param_54=l9_102;
}
}
}
float4 l9_103=param_54;
FinalColor=l9_103;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_104=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_104=float4(0.0);
...
float3 param_55=in.varPos;
float4 param_56=FinalColor;
FinalColor=outputMotionVectorsIfNeeded(param_55,param_56,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_57=FinalColor;
float4 l9_106=param_57;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_106.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_106;
return out;
}
} // FRAGMENT SHADER
...
float2 Output1_N11=float2(0.0);
float Output2_N11=0.0;
float3 param=Value_N10;
float2 param_1=float2(param.xz);
float param_2=param.y;
Output1_N11=param_1;
Output2_N11=param_2;
float3 Output_N8=float3(0.0);
float3 param_3=(*sc_set0.UserUniforms).grainRotation;
Output_N8=param_3;
float3 Value_N7=float3(0.0);
Value_N7=Output_N8;
float3 Value_N12=float3(0.0);
...
Value3_N17=param_7;
float2 CoordsOut_N13=float2(0.0);
float2 param_8=Output1_N11;
float param_9=Value3_N17;
float2 param_10=(*sc_set0.UserUniforms).Port_Center_N013;
float l9_0=sin(radians(param_9));
float l9_1=cos(radians(param_9));
float2 param_11=param_8-param_10;
param_11=float2(dot(float2(l9_1,l9_0),param_11),dot(float2(-l9_0,l9_1),param_11))+param_10;
CoordsOut_N13=param_11;
float3 Output1_N14=float3(0.0);
Output1_N14=float3(CoordsOut_N13,Output2_N11);
float2 Output1_N15=float2(0.0);
float Output2_N15=0.0;
float3 param_12=Output1_N14;
float2 param_13=float2(param_12.xz);
float param_14=param_12.y;
Output1_N15=param_13;
Output2_N15=param_14;
float2 CoordsOut_N16=float2(0.0);
float2 param_15=Output1_N15;
float param_16=Value1_N17;
float2 param_17=(*sc_set0.UserUniforms).Port_Center_N016;
float l9_2=sin(radians(param_16));
float l9_3=cos(radians(param_16));
float2 param_18=param_15-param_17;
param_18=float2(dot(float2(l9_3,l9_2),param_18),dot(float2(-l9_2,l9_3),param_18))+param_17;
CoordsOut_N16=param_18;
float3 Output1_N18=float3(0.0);
Output1_N18=float3(Output2_N15,CoordsOut_N16);
float2 Output1_N19=float2(0.0);
float Output2_N19=0.0;
float3 param_19=Output1_N18;
float2 param_20=float2(param_19.xz);
float param_21=param_19.y;
Output1_N19=param_20;
Output2_N19=param_21;
float2 CoordsOut_N20=float2(0.0);
float2 param_22=Output1_N19;
float param_23=Value2_N17;
float2 param_24=(*sc_set0.UserUniforms).Port_Center_N020;
float l9_4=sin(radians(param_23));
float l9_5=cos(radians(param_23));
float2 param_25=param_22-param_24;
param_25=float2(dot(float2(l9_5,l9_4),param_25),dot(float2(-l9_4,l9_5),param_25))+param_24;
CoordsOut_N20=param_25;
float3 Output1_N21=float3(0.0);
Output1_N21=float3(CoordsOut_N20.x,Output2_N19,CoordsOut_N20.y);
float3 Export_N22=float3(0.0);
Export_N22=Output1_N21;
...
Output_N56=float2(Export_N22.y,Export_N22.z);
float Output_N3=0.0;
float param_26=(*sc_set0.UserUniforms).knottyness;
Output_N3=param_26;
float3 Value_N1=float3(0.0);
Value_N1.x=(*sc_set0.UserUniforms).Port_Value1_N001;
Value_N1.y=Output_N3;
Value_N1.z=(*sc_set0.UserUniforms).Port_Value3_N001;
float3 Output_N171=float3(0.0);
float3 param_27=Value_N1;
float l9_6=dot(param_27,param_27);
float l9_7;
if (l9_6>0.0)
{
l9_7=1.0/sqrt(l9_6);
...
float l9_8=l9_7;
float3 param_28=param_27*l9_8;
Output_N171=param_28;
float3 Value_N57=float3(0.0);
Value_N57=Output_N171;
float2 Output_N58=float2(0.0);
Output_N58=float2(Value_N57.y,Value_N57.z);
...
Output_N79=(Output_N56*Output_N58)+Output_N60;
float Noise_N81=0.0;
float2 param_29=Output_N79;
float2 param_30=(*sc_set0.UserUniforms).Port_Scale_N081;
param_29.x=floor(param_29.x*10000.0)*9.9999997e-05;
param_29.y=floor(param_29.y*10000.0)*9.9999997e-05;
param_29*=(param_30*0.5);
float2 l9_9=param_29;
float param_31=(snoise(l9_9)*0.5)+0.5;
...
Output_N86=(Output_N82*Output_N83)+Output_N85;
float Noise_N89=0.0;
float2 param_32=Output_N86;
float2 param_33=(*sc_set0.UserUniforms).Port_Scale_N089;
param_32.x=floor(param_32.x*10000.0)*9.9999997e-05;
param_32.y=floor(param_32.y*10000.0)*9.9999997e-05;
param_32*=(param_33*0.5);
float2 l9_10=param_32;
float param_34=(snoise(l9_10)*0.5)+0.5;
param_34=floor(param_34*10000.0)*9.9999997e-05;
Noise_N89=param_34;
float2 Output_N90=float2(0.0);
Output_N90=float2(Export_N22.x,Export_N22.y);
float2 Output_N91=float2(0.0);
...
Output_N93=(Output_N90*Output_N91)+Output_N92;
float Noise_N94=0.0;
float2 param_35=Output_N93;
float2 param_36=(*sc_set0.UserUniforms).Port_Scale_N094;
param_35.x=floor(param_35.x*10000.0)*9.9999997e-05;
param_35.y=floor(param_35.y*10000.0)*9.9999997e-05;
param_35*=(param_36*0.5);
float2 l9_11=param_35;
float param_37=(snoise(l9_11)*0.5)+0.5;
...
Export_N97=Output_N96;
float Output_N179=0.0;
float param_38=(*sc_set0.UserUniforms).scale;
Output_N179=param_38;
float Output_N151=0.0;
Output_N151=((*sc_set0.UserUniforms).Port_Input0_N151*Export_N97)*Output_N179;
float Value_N156=0.0;
Value_N156=Output_N151;
...
Output_N169=1.0-Export_N168;
float Output_N178=0.0;
float param_39=(*sc_set0.UserUniforms).roughness;
Output_N178=param_39;
float Output_N177=0.0;
Output_N177=Output_N169+Output_N178;
float param_40=(*sc_set0.UserUniforms).Port_Opacity_N176;
float3 param_41=float3(Output_N177);
float param_42=Output_N177;
...
float l9_12=param_40;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_12<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float3 l9_16=param_43.PositionWS;
float3 l9_17=param_43.BumpedNormal;
float l9_18=param_42;
float3 l9_19=normalize((*sc_set0.UserUniforms).sc_Camera.position-l9_16);
if (dot(l9_19,l9_17)>=(-0.050000001))
{
uint3 l9_20=uint3(round((l9_16-(*sc_set0.UserUniforms).OriginNormalizationOffset)*(*sc_set0.UserUniforms).OriginNormalizationScale));
out.position_and_mask=uint4(l9_20.x,l9_20.y,l9_20.z,out.position_and_mask.w);
out.position_and_mask.w=uint((*sc_set0.UserUniforms).receiver_mask);
float3 l9_21=l9_17;
float l9_22=dot(abs(l9_21),float3(1.0));
l9_21/=float3(l9_22);
float l9_23=fast::clamp(-l9_21.z,0.0,1.0);
float2 l9_24=l9_21.xy;
float l9_25;
if (l9_21.x>=0.0)
{
l9_25=l9_23;
...
float2 l9_27=l9_24;
float2 l9_28=l9_27;
uint2 l9_29=uint2(as_type<uint>(half2(float2(l9_28.x,0.0))),as_type<uint>(half2(float2(l9_28.y,0.0))));
out.normal_and_more=uint4(l9_29.x,l9_29.y,out.normal_and_more.z,out.normal_and_more.w);
...
{
l9_30=uint(fast::clamp(l9_18,0.0,1.0)*1000.0);
}
uint l9_31=l9_30;
l9_31 |= uint(((*sc_set0.UserUniforms).receiverId%32)<<int(10u));
out.normal_and_more.w=l9_31;
}
else
{
