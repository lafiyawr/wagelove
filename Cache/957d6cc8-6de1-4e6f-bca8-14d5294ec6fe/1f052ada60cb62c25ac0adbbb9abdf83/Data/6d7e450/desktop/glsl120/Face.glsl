...
float l9_4=radians(grainRotation.z);
float l9_5=sin(l9_4);
float l9_6=cos(l9_4);
vec2 l9_7=vec2(l9_3.xz)-Port_Center_N013;
vec2 l9_8=vec2(dot(vec2(l9_6,l9_5),l9_7),dot(vec2(-l9_5,l9_6),l9_7))+Port_Center_N013;
float l9_9=radians(grainRotation.x);
float l9_10=sin(l9_9);
float l9_11=cos(l9_9);
vec2 l9_12=vec2(l9_8.x,l9_3.y)-Port_Center_N016;
vec2 l9_13=vec2(dot(vec2(l9_11,l9_10),l9_12),dot(vec2(-l9_10,l9_11),l9_12))+Port_Center_N016;
float l9_14=l9_13.x;
float l9_15=radians(grainRotation.y);
float l9_16=sin(l9_15);
float l9_17=cos(l9_15);
vec2 l9_18=vec2(l9_8.y,l9_13.y)-Port_Center_N020;
vec2 l9_19=vec2(dot(vec2(l9_17,l9_16),l9_18),dot(vec2(-l9_16,l9_17),l9_18))+Port_Center_N020;
float l9_20=l9_19.y;
vec3 l9_21=vec3(Port_Value1_N001,knottyness,Port_Value3_N001);
...
vec2 l9_25=(vec2(l9_14,l9_20)*vec2(l9_24.yz))+vec2(Port_Import_N059.yz);
float l9_26=snoise(vec2(floor(l9_25.x*10000.0)*9.9999997e-05,floor(l9_25.y*10000.0)*9.9999997e-05)*(Port_Scale_N081*0.5));
vec2 l9_27=(vec2(l9_20,l9_19.x)*vec2(l9_24.zx))+vec2(Port_Import_N059.zx);
float l9_28=snoise(vec2(floor(l9_27.x*10000.0)*9.9999997e-05,floor(l9_27.y*10000.0)*9.9999997e-05)*(Port_Scale_N089*0.5));
vec2 l9_29=(vec2(l9_19.x,l9_14)*vec2(l9_24.xy))+vec2(Port_Import_N059.xy);
float l9_30=snoise(vec2(floor(l9_29.x*10000.0)*9.9999997e-05,floor(l9_29.y*10000.0)*9.9999997e-05)*(Port_Scale_N094*0.5));
float l9_31=smoothstep(Port_Input0_N167,(Port_Import_N153*Port_Input1_N154)+Port_Import_N153,abs(sin(sin((((Port_Input0_N151*((((floor(((l9_26*0.5)+0.5)*10000.0)*9.9999997e-05)+(floor(((l9_28*0.5)+0.5)*10000.0)*9.9999997e-05))+(floor(((l9_30*0.5)+0.5)*10000.0)*9.9999997e-05))*Port_Input1_N096))*scale)*Port_Input1_N157)*3.1415927)+(Port_Input0_N162*Port_Import_N153)))*Port_Input1_N166);
float l9_32=1.0-l9_31;
float l9_33=l9_32+roughness;
vec3 l9_34;
#if (!sc_ProjectiveShadowsCaster)
{
l9_34=mat3(l9_1,cross(l9_2,l9_1)*varTangent.w,l9_2)*vec3(l9_33);
}
#else
{
l9_34=vec3(0.0);
...
#endif
vec3 l9_35=max(((baseColor*vec4(l9_31))+(lineColor*vec4(l9_32))).xyz,vec3(0.0));
vec4 l9_36;
#if (sc_ProjectiveShadowsCaster)
{
l9_36=vec4(l9_35,Port_Opacity_N176);
}
#else
{
float l9_37=clamp(l9_33,0.0,1.0);
vec3 l9_38=ssSRGB_to_Linear(l9_35);
vec3 l9_39=normalize(l9_34);
vec3 l9_40=ssSRGB_to_Linear(Port_Emissive_N176);
vec3 l9_41;
#if (sc_SSAOEnabled)
{
l9_41=evaluateSSAO(varPos);
}
#else
{
l9_41=Port_AO_N176;
...
#endif
vec3 l9_42=vec3(Port_Metallic_N176);
vec3 l9_43=mix(vec3(0.039999999),l9_38*Port_Metallic_N176,l9_42);
vec3 l9_44=mix(l9_38*(1.0-Port_Metallic_N176),vec3(0.0),l9_42);
SurfaceProperties l9_45=SurfaceProperties(l9_44,Port_Opacity_N176,l9_39,varPos,l9_0,Port_Metallic_N176,l9_37,l9_40,l9_41,Port_SpecularAO_N176,vec3(1.0),l9_43);
vec4 l9_46=vec4(1.0);
vec3 l9_47;
vec3 l9_48;
vec3 l9_49;
...
l9_55=vec3(0.0);
l9_54=vec3(0.0);
LightingComponents l9_61;
LightProperties l9_62;
SurfaceProperties l9_63;
vec3 l9_64;
int l9_65=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_65<sc_DirectionalLightsCount)
{
LightingComponents l9_66=accumulateLight(LightingComponents(l9_54,l9_55,l9_60,l9_59,l9_57,l9_56),LightProperties(sc_DirectionalLights[l9_65].direction,sc_DirectionalLights[l9_65].color.xyz,sc_DirectionalLights[l9_65].color.w*l9_46[(l9_58<3) ? l9_58 : 3]),l9_45,l9_0);
l9_60=l9_66.indirectDiffuse;
l9_59=l9_66.indirectSpecular;
l9_58++;
l9_57=l9_66.emitted;
l9_56=l9_66.transmitted;
l9_55=l9_66.directSpecular;
l9_54=l9_66.directDiffuse;
l9_65++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_83<sc_PointLightsCount)
{
vec3 l9_85=sc_PointLights[l9_83].position-varPos;
vec3 l9_86=normalize(l9_85);
float l9_87=l9_46[(l9_84<3) ? l9_84 : 3];
float l9_88=clamp((dot(l9_86,sc_PointLights[l9_83].direction)*sc_PointLights[l9_83].angleScale)+sc_PointLights[l9_83].angleOffset,0.0,1.0);
float l9_89=(sc_PointLights[l9_83].color.w*l9_87)*(l9_88*l9_88);
float l9_90;
if (sc_PointLights[l9_83].falloffEnabled)
{
l9_90=l9_89*computeDistanceAttenuation(length(l9_85),sc_PointLights[l9_83].falloffEndDistance);
}
else
{
l9_90=l9_89;
...
l9_76=l9_84+1;
LightingComponents l9_91=accumulateLight(LightingComponents(l9_70,l9_71,l9_75,l9_74,l9_73,l9_72),LightProperties(l9_86,sc_PointLights[l9_83].color.xyz,l9_90),l9_45,l9_0);
l9_77=l9_91.directDiffuse;
l9_78=l9_91.directSpecular;
l9_79=l9_91.indirectDiffuse;
l9_80=l9_91.indirectSpecular;
l9_81=l9_91.emitted;
l9_82=l9_91.transmitted;
l9_75=l9_79;
l9_74=l9_80;
l9_84=l9_76;
l9_73=l9_81;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_95=abs(varShadowTex-vec2(0.5));
vec4 l9_96=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_95.x,l9_95.y),0.5);
l9_94=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_96.xyz,vec3(sc_ShadowColor.w)),vec3(l9_96.w*sc_ShadowDensity));
}
#else
{
l9_94=vec3(1.0);
...
{
vec2 l9_98=calcPanoramicTexCoordsFromDir(l9_39,sc_EnvmapRotation.y);
vec4 l9_99;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_100=calcSeamlessPanoramicUvsForSampling(l9_98,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_100=l9_98;
...
#endif
l9_99=sc_EnvmapSpecularSampleViewIndexBias(l9_100,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_101;
...
{
vec2 l9_102=calcSeamlessPanoramicUvsForSampling(l9_98,sc_EnvmapDiffuseSize.xy,0.0);
int l9_103;
...
#endif
l9_101=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_102,sc_EnvmapDiffuseLayout,l9_103).xy,-13.0);
}
#else
{
l9_101=sc_EnvmapSpecularSampleViewIndexBias(l9_98,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_99=l9_101;
}
#endif
l9_97=(l9_99.xyz*(1.0/l9_99.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_104;
...
{
l9_110=l9_97+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_111=l9_97;
l9_111.x=l9_97.x+(1e-06*sc_AmbientLights[0].color.x);
l9_110=l9_111;
}
#endif
l9_109=l9_110;
...
{
l9_113=l9_109+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_114=l9_109;
l9_114.x=l9_109.x+(1e-06*sc_AmbientLights[1].color.x);
l9_113=l9_114;
}
#endif
l9_112=l9_113;
...
{
l9_116=l9_112+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_117=l9_112;
l9_117.x=l9_112.x+(1e-06*sc_AmbientLights[2].color.x);
l9_116=l9_117;
}
#endif
l9_115=l9_116;
...
{
vec3 l9_119;
l9_119=sc_LightEstimationData.ambientLight;
vec3 l9_120;
int l9_121=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
...
{
float l9_122=dot(sc_LightEstimationData.sg[l9_121].axis,l9_39);
float l9_123=exp(-sc_LightEstimationData.sg[l9_121].sharpness);
float l9_124=l9_123*l9_123;
float l9_125=1.0/sc_LightEstimationData.sg[l9_121].sharpness;
float l9_126=(1.0+(2.0*l9_124))-l9_125;
float l9_127=sqrt(1.0-l9_126);
float l9_128=0.36000001*l9_122;
float l9_129=(1.0/(4.0*0.36000001))*l9_127;
float l9_130=l9_128+l9_129;
float l9_131;
if (step(abs(l9_128),l9_129)>0.5)
{
l9_131=(l9_130*l9_130)/l9_127;
}
else
{
l9_131=clamp(l9_122,0.0,1.0);
}
l9_120=l9_119+((((sc_LightEstimationData.sg[l9_121].color/vec3(sc_LightEstimationData.sg[l9_121].sharpness))*6.2831855)*((l9_126*l9_131)+(((l9_123-l9_124)*l9_125)-l9_124)))/vec3(3.1415927));
l9_119=l9_120;
l9_121++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_133=clamp(pow(l9_37,0.66666669),0.0,1.0)*5.0;
vec2 l9_134=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_39,reflect(-l9_0,l9_39),l9_37),sc_EnvmapRotation.y);
vec4 l9_135;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_136=floor(l9_133);
float l9_137=ceil(l9_133);
l9_135=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_134,sc_EnvmapSpecularSize.xy,l9_136),sc_EnvmapSpecularGetStereoViewIndex(),l9_136),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_134,sc_EnvmapSpecularSize.xy,l9_137),sc_EnvmapSpecularGetStereoViewIndex(),l9_137),vec4(l9_133-l9_136));
}
#else
{
l9_135=sc_EnvmapSpecularSampleViewIndexLevel(l9_134,sc_EnvmapSpecularGetStereoViewIndex(),l9_133);
}
#endif
l9_132=vec3(0.0)+((((l9_135.xyz*(1.0/l9_135.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_45,abs(dot(l9_39,l9_0))));
}
#else
{
l9_132=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_139=clamp(l9_37*l9_37,0.0099999998,1.0);
vec3 l9_140;
l9_140=sc_LightEstimationData.ambientLight*l9_43;
int l9_141=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_141<sc_LightEstimationSGCount)
{
float l9_142=l9_139*l9_139;
vec3 l9_143=reflect(-l9_0,l9_39);
float l9_144=dot(l9_39,l9_0);
float l9_145=(2.0/l9_142)/(4.0*max(l9_144,9.9999997e-05));
float l9_146=length((l9_143*l9_145)+(sc_LightEstimationData.sg[l9_141].axis*sc_LightEstimationData.sg[l9_141].sharpness));
float l9_147=clamp(dot(l9_39,l9_143),0.0,1.0);
float l9_148=clamp(l9_144,0.0,1.0);
float l9_149=1.0-l9_142;
l9_140+=((((((((vec3(1.0/(3.1415927*l9_142))*exp((l9_146-l9_145)-sc_LightEstimationData.sg[l9_141].sharpness))*sc_LightEstimationData.sg[l9_141].color)*6.2831855)*(1.0-exp((-2.0)*l9_146)))/vec3(l9_146))*((1.0/(l9_147+sqrt(l9_142+((l9_149*l9_147)*l9_147))))*(1.0/(l9_148+sqrt(l9_142+((l9_149*l9_148)*l9_148))))))*(l9_43+((vec3(1.0)-l9_43)*pow(1.0-clamp(dot(l9_143,normalize(l9_143+l9_0)),0.0,1.0),5.0))))*l9_147);
l9_141++;
continue;
}
else
...
l9_153=vec3(0.0);
l9_152=vec3(0.0);
l9_151=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_44,vec3(Port_Opacity_N176));
l9_150=1.0;
}
#else
{
...
#endif
vec3 l9_155=l9_152*l9_41;
vec3 l9_156=l9_153+l9_155;
vec3 l9_157=l9_44*l9_156;
vec3 l9_158=l9_138*Port_SpecularAO_N176;
vec3 l9_159=l9_92+l9_158;
vec3 l9_160;
if (l9_154)
{
l9_160=l9_157*srgbToLinear(l9_150);
}
else
{
l9_160=l9_157;
}
vec3 l9_161=l9_160+l9_159;
vec3 l9_162=(l9_161+l9_40)+l9_151;
float l9_163=l9_162.x;
vec4 l9_164=vec4(l9_163,l9_162.yz,l9_150);
vec4 l9_165;
#if (sc_IsEditor)
{
vec4 l9_166=l9_164;
l9_166.x=l9_163+((l9_41.x*Port_SpecularAO_N176.x)*9.9999997e-06);
l9_165=l9_166;
}
#else
{
...
{
vec3 l9_168=l9_165.xyz*1.8;
vec3 l9_169=(l9_165.xyz*(l9_168+vec3(1.4)))/((l9_165.xyz*(l9_168+vec3(0.5)))+vec3(1.5));
l9_167=vec4(l9_169.x,l9_169.y,l9_169.z,l9_165.w);
}
#else
{
l9_167=l9_165;
...
#endif
vec3 l9_170=vec3(linearToSrgb(l9_167.x),linearToSrgb(l9_167.y),linearToSrgb(l9_167.z));
l9_36=vec4(l9_170.x,l9_170.y,l9_170.z,l9_167.w);
}
#endif
vec4 l9_171=max(l9_36,vec4(0.0));
vec4 l9_172;
#if (sc_ProjectiveShadowsCaster)
{
float l9_173;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_201-0.0039215689)),min(1.0,l9_201+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_203),packValue(l9_203),packValue(l9_203),packValue(l9_203)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
sc_writeFragData0Internal(l9_245,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
