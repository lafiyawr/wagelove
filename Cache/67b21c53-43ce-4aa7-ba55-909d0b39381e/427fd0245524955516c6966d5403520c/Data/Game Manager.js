...
function onReady() {
    ...
    try {
        ...
        syncEntity.onEventReceived.add('playerCompletedSelections', function(eventData, messageInfo) {
            print("Player completed their tearth touch");
            handlePlayerCompletedSelections(eventData, messageInfo);
        });
        
        
         syncEntity.onEventReceived.add('playerCompletedHealing', function(eventData, messageInfo) {
            print("Player completed their Healing");
            handlePlayerCompletedSelections(eventData, messageInfo);
        });
        ...
        global.onPlayerCompletedTouch = onPlayerCompletedTouch;
        script.api.onPlayerCompletedTouch = onPlayerCompletedTouch;// For script component access
...
function onPlayerCompletedTouch() {
