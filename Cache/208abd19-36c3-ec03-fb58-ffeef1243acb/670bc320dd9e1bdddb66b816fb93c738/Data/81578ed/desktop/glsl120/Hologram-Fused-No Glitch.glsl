...
#endif
vec3 l9_0=(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz+vec3(sc_Time.x*Port_Multiplier_N134);
float l9_1;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
vec2 l9_2=vec2(floor(l9_0.x*10000.0)*9.9999997e-05,floor(l9_0.y*10000.0)*9.9999997e-05)*Port_Scale_N136;
float l9_3;
vec3 l9_4;
l9_3=0.0;
...
vec2 l9_14=VoronoiHash2D(l9_13+floor(l9_2),abs(Port_Offset_N136)+1000.0);
...
#endif
float l9_16=l9_1*clamp(Port_Import_N137,0.0,3.0);
float l9_17=clamp(Port_Import_N139,0.0,1.0);
vec4 l9_18=vec4(l9_16,l9_17,Port_Value3_N142,0.0);
float l9_19=3.0*fract(l9_16+0.16666667);
float l9_20=2.0*fract(l9_19);
vec2 l9_21=l9_18.zz-((vec2(1.0,l9_20)-vec2(max(0.0,l9_20-1.0)))*(Port_Value3_N142*clamp(l9_17,0.0,1.0)));
vec3 l9_22=vec3(l9_18.z,l9_21.x,l9_21.y);
vec3 l9_23;
if (l9_19>=1.0)
{
l9_23=l9_22.zxy;
...
vec4 l9_25=(Port_Input0_N022+Port_Input1_N022)+(vec4(1.0-clamp(dot(normalize(sc_Camera.position-varPos),normalize(varNormal)),0.0,1.0))*vec4(l9_24,1.0));
...
{
l9_29=clamp(Opacity*2.0,0.0,1.0);
}
#else
{
float l9_30;
...
{
l9_30=clamp(dot(l9_26.xyz,vec3(Opacity)),0.0,1.0);
}
#else
{
float l9_31;
...
{
l9_32=(1.0-dot(l9_26.xyz,vec3(0.33333001)))*Opacity;
}
#else
{
float l9_33;
...
{
l9_33=(1.0-clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0))*Opacity;
}
#else
{
float l9_34;
...
{
l9_34=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0)*Opacity;
}
#else
{
float l9_35;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_36=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0)*Opacity;
}
#else
{
float l9_37;
...
{
l9_37=dot(l9_26.xyz,vec3(0.33333001))*Opacity;
}
#else
{
float l9_38;
...
#endif
vec3 l9_50=mix(l9_48.xyz,definedBlend(l9_48.xyz,l9_26.xyz).xyz,vec3(Opacity));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_52=vec4(mix(vec3(1.0),l9_26.xyz,vec3(Opacity)),Opacity);
}
#else
{
vec4 l9_53;
