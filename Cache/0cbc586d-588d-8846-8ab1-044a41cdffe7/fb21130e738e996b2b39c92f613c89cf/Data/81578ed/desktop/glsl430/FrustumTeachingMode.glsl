...
vec4 l9_121=vec4(l9_2);
vec4 l9_122;
#if (Tweak_N99Layout==2)
{
bool l9_123=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N99)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N99)!=0));
float l9_124=l9_1.x;
sc_SoftwareWrapEarly(l9_124,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).x);
float l9_125=l9_124;
float l9_126=l9_1.y;
sc_SoftwareWrapEarly(l9_126,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).y);
float l9_127=l9_126;
vec2 l9_128;
float l9_129;
...
{
l9_130=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).x==3;
}
#else
{
...
float l9_131=l9_125;
float l9_132=1.0;
sc_ClampUV(l9_131,Tweak_N99UvMinMax.x,Tweak_N99UvMinMax.z,l9_130,l9_132);
float l9_133=l9_131;
float l9_134=l9_132;
bool l9_135;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N99)
{
l9_135=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).y==3;
}
#else
{
l9_135=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N99)!=0);
}
#endif
float l9_136=l9_127;
float l9_137=l9_134;
sc_ClampUV(l9_136,Tweak_N99UvMinMax.y,Tweak_N99UvMinMax.w,l9_135,l9_137);
l9_129=l9_137;
...
#endif
vec2 l9_138=sc_TransformUV(l9_128,(int(SC_USE_UV_TRANSFORM_Tweak_N99)!=0),Tweak_N99Transform);
float l9_139=l9_138.x;
float l9_140=l9_129;
sc_SoftwareWrapLate(l9_139,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).x,l9_123,l9_140);
float l9_141=l9_138.y;
float l9_142=l9_140;
sc_SoftwareWrapLate(l9_141,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).y,l9_123,l9_142);
float l9_143=l9_142;
vec3 l9_144=sc_SamplingCoordsViewToGlobal(vec2(l9_139,l9_141),Tweak_N99Layout,Tweak_N99GetStereoViewIndex());
vec4 l9_145=texture(Tweak_N99ArrSC,l9_144,0.0);
vec4 l9_146;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N99)
{
l9_146=mix(Tweak_N99BorderColor,l9_145,vec4(l9_143));
}
#else
{
l9_146=l9_145;
...
#else
{
bool l9_147=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N99)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N99)!=0));
float l9_148=l9_1.x;
sc_SoftwareWrapEarly(l9_148,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).x);
float l9_149=l9_148;
float l9_150=l9_1.y;
sc_SoftwareWrapEarly(l9_150,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).y);
float l9_151=l9_150;
vec2 l9_152;
float l9_153;
#if (SC_USE_UV_MIN_MAX_Tweak_N99)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N99)
{
l9_154=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).x==3;
}
#else
{
...
float l9_155=l9_149;
float l9_156=1.0;
sc_ClampUV(l9_155,Tweak_N99UvMinMax.x,Tweak_N99UvMinMax.z,l9_154,l9_156);
float l9_157=l9_155;
float l9_158=l9_156;
bool l9_159;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N99)
{
l9_159=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).y==3;
}
#else
{
l9_159=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N99)!=0);
}
#endif
float l9_160=l9_151;
float l9_161=l9_158;
sc_ClampUV(l9_160,Tweak_N99UvMinMax.y,Tweak_N99UvMinMax.w,l9_159,l9_161);
l9_153=l9_161;
...
#endif
vec2 l9_162=sc_TransformUV(l9_152,(int(SC_USE_UV_TRANSFORM_Tweak_N99)!=0),Tweak_N99Transform);
float l9_163=l9_162.x;
float l9_164=l9_153;
sc_SoftwareWrapLate(l9_163,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).x,l9_147,l9_164);
float l9_165=l9_162.y;
float l9_166=l9_164;
sc_SoftwareWrapLate(l9_165,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N99,SC_SOFTWARE_WRAP_MODE_V_Tweak_N99).y,l9_147,l9_166);
float l9_167=l9_166;
vec3 l9_168=sc_SamplingCoordsViewToGlobal(vec2(l9_163,l9_165),Tweak_N99Layout,Tweak_N99GetStereoViewIndex());
vec4 l9_169=texture(Tweak_N99,l9_168.xy,0.0);
vec4 l9_170;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N99)
{
l9_170=mix(Tweak_N99BorderColor,l9_169,vec4(l9_167));
}
#else
{
l9_170=l9_169;
...
#endif
float l9_171=floor(((snoise(vec2(floor(Port_Seed_N083.x*10000.0)*9.9999997e-05,floor(Port_Seed_N083.y*10000.0)*9.9999997e-05)*((((l9_1-Port_Center_N092)*Port_Scale_N092)+Port_Center_N092)*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05;
vec3 l9_172=((l9_120*mix(l9_120,Port_Input1_N097,l9_121))+l9_122).xyz;
vec4 l9_173=vec4(l9_70.x,l9_70.y,l9_70.z,vec4(0.0).w);
l9_173.w=mix(l9_172,(vec4(l9_171).xyz*l9_172).xyz,vec3(l9_171)).x;
vec4 l9_174=l9_173*vec4(alpha);
