...
let UIRingRotation = class UIRingRotation extends BaseScriptComponent {
    onAwake() {
        ...
        const rotationTween = LSTween_1.LSTween.rotateOffset(transform, quat.angleAxis(MathUtils.DegToRad * 360, vec3.up()), 15000, RotationInterpolationType_1.RotationInterpolationType.LERP)
            .onEveryStart(() => {
