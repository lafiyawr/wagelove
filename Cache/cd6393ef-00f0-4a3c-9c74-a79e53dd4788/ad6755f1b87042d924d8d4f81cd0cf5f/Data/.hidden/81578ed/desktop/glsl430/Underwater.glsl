...
Value2=mix(mix(colorA,colorB,vec4(smoothstep(Port_Input0_N066,Port_Input1_N066,clamp((dot((((((((Globals.Surface_UVCoord0-vec2(Port_RangeMinA_N033))/vec2((Port_RangeMaxA_N033-Port_RangeMinA_N033)+1e-06))*(Port_RangeMaxB_N033-Port_RangeMinB_N033))+vec2(Port_RangeMinB_N033))-Port_Center_N047)*Port_Import_N022)+Port_Center_N047)-Port_Import_N058,l9_3)/dot(l9_3,l9_3))+0.001,Port_Input1_N065+0.001,Port_Input2_N065+0.001)-0.001))),mix(repelcolorA,repelcolorB,vec4((distance(((((((Globals.Surface_UVCoord0-vec2(Port_RangeMinA_N027))/vec2((Port_RangeMaxA_N027-Port_RangeMinA_N027)+1e-06))*(Port_RangeMaxB_N027-Port_RangeMinB_N027))+vec2(Port_RangeMinB_N027))-Port_Center_N034)*Port_Import_N030)+Port_Center_N034,Port_Import_N028)-Port_Import_N031)/Port_Import_N035)),vec4(fadetimeB));
Result=Value2;
}
else
{
vec2 l9_4=Port_Import_N060-Port_Import_N058;
Default=mix(mix(repelcolorA,repelcolorB,vec4((distance(((((((Globals.Surface_UVCoord0-vec2(Port_RangeMinA_N027))/vec2((Port_RangeMaxA_N027-Port_RangeMinA_N027)+1e-06))*(Port_RangeMaxB_N027-Port_RangeMinB_N027))+vec2(Port_RangeMinB_N027))-Port_Center_N034)*Port_Import_N030)+Port_Center_N034,Port_Import_N028)-Port_Import_N031)/Port_Import_N035)),mix(colorA,colorB,vec4(smoothstep(Port_Input0_N066,Port_Input1_N066,clamp((dot((((((((Globals.Surface_UVCoord0-vec2(Port_RangeMinA_N033))/vec2((Port_RangeMaxA_N033-Port_RangeMinA_N033)+1e-06))*(Port_RangeMaxB_N033-Port_RangeMinB_N033))+vec2(Port_RangeMinB_N033))-Port_Center_N047)*Port_Import_N022)+Port_Center_N047)-Port_Import_N058,l9_4)/dot(l9_4,l9_4))+0.001,Port_Input1_N065+0.001,Port_Input2_N065+0.001)-0.001))),vec4(fadetimeA));
Result=Default;
}
}
}
