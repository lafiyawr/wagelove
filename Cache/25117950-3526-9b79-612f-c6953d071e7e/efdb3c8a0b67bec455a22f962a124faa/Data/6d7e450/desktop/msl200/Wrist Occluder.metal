...
//spec_const bool Tweak_N1 40 0
//spec_const bool Tweak_N6 41 0
...
constant bool Tweak_N1 [[function_constant(40)]];
constant bool Tweak_N1_tmp = is_function_constant_defined(Tweak_N1) ? Tweak_N1 : false;
constant bool Tweak_N6 [[function_constant(41)]];
...
float4 param_1=(*sc_set0.UserUniforms).Port_Input1_N002;
...
float3 Value1_N9=float3(0.0);
float Value2_N9=0.0;
float4 param_5=Output_N5;
float3 param_6=param_5.xyz;
float param_7=param_5.w;
Value1_N9=param_6;
Value2_N9=param_7;
float4 Output_N8=float4(0.0);
float4 param_8=(*sc_set0.UserUniforms).Port_Input1_N008;
...
int l9_105=l9_103;
float2 l9_106=param_11.Surface_UVCoord0;
...
Output_N10=Output_N8.w;
float Output_N11=0.0;
Output_N11=Value2_N9*Output_N10;
float4 Value_N12=float4(0.0);
Value_N12=float4(Value1_N9.x,Value1_N9.y,Value1_N9.z,Value_N12.w);
...
float4 l9_193=fast::max(param_13,float4(0.0));
float4 param_14=l9_193;
if (sc_ShaderCacheConstant_tmp!=0)
{
