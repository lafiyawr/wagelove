...
#endif
vec4 l9_26=baseColor*l9_0;
vec4 l9_27;
#if (Tweak_N6)
{
l9_27=Port_Input1_N008;
}
#else
{
int l9_28;
...
#endif
bool l9_29=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_30=varPackedTex.x;
sc_SoftwareWrapEarly(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_31=l9_30;
float l9_32=varPackedTex.y;
sc_SoftwareWrapEarly(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_33=l9_32;
vec2 l9_34;
float l9_35;
...
{
l9_36=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
l9_36=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0);
}
#endif
float l9_37=l9_31;
float l9_38=1.0;
sc_ClampUV(l9_37,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_36,l9_38);
float l9_39=l9_37;
float l9_40=l9_38;
bool l9_41;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_41=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_42=l9_33;
float l9_43=l9_40;
sc_ClampUV(l9_42,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_41,l9_43);
l9_35=l9_43;
...
#endif
vec2 l9_44=sc_TransformUV(l9_34,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_45=l9_44.x;
float l9_46=l9_35;
sc_SoftwareWrapLate(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_29,l9_46);
float l9_47=l9_44.y;
float l9_48=l9_46;
sc_SoftwareWrapLate(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_29,l9_48);
float l9_49=l9_48;
vec3 l9_50=sc_SamplingCoordsViewToGlobal(vec2(l9_45,l9_47),opacityTexLayout,l9_28);
vec4 l9_51=texture2D(opacityTex,l9_50.xy,0.0);
vec4 l9_52;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_52=mix(opacityTexBorderColor,l9_51,vec4(l9_49));
}
#else
{
l9_52=l9_51;
...
#endif
float l9_53=l9_26.w*l9_27.w;
vec4 l9_54=vec4(l9_26.x,l9_26.y,l9_26.z,vec4(0.0).w);
l9_54.w=l9_53;
