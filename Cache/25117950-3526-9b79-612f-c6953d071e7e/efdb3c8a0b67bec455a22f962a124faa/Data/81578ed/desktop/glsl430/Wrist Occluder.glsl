...
#endif
float l9_103=l9_52.w*l9_53.w;
vec4 l9_104=vec4(l9_52.x,l9_52.y,l9_52.z,vec4(0.0).w);
l9_104.w=l9_103;
...
{
l9_109=clamp(l9_103*2.0,0.0,1.0);
}
#else
{
float l9_110;
...
{
l9_110=clamp(dot(l9_104.xyz,vec3(l9_103)),0.0,1.0);
}
#else
{
float l9_111;
...
{
l9_112=(1.0-dot(l9_104.xyz,vec3(0.33333001)))*l9_103;
}
#else
{
float l9_113;
...
{
l9_113=(1.0-clamp(dot(l9_104.xyz,vec3(1.0)),0.0,1.0))*l9_103;
}
#else
{
float l9_114;
...
{
l9_114=clamp(dot(l9_104.xyz,vec3(1.0)),0.0,1.0)*l9_103;
}
#else
{
float l9_115;
#if (sc_BlendMode_Add)
{
l9_115=clamp(dot(l9_104.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_116;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_116=clamp(dot(l9_104.xyz,vec3(1.0)),0.0,1.0)*l9_103;
}
#else
{
float l9_117;
...
{
l9_117=dot(l9_104.xyz,vec3(0.33333001))*l9_103;
}
#else
{
float l9_118;
#if (sc_BlendMode_Min)
{
l9_118=1.0-clamp(dot(l9_104.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_119;
#if (sc_BlendMode_Max)
{
l9_119=clamp(dot(l9_104.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_119=1.0;
...
#endif
l9_107=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_104.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_108);
}
#else
{
vec4 l9_120;
...
#endif
vec3 l9_131=mix(l9_129.xyz,definedBlend(l9_129.xyz,l9_104.xyz).xyz,vec3(l9_103));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_133=vec4(mix(vec3(1.0),l9_104.xyz,vec3(l9_103)),l9_103);
}
#else
{
vec4 l9_134;
...
#endif
l9_134=vec4(l9_104.xyz*l9_135,l9_135);
}
#else
{
l9_134=l9_104;
