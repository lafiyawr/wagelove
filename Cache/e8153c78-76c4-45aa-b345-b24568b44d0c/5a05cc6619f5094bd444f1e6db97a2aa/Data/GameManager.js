...
function onSyncReady() {
    ...
    // Don't set state here - let the user choice determine the initial state
...
function showWaitingForPlayers() {
    ...
    // Add a small delay, but also check immediately if SyncEntity is ready
    if (syncEntity && syncEntity.doIOwnStore() !== undefined) {
        // SyncEntity is ready, check immediately
        checkHostStatusAndShowUI();
    } else {
        // Wait a moment for SyncEntity to be fully ready
