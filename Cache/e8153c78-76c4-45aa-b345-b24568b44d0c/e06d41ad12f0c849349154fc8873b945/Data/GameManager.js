...
function onSyncReady() {
    ...
    try {
        ...
        syncEntity.onEventReceived.add('playerCompletedSelections', function(eventData, messageInfo) {
            sendReadyToFuse(eventData, messageInfo);
        });
...
function onReceivePlayerCompleted(eventData, messageInfo) {
    ...
    // Add this debug info:
    print("*** DEBUG: globalSelectionCount = " + globalSelectionCount);
    print("*** DEBUG: totalPlayersCount = " + totalPlayersCount);
    print("*** DEBUG: Should send ready to fuse? " + (globalSelectionCount >= totalPlayersCount));
    ...
    if (globalSelectionCount >= totalPlayersCount) {
        ...
        print("*** NOT sending ready to fuse - need " + (totalPlayersCount - globalSelectionCount) + " more players");
    }
}
