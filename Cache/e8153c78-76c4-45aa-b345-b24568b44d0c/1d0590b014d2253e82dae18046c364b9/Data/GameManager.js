...
function onReceiveObjectsPlaced(eventData, messageInfo) {
    ...
    if (!isHost()) {
        ...
        // The SyncTransform components you added should automatically sync the positions
        // We don't need to manually set transforms since you're using the built-in components
