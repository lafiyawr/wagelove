...
function enableSurfaceTracking(enable) {
    if (script.surfaceDetection) {
        ...
        print("Surface detection object kept enabled, script components: " + enable);
    } else {
        ...
        if (script.surfaceDetection) {
            ...
            transformData = {
                ...
                rotation: {
                    ...
                    w: transform.getWorldRotation().w
                }
            };
            print("Sending transform data: position(" + transformData.position.x + "," + transformData.position.y + "," + transformData.position.z + ")");
        }
