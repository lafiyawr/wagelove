                    ...
                    for (var j = 0; j < grandChildCount; j++) {
                        ...
                        if (grandChild.name === "VisualAnchor") {
                            ...
                            if (pos.x !== 0 || pos.y !== 0 || pos.z !== 0) {
                                ...
                                print("If content still not visible, check:");
                                print("1. Are all content objects enabled?");
                                print("2. Do materials/textures need to be refreshed?");
                                print("3. Is the camera positioned correctly relative to content?");
                            } else {
