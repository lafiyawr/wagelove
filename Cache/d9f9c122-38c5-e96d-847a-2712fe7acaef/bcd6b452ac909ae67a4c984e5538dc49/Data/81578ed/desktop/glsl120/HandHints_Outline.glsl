...
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N0 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 82 -1
//spec_const int Tweak_N0Layout 83 0
...
float l9_24=l9_23;
vec3 l9_25=sc_SamplingCoordsViewToGlobal(vec2(l9_20,l9_22),Tweak_N0Layout,l9_3);
vec4 l9_26=texture2D(Tweak_N0,l9_25.xy,0.0);
vec4 l9_27;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
...
#endif
vec4 l9_28=vec4(l9_2,l9_2,l9_2,l9_27.x);
#if (sc_BlendMode_AlphaTest)
{
if (l9_27.x<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_27.x<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_31=clamp(l9_27.x*2.0,0.0,1.0);
}
#else
{
float l9_32;
...
{
l9_32=clamp(dot(l9_28.xyz,vec3(l9_27.x)),0.0,1.0);
}
#else
{
float l9_33;
...
{
l9_34=(1.0-dot(l9_28.xyz,vec3(0.33333001)))*l9_27.x;
}
#else
{
float l9_35;
...
{
l9_35=(1.0-clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0))*l9_27.x;
}
#else
{
float l9_36;
...
{
l9_36=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0)*l9_27.x;
}
#else
{
float l9_37;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_38=clamp(dot(l9_28.xyz,vec3(1.0)),0.0,1.0)*l9_27.x;
}
#else
{
float l9_39;
...
{
l9_39=dot(l9_28.xyz,vec3(0.33333001))*l9_27.x;
}
#else
{
float l9_40;
...
#endif
vec3 l9_52=mix(l9_50.xyz,definedBlend(l9_50.xyz,l9_28.xyz).xyz,vec3(l9_27.x));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_54=vec4(mix(vec3(1.0),l9_28.xyz,vec3(l9_27.x)),l9_27.x);
}
#else
{
vec4 l9_55;
