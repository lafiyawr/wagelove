...
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N0 36 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 37 0
//spec_const bool Tweak_N0HasSwappedViews 38 0
...
//spec_const int Tweak_N0Layout 84 0
...
#if (Tweak_N0Layout==2)
{
bool l9_15=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0));
float l9_16=l9_0.x;
sc_SoftwareWrapEarly(l9_16,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_17=l9_16;
float l9_18=l9_0.y;
sc_SoftwareWrapEarly(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_19=l9_18;
vec2 l9_20;
float l9_21;
...
{
l9_22=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
l9_22=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_23=l9_17;
float l9_24=1.0;
sc_ClampUV(l9_23,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_22,l9_24);
float l9_25=l9_23;
float l9_26=l9_24;
bool l9_27;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_27=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_27=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_28=l9_19;
float l9_29=l9_26;
sc_ClampUV(l9_28,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_27,l9_29);
l9_21=l9_29;
...
#endif
vec2 l9_30=sc_TransformUV(l9_20,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_31=l9_30.x;
float l9_32=l9_21;
sc_SoftwareWrapLate(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,l9_15,l9_32);
float l9_33=l9_30.y;
float l9_34=l9_32;
sc_SoftwareWrapLate(l9_33,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,l9_15,l9_34);
float l9_35=l9_34;
vec3 l9_36=sc_SamplingCoordsViewToGlobal(vec2(l9_31,l9_33),Tweak_N0Layout,Tweak_N0GetStereoViewIndex());
vec4 l9_37=texture(Tweak_N0ArrSC,l9_36,0.0);
vec4 l9_38;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_38=mix(Tweak_N0BorderColor,l9_37,vec4(l9_35));
}
#else
{
l9_38=l9_37;
...
#else
{
bool l9_39=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0));
float l9_40=l9_0.x;
sc_SoftwareWrapEarly(l9_40,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_41=l9_40;
float l9_42=l9_0.y;
sc_SoftwareWrapEarly(l9_42,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_43=l9_42;
vec2 l9_44;
float l9_45;
#if (SC_USE_UV_MIN_MAX_Tweak_N0)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_46=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
l9_46=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_47=l9_41;
float l9_48=1.0;
sc_ClampUV(l9_47,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_46,l9_48);
float l9_49=l9_47;
float l9_50=l9_48;
bool l9_51;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_51=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_51=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_52=l9_43;
float l9_53=l9_50;
sc_ClampUV(l9_52,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_51,l9_53);
l9_45=l9_53;
...
#endif
vec2 l9_54=sc_TransformUV(l9_44,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_55=l9_54.x;
float l9_56=l9_45;
sc_SoftwareWrapLate(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,l9_39,l9_56);
float l9_57=l9_54.y;
float l9_58=l9_56;
sc_SoftwareWrapLate(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,l9_39,l9_58);
float l9_59=l9_58;
vec3 l9_60=sc_SamplingCoordsViewToGlobal(vec2(l9_55,l9_57),Tweak_N0Layout,Tweak_N0GetStereoViewIndex());
vec4 l9_61=texture(Tweak_N0,l9_60.xy,0.0);
vec4 l9_62;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_62=mix(Tweak_N0BorderColor,l9_61,vec4(l9_59));
}
#else
{
l9_62=l9_61;
...
#endif
vec4 l9_63=vec4(l9_13,l9_13,l9_13,l9_14.x);
...
{
l9_68=clamp(l9_14.x*2.0,0.0,1.0);
}
#else
{
float l9_69;
...
{
l9_69=clamp(dot(l9_63.xyz,vec3(l9_14.x)),0.0,1.0);
}
#else
{
float l9_70;
...
{
l9_71=(1.0-dot(l9_63.xyz,vec3(0.33333001)))*l9_14.x;
}
#else
{
float l9_72;
...
{
l9_72=(1.0-clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0))*l9_14.x;
}
#else
{
float l9_73;
...
{
l9_73=clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0)*l9_14.x;
}
#else
{
float l9_74;
#if (sc_BlendMode_Add)
{
l9_74=clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_75;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_75=clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0)*l9_14.x;
}
#else
{
float l9_76;
...
{
l9_76=dot(l9_63.xyz,vec3(0.33333001))*l9_14.x;
}
#else
{
float l9_77;
#if (sc_BlendMode_Min)
{
l9_77=1.0-clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_78;
#if (sc_BlendMode_Max)
{
l9_78=clamp(dot(l9_63.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_78=1.0;
...
#endif
l9_66=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_63.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_67);
}
#else
{
vec4 l9_79;
...
{
l9_87=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_85,sc_ScreenTextureLayout,l9_86),0.0);
}
#else
{
l9_87=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_85,sc_ScreenTextureLayout,l9_86).xy,0.0);
}
#endif
l9_81=l9_87;
}
...
{
vec4 l9_89=l9_81;
l9_89.x=l9_81.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_88=l9_89;
}
#else
{
...
#endif
vec3 l9_90=mix(l9_88.xyz,definedBlend(l9_88.xyz,l9_63.xyz).xyz,vec3(l9_14.x));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_92=vec4(mix(vec3(1.0),l9_63.xyz,vec3(l9_14.x)),l9_14.x);
}
#else
{
vec4 l9_93;
...
#endif
l9_93=vec4(l9_63.xyz*l9_94,l9_94);
}
#else
{
l9_93=l9_63;
