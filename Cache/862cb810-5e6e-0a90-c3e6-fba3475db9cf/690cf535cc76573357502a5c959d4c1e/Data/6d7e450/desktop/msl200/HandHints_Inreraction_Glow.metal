...
//texture texture2D Tweak_N6 0:4:0:22
...
//float3x3 Tweak_N6Transform 4320
//float4 Tweak_N6UvMinMax 4368
//float4 Tweak_N6BorderColor 4384
//float glowIntensity 4400
//float4 Port_Color_N011 4416
//float4 Port_Value_N017 4432
//float depthRef 4452
//}
...
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N6 33 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N6 35 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36 0
//spec_const bool Tweak_N6HasSwappedViews 37 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N6 71 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 72 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 73 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 74 -1
//spec_const int Tweak_N6Layout 75 0
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N6 [[function_constant(33)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N6 [[function_constant(35)]];
...
constant bool Tweak_N6HasSwappedViews [[function_constant(37)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N6 [[function_constant(71)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N6 [[function_constant(73)]];
...
constant int Tweak_N6Layout [[function_constant(75)]];
...
int l9_10=l9_5;
int param=Tweak_N6Layout_tmp;
int param_1=l9_10;
float2 param_2=Globals.Surface_UVCoord0;
bool param_3=(int(SC_USE_UV_TRANSFORM_Tweak_N6_tmp)!=0);
float3x3 param_4=(*sc_set0.UserUniforms).Tweak_N6Transform;
int2 param_5=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6_tmp);
bool param_6=(int(SC_USE_UV_MIN_MAX_Tweak_N6_tmp)!=0);
float4 param_7=(*sc_set0.UserUniforms).Tweak_N6UvMinMax;
bool param_8=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6_tmp)!=0);
float4 param_9=(*sc_set0.UserUniforms).Tweak_N6BorderColor;
float param_10=0.0;
...
float l9_80=l9_72;
float4 l9_81=sc_set0.Tweak_N6.sample(sc_set0.Tweak_N6SmpSC,l9_79,bias(l9_80));
float4 l9_82=l9_81;
float4 l9_83=l9_82;
if (param_8)
{
