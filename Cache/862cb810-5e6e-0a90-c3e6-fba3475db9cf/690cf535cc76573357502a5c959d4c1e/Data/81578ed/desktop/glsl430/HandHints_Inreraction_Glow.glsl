...
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N6 36 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 37 0
//spec_const bool Tweak_N6HasSwappedViews 38 0
...
#if (Tweak_N6Layout==2)
{
bool l9_3=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0));
float l9_4=l9_0.x;
...
float l9_19=l9_18.x;
float l9_20=l9_9;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,l9_3,l9_20);
float l9_21=l9_18.y;
float l9_22=l9_20;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,l9_3,l9_22);
float l9_23=l9_22;
vec3 l9_24=sc_SamplingCoordsViewToGlobal(vec2(l9_19,l9_21),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_25=texture(Tweak_N6ArrSC,l9_24,0.0);
vec4 l9_26;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
...
#else
{
bool l9_27=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N6)!=0));
float l9_28=l9_0.x;
sc_SoftwareWrapEarly(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x);
float l9_29=l9_28;
float l9_30=l9_0.y;
sc_SoftwareWrapEarly(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y);
float l9_31=l9_30;
vec2 l9_32;
float l9_33;
#if (SC_USE_UV_MIN_MAX_Tweak_N6)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_34=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x==3;
}
#else
{
l9_34=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_35=l9_29;
float l9_36=1.0;
sc_ClampUV(l9_35,Tweak_N6UvMinMax.x,Tweak_N6UvMinMax.z,l9_34,l9_36);
float l9_37=l9_35;
float l9_38=l9_36;
bool l9_39;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_39=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y==3;
}
#else
{
l9_39=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N6)!=0);
}
#endif
float l9_40=l9_31;
float l9_41=l9_38;
sc_ClampUV(l9_40,Tweak_N6UvMinMax.y,Tweak_N6UvMinMax.w,l9_39,l9_41);
l9_33=l9_41;
...
#endif
vec2 l9_42=sc_TransformUV(l9_32,(int(SC_USE_UV_TRANSFORM_Tweak_N6)!=0),Tweak_N6Transform);
float l9_43=l9_42.x;
float l9_44=l9_33;
sc_SoftwareWrapLate(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).x,l9_27,l9_44);
float l9_45=l9_42.y;
float l9_46=l9_44;
sc_SoftwareWrapLate(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N6,SC_SOFTWARE_WRAP_MODE_V_Tweak_N6).y,l9_27,l9_46);
float l9_47=l9_46;
vec3 l9_48=sc_SamplingCoordsViewToGlobal(vec2(l9_43,l9_45),Tweak_N6Layout,Tweak_N6GetStereoViewIndex());
vec4 l9_49=texture(Tweak_N6,l9_48.xy,0.0);
vec4 l9_50;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N6)
{
l9_50=mix(Tweak_N6BorderColor,l9_49,vec4(l9_47));
}
#else
{
l9_50=l9_49;
...
#endif
vec4 l9_51=Port_Value_N017+l9_2;
vec4 l9_52=l9_51*l9_2;
vec4 l9_53=(l9_52*Port_Value_N017)*vec4(glowIntensity);
vec3 l9_54=Port_Color_N011.xyz*Port_Color_N011.w;
float l9_55=l9_53.x;
vec4 l9_56=vec4(min(vec4(l9_54.x,l9_54.y,l9_54.z,Port_Color_N011.w)+l9_53,vec4(1.0)).xyz,l9_55);
...
{
l9_62=clamp(dot(l9_56.xyz,vec3(l9_55)),0.0,1.0);
}
#else
{
float l9_63;
...
{
l9_64=(1.0-dot(l9_56.xyz,vec3(0.33333001)))*l9_55;
}
#else
{
float l9_65;
...
{
l9_65=(1.0-clamp(dot(l9_56.xyz,vec3(1.0)),0.0,1.0))*l9_55;
}
#else
{
float l9_66;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_68=clamp(dot(l9_56.xyz,vec3(1.0)),0.0,1.0)*l9_55;
}
#else
{
float l9_69;
...
{
l9_69=dot(l9_56.xyz,vec3(0.33333001))*l9_55;
}
#else
{
float l9_70;
...
#endif
vec3 l9_83=mix(l9_81.xyz,definedBlend(l9_81.xyz,l9_56.xyz).xyz,vec3(l9_55));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_85=vec4(mix(vec3(1.0),l9_56.xyz,vec3(l9_55)),l9_55);
}
#else
{
vec4 l9_86;
...
#endif
l9_86=vec4(l9_56.xyz*l9_87,l9_87);
}
#else
{
l9_86=l9_56;
