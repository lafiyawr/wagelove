...
l9_2=l9_5;
l9_1=l9_4.normalWS;
l9_0=(sc_ModelMatrixInverse*vec4(l9_5,1.0)).xyz;
}
else
{
...
float l9_6=length(l9_0);
float l9_7=mod((sc_Time.x*((Port_Value_N001+0.001)-0.001))+(l9_6*(1.0/((Port_Value_N000+0.001)-0.001))),(Port_Value_N003+0.001)-0.001);
float l9_8=((1.0-l9_7)*l9_7)*Port_Input2_N036;
float l9_9;
if (l9_8<=0.0)
{
l9_9=0.0;
...
{
l9_9=pow(l9_8,Port_Import_N037);
}
vec4 l9_10=vec4(l9_9);
vec3 l9_11=-l9_3;
float l9_12=dot(l9_11,l9_1);
vec3 l9_13;
#if (!sc_ProjectiveShadowsCaster)
{
l9_13=l9_1;
...
#endif
vec3 l9_14=max(Port_Value_N014.xyz,vec3(0.0));
vec4 l9_15;
#if (sc_ProjectiveShadowsCaster)
{
...
#else
{
l9_15=ngsCalculateLighting(l9_14,Port_Opacity_N006,l9_13,l9_2,l9_3,max((mix(Port_Value_N008,Port_Value_N016,l9_10)*vec4(max(pow(1.0-abs(l9_12),Port_Exponent_N007),0.0)*Port_Intensity_N007)).xyz,vec3(0.0)),Port_Metallic_N006,Port_Roughness_N006,Port_AO_N006,Port_SpecularAO_N006);
}
#endif
...
#endif
sc_writeFragData0Internal(max(l9_17,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_19;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_21=clamp(l9_16.w*2.0,0.0,1.0);
}
#else
{
float l9_22;
...
{
l9_22=clamp(dot(l9_16.xyz,vec3(l9_16.w)),0.0,1.0);
}
#else
{
float l9_23;
...
#if (sc_BlendMode_Multiply)
{
l9_24=(1.0-dot(l9_16.xyz,vec3(0.33333001)))*l9_16.w;
}
#else
{
float l9_25;
...
{
l9_25=(1.0-clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0))*l9_16.w;
}
#else
{
float l9_26;
#if (sc_BlendMode_ColoredGlass)
{
l9_26=clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0)*l9_16.w;
}
#else
{
float l9_27;
#if (sc_BlendMode_Add)
{
l9_27=clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_28;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_28=clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0)*l9_16.w;
}
#else
{
float l9_29;
...
{
l9_29=dot(l9_16.xyz,vec3(0.33333001))*l9_16.w;
}
#else
{
float l9_30;
#if (sc_BlendMode_Min)
{
l9_30=1.0-clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_31;
#if (sc_BlendMode_Max)
{
l9_31=clamp(dot(l9_16.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_31=1.0;
...
#endif
l9_19=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_16.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_20);
}
#else
{
vec4 l9_32;
...
{
vec3 l9_34=sc_GetFramebufferColor().xyz;
vec3 l9_35=mix(l9_34,definedBlend(l9_34,l9_16.xyz).xyz,vec3(l9_16.w));
...
{
float l9_38=l9_16.w;
l9_37=vec4(mix(vec3(1.0),l9_16.xyz,vec3(l9_38)),l9_38);
}
#else
{
vec4 l9_39;
...
#endif
l9_39=vec4(l9_16.xyz*l9_41,l9_41);
}
#else
{
l9_39=l9_16;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_48-0.0039215689)),min(1.0,l9_48+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_50),packValue(l9_50),packValue(l9_50),packValue(l9_50)),sc_UniformConstants.x,sc_ShaderCacheConstant);
