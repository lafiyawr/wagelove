...
//}
//ubo int UserUniforms 0:39:4752 {
...
//float4 Port_Value_N014 4560
//float Port_Opacity_N006 4576
//float4 Port_Value_N008 4608
//float4 Port_Value_N016 4624
//float Port_Value_N001 4640
//float Port_Value_N000 4648
//float Port_Value_N003 4656
//float Port_Input2_N036 4668
//float Port_Import_N037 4672
//float Port_Exponent_N007 4676
//float Port_Intensity_N007 4680
//float Port_Metallic_N006 4684
//float Port_Roughness_N006 4688
//float3 Port_AO_N006 4704
//float3 Port_SpecularAO_N006 4720
//float depthRef 4736
//}
...
Output_N14=(*sc_set0.UserUniforms).Port_Value_N014;
float4 Output_N8=float4(0.0);
Output_N8=(*sc_set0.UserUniforms).Port_Value_N008;
float4 Output_N16=float4(0.0);
Output_N16=(*sc_set0.UserUniforms).Port_Value_N016;
float Output_N1=0.0;
float param=(*sc_set0.UserUniforms).Port_Value_N001;
...
float Output_N0=0.0;
float param_2=(*sc_set0.UserUniforms).Port_Value_N000;
...
float Output_N3=0.0;
float param_4=(*sc_set0.UserUniforms).Port_Value_N003;
...
Output_N36=(Output_N35*Value_N34)*(*sc_set0.UserUniforms).Port_Input2_N036;
float Value_N37=0.0;
Value_N37=(*sc_set0.UserUniforms).Port_Import_N037;
...
float Rim_N7=0.0;
float3 param_6=Normal_N5;
float param_7=(*sc_set0.UserUniforms).Port_Exponent_N007;
float param_8=(*sc_set0.UserUniforms).Port_Intensity_N007;
ssGlobals param_10=Globals;
float l9_6=abs(dot(-param_10.ViewDirWS,param_6));
float param_9=pow(1.0-l9_6,param_7);
...
float3 param_11=Output_N14.xyz;
float param_12=(*sc_set0.UserUniforms).Port_Opacity_N006;
float3 param_13=Output_N9.xyz;
float param_14=(*sc_set0.UserUniforms).Port_Metallic_N006;
float param_15=(*sc_set0.UserUniforms).Port_Roughness_N006;
float3 param_16=(*sc_set0.UserUniforms).Port_AO_N006;
float3 param_17=(*sc_set0.UserUniforms).Port_SpecularAO_N006;
ssGlobals param_19=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_19.BumpedNormal=param_19.VertexNormal_WorldSpace;
}
float l9_7=param_12;
...
float4 l9_22=fast::max(param_20,float4(0.0));
float4 param_21=l9_22;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
float4 l9_31=param_22;
float4 l9_32=float4(0.0);
float4 l9_33=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_34=out.FragColor0;
float4 l9_35=l9_34;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_35.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_36=l9_35;
l9_33=l9_36;
}
...
float4 l9_63=float4(0.0);
float2 l9_64=l9_60;
int l9_65=sc_ScreenTextureLayout_tmp;
int l9_66=l9_61;
float l9_67=l9_62;
float2 l9_68=l9_64;
int l9_69=l9_65;
...
float l9_75=l9_67;
float4 l9_76=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_74,bias(l9_75));
float4 l9_77=l9_76;
l9_63=l9_77;
float4 l9_78=l9_63;
float4 l9_79=l9_78;
...
l9_32=float4(l9_86.x,l9_86.y,l9_86.z,l9_32.w);
float3 l9_87=mix(l9_83,l9_32.xyz,float3(l9_31.w));
l9_32=float4(l9_87.x,l9_87.y,l9_87.z,l9_32.w);
l9_32.w=1.0;
float4 l9_88=l9_32;
param_22=l9_88;
}
...
{
l9_94=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_94=float4(0.0);
