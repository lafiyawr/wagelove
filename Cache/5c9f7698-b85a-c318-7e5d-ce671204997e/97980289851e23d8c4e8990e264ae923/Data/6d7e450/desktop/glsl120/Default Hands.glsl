...
float l9_2=mod((sc_Time.x*((Port_Value_N001+0.001)-0.001))+(length((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz)*(1.0/((Port_Value_N000+0.001)-0.001))),(Port_Value_N003+0.001)-0.001);
float l9_3=((1.0-l9_2)*l9_2)*Port_Input2_N036;
float l9_4;
if (l9_3<=0.0)
{
l9_4=0.0;
...
{
l9_4=pow(l9_3,Port_Import_N037);
}
vec4 l9_5=vec4(l9_4);
vec3 l9_6=-l9_1;
vec3 l9_7;
...
#endif
vec3 l9_8=max(Port_Value_N014.xyz,vec3(0.0));
vec4 l9_9;
#if (sc_ProjectiveShadowsCaster)
{
...
vec3 l9_12=ssSRGB_to_Linear(max((mix(Port_Value_N008,Port_Value_N016,l9_5)*vec4(max(pow(1.0-abs(dot(l9_6,l9_0)),Port_Exponent_N007),0.0)*Port_Intensity_N007)).xyz,vec3(0.0)));
vec3 l9_13;
#if (sc_SSAOEnabled)
{
...
SurfaceProperties l9_17=SurfaceProperties(l9_16,Port_Opacity_N006,l9_11,varPos,l9_1,Port_Metallic_N006,Port_Roughness_N006,l9_12,l9_13,Port_SpecularAO_N006,vec3(1.0),l9_15);
vec4 l9_18=vec4(1.0);
vec3 l9_19;
vec3 l9_20;
vec3 l9_21;
...
{
LightingComponents l9_38=accumulateLight(LightingComponents(l9_26,l9_27,l9_32,l9_31,l9_29,l9_28),LightProperties(sc_DirectionalLights[l9_37].direction,sc_DirectionalLights[l9_37].color.xyz,sc_DirectionalLights[l9_37].color.w*l9_18[(l9_30<3) ? l9_30 : 3]),l9_17,l9_1);
...
l9_48=l9_56+1;
LightingComponents l9_63=accumulateLight(LightingComponents(l9_42,l9_43,l9_47,l9_46,l9_45,l9_44),LightProperties(l9_58,sc_PointLights[l9_55].color.xyz,l9_62),l9_17,l9_1);
...
#endif
l9_73=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_74,sc_EnvmapDiffuseLayout,l9_75).xy,-13.0);
}
#else
{
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_105=clamp(pow(Port_Roughness_N006,0.66666669),0.0,1.0)*5.0;
vec2 l9_106=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_11,reflect(l9_6,l9_11),Port_Roughness_N006),sc_EnvmapRotation.y);
vec4 l9_107;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
#endif
l9_104=vec3(0.0)+((((l9_107.xyz*(1.0/l9_107.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_17,abs(dot(l9_11,l9_1))));
}
#else
{
l9_104=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_111=clamp(Port_Roughness_N006*Port_Roughness_N006,0.0099999998,1.0);
vec3 l9_112;
...
vec3 l9_115=reflect(l9_6,l9_11);
float l9_116=dot(l9_11,l9_1);
...
l9_112+=((((((((vec3(1.0/(3.1415927*l9_114))*exp((l9_118-l9_117)-sc_LightEstimationData.sg[l9_113].sharpness))*sc_LightEstimationData.sg[l9_113].color)*6.2831855)*(1.0-exp((-2.0)*l9_118)))/vec3(l9_118))*((1.0/(l9_119+sqrt(l9_114+((l9_121*l9_119)*l9_119))))*(1.0/(l9_120+sqrt(l9_114+((l9_121*l9_120)*l9_120))))))*(l9_15+((vec3(1.0)-l9_15)*pow(1.0-clamp(dot(l9_115,normalize(l9_115+l9_1)),0.0,1.0),5.0))))*l9_119);
l9_113++;
continue;
}
else
...
l9_125=vec3(0.0);
l9_124=vec3(0.0);
l9_123=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_16,vec3(Port_Opacity_N006));
l9_122=1.0;
}
#else
{
...
l9_9=vec4(l9_142.x,l9_142.y,l9_142.z,l9_139.w);
}
#endif
vec4 l9_143=max(l9_9,vec4(0.0));
vec4 l9_144;
#if (sc_ProjectiveShadowsCaster)
{
float l9_145;
