...
float l9_8=floor(l9_3/30.0)*6.6666698;
float l9_9;
...
gParticle=ssParticle(gParticle.Position,gParticle.Velocity,gParticle.Color,gParticle.Size,gParticle.Age,gParticle.Life,gParticle.Mass,gParticle.Matrix,false,gParticle.Quaternion,gParticle.SpawnIndex,gParticle.SpawnIndexRemainder,gParticle.NextBurstTime,gParticle.collisionCount_N134,l9_8,fract(abs(((l9_7*0.97637898)+0.151235)+(floor(((((l9_9-l9_8)-0.0)+0.0)+26.666599)/13.3333)*4.32723))),(vec2(ivec2(l9_0%400,l9_0/400))+vec2(1.0))/vec2(399.0),0.0,l9_0,l9_2,l9_3,(60*(l9_1+1))-1,(l9_5+0.5)/60.0,l9_7,l9_3/59.0,l9_4,(l9_6+vec2(0.5))/vec2(60.0,1.0),l9_6/vec2(59.0,1.0),vec3(0.0),false,gParticle.CopyId,gParticle.SpawnAmount,gParticle.BurstAmount,gParticle.BurstPeriod);
int l9_10=InstanceID;
int l9_11=(vfxOffsetInstancesRead+l9_10)*5;
...
vec2 l9_28=l9_13+vec2(0.001953125,0.0);
gParticle.collisionCount_N134=0.0+((((floor((renderTarget0SampleViewIndexBias(l9_28,renderTarget0GetStereoViewIndex(),0.0).x*255.0)+0.5)/255.0)-0.0)*(255.0-0.0))/(1.0-0.0));
...
vec3 l9_12;
if ((l9_11<0.029999999)||(Port_Import_N004<9.9999997e-05))
{
...
#endif
float l9_4=1.0-(distance(varPackedTex.xy,Port_Input1_N131)*Port_Input1_N153);
float l9_5;
if (l9_4<=0.0)
{
l9_5=0.0;
...
{
l9_5=pow(l9_4,Port_Import_N286);
}
if ((float((clamp((l9_5*Port_Import_N288)+0.001,Port_Input1_N290+0.001,Port_Input2_N290+0.001)-0.001)<Port_Input1_N294)*1.0)!=0.0)
{
discard;
}
vec4 l9_6;
...
{
l9_6=vec4(Interp_Particle_Color.w);
}
#else
{
vec4 l9_7;
...
#if (sc_FramebufferFetch)
{
vec4 l9_9=sc_readFragData0_Platform();
vec4 l9_10;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_11=l9_9;
l9_11.x=l9_9.x+_sc_framebufferFetchMarker;
l9_10=l9_11;
}
#else
{
...
#else
{
vec2 l9_12=gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw;
vec2 l9_13;
#if (sc_StereoRenderingMode==1)
{
...
{
l9_16=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_13,sc_ScreenTextureLayout,l9_15),0.0);
}
#else
{
l9_16=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_13,sc_ScreenTextureLayout,l9_15).xy,0.0);
}
#endif
l9_8=l9_16;
}
...
{
vec4 l9_18=l9_8;
l9_18.x=l9_8.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_17=l9_18;
}
#else
{
...
#endif
vec3 l9_19=mix(l9_17.xyz,definedBlend(l9_17.xyz,Interp_Particle_Color.xyz).xyz,vec3(Interp_Particle_Color.w));
...
{
l9_21=vec4(mix(vec3(1.0),Interp_Particle_Color.xyz,vec3(Interp_Particle_Color.w)),Interp_Particle_Color.w);
}
#else
{
vec4 l9_22;
...
{
l9_23=clamp(Interp_Particle_Color.w,0.0,1.0);
}
#else
{
l9_23=Interp_Particle_Color.w;
}
#endif
l9_22=vec4(Interp_Particle_Color.xyz*l9_23,l9_23);
}
#else
{
l9_22=Interp_Particle_Color;
}
#endif
l9_21=l9_22;
}
...
{
l9_24=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_24=vec4(0.0);
