...
#endif
l9_8=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_13,sc_ScreenTextureLayout,l9_15).xy,0.0);
}
#endif
vec4 l9_16;
...
{
vec4 l9_17=l9_8;
l9_17.x=l9_8.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_16=l9_17;
}
#else
{
...
#endif
vec3 l9_18=mix(l9_16.xyz,definedBlend(l9_16.xyz,Interp_Particle_Color.xyz).xyz,vec3(Interp_Particle_Color.w));
...
{
l9_20=vec4(mix(vec3(1.0),Interp_Particle_Color.xyz,vec3(Interp_Particle_Color.w)),Interp_Particle_Color.w);
}
#else
{
vec4 l9_21;
...
{
l9_22=clamp(Interp_Particle_Color.w,0.0,1.0);
}
#else
{
l9_22=Interp_Particle_Color.w;
}
#endif
l9_21=vec4(Interp_Particle_Color.xyz*l9_22,l9_22);
}
#else
{
l9_21=Interp_Particle_Color;
}
#endif
l9_20=l9_21;
}
...
{
l9_23=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_23=vec4(0.0);
...
sc_writeFragData0Internal(l9_24,sc_UniformConstants.x,sc_ShaderCacheConstant);
}
