...
let Ancestors = class Ancestors extends BaseScriptComponent {
    onAwake() {
        ...
        const tween1 = LSTween_1.LSTween.scaleToLocal(a1, vec3.one(), 1000)
            .easing(Easing_1.default.Circular.InOut)
            .delay(0);
        const tween2 = LSTween_1.LSTween.scaleToLocal(a2, vec3.one(), 1000)
            .easing(Easing_1.default.Circular.InOut)
            .delay(2000);
        const tween3 = LSTween_1.LSTween.scaleToLocal(a3, vec3.one(), 1000)
            .easing(Easing_1.default.Circular.InOut)
            .delay(4000);
        tween1.start();
        tween2.start();
