...
export class Ancestors extends BaseScriptComponent {
  ...
  onAwake() {
    ...
    const tween1 = LSTween.scaleToLocal(a1, vec3.one(), 1000)
      .easing(Easing.Circular.InOut)
      .delay(0);

    const tween2 = LSTween.scaleToLocal(a2, vec3.one(), 1000)
      .easing(Easing.Circular.InOut)
      .delay(2000);

    const tween3 = LSTween.scaleToLocal(a3, vec3.one(), 1000)
      .easing(Easing.Circular.InOut)
      .delay(4000);
