...
let Ancestors = class Ancestors extends BaseScriptComponent {
    onAwake() {
        ...
        const tween1 = LSTween_1.LSTween.scaleToLocal(a1, ancestorTargetScale, 9000)
            .easing(Easing_1.default.Quadratic.InOut)
            .delay(0);
        const tween2 = LSTween_1.LSTween.scaleToLocal(a2, ancestorTargetScale, 9000)
            .easing(Easing_1.default.Quadratic.InOut)
            .delay(2000);
        const tween3 = LSTween_1.LSTween.scaleToLocal(a3, ancestorTargetScale, 9000)
            .easing(Easing_1.default.Quadratic.InOut)
            .delay(4000);
        const tweenGifts = LSTween_1.LSTween.scaleToLocal(gifts, giftTargetScale, 9000)
            .easing(Easing_1.default.Quadratic.InOut)
            .delay(9500);
        tween1.start();
        tween2.start();
