...
tempGlobals=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec2(0.0),vec2(0.0),vec3(0.0),l9_0,varPos,varPos,l9_1,l9_2,cross(l9_1,l9_2)*varTangent.w,varPackedTex.xy,varPackedTex.zw,varColor,sc_ScreenCoordsGlobalToView(l9_3));
...
{
vec3 l9_150=tempGlobals.SurfacePosition_WorldSpace;
vec3 l9_151=reflect(normalize(sc_Camera.position-l9_150),l9_63);
...
#endif
l9_213=N7_vec3srgbToLinear(l9_212*l9_239.xyz);
}
#else
{
l9_213=l9_212;
...
#endif
vec3 l9_240=tempGlobals.SurfacePosition_WorldSpace;
float l9_241=dot(l9_63,normalize(sc_Camera.position-l9_240));
...
SurfaceProperties l9_291=SurfaceProperties(l9_290,l9_277,l9_285,varPos,l9_0,l9_280,l9_281,l9_286,l9_287,l9_283,vec3(1.0),l9_289);
...
{
LightingComponents l9_312=accumulateLight(LightingComponents(l9_300,l9_301,l9_306,l9_305,l9_303,l9_302),LightProperties(sc_DirectionalLights[l9_311].direction,sc_DirectionalLights[l9_311].color.xyz,sc_DirectionalLights[l9_311].color.w*l9_292[(l9_304<3) ? l9_304 : 3]),l9_291,l9_0);
...
l9_322=l9_330+1;
LightingComponents l9_337=accumulateLight(LightingComponents(l9_316,l9_317,l9_321,l9_320,l9_319,l9_318),LightProperties(l9_332,sc_PointLights[l9_329].color.xyz,l9_336),l9_291,l9_0);
...
vec2 l9_380=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_285,reflect(-l9_0,l9_285),l9_281),sc_EnvmapRotation.y);
vec4 l9_381;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
#endif
l9_378=vec3(0.0)+((((l9_381.xyz*(1.0/l9_381.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_291,abs(dot(l9_285,l9_0))));
}
#else
{
l9_378=vec3(0.0);
...
vec3 l9_389=reflect(-l9_0,l9_285);
float l9_390=dot(l9_285,l9_0);
...
l9_386+=((((((((vec3(1.0/(3.1415927*l9_388))*exp((l9_392-l9_391)-sc_LightEstimationData.sg[l9_387].sharpness))*sc_LightEstimationData.sg[l9_387].color)*6.2831855)*(1.0-exp((-2.0)*l9_392)))/vec3(l9_392))*((1.0/(l9_393+sqrt(l9_388+((l9_395*l9_393)*l9_393))))*(1.0/(l9_394+sqrt(l9_388+((l9_395*l9_394)*l9_394))))))*(l9_289+((vec3(1.0)-l9_289)*pow(1.0-clamp(dot(l9_389,normalize(l9_389+l9_0)),0.0,1.0),5.0))))*l9_393);
l9_387++;
continue;
}
else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_448=sc_ScreenCoordsGlobalToView(l9_3);
...
#if (sc_OITCompositingPass)
{
vec2 l9_461=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
