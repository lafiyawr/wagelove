...
#endif
tempGlobals=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec2(0.0),vec2(0.0),vec3(0.0),l9_0,varPos,varPos,l9_1,l9_2,cross(l9_1,l9_2)*varTangent.w,varPackedTex.xy,varPackedTex.zw,varColor,l9_4);
...
{
vec3 l9_270=tempGlobals.SurfacePosition_WorldSpace;
vec3 l9_271=reflect(normalize(sc_Camera.position-l9_270),l9_111);
...
#endif
l9_381=N7_vec3srgbToLinear(l9_380*l9_383.xyz);
}
#else
{
l9_381=l9_380;
...
#endif
vec3 l9_432=tempGlobals.SurfacePosition_WorldSpace;
float l9_433=dot(l9_111,normalize(sc_Camera.position-l9_432));
...
#endif
if (dot(l9_0,l9_487)>=(-0.050000001))
{
...
tempGlobals=ssGlobals(sc_Time.x,sc_Time.y,0.0,vec2(0.0),vec2(0.0),vec3(0.0),l9_8,l9_7,l9_7,l9_6,l9_5,l9_4,l9_3,l9_2,l9_1,l9_0);
tempGlobals.N7_TransformedUV2=N7_gettransformUV(NODE_13_DROPLIST_ITEM,uv2Scale,uv2Offset,(int(uv2EnableAnimation)!=0),(int(ENABLE_UV2)!=0));
tempGlobals.N7_TransformedUV3=N7_gettransformUV(NODE_49_DROPLIST_ITEM,uv3Scale,uv3Offset,(int(uv3EnableAnimation)!=0),(int(ENABLE_UV3)!=0));
vec4 l9_17;
#if (ENABLE_BASE_TEX)
...
#if (ENABLE_SIMPLE_REFLECTION)
{
vec3 l9_283=tempGlobals.SurfacePosition_WorldSpace;
vec3 l9_284=reflect(normalize(sc_Camera.position-l9_283),l9_124);
...
#endif
l9_394=N7_vec3srgbToLinear(l9_393*l9_396.xyz);
}
#else
{
l9_394=l9_393;
...
#endif
vec3 l9_445=tempGlobals.SurfacePosition_WorldSpace;
float l9_446=dot(l9_124,normalize(sc_Camera.position-l9_445));
