...
#if (sc_ProjectiveShadowsCaster)
{
l9_83=vec4(Port_Albedo_N006,l9_82);
}
#else
{
float l9_84=clamp(l9_80.x,0.0,1.0);
float l9_85=clamp(l9_80.y,0.0,1.0);
vec3 l9_86=ssSRGB_to_Linear(Port_Albedo_N006);
...
#endif
vec3 l9_90=vec3(l9_84);
vec3 l9_91=mix(vec3(0.039999999),l9_86*l9_84,l9_90);
vec3 l9_92=mix(l9_86*(1.0-l9_84),vec3(0.0),l9_90);
SurfaceProperties l9_93=SurfaceProperties(l9_92,l9_82,l9_87,varPos,l9_0,l9_84,l9_85,l9_88,l9_89,Port_SpecularAO_N006,vec3(1.0),l9_91);
vec4 l9_94=vec4(1.0);
vec3 l9_95;
vec3 l9_96;
vec3 l9_97;
...
l9_83=vec4(l9_218.x,l9_218.y,l9_218.z,l9_215.w);
}
#endif
vec4 l9_219=max(l9_83,vec4(0.0));
vec4 l9_220;
#if (sc_ProjectiveShadowsCaster)
{
float l9_221;
