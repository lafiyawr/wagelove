...
#if (sc_ProjectiveShadowsCaster)
{
l9_163=vec4(Port_Albedo_N006,l9_162);
}
#else
{
l9_163=ngsCalculateLighting(Port_Albedo_N006,l9_162,l9_161,l9_4,l9_5,Port_Emissive_N006,clamp(l9_112.x,0.0,1.0),clamp(l9_112.y,0.0,1.0),clamp(vec3(l9_112.z),vec3(0.0),vec3(1.0)),Port_SpecularAO_N006);
}
#endif
vec4 l9_164=max(l9_163,vec4(0.0));
if (isProxyMode)
{
vec4 l9_165;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0Internal(max(l9_165,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_167;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_169=clamp(l9_164.w*2.0,0.0,1.0);
}
#else
{
float l9_170;
...
{
l9_170=clamp(dot(l9_164.xyz,vec3(l9_164.w)),0.0,1.0);
}
#else
{
float l9_171;
...
#if (sc_BlendMode_Multiply)
{
l9_172=(1.0-dot(l9_164.xyz,vec3(0.33333001)))*l9_164.w;
}
#else
{
float l9_173;
...
{
l9_173=(1.0-clamp(dot(l9_164.xyz,vec3(1.0)),0.0,1.0))*l9_164.w;
}
#else
{
float l9_174;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_176=clamp(dot(l9_164.xyz,vec3(1.0)),0.0,1.0)*l9_164.w;
}
#else
{
float l9_177;
...
{
l9_177=dot(l9_164.xyz,vec3(0.33333001))*l9_164.w;
}
#else
{
float l9_178;
...
vec3 l9_183=mix(l9_182,definedBlend(l9_182,l9_164.xyz).xyz,vec3(l9_164.w));
...
l9_185=vec4(mix(vec3(1.0),l9_164.xyz,vec3(l9_186)),l9_186);
}
#else
{
vec4 l9_187;
...
#endif
l9_187=vec4(l9_164.xyz*l9_189,l9_189);
}
#else
{
l9_187=l9_164;
...
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_197).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_198=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_197).xy);
...
if (l9_215==0)
{
l9_218=texture(sc_OITAlpha0,l9_210);
l9_217=texture(sc_OITDepthLow0,l9_210);
l9_216=texture(sc_OITDepthHigh0,l9_210);
}
else
{
l9_218=vec4(0.0);
...
if (l9_215==1)
{
l9_221=texture(sc_OITAlpha1,l9_210);
l9_220=texture(sc_OITDepthLow1,l9_210);
l9_219=texture(sc_OITDepthHigh1,l9_210);
}
else
{
l9_221=l9_218;
...
vec4 l9_236=texture(sc_OITFilteredDepthBoundsTexture,l9_210);
