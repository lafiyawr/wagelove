...
#endif
vec4 l9_57=vec4(min(vec4(l9_31.x,l9_31.y,l9_31.z,l9_30.w)+((l9_29*Port_Value_N017)*vec4(glowIntensity)),vec4(1.0)).xyz,l9_56.x);
#if (sc_BlendMode_AlphaTest)
{
if (l9_56.x<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_56.x<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_60=clamp(l9_56.x*2.0,0.0,1.0);
}
#else
{
float l9_61;
...
{
l9_61=clamp(dot(l9_57.xyz,vec3(l9_56.x)),0.0,1.0);
}
#else
{
float l9_62;
...
{
l9_63=(1.0-dot(l9_57.xyz,vec3(0.33333001)))*l9_56.x;
}
#else
{
float l9_64;
...
{
l9_64=(1.0-clamp(dot(l9_57.xyz,vec3(1.0)),0.0,1.0))*l9_56.x;
}
#else
{
float l9_65;
...
{
l9_65=clamp(dot(l9_57.xyz,vec3(1.0)),0.0,1.0)*l9_56.x;
}
#else
{
float l9_66;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_67=clamp(dot(l9_57.xyz,vec3(1.0)),0.0,1.0)*l9_56.x;
}
#else
{
float l9_68;
...
{
l9_68=dot(l9_57.xyz,vec3(0.33333001))*l9_56.x;
}
#else
{
float l9_69;
...
#endif
vec3 l9_81=mix(l9_79.xyz,definedBlend(l9_79.xyz,l9_57.xyz).xyz,vec3(l9_56.x));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_83=vec4(mix(vec3(1.0),l9_57.xyz,vec3(l9_56.x)),l9_56.x);
}
#else
{
vec4 l9_84;
