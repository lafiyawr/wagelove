...
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N6 39 0
...
#endif
vec4 l9_64=Port_Value_N017+l9_15;
vec4 l9_65=l9_64*l9_15;
vec4 l9_66=vec4(l9_14);
vec3 l9_67=l9_66.xyz*l9_14;
vec4 l9_68;
#if (Tweak_N0Layout==2)
{
bool l9_69=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0));
float l9_70=l9_0.x;
sc_SoftwareWrapEarly(l9_70,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_71=l9_70;
float l9_72=l9_0.y;
sc_SoftwareWrapEarly(l9_72,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_73=l9_72;
vec2 l9_74;
float l9_75;
...
{
l9_76=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
l9_76=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_77=l9_71;
float l9_78=1.0;
sc_ClampUV(l9_77,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_76,l9_78);
float l9_79=l9_77;
float l9_80=l9_78;
bool l9_81;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_81=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_81=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_82=l9_73;
float l9_83=l9_80;
sc_ClampUV(l9_82,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_81,l9_83);
l9_75=l9_83;
...
#endif
vec2 l9_84=sc_TransformUV(l9_74,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_85=l9_84.x;
float l9_86=l9_75;
sc_SoftwareWrapLate(l9_85,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,l9_69,l9_86);
float l9_87=l9_84.y;
float l9_88=l9_86;
sc_SoftwareWrapLate(l9_87,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,l9_69,l9_88);
float l9_89=l9_88;
vec3 l9_90=sc_SamplingCoordsViewToGlobal(vec2(l9_85,l9_87),Tweak_N0Layout,Tweak_N0GetStereoViewIndex());
vec4 l9_91=texture(Tweak_N0ArrSC,l9_90,0.0);
vec4 l9_92;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_92=mix(Tweak_N0BorderColor,l9_91,vec4(l9_89));
}
#else
{
l9_92=l9_91;
...
#else
{
bool l9_93=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0));
float l9_94=l9_0.x;
sc_SoftwareWrapEarly(l9_94,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x);
float l9_95=l9_94;
float l9_96=l9_0.y;
sc_SoftwareWrapEarly(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y);
float l9_97=l9_96;
vec2 l9_98;
float l9_99;
#if (SC_USE_UV_MIN_MAX_Tweak_N0)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_100=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x==3;
}
#else
{
l9_100=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_101=l9_95;
float l9_102=1.0;
sc_ClampUV(l9_101,Tweak_N0UvMinMax.x,Tweak_N0UvMinMax.z,l9_100,l9_102);
float l9_103=l9_101;
float l9_104=l9_102;
bool l9_105;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_105=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y==3;
}
#else
{
l9_105=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0);
}
#endif
float l9_106=l9_97;
float l9_107=l9_104;
sc_ClampUV(l9_106,Tweak_N0UvMinMax.y,Tweak_N0UvMinMax.w,l9_105,l9_107);
l9_99=l9_107;
...
#endif
vec2 l9_108=sc_TransformUV(l9_98,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform);
float l9_109=l9_108.x;
float l9_110=l9_99;
sc_SoftwareWrapLate(l9_109,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).x,l9_93,l9_110);
float l9_111=l9_108.y;
float l9_112=l9_110;
sc_SoftwareWrapLate(l9_111,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0).y,l9_93,l9_112);
float l9_113=l9_112;
vec3 l9_114=sc_SamplingCoordsViewToGlobal(vec2(l9_109,l9_111),Tweak_N0Layout,Tweak_N0GetStereoViewIndex());
vec4 l9_115=texture(Tweak_N0,l9_114.xy,0.0);
vec4 l9_116;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N0)
{
l9_116=mix(Tweak_N0BorderColor,l9_115,vec4(l9_113));
}
#else
{
l9_116=l9_115;
...
#endif
vec4 l9_117=vec4(min(vec4(l9_67.x,l9_67.y,l9_67.z,l9_66.w)+((l9_65*Port_Value_N017)*vec4(glowIntensity)),vec4(1.0)).xyz,l9_68.x);
#if (sc_BlendMode_AlphaTest)
{
if (l9_68.x<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_68.x<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_122=clamp(l9_68.x*2.0,0.0,1.0);
}
#else
{
float l9_123;
...
{
l9_123=clamp(dot(l9_117.xyz,vec3(l9_68.x)),0.0,1.0);
}
#else
{
float l9_124;
...
{
l9_125=(1.0-dot(l9_117.xyz,vec3(0.33333001)))*l9_68.x;
}
#else
{
float l9_126;
...
{
l9_126=(1.0-clamp(dot(l9_117.xyz,vec3(1.0)),0.0,1.0))*l9_68.x;
}
#else
{
float l9_127;
...
{
l9_127=clamp(dot(l9_117.xyz,vec3(1.0)),0.0,1.0)*l9_68.x;
}
#else
{
float l9_128;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_129=clamp(dot(l9_117.xyz,vec3(1.0)),0.0,1.0)*l9_68.x;
}
#else
{
float l9_130;
...
{
l9_130=dot(l9_117.xyz,vec3(0.33333001))*l9_68.x;
}
#else
{
float l9_131;
...
#if (sc_FramebufferFetch)
{
vec4 l9_136=sc_readFragData0_Platform();
vec4 l9_137;
...
#endif
vec3 l9_144=mix(l9_142.xyz,definedBlend(l9_142.xyz,l9_117.xyz).xyz,vec3(l9_68.x));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_146=vec4(mix(vec3(1.0),l9_117.xyz,vec3(l9_68.x)),l9_68.x);
}
#else
{
vec4 l9_147;
...
#endif
l9_147=vec4(l9_117.xyz*l9_148,l9_148);
}
#else
{
l9_147=l9_117;
...
{
l9_151=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_151=vec4(0.0);
...
vec4 l9_153=outputMotionVectorsIfNeeded(varPos,max(l9_152,vec4(0.0)));
...
#endif
int l9_157=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_156).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_169).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_174==0)
{
l9_177=texture(sc_OITAlpha0,l9_169);
l9_176=texture(sc_OITDepthLow0,l9_169);
l9_175=texture(sc_OITDepthHigh0,l9_169);
}
else
{
l9_177=vec4(0.0);
...
if (l9_174==1)
{
l9_180=texture(sc_OITAlpha1,l9_169);
l9_179=texture(sc_OITDepthLow1,l9_169);
l9_178=texture(sc_OITDepthHigh1,l9_169);
}
else
{
l9_180=l9_177;
...
vec4 l9_195=texture(sc_OITFilteredDepthBoundsTexture,l9_169);
