...
{
vec2 l9_68;
Node122_If_else(0.0,vec2(0.0),vec2(0.0),l9_68,l9_5);
float l9_69;
Node67_Bool_Parameter(l9_69,l9_5);
l9_67=mix(l9_2,l9_68,vec2(l9_69));
}
#else
{
vec2 l9_70;
...
{
vec2 l9_71;
Node64_If_else(0.0,vec2(0.0),vec2(0.0),l9_71,l9_5);
float l9_72;
Node11_Bool_Parameter(l9_72,l9_5);
l9_70=mix(l9_2,l9_71,vec2(l9_72));
}
#else
{
l9_70=l9_2;
...
#else
{
bool l9_93=(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_opacityTex)!=0));
float l9_94=l9_65.x;
sc_SoftwareWrapEarly(l9_94,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x);
float l9_95=l9_94;
float l9_96=l9_65.y;
sc_SoftwareWrapEarly(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y);
float l9_97=l9_96;
vec2 l9_98;
float l9_99;
#if (SC_USE_UV_MIN_MAX_opacityTex)
...
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_100=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x==3;
}
#else
{
...
float l9_101=l9_95;
float l9_102=1.0;
sc_ClampUV(l9_101,opacityTexUvMinMax.x,opacityTexUvMinMax.z,l9_100,l9_102);
float l9_103=l9_101;
float l9_104=l9_102;
bool l9_105;
#if (SC_USE_CLAMP_TO_BORDER_opacityTex)
{
l9_105=ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y==3;
}
#else
{
...
float l9_106=l9_97;
float l9_107=l9_104;
sc_ClampUV(l9_106,opacityTexUvMinMax.y,opacityTexUvMinMax.w,l9_105,l9_107);
l9_99=l9_107;
...
#endif
vec2 l9_108=sc_TransformUV(l9_98,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform);
float l9_109=l9_108.x;
float l9_110=l9_99;
sc_SoftwareWrapLate(l9_109,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).x,l9_93,l9_110);
float l9_111=l9_108.y;
float l9_112=l9_110;
sc_SoftwareWrapLate(l9_111,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex).y,l9_93,l9_112);
}
#endif
}
#else
...
#endif
vec4 l9_113=vec4(l9_64.x,l9_64.y,l9_64.z,vec4(0.0).w);
l9_113.w=alpha;
...
{
l9_118=clamp(alpha*2.0,0.0,1.0);
}
#else
{
float l9_119;
...
{
l9_119=clamp(dot(l9_113.xyz,vec3(alpha)),0.0,1.0);
}
#else
{
float l9_120;
...
{
l9_121=(1.0-dot(l9_113.xyz,vec3(0.33333001)))*alpha;
}
#else
{
float l9_122;
...
{
l9_122=(1.0-clamp(dot(l9_113.xyz,vec3(1.0)),0.0,1.0))*alpha;
}
#else
{
float l9_123;
...
{
l9_123=clamp(dot(l9_113.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_124;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_125=clamp(dot(l9_113.xyz,vec3(1.0)),0.0,1.0)*alpha;
}
#else
{
float l9_126;
...
{
l9_126=dot(l9_113.xyz,vec3(0.33333001))*alpha;
}
#else
{
float l9_127;
...
#endif
vec3 l9_140=mix(l9_138.xyz,definedBlend(l9_138.xyz,l9_113.xyz).xyz,vec3(alpha));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_142=vec4(mix(vec3(1.0),l9_113.xyz,vec3(alpha)),alpha);
}
#else
{
vec4 l9_143;
