...
#endif
float l9_3=snoise(vec2(floor(((((varPackedTex.x+Port_Input1_N007)*Tweak_N9)+((Tweak_N9*Tweak_N12)*l9_1))*(Port_Input0_N016/mix(Port_Input0_N014,Tweak_N15,l9_1)))*10000.0)*9.9999997e-05,floor(l9_2*10000.0)*9.9999997e-05)*(Port_Scale_N022*0.5));
