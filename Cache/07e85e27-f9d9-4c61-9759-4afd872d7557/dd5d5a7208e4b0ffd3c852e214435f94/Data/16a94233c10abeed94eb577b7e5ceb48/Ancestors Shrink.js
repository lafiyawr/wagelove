...
var __selfType = requireType("./Ancestors Shrink");
...
let Ancestors = class Ancestors extends BaseScriptComponent {
    onAwake() {
        ...
        const tween1 = LSTween_1.LSTween.scaleToLocal(a1, targetScale, 13000)
            .easing(Easing_1.default.Circular.InOut)
            .delay(5000);
        const tween2 = LSTween_1.LSTween.scaleToLocal(a2, targetScale, 13000)
            .easing(Easing_1.default.Circular.InOut)
            .delay(5200);
        const tween3 = LSTween_1.LSTween.scaleToLocal(a3, targetScale, 13000)
            .easing(Easing_1.default.Circular.InOut)
            .delay(5300);
        tween1.start();
        tween2.start();
...
//# sourceMappingURL=Ancestors%20Shrink.js.map