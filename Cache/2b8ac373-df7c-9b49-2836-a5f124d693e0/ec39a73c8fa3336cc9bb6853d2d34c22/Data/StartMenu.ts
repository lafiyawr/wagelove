...
export class StartMenu extends BaseScriptComponent {
        ...
        switch (this.singlePlayerType) {
            ...
            default:
                ...
                if ((global as any).startSinglePlayer) {
                    ...
                    this.log.i("Game Manager not available - using original single player behavior")
    ...
    private startMultiplayerSession() {
        ...
        if ((global as any).startMultiplayer) {
            ...
            // Fallback - Game Manager not available, just continue with session init
            this.log.i("Game Manager not available - session controller initialized only")
        }
    }
