...
float l9_2=length(sc_ModelMatrix[0].xyz);
float l9_3=length(sc_ModelMatrix[1].xyz);
float l9_4=min(min(clamp(borderScale,0.0,1.0),l9_2/2.0),l9_3/2.0);
float l9_5=(baseTexSize.x/baseTexSize.y)*l9_4;
float l9_6=((sliceSizeLeft*l9_5)*2.0)/l9_2;
float l9_7=1.0-(((sliceSizeRight*l9_5)*2.0)/l9_2);
float l9_8=((sliceSizeBottom*l9_4)*2.0)/l9_3;
float l9_9=1.0-(((sliceSizeTop*l9_4)*2.0)/l9_3);
float l9_10=1.0-sliceSizeRight;
float l9_11=1.0-sliceSizeTop;
float l9_12;
if (l9_0.x<l9_6)
{
l9_12=0.0+(((l9_0.x-0.0)*(sliceSizeLeft-0.0))/((l9_6-0.0)+1e-06));
}
else
{
l9_12=(l9_0.x<l9_7) ? (sliceSizeLeft+(((l9_0.x-l9_6)*(l9_10-sliceSizeLeft))/((l9_7-l9_6)+1e-06))) : (l9_10+(((l9_0.x-l9_7)*(1.0-l9_10))/((1.0-l9_7)+1e-06)));
}
float l9_13;
if (l9_0.y<l9_8)
{
l9_13=0.0+(((l9_0.y-0.0)*(sliceSizeBottom-0.0))/((l9_8-0.0)+1e-06));
}
else
{
l9_13=(l9_0.y<l9_9) ? (sliceSizeBottom+(((l9_0.y-l9_8)*(l9_11-sliceSizeBottom))/((l9_9-l9_8)+1e-06))) : (l9_11+(((l9_0.y-l9_9)*(1.0-l9_11))/((1.0-l9_9)+1e-06)));
}
vec4 l9_14;
#if (baseTexLayout==2)
{
...
{
l9_67=clamp(l9_14.w*2.0,0.0,1.0);
}
#else
{
float l9_68;
...
{
l9_68=clamp(dot(l9_14.xyz,vec3(l9_14.w)),0.0,1.0);
}
#else
{
float l9_69;
...
{
l9_70=(1.0-dot(l9_14.xyz,vec3(0.33333001)))*l9_14.w;
}
#else
{
float l9_71;
...
{
l9_71=(1.0-clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0))*l9_14.w;
}
#else
{
float l9_72;
...
{
l9_72=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0)*l9_14.w;
}
#else
{
float l9_73;
#if (sc_BlendMode_Add)
{
l9_73=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_74;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_74=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0)*l9_14.w;
}
#else
{
float l9_75;
...
{
l9_75=dot(l9_14.xyz,vec3(0.33333001))*l9_14.w;
}
#else
{
float l9_76;
#if (sc_BlendMode_Min)
{
l9_76=1.0-clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_77;
#if (sc_BlendMode_Max)
{
l9_77=clamp(dot(l9_14.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_77=1.0;
...
#endif
l9_65=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_14.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_66);
}
#else
{
vec4 l9_78;
...
#endif
vec3 l9_89=mix(l9_87.xyz,definedBlend(l9_87.xyz,l9_14.xyz).xyz,vec3(l9_14.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_91=vec4(mix(vec3(1.0),l9_14.xyz,vec3(l9_14.w)),l9_14.w);
}
#else
{
vec4 l9_92;
...
#endif
l9_92=vec4(l9_14.xyz*l9_93,l9_93);
}
#else
{
l9_92=l9_14;
