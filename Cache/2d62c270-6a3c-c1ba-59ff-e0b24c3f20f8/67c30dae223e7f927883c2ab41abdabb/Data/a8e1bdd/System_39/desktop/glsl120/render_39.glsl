...
#endif
l9_11=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_16,sc_ScreenTextureLayout,l9_18).xy,0.0);
}
#endif
vec4 l9_19;
...
{
vec4 l9_20=l9_11;
l9_20.x=l9_11.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_19=l9_20;
}
#else
{
...
#endif
vec3 l9_21=mix(l9_19.xyz,definedBlend(l9_19.xyz,l9_8.xyz).xyz,vec3(l9_7));
...
{
l9_23=vec4(mix(vec3(1.0),l9_8.xyz,vec3(l9_7)),l9_7);
}
#else
{
vec4 l9_24;
...
#endif
l9_24=vec4(l9_8.xyz*l9_25,l9_25);
}
#else
{
l9_24=l9_8;
