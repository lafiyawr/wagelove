...
uniform vec3 Port_Import_N193;
uniform vec3 Port_Import_N194;
uniform vec3 Port_Import_N195;
uniform vec3 Port_Import_N196;
uniform vec2 Port_Scale_N198;
uniform vec2 Port_Scale_N199;
uniform vec2 Port_Scale_N200;
uniform vec3 Port_Input1_N202;
...
if (!l9_14)
{
l9_15=!vfxBatchEnable[sc_GetLocalInstanceID()/10001];
}
else
{
l9_15=l9_14;
...
gParticle.SpawnAmount=16.0*l9_6;
...
float l9_21=floor(100.0);
gParticle.Position=(vec3(((floor(mod(gParticle.Index1DPerCopyF,l9_21))/100.0)*2.0)-1.0,((floor(gParticle.Index1DPerCopyF/l9_21)/100.0)*2.0)-1.0,0.0)*20.0)+vec3(1.0,1.0,0.0);
gParticle.Velocity=vec3(0.0);
...
gParticle.Matrix=mat3(vec3(1.0,0.0,0.0),vec3(0.0,1.0,0.0),vec3(0.0,0.0,1.0));
gParticle.Quaternion=vec4(0.0,0.0,0.0,1.0);
tempGlobals=ssGlobals(sc_Time.x,l9_6,l9_8,overrideTimeElapsed[l9_5]);
vec3 l9_22=N42_system_getParticleRandomVec3(true,true,true,0.0);
vec3 l9_23=N42_system_getParticleRandomVec3(true,true,true,150.0);
float l9_24=1.0-clamp(Port_Import_N041,0.0,1.0);
float l9_25;
if (l9_24<=0.0)
{
l9_25=0.0;
...
vec3 l9_26=vec3(l9_25);
vec3 l9_27=mix(l9_26,vec3(1.0),l9_22);
float l9_28=l9_27.x;
float l9_29;
if (l9_28<=0.0)
{
...
vec3 l9_34=mix(vec3(-1.0),vec3(1.0),l9_23);
gParticle.Position=(((vec3(l9_29,l9_31,l9_33)*(l9_34/vec3(length(l9_34+vec3(9.9999997e-05)))))*Port_Import_N037)*Port_Import_N036)+Port_Import_N005;
gParticle.Velocity+=((gParticle.Force/vec3(gParticle.Mass))*0.033330001);
gParticle.Force=vec3(0.0);
gParticle.Position=(vfxModelMatrix[sc_GetLocalInstanceID()/10001]*vec4(gParticle.Position,1.0)).xyz;
int l9_35=sc_GetLocalInstanceID()/10001;
gParticle.Velocity=mat3(vfxModelMatrix[l9_35][0].xyz,vfxModelMatrix[l9_35][1].xyz,vfxModelMatrix[l9_35][2].xyz)*gParticle.Velocity;
int l9_36=sc_GetLocalInstanceID()/10001;
gParticle.Force=mat3(vfxModelMatrix[l9_36][0].xyz,vfxModelMatrix[l9_36][1].xyz,vfxModelMatrix[l9_36][2].xyz)*gParticle.Force;
gParticle.Size=max(length(vfxModelMatrix[sc_GetLocalInstanceID()/10001][0].xyz),max(length(vfxModelMatrix[sc_GetLocalInstanceID()/10001][1].xyz),length(vfxModelMatrix[sc_GetLocalInstanceID()/10001][2].xyz)))*gParticle.Size;
...
ssGlobals l9_37=ssGlobals(sc_Time.x,l9_6,l9_8,overrideTimeElapsed[l9_5]);
tempGlobals=l9_37;
vec3 l9_38=(gParticle.Position+(Port_Import_N195+(Port_Import_N196*tempGlobals.gTimeElapsedShifted)))/Port_Import_N194;
...
gParticle.Force+=(Port_Import_N193*((vec3(floor(((snoise(vec2(floor(l9_39.x*10000.0)*9.9999997e-05,floor(l9_39.y*10000.0)*9.9999997e-05)*(Port_Scale_N198*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05,floor(((snoise(vec2(floor(l9_40.x*10000.0)*9.9999997e-05,floor(l9_40.y*10000.0)*9.9999997e-05)*(Port_Scale_N199*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05,floor(((snoise(vec2(floor(l9_41.x*10000.0)*9.9999997e-05,floor(l9_41.y*10000.0)*9.9999997e-05)*(Port_Scale_N200*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05)*Port_Input1_N202)-vec3(1.0)));
tempGlobals=l9_37;
float l9_42=clamp(gParticle.Age/gParticle.Life,0.0,1.0);
gParticle.Size=mix(Port_Import_N092,Port_Import_N108,clamp(l9_42/(Port_Import_N109/gParticle.Life),0.0,1.0)*clamp((1.0-l9_42)/(Port_Import_N111/gParticle.Life),0.0,1.0));
...
{
l9_43=gParticle.Force.x;
}
gParticle.Force.x=l9_43;
float l9_44;
...
{
l9_44=gParticle.Force.y;
}
gParticle.Force.y=l9_44;
float l9_45;
...
{
l9_45=gParticle.Force.z;
}
gParticle.Force.z=l9_45;
...
{
l9_46=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_46;
float l9_47;
...
{
l9_47=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_47;
float l9_48;
...
{
l9_48=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_48;
gParticle.Position+=(gParticle.Velocity*l9_6);
vec2 l9_49=vec2(3.0,1.0)/vec2(2048.0,vfxTargetSizeWrite.y);
int l9_50=vfxOffsetInstancesWrite+sc_GetLocalInstanceID();
float l9_51;
if (texture0.x<0.5)
{
l9_51=0.0;
...
sc_SetClipPosition(vec4(((vec2(l9_51,l9_52)+(vec2(float(l9_50%682),float(l9_50/682))*l9_49))*2.0)-vec2(1.0),1.0,1.0));
...
float l9_64=1.0-0.0;
float l9_65=1.00001-0.0;
l9_58=0.0+(((clamp(Interp_Particle_Color.w,0.0,1.00001)-0.0)*l9_64)/l9_65);
l9_57=0.0+(((clamp(Interp_Particle_Color.z,0.0,1.00001)-0.0)*l9_64)/l9_65);
l9_56=0.0+(((clamp(Interp_Particle_Color.y,0.0,1.00001)-0.0)*l9_64)/l9_65);
l9_55=0.0+(((clamp(Interp_Particle_Color.x,0.0,1.00001)-0.0)*l9_64)/l9_65);
l9_54=l9_63.y;
l9_53=l9_63.x;
l9_52=l9_62.y;
l9_51=l9_62.x;
...
vec4 l9_69=vec4(l9_17,l9_18,l9_19,l9_20);
vec4 l9_70;
vec4 l9_71;
if (int(Interp_Particle_Index)==((10001*(int(Interp_Particle_Index/10001.0)+1))-1))
{
vec2 l9_72=ssEncodeFloat16(Interp_Particle_NextBurstTime,0.0,300.0,0.99998999);
l9_71=vec4(l9_72.x,l9_72.y,l9_67.z,l9_67.w);
l9_70=ssEncodeFloat32(Interp_Particle_SpawnIndex,-1.0,500000.0,0.99998999);
}
else
{
l9_71=l9_67;
...
vec4 l9_73;
if (dot(((l9_70+l9_71)+l9_68)+l9_69,vec4(0.23454))==0.34231836)
{
l9_73=l9_70+vec4(1e-06);
}
else
{
l9_73=l9_70;
