...
if (!l9_16)
{
l9_17=!vfxBatchEnable[sc_GetLocalInstanceID()/100000];
}
else
{
l9_17=l9_16;
...
bool l9_3=l9_2>=(100000*(vfxNumCopies+1));
bool l9_4;
if (!l9_3)
{
l9_4=vfxBatchEnable[sc_GetLocalInstanceID()/100000]==false;
}
else
{
l9_4=l9_3;
...
float l9_6=l9_5*Port_Import_N003;
float l9_7=Interp_Particle_Color.w*(clamp(l9_6+0.001,Port_Input1_N144+0.001,Port_Input2_N144+0.001)-0.001);
vec4 l9_8=vec4(Interp_Particle_Color.x,Interp_Particle_Color.y,Interp_Particle_Color.z,vec4(0.0).w);
l9_8.w=l9_7;
vec4 l9_9;
