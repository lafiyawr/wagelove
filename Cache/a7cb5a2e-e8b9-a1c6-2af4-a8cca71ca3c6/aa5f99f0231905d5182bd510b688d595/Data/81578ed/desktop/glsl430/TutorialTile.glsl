...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask 83 -1
//spec_const int intensityTextureLayout 84 0
//spec_const int notification_outline_maskLayout 85 0
...
float l9_7=clamp((vec2(dot(vec2(cos(l9_6),sin(l9_6)),((vec4((l9_1.x*Port_Input1_N018)+Port_Input1_N021)+mix(Port_Import_N038,Port_Import_N039,vec4(smoothstep(Port_Input0_N066,Port_Input1_N066,clamp((dot(((((((l9_4/vec2((Port_RangeMaxA_N033-Port_RangeMinA_N033)+1e-06))*(Port_RangeMaxB_N033-Port_RangeMinB_N033))+vec2(Port_RangeMinB_N033))-Port_Center_N047)*Port_Import_N025)+Port_Center_N047)-Port_Import_N058,l9_5)/dot(l9_5,l9_5))+0.001,Port_Input1_N065+0.001,Port_Input2_N065+0.001)-0.001)))).xy+Port_Offset_N003)-Port_Center_N007),0.0)+Port_Center_N007).x,0.0,1.0);
vec4 l9_8;
...
{
bool l9_27=(int(SC_USE_CLAMP_TO_BORDER_notification_outline_mask)!=0)&&(!(int(SC_USE_UV_MIN_MAX_notification_outline_mask)!=0));
float l9_28=l9_2.x;
sc_SoftwareWrapEarly(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask,SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask).x);
float l9_29=l9_28;
float l9_30=l9_2.y;
sc_SoftwareWrapEarly(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask,SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask).y);
float l9_31=l9_30;
vec2 l9_32;
float l9_33;
...
{
l9_34=ivec2(SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask,SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask).x==3;
}
#else
{
l9_34=(int(SC_USE_CLAMP_TO_BORDER_notification_outline_mask)!=0);
}
#endif
float l9_35=l9_29;
float l9_36=1.0;
sc_ClampUV(l9_35,notification_outline_maskUvMinMax.x,notification_outline_maskUvMinMax.z,l9_34,l9_36);
float l9_37=l9_35;
float l9_38=l9_36;
bool l9_39;
#if (SC_USE_CLAMP_TO_BORDER_notification_outline_mask)
{
l9_39=ivec2(SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask,SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask).y==3;
}
#else
{
l9_39=(int(SC_USE_CLAMP_TO_BORDER_notification_outline_mask)!=0);
}
#endif
float l9_40=l9_31;
float l9_41=l9_38;
sc_ClampUV(l9_40,notification_outline_maskUvMinMax.y,notification_outline_maskUvMinMax.w,l9_39,l9_41);
l9_33=l9_41;
...
#endif
vec2 l9_42=sc_TransformUV(l9_32,(int(SC_USE_UV_TRANSFORM_notification_outline_mask)!=0),notification_outline_maskTransform);
float l9_43=l9_42.x;
float l9_44=l9_33;
sc_SoftwareWrapLate(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask,SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask).x,l9_27,l9_44);
float l9_45=l9_42.y;
float l9_46=l9_44;
sc_SoftwareWrapLate(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask,SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask).y,l9_27,l9_46);
float l9_47=l9_46;
vec3 l9_48=sc_SamplingCoordsViewToGlobal(vec2(l9_43,l9_45),notification_outline_maskLayout,notification_outline_maskGetStereoViewIndex());
vec4 l9_49=texture(notification_outline_maskArrSC,l9_48,0.0);
vec4 l9_50;
#if (SC_USE_CLAMP_TO_BORDER_notification_outline_mask)
{
l9_50=mix(notification_outline_maskBorderColor,l9_49,vec4(l9_47));
}
#else
{
l9_50=l9_49;
...
#else
{
bool l9_51=(int(SC_USE_CLAMP_TO_BORDER_notification_outline_mask)!=0)&&(!(int(SC_USE_UV_MIN_MAX_notification_outline_mask)!=0));
float l9_52=l9_2.x;
sc_SoftwareWrapEarly(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask,SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask).x);
float l9_53=l9_52;
float l9_54=l9_2.y;
sc_SoftwareWrapEarly(l9_54,ivec2(SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask,SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask).y);
float l9_55=l9_54;
vec2 l9_56;
float l9_57;
#if (SC_USE_UV_MIN_MAX_notification_outline_mask)
...
#if (SC_USE_CLAMP_TO_BORDER_notification_outline_mask)
{
l9_58=ivec2(SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask,SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask).x==3;
}
#else
{
l9_58=(int(SC_USE_CLAMP_TO_BORDER_notification_outline_mask)!=0);
}
#endif
float l9_59=l9_53;
float l9_60=1.0;
sc_ClampUV(l9_59,notification_outline_maskUvMinMax.x,notification_outline_maskUvMinMax.z,l9_58,l9_60);
float l9_61=l9_59;
float l9_62=l9_60;
bool l9_63;
#if (SC_USE_CLAMP_TO_BORDER_notification_outline_mask)
{
l9_63=ivec2(SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask,SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask).y==3;
}
#else
{
l9_63=(int(SC_USE_CLAMP_TO_BORDER_notification_outline_mask)!=0);
}
#endif
float l9_64=l9_55;
float l9_65=l9_62;
sc_ClampUV(l9_64,notification_outline_maskUvMinMax.y,notification_outline_maskUvMinMax.w,l9_63,l9_65);
l9_57=l9_65;
...
#endif
vec2 l9_66=sc_TransformUV(l9_56,(int(SC_USE_UV_TRANSFORM_notification_outline_mask)!=0),notification_outline_maskTransform);
float l9_67=l9_66.x;
float l9_68=l9_57;
sc_SoftwareWrapLate(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask,SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask).x,l9_51,l9_68);
float l9_69=l9_66.y;
float l9_70=l9_68;
sc_SoftwareWrapLate(l9_69,ivec2(SC_SOFTWARE_WRAP_MODE_U_notification_outline_mask,SC_SOFTWARE_WRAP_MODE_V_notification_outline_mask).y,l9_51,l9_70);
float l9_71=l9_70;
vec3 l9_72=sc_SamplingCoordsViewToGlobal(vec2(l9_67,l9_69),notification_outline_maskLayout,notification_outline_maskGetStereoViewIndex());
vec4 l9_73=texture(notification_outline_mask,l9_72.xy,0.0);
vec4 l9_74;
#if (SC_USE_CLAMP_TO_BORDER_notification_outline_mask)
{
l9_74=mix(notification_outline_maskBorderColor,l9_73,vec4(l9_71));
}
#else
{
l9_74=l9_73;
...
#endif
vec3 l9_75=mix(l9_15.xyz,l9_25,l9_26.xyz);
vec2 l9_76=l9_2-vec2(Port_RangeMinA_N035);
vec2 l9_77=Port_Import_N042-Port_Import_N040;
vec4 l9_78=mix(Port_Import_N031,Port_Import_N032,vec4(smoothstep(Port_Input0_N049,Port_Input1_N049,clamp((dot(((((((l9_76/vec2((Port_RangeMaxA_N035-Port_RangeMinA_N035)+1e-06))*(Port_RangeMaxB_N035-Port_RangeMinB_N035))+vec2(Port_RangeMinB_N035))-Port_Center_N037)*Port_Import_N036)+Port_Center_N037)-Port_Import_N040,l9_77)/dot(l9_77,l9_77))+0.001,Port_Input1_N048+0.001,Port_Input2_N048+0.001)-0.001)));
vec4 l9_79=l9_26*vec4(Tweak_N12);
vec3 l9_80=l9_79.xyz*l9_79.w;
vec3 l9_81=l9_78.xyz*l9_78.w;
vec4 l9_82=min(vec4(l9_81.x,l9_81.y,l9_81.z,l9_78.w)+min(vec4(l9_80.x,l9_80.y,l9_80.z,l9_79.w)+vec4(notification_tile_opacity),vec4(1.0)),vec4(1.0));
float l9_83=l9_82.x;
vec4 l9_84=vec4(l9_75.x,l9_75.y,l9_75.z,vec4(0.0).w);
l9_84.w=l9_83;
...
{
l9_90=clamp(dot(l9_84.xyz,vec3(l9_83)),0.0,1.0);
}
#else
{
float l9_91;
...
{
l9_92=(1.0-dot(l9_84.xyz,vec3(0.33333001)))*l9_83;
}
#else
{
float l9_93;
...
{
l9_93=(1.0-clamp(dot(l9_84.xyz,vec3(1.0)),0.0,1.0))*l9_83;
}
#else
{
float l9_94;
...
#if (sc_BlendMode_Add)
{
l9_95=clamp(dot(l9_84.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_96;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_96=clamp(dot(l9_84.xyz,vec3(1.0)),0.0,1.0)*l9_83;
}
#else
{
float l9_97;
...
{
l9_97=dot(l9_84.xyz,vec3(0.33333001))*l9_83;
}
#else
{
float l9_98;
#if (sc_BlendMode_Min)
{
l9_98=1.0-clamp(dot(l9_84.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_99;
#if (sc_BlendMode_Max)
{
l9_99=clamp(dot(l9_84.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_99=1.0;
...
#endif
l9_87=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_84.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_88);
}
#else
{
vec4 l9_100;
...
#endif
vec3 l9_111=mix(l9_109.xyz,definedBlend(l9_109.xyz,l9_84.xyz).xyz,vec3(l9_83));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_113=vec4(mix(vec3(1.0),l9_84.xyz,vec3(l9_83)),l9_83);
}
#else
{
vec4 l9_114;
...
#endif
l9_114=vec4(l9_84.xyz*l9_115,l9_115);
}
#else
{
l9_114=l9_84;
