...
//texture texture2D background 0:3:0:25
...
//texture texture2DArray backgroundArrSC 0:40:0:25
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_background 93 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 94 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_background 95 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 96 -1
//spec_const int backgroundLayout 97 0
...
vec3 l9_3=Globals.ViewDirWS;
vec3 l9_4=Globals.VertexNormal_WorldSpace;
vec2 l9_5=Globals.gScreenCoord;
vec3 l9_6=Globals.ViewDirWS;
vec3 l9_7=Globals.VertexNormal_WorldSpace;
...
vec3 l9_10=l9_7*l9_9;
vec2 l9_11=l9_5+(vec2(refract(l9_6,l9_10,Port_Input2_N045).xy)*vec2(intensity));
vec2 l9_12=vec2((chromaticAberration*(Port_Input0_N052-clamp(dot(l9_3,l9_4),0.0,1.0)))*Port_Input2_N051);
vec2 l9_13=l9_12+l9_11;
...
#endif
if (dot(normalize(sc_Camera.position-Globals.PositionWS),l9_135)>=(-0.050000001))
{
uvec3 l9_136=uvec3(round((Globals.PositionWS-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_136.x,l9_136.y,l9_136.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_137=abs(l9_135);
vec3 l9_138=l9_135/vec3(dot(l9_137,vec3(1.0)));
float l9_139=clamp(-l9_138.z,0.0,1.0);
...
uvec2 l9_145=uvec2(packHalf2x16(vec2(l9_142,0.0)),packHalf2x16(vec2(l9_143+l9_144,0.0)));
normal_and_more=uvec4(l9_145.x,l9_145.y,normal_and_more.z,normal_and_more.w);
...
{
l9_146=uint(clamp(Port_Roughness_N006,0.0,1.0)*1000.0);
}
normal_and_more.w=l9_146|uint((receiverId%32)<<int(10u));
}
else
{
...
#endif
vec4 param_2;
Node24_Override(vec4(0.0),vec3(0.0),param_2,ssGlobals(sc_Time.x,sc_Time.y,0.0,normalize(varNormal),varPos,vec3(0.0),normalize(sc_Camera.position-varPos),varPos,l9_1));
}
...
float l9_6=clamp(dot(l9_4,l9_5),0.0,1.0);
vec2 l9_7=Globals.gScreenCoord;
vec3 l9_8=Globals.ViewDirWS;
vec3 l9_9=Globals.VertexNormal_WorldSpace;
...
vec2 l9_13=l9_7+(vec2(refract(l9_8,l9_12,Port_Input2_N045).xy)*vec2(intensity));
vec2 l9_14=vec2((chromaticAberration*(Port_Input0_N052-l9_6))*Port_Input2_N051);
vec2 l9_15=l9_14+l9_13;
vec4 l9_16;
#if (backgroundLayout==2)
{
...
vec4 l9_39=texture(backgroundArrSC,l9_38,thickness);
vec4 l9_40;
#if (SC_USE_CLAMP_TO_BORDER_background)
{
...
vec4 l9_63=texture(background,l9_62.xy,thickness);
vec4 l9_64;
#if (SC_USE_CLAMP_TO_BORDER_background)
{
...
vec4 l9_88=texture(backgroundArrSC,l9_87,thickness);
vec4 l9_89;
#if (SC_USE_CLAMP_TO_BORDER_background)
{
...
vec4 l9_112=texture(background,l9_111.xy,thickness);
vec4 l9_113;
#if (SC_USE_CLAMP_TO_BORDER_background)
{
...
vec4 l9_138=texture(backgroundArrSC,l9_137,thickness);
vec4 l9_139;
#if (SC_USE_CLAMP_TO_BORDER_background)
{
...
vec4 l9_162=texture(background,l9_161.xy,thickness);
vec4 l9_163;
#if (SC_USE_CLAMP_TO_BORDER_background)
{
...
#endif
vec3 l9_164=vec3(l9_16.x,l9_65.y,l9_115.z);
float l9_165=abs(Port_Input0_N018-l9_6);
float l9_166;
if (l9_165<=0.0)
{
l9_166=0.0;
...
{
l9_166=pow(l9_165,exponent);
}
float l9_167=1.0-l9_166;
float l9_168=mix(Port_Input0_N025,l9_167,darken);
vec3 l9_169;
#if (!sc_ProjectiveShadowsCaster)
{
l9_169=Globals.VertexNormal_WorldSpace;
}
#else
{
l9_169=Globals.BumpedNormal;
}
#endif
#if (sc_BlendMode_AlphaTest)
{
...
#endif
vec3 l9_170=max(mix(l9_164,l9_164*colorTint.xyz,vec3(Port_Input2_N029))*vec3(l9_168*l9_168),vec3(0.0));
vec4 l9_171;
#if (sc_ProjectiveShadowsCaster)
{
l9_171=vec4(l9_170,Port_Opacity_N006);
}
#else
{
l9_171=ngsCalculateLighting(l9_170,Port_Opacity_N006,l9_169,Globals.PositionWS,Globals.ViewDirWS,Port_Emissive_N006,Port_Metallic_N006,Port_Roughness_N006,Port_AO_N006,Port_SpecularAO_N006);
}
#endif
Input=max(l9_171,vec4(0.0));
Output=Input;
}
...
vec4 l9_6=sc_ViewProjectionMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_5,1.0);
l9_3=l9_4.normalWS;
l9_2=l9_5;
l9_1=l9_4.viewDirWS;
l9_0=((l9_6.xy/vec2(l9_6.w))*0.5)+vec2(0.5);
}
else
{
...
vec4 param_2;
Node24_Override(vec4(0.0),vec3(0.0),param_2,ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_3,l9_2,vec3(0.0),l9_1,l9_2,l9_0));
vec4 l9_7=param_2;
if (isProxyMode)
{
vec4 l9_8;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_12=clamp(l9_7.w*2.0,0.0,1.0);
}
#else
{
float l9_13;
...
{
l9_13=clamp(dot(l9_7.xyz,vec3(l9_7.w)),0.0,1.0);
}
#else
{
float l9_14;
...
#if (sc_BlendMode_Multiply)
{
l9_15=(1.0-dot(l9_7.xyz,vec3(0.33333001)))*l9_7.w;
}
#else
{
float l9_16;
...
{
l9_16=(1.0-clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0))*l9_7.w;
}
#else
{
float l9_17;
#if (sc_BlendMode_ColoredGlass)
{
l9_17=clamp(dot(l9_7.xyz,vec3(1.0)),0.0,1.0)*l9_7.w;
}
#else
{
float l9_18;
...
{
l9_20=dot(l9_7.xyz,vec3(0.33333001))*l9_7.w;
}
#else
{
float l9_21;
...
vec3 l9_26=mix(l9_25,definedBlend(l9_25,l9_7.xyz).xyz,vec3(l9_7.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_28=vec4(mix(vec3(1.0),l9_7.xyz,vec3(l9_7.w)),l9_7.w);
}
#else
{
vec4 l9_29;
...
#endif
l9_29=vec4(l9_7.xyz*l9_30,l9_30);
}
#else
{
l9_29=l9_7;
