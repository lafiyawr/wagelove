...
#endif
vec4 l9_0=mix(Tweak_N1,Tweak_N2,vec4(varPackedTex.y));
float l9_1=1.0-varPackedTex.y;
float l9_2;
#if (animated)
{
l9_2=(sc_Time.x*Tweak_N21)+Offset;
}
#else
{
l9_2=Offset;
...
#endif
float l9_3=snoise(vec2(floor(((((varPackedTex.x+Port_Input1_N007)*Tweak_N9)+((Tweak_N9*Tweak_N12)*l9_1))*(Port_Input0_N016/(mix(Port_Input0_N014,Tweak_N15,l9_1)+1.234e-06)))*10000.0)*9.9999997e-05,floor(l9_2*10000.0)*9.9999997e-05)*(Port_Scale_N022*0.5));
float l9_4=(floor(((l9_3*0.5)+0.5)*10000.0)*9.9999997e-05)*intensity;
float l9_5=clamp((l9_0.w*mix(l9_4,l9_4*varPackedTex.y,Tweak_N31))+0.001,Port_Input1_N034+0.001,Port_Input2_N034+0.001)-0.001;
vec4 l9_6=vec4(l9_0.x,l9_0.y,l9_0.z,vec4(0.0).w);
l9_6.w=l9_5;
...
{
l9_28=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_26,sc_ScreenTextureLayout,l9_27),0.0);
}
#else
{
l9_28=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_26,sc_ScreenTextureLayout,l9_27).xy,0.0);
}
#endif
l9_22=l9_28;
}
...
#endif
vec3 l9_31=mix(l9_29.xyz,definedBlend(l9_29.xyz,l9_6.xyz).xyz,vec3(l9_5));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_33=vec4(mix(vec3(1.0),l9_6.xyz,vec3(l9_5)),l9_5);
}
#else
{
vec4 l9_34;
...
#endif
l9_34=vec4(l9_6.xyz*l9_35,l9_35);
}
#else
{
l9_34=l9_6;
