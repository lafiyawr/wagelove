...
l9_76.w=Port_Value2_N014;
vec4 l9_77=l9_76*vec4(notification_tile_opacity);
float l9_78=l9_77.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_78<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_78<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
#endif
sc_writeFragData0Internal(max(l9_79,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_81;
...
{
l9_84=clamp(dot(l9_77.xyz,vec3(l9_78)),0.0,1.0);
}
#else
{
float l9_85;
...
{
l9_86=(1.0-dot(l9_77.xyz,vec3(0.33333001)))*l9_78;
}
#else
{
float l9_87;
...
{
l9_87=(1.0-clamp(dot(l9_77.xyz,vec3(1.0)),0.0,1.0))*l9_78;
}
#else
{
float l9_88;
...
{
l9_88=clamp(dot(l9_77.xyz,vec3(1.0)),0.0,1.0)*l9_78;
}
#else
{
float l9_89;
#if (sc_BlendMode_Add)
{
l9_89=clamp(dot(l9_77.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_90;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_90=clamp(dot(l9_77.xyz,vec3(1.0)),0.0,1.0)*l9_78;
}
#else
{
float l9_91;
...
{
l9_91=dot(l9_77.xyz,vec3(0.33333001))*l9_78;
}
#else
{
float l9_92;
#if (sc_BlendMode_Min)
{
l9_92=1.0-clamp(dot(l9_77.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_93;
#if (sc_BlendMode_Max)
{
l9_93=clamp(dot(l9_77.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_93=1.0;
...
#endif
l9_81=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_77.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_82);
}
#else
{
vec4 l9_94;
...
#endif
vec3 l9_105=mix(l9_103.xyz,definedBlend(l9_103.xyz,l9_77.xyz).xyz,vec3(l9_78));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_107=vec4(mix(vec3(1.0),l9_77.xyz,vec3(l9_78)),l9_78);
}
#else
{
vec4 l9_108;
...
#endif
l9_108=vec4(l9_77.xyz*l9_109,l9_109);
}
#else
{
l9_108=l9_77;
