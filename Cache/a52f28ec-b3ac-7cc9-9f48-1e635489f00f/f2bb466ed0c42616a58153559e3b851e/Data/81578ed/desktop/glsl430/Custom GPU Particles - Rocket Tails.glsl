...
Node2_Pixel_Shader_Particles(l9_0,float(TRAILBEHAVIOR),float(l9_3),param_2,param_4,vec4(trailFadeStartEnd.x,trailFadeStartEnd.y,param_9.x,param_9.y),trailLength,colorStart,colorEnd,param_11,colorMinStart,colorMinEnd,colorMaxStart,colorMaxEnd,param_13,alphaStart,alphaEnd,param_15,alphaMinStart,alphaMinEnd,alphaMaxStart,alphaMaxEnd,param_17,alphaDissolveMult,param_19,param_21,param_23,param_25,numValidFrames,gridSize,flipBookSpeedMult,flipBookRandomStart,param_27,param_29,param_31,colorRampTextureSize.xy,colorRampMult,param_33,param_35,param_37,externalSeed,vec4(Interpolator0.x,Interpolator0.y,Interpolator0.z,Interpolator0.w),vec4(Interpolator1.x,Interpolator1.y,Interpolator1.z,Interpolator1.w),param_82,param_83,param_84,param_85,param_86,param_87,param_88,Globals);
vec4 l9_4=param_85;
float l9_5=clamp((vec4(1.0)-l9_4).x,0.0,1.0);
vec4 l9_6;
if (l9_5<ratio1)
{
l9_6=mix(color1,color2,vec4(clamp(l9_5/ratio1,0.0,1.0)));
}
else
{
vec4 l9_7;
if (l9_5<ratio2)
{
l9_7=mix(color2,color3,vec4(clamp((l9_5-ratio1)/(ratio2-ratio1),0.0,1.0)));
}
else
{
vec4 l9_8;
if (l9_5<ratio3)
{
l9_8=mix(color3,color4,vec4(clamp((l9_5-ratio2)/(ratio3-ratio2),0.0,1.0)));
}
else
{
vec4 l9_9;
if (l9_5<ratio4)
{
l9_9=mix(color4,color5,vec4(clamp((l9_5-ratio3)/(ratio4-ratio3),0.0,1.0)));
}
else
{
l9_9=mix(color5,color5,vec4(clamp((l9_5-ratio4)/(1.0-ratio4),0.0,1.0)));
}
l9_8=l9_9;
}
l9_7=l9_8;
...
#if (!sc_ProjectiveShadowsCaster)
{
l9_13=mat3(Globals.VertexTangent_WorldSpace,Globals.VertexBinormal_WorldSpace,Globals.VertexNormal_WorldSpace)*l9_12;
}
#else
{
l9_13=Globals.BumpedNormal;
}
#endif
float l9_14=clamp(l9_4.w,0.0,1.0);
#if (sc_BlendMode_AlphaTest)
{
...
#endif
vec3 l9_15=max(l9_6.xyz,vec3(0.0));
vec4 l9_16;
#if (sc_ProjectiveShadowsCaster)
{
...
#else
{
float l9_17=clamp(metallic,0.0,1.0);
float l9_18=clamp(roughness,0.0,1.0);
vec3 l9_19=ssSRGB_to_Linear(l9_15);
vec3 l9_20=normalize(l9_13);
vec3 l9_21=ssSRGB_to_Linear(l9_15);
vec3 l9_22;
#if (sc_SSAOEnabled)
{
l9_22=evaluateSSAO(Globals.PositionWS);
}
#else
{
l9_22=Port_AO_N014;
...
SurfaceProperties l9_26=SurfaceProperties(l9_25,l9_14,l9_20,Globals.PositionWS,Globals.ViewDirWS,l9_17,l9_18,l9_21,l9_22,Port_SpecularAO_N014,vec3(1.0),l9_24);
vec4 l9_27=vec4(1.0);
vec3 l9_28;
vec3 l9_29;
vec3 l9_30;
...
{
LightingComponents l9_47=accumulateLight(LightingComponents(l9_35,l9_36,l9_41,l9_40,l9_38,l9_37),LightProperties(sc_DirectionalLights[l9_46].direction,sc_DirectionalLights[l9_46].color.xyz,sc_DirectionalLights[l9_46].color.w*l9_27[(l9_39<3) ? l9_39 : 3]),l9_26,Globals.ViewDirWS);
...
{
vec3 l9_66=sc_PointLights[l9_64].position-Globals.PositionWS;
...
l9_57=l9_65+1;
LightingComponents l9_72=accumulateLight(LightingComponents(l9_51,l9_52,l9_56,l9_55,l9_54,l9_53),LightProperties(l9_67,sc_PointLights[l9_64].color.xyz,l9_71),l9_26,Globals.ViewDirWS);
...
vec4 l9_77=texture(sc_ShadowTexture,varShadowTex)*step(max(l9_76.x,l9_76.y),0.5);
...
{
l9_82=texture(sc_RayTracedShadowTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_80,sc_RayTracedShadowTextureLayout,l9_81),0.0);
}
#else
{
l9_82=texture(sc_RayTracedShadowTexture,sc_SamplingCoordsViewToGlobal(l9_80,sc_RayTracedShadowTextureLayout,l9_81).xy,0.0);
}
#endif
vec3 l9_83=vec3(1.0)-vec3(l9_82.x);
l9_79=l9_73*l9_83;
l9_78=l9_74*l9_83;
}
else
...
{
vec2 l9_85=calcPanoramicTexCoordsFromDir(l9_20,sc_EnvmapRotation.y);
vec4 l9_86;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_87=calcSeamlessPanoramicUvsForSampling(l9_85,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_87=l9_85;
...
#endif
l9_86=sc_EnvmapSpecularSampleViewIndexBias(l9_87,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_88;
...
{
vec2 l9_89=calcSeamlessPanoramicUvsForSampling(l9_85,sc_EnvmapDiffuseSize.xy,0.0);
int l9_90;
...
{
l9_91=texture(sc_EnvmapDiffuseArrSC,sc_SamplingCoordsViewToGlobal(l9_89,sc_EnvmapDiffuseLayout,l9_90),-13.0);
}
#else
{
l9_91=texture(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_89,sc_EnvmapDiffuseLayout,l9_90).xy,-13.0);
}
#endif
l9_88=l9_91;
}
#else
{
l9_88=sc_EnvmapSpecularSampleViewIndexBias(l9_85,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_86=l9_88;
}
#endif
l9_84=(l9_86.xyz*(1.0/l9_86.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_92;
...
float l9_95=l9_93.y;
float l9_96=l9_93.z;
l9_92=(((((((sc_Sh[8]*0.42904299)*((l9_94*l9_94)-(l9_95*l9_95)))+((sc_Sh[6]*0.74312502)*(l9_96*l9_96)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_94*l9_95))+(sc_Sh[7]*(l9_94*l9_96)))+(sc_Sh[5]*(l9_95*l9_96)))*0.85808599))+((((sc_Sh[3]*l9_94)+(sc_Sh[1]*l9_95))+(sc_Sh[2]*l9_96))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_92=vec3(0.0);
...
if (receivesRayTracedDiffuseIndirect)
{
vec4 l9_98=sampleRayTracedIndirectDiffuse();
l9_97=mix(l9_84,l9_98.xyz,vec3(l9_98.w));
}
else
{
l9_97=l9_84;
...
{
l9_100=l9_97+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_101=l9_97;
l9_101.x=l9_97.x+(1e-06*sc_AmbientLights[0].color.x);
l9_100=l9_101;
}
#endif
l9_99=l9_100;
...
{
l9_103=l9_99+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_104=l9_99;
l9_104.x=l9_99.x+(1e-06*sc_AmbientLights[1].color.x);
l9_103=l9_104;
}
#endif
l9_102=l9_103;
...
{
l9_106=l9_102+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_107=l9_102;
l9_107.x=l9_102.x+(1e-06*sc_AmbientLights[2].color.x);
l9_106=l9_107;
}
#endif
l9_105=l9_106;
...
{
vec3 l9_109;
l9_109=sc_LightEstimationData.ambientLight;
vec3 l9_110;
int l9_111=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
...
{
float l9_112=dot(sc_LightEstimationData.sg[l9_111].axis,l9_20);
float l9_113=exp(-sc_LightEstimationData.sg[l9_111].sharpness);
float l9_114=l9_113*l9_113;
float l9_115=1.0/sc_LightEstimationData.sg[l9_111].sharpness;
float l9_116=(1.0+(2.0*l9_114))-l9_115;
float l9_117=sqrt(1.0-l9_116);
float l9_118=0.36000001*l9_112;
float l9_119=(1.0/(4.0*0.36000001))*l9_117;
float l9_120=l9_118+l9_119;
float l9_121;
if (step(abs(l9_118),l9_119)>0.5)
{
l9_121=(l9_120*l9_120)/l9_117;
}
else
{
l9_121=clamp(l9_112,0.0,1.0);
}
l9_110=l9_109+((((sc_LightEstimationData.sg[l9_111].color/vec3(sc_LightEstimationData.sg[l9_111].sharpness))*6.2831855)*((l9_116*l9_121)+(((l9_113-l9_114)*l9_115)-l9_114)))/vec3(3.1415927));
l9_109=l9_110;
l9_111++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_123=clamp(pow(l9_18,0.66666669),0.0,1.0)*5.0;
vec2 l9_124=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_20,reflect(-Globals.ViewDirWS,l9_20),l9_18),sc_EnvmapRotation.y);
vec4 l9_125;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_126=floor(l9_123);
float l9_127=ceil(l9_123);
l9_125=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_124,sc_EnvmapSpecularSize.xy,l9_126),sc_EnvmapSpecularGetStereoViewIndex(),l9_126),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_124,sc_EnvmapSpecularSize.xy,l9_127),sc_EnvmapSpecularGetStereoViewIndex(),l9_127),vec4(l9_123-l9_126));
}
#else
{
l9_125=sc_EnvmapSpecularSampleViewIndexLevel(l9_124,sc_EnvmapSpecularGetStereoViewIndex(),l9_123);
}
#endif
vec3 l9_128=((l9_125.xyz*(1.0/l9_125.w))*sc_EnvmapExposure)+vec3(1e-06);
vec3 l9_129;
if (receivesRayTracedReflections)
{
vec4 l9_130=sampleRayTracedReflections();
l9_129=mix(l9_128,l9_130.xyz,vec3(l9_130.w));
}
else
{
l9_129=l9_128;
}
l9_122=vec3(0.0)+(l9_129*envBRDFApprox(l9_26,abs(dot(l9_20,Globals.ViewDirWS))));
}
#else
{
l9_122=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_132=clamp(l9_18*l9_18,0.0099999998,1.0);
vec3 l9_133;
l9_133=sc_LightEstimationData.ambientLight*l9_24;
int l9_134=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
...
vec3 l9_136=reflect(-Globals.ViewDirWS,l9_20);
float l9_137=dot(l9_20,Globals.ViewDirWS);
...
l9_146=vec3(0.0);
l9_145=vec3(0.0);
l9_144=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_25,vec3(l9_14));
l9_143=1.0;
}
#else
{
...
if (receivesRayTracedAo)
{
l9_148=l9_25*(l9_146+(l9_145*vec3(1.0-sampleRayTracedAo())));
}
else
{
l9_148=l9_25*(l9_146+(l9_145*l9_22));
}
vec3 l9_149=l9_131*Port_SpecularAO_N014;
vec3 l9_150=l9_78+l9_149;
vec3 l9_151;
if (l9_147)
{
l9_151=l9_148*srgbToLinear(l9_143);
}
else
{
l9_151=l9_148;
...
vec3 l9_153=(l9_152+l9_21)+l9_144;
float l9_154=l9_153.x;
vec4 l9_155=vec4(l9_154,l9_153.yz,l9_143);
vec4 l9_156;
#if (sc_IsEditor)
{
vec4 l9_157=l9_155;
l9_157.x=l9_154+((l9_22.x*Port_SpecularAO_N014.x)*9.9999997e-06);
l9_156=l9_157;
}
#else
{
...
l9_16=vec4(l9_161.x,l9_161.y,l9_161.z,l9_158.w);
}
#endif
Value1=max(l9_16,vec4(0.0));
Result=Value1;
}
#else
{
float param_95;
Node192_Bool_Parameter(param_95,Globals);
float l9_162=param_95;
vec4 l9_163=Globals.VertexColor;
bool l9_164=(l9_162*1.0)!=0.0;
bool l9_165;
if (l9_164)
{
l9_165=(l9_163.x*1.0)!=0.0;
}
else
{
l9_165=l9_164;
...
float param_182;
vec2 param_183;
Node2_Pixel_Shader_Particles(l9_162,float(TRAILBEHAVIOR),float(l9_165),param_97,param_99,vec4(trailFadeStartEnd.x,trailFadeStartEnd.y,param_104.x,param_104.y),trailLength,colorStart,colorEnd,param_106,colorMinStart,colorMinEnd,colorMaxStart,colorMaxEnd,param_108,alphaStart,alphaEnd,param_110,alphaMinStart,alphaMinEnd,alphaMaxStart,alphaMaxEnd,param_112,alphaDissolveMult,param_114,param_116,param_118,param_120,numValidFrames,gridSize,flipBookSpeedMult,flipBookRandomStart,param_122,param_124,param_126,colorRampTextureSize.xy,colorRampMult,param_128,param_130,param_132,externalSeed,vec4(Interpolator0.x,Interpolator0.y,Interpolator0.z,Interpolator0.w),vec4(Interpolator1.x,Interpolator1.y,Interpolator1.z,Interpolator1.w),param_177,param_178,param_179,param_180,param_181,param_182,param_183,Globals);
Default=param_180;
Result=Default;
}
#endif
