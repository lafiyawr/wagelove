...
#endif
l9_82=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_83,sc_EnvmapDiffuseLayout,l9_84).xy,-13.0);
}
#else
{
...
vec2 l9_115=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_20,reflect(-Globals.ViewDirWS,l9_20),l9_18),sc_EnvmapRotation.y);
vec4 l9_116;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
#endif
l9_113=vec3(0.0)+((((l9_116.xyz*(1.0/l9_116.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_26,abs(dot(l9_20,Globals.ViewDirWS))));
}
#else
{
l9_113=vec3(0.0);
...
vec3 l9_124=reflect(-Globals.ViewDirWS,l9_20);
float l9_125=dot(l9_20,Globals.ViewDirWS);
...
vec3 l9_139=l9_119*Port_SpecularAO_N014;
...
{
vec4 l9_147=l9_145;
l9_147.x=l9_144+((l9_22.x*Port_SpecularAO_N014.x)*9.9999997e-06);
l9_146=l9_147;
}
#else
{
...
float l9_152=param_95;
vec4 l9_153=Globals.VertexColor;
bool l9_154=(l9_152*1.0)!=0.0;
bool l9_155;
if (l9_154)
{
l9_155=(l9_153.x*1.0)!=0.0;
}
else
{
l9_155=l9_154;
