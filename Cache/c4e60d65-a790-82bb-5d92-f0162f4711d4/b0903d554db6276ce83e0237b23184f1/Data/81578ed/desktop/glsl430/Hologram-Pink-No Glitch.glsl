...
vec4 l9_3=(Port_Input0_N022+Port_Input1_N022)+(vec4(1.0-clamp(dot(l9_0,l9_1),0.0,1.0))*rimTint);
vec4 l9_4=vec4(l9_3.x,l9_3.y,l9_3.z,vec4(0.0).w);
l9_4.w=Opacity;
...
#endif
sc_writeFragData0Internal(max(l9_5,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_7;
...
{
l9_9=clamp(Opacity*2.0,0.0,1.0);
}
#else
{
float l9_10;
...
{
l9_10=clamp(dot(l9_4.xyz,vec3(Opacity)),0.0,1.0);
}
#else
{
float l9_11;
...
{
l9_12=(1.0-dot(l9_4.xyz,vec3(0.33333001)))*Opacity;
}
#else
{
float l9_13;
...
{
l9_13=(1.0-clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0))*Opacity;
}
#else
{
float l9_14;
...
{
l9_14=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*Opacity;
}
#else
{
float l9_15;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_16=clamp(dot(l9_4.xyz,vec3(1.0)),0.0,1.0)*Opacity;
}
#else
{
float l9_17;
...
{
l9_17=dot(l9_4.xyz,vec3(0.33333001))*Opacity;
}
#else
{
float l9_18;
...
#endif
vec3 l9_31=mix(l9_29.xyz,definedBlend(l9_29.xyz,l9_4.xyz).xyz,vec3(Opacity));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_33=vec4(mix(vec3(1.0),l9_4.xyz,vec3(Opacity)),Opacity);
}
#else
{
vec4 l9_34;
