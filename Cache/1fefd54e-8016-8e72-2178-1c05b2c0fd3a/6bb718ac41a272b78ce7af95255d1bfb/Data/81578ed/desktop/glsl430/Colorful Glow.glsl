...
uniform vec2 Port_Scale_N000;
uniform float Port_Offset_N000;
uniform float Port_Import_N026;
uniform float Port_Import_N025;
uniform float Port_Value3_N003;
uniform float Port_Value_N013;
uniform int PreviewEnabled;
...
void Node0_Voronoi_Noise(vec2 Seed,vec2 Scale,float Offset,out float Noise,out float Cells,ssGlobals Globals)
{
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
vec3 l9_2=l9_0+vec3(sc_Time.x*Port_Multiplier_N006);
vec2 l9_3=l9_2.xy;
ssGlobals l9_4=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_0);
float param_3;
float param_4;
Node0_Voronoi_Noise(l9_3,Port_Scale_N000,Port_Offset_N000,param_3,param_4,l9_4);
float l9_5=clamp(Port_Import_N026,0.0,3.0);
float l9_6=clamp(Port_Import_N025,0.0,1.0);
vec3 l9_7=ssHSV_to_RGB(vec4(param_3*l9_5,l9_6,Port_Value3_N003,0.0).xyz);
...
float param_10;
float param_11;
Node0_Voronoi_Noise(l9_3,Port_Scale_N000,Port_Offset_N000,param_10,param_11,l9_4);
vec3 l9_9=ssHSV_to_RGB(vec4(param_10*l9_5,l9_6,Port_Value3_N003,0.0).xyz);
if (isProxyMode)
{
vec4 l9_10;
#if (sc_ProxyAlphaOne)
...
{
l9_15=clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_16;
...
{
l9_17=(1.0-dot(l9_8.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_18;
...
{
l9_18=(1.0-clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_19;
...
{
l9_19=clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_20;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_21=clamp(dot(l9_8.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_22;
...
{
l9_22=dot(l9_8.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_23;
...
#endif
l9_12=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_8.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_13);
}
#else
{
vec4 l9_25;
...
#endif
vec3 l9_36=definedBlend(l9_34.xyz,l9_8.xyz);
...
vec4 l9_44=max(vec4(l9_9,1.0)*vec4((Port_Value_N013+0.001)-0.001),vec4(0.0));
sc_writeFragData1(l9_44);
vec4 l9_45=outputMotionVectorsIfNeeded(varPos,max(l9_43,vec4(0.0))+(l9_44*1e-06));
