...
ivec2 l9_11=ivec2(l9_7%512,l9_7/512);
...
if (overrideTimeEnabled==1)
{
l9_16=overrideTimeElapsed[l9_8];
}
else
{
l9_16=sc_Time.x;
}
gParticle=ssParticle(gParticle.Position,gParticle.Velocity,gParticle.Color,gParticle.Size,gParticle.Age,gParticle.Life,gParticle.Mass,gParticle.Matrix,false,gParticle.Quaternion,gParticle.SpawnIndex,gParticle.SpawnIndexRemainder,gParticle.NextBurstTime,l9_15,fract(abs(((l9_14*0.97637898)+0.151235)+(floor(((((l9_16-l9_15)-0.0)+0.0)+16.0)/8.0)*4.32723))),(vec2(ivec2(l9_7%400,l9_7/400))+vec2(1.0))/vec2(399.0),float(((l9_7*((l9_7*1471343)+101146501))+1559861749)&2147483647)*4.6566129e-10,l9_7,l9_9,l9_10,(1600*(l9_8+1))-1,(l9_12+0.5)/1600.0,l9_14,l9_10/1599.0,l9_11,(l9_13+vec2(0.5))/vec2(512.0,4.0),l9_13/vec2(511.0,3.0),vec3(0.0),false,gParticle.CopyId,gParticle.SpawnAmount,gParticle.BurstAmount,gParticle.BurstPeriod);
float l9_17=gParticle.TimeShift;
ssGlobals l9_18=ssGlobals(sc_Time.x,l9_4,(sc_Time.x-(l9_17*l9_4))-0.0,vec3(0.0),normalize(sc_Camera.position-varPos),varPos,l9_5,l9_6,cross(l9_6,l9_5),varPackedTex.xy,overrideTimeElapsed[int(Interp_Particle_Index/1600.0)]);
vec4 l9_19;
if ((float(isIdle)*1.0)!=0.0)
{
vec2 l9_20;
Node159_Rotate_Coords(varPackedTex.xy,Port_Rotation_N159,Port_Center_N159,l9_20,l9_18);
vec4 l9_21;
Node45_Flipbook_Sample(Port_SpriteCount_N045,Port_MaxFrames_N045,l9_20,gParticle.Index1DPerCopyF,(((gParticle.Ratio1DPerCopy-Port_RangeMinA_N156)/((Port_RangeMaxA_N156-Port_RangeMinA_N156)+1e-06))*(Port_RangeMaxB_N156-Port_RangeMinB_N156))+Port_RangeMinB_N156,Port_SecondOffset_N045,l9_21,l9_18);
vec4 l9_22=l9_21;
vec2 l9_23=(varPackedTex.xy*Port_Input1_N031)-vec2(1.0);
float l9_24=1.0-(clamp(dot(l9_23,l9_23)+0.001,Port_Input1_N246+0.001,Port_Input2_N246+0.001)-0.001);
float l9_25;
if (l9_24<=0.0)
{
l9_25=0.0;
...
vec3 l9_26=vec3(l9_23.x,l9_23.y,vec3(0.0).z);
l9_26.z=l9_25;
vec4 l9_27;
Node26_PBR_Lighting(l9_22.xyz,l9_22.w*gParticle.Color.w,mix(Port_Input0_N038,l9_26,vec3(float(distance(varPackedTex.xy,Port_Input1_N035)<Port_Input1_N036))),Port_Emissive_N026,Port_Metallic_N026,Port_Roughness_N026,Port_AO_N026,Port_SpecularAO_N026,l9_27,l9_18);
l9_19=l9_27;
}
else
{
vec4 l9_28;
Node11_Conditional(1.0,vec4(1.0),vec4(0.5,0.0,0.0,0.0),l9_28,l9_18);
l9_19=l9_28;
}
vec4 l9_29;
...
{
vec3 l9_31=sc_GetFramebufferColor().xyz;
vec3 l9_32=mix(l9_31,definedBlend(l9_31,l9_19.xyz).xyz,vec3(l9_19.w));
...
{
l9_34=vec4(mix(vec3(1.0),l9_19.xyz,vec3(l9_19.w)),l9_19.w);
}
#else
{
vec4 l9_35;
...
#endif
l9_35=vec4(l9_19.xyz*l9_36,l9_36);
}
#else
{
l9_35=l9_19;
