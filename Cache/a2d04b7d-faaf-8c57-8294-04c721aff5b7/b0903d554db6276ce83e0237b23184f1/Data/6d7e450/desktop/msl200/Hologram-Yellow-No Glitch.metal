...
//float4 rimTint 4272
//float Opacity 4288
//float4 Port_Input0_N022 4304
//float4 Port_Input1_N022 4320
//float depthRef 4336
//}
...
float4 param_1=(*sc_set0.UserUniforms).rimTint;
Output_N25=param_1;
...
float Output_N8=0.0;
float param_2=(*sc_set0.UserUniforms).Opacity;
Output_N8=param_2;
...
float4 l9_10=fast::max(param_4,float4(0.0));
float4 param_5=l9_10;
if (sc_ShaderCacheConstant_tmp!=0)
{
