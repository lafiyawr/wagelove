...
float l9_23=l9_22;
vec3 l9_24=sc_SamplingCoordsViewToGlobal(vec2(l9_19,l9_21),maskTexLayout,l9_2);
vec4 l9_25=texture2D(maskTex,l9_24.xy,0.0);
vec4 l9_26;
#if (SC_USE_CLAMP_TO_BORDER_maskTex)
{
...
#endif
float l9_27=l9_0.w*l9_1;
vec4 l9_28=vec4(l9_0.x,l9_0.y,l9_0.z,vec4(0.0).w);
l9_28.w=l9_27;
