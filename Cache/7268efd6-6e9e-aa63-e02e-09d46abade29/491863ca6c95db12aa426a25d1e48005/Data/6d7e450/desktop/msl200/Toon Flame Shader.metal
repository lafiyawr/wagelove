...
//sampler sampler Tweak_N9SmpSC 0:26
...
//texture texture2D Tweak_N9 0:4:0:26
...
//float4 Tweak_N14 4560
//float Tweak_N16 4576
//float3x3 Tweak_N9Transform 4640
//float4 Tweak_N9UvMinMax 4688
//float4 Tweak_N9BorderColor 4704
//float4 Tweak_N24 4720
//float Tweak_N17 4736
//float2 Port_Direction_N002 4744
//float Port_Speed_N002 4752
//float2 Port_Scale_N003 4760
//float Port_Offset_N003 4768
//float2 Port_Direction_N006 4776
//float Port_Speed_N006 4784
//float2 Port_Scale_N007 4792
//float Port_Offset_N007 4800
//float3 Port_Red_N011 4816
//float3 Port_Green_N011 4832
//float3 Port_Blue_N011 4848
//float3 Port_AO_N000 4880
//float depthRef 4896
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_Tweak_N9 31 0
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 32 0
//spec_const bool SC_USE_UV_MIN_MAX_Tweak_N9 33 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34 0
//spec_const bool SC_USE_UV_TRANSFORM_Tweak_N9 35 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36 0
//spec_const bool Tweak_N9HasSwappedViews 37 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N9 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N9 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 83 -1
//spec_const int Tweak_N9Layout 84 0
...
//spec_const int sc_MaxTextureImageUnits 100 0
//spec_const int sc_PointLightsCount 101 0
//spec_const int sc_RayTracedAoTextureLayout 102 0
//spec_const int sc_RayTracedDiffIndTextureLayout 103 0
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N9 [[function_constant(31)]];
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N9 [[function_constant(33)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N9 [[function_constant(35)]];
...
constant bool Tweak_N9HasSwappedViews [[function_constant(37)]];
...
constant bool sc_RayTracedShadowTextureHasSwappedViews [[function_constant(70)]];
...
constant bool sc_SSAOEnabled [[function_constant(72)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N9 [[function_constant(80)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N9 [[function_constant(82)]];
...
constant int Tweak_N9Layout [[function_constant(84)]];
...
float4 Tweak_N24;
float Tweak_N17;
float2 Port_Direction_N002;
float Port_Speed_N002;
float2 Port_Scale_N003;
float Port_Offset_N003;
float2 Port_Direction_N006;
float Port_Speed_N006;
float2 Port_Scale_N007;
float Port_Offset_N007;
float3 Port_Red_N011;
float3 Port_Green_N011;
float3 Port_Blue_N011;
...
float4 param=(*sc_set0.UserUniforms).Tweak_N14;
Output_N14=param;
...
CoordsOut_N2=UVCoord_N1+((*sc_set0.UserUniforms).Port_Direction_N002*(Globals.gTimeElapsed*(*sc_set0.UserUniforms).Port_Speed_N002));
float Noise_N3=0.0;
float2 param_2=CoordsOut_N2;
float2 param_3=(*sc_set0.UserUniforms).Port_Scale_N003;
float param_4=(*sc_set0.UserUniforms).Port_Offset_N003;
float param_5;
if (SC_DEVICE_CLASS_tmp>=2)
{
param_2.x=floor(param_2.x*10000.0)*9.9999997e-05;
param_2.y=floor(param_2.y*10000.0)*9.9999997e-05;
float2 l9_5=floor(param_2*param_3);
float2 l9_6=fract(param_2*param_3);
float3 l9_7=float3(8.0,0.0,0.0);
int l9_8=-1;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_8<=1)
...
if (l9_9<=1)
{
float2 l9_10=float2(float(l9_9),float(l9_8));
float2 l9_11=l9_10+l9_5;
float l9_12=abs(param_4)+1000.0;
float2 l9_13=VoronoiHash2D(l9_11,l9_12);
float2 l9_14=l9_13;
float l9_15=distance(l9_10+l9_14,l9_6);
if (l9_15<l9_7.x)
{
l9_7=float3(l9_15,l9_14.x,l9_14.y);
param_5=l9_7.x;
...
CoordsOut_N6=UVCoord_N5+((*sc_set0.UserUniforms).Port_Direction_N006*(Globals.gTimeElapsed*(*sc_set0.UserUniforms).Port_Speed_N006));
float Noise_N7=0.0;
float2 param_6=CoordsOut_N6;
float2 param_7=(*sc_set0.UserUniforms).Port_Scale_N007;
float param_8=(*sc_set0.UserUniforms).Port_Offset_N007;
float param_9;
if (SC_DEVICE_CLASS_tmp>=2)
{
param_6.x=floor(param_6.x*10000.0)*9.9999997e-05;
param_6.y=floor(param_6.y*10000.0)*9.9999997e-05;
float2 l9_16=floor(param_6*param_7);
float2 l9_17=fract(param_6*param_7);
float3 l9_18=float3(8.0,0.0,0.0);
int l9_19=-1;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_19<=1)
...
if (l9_20<=1)
{
float2 l9_21=float2(float(l9_20),float(l9_19));
float2 l9_22=l9_21+l9_16;
float l9_23=abs(param_8)+1000.0;
float2 l9_24=VoronoiHash2D(l9_22,l9_23);
float2 l9_25=l9_24;
float l9_26=distance(l9_21+l9_25,l9_17);
if (l9_26<l9_18.x)
{
l9_18=float3(l9_26,l9_25.x,l9_25.y);
param_9=l9_18.x;
...
int l9_32=l9_27;
int param_10=Tweak_N9Layout_tmp;
int param_11=l9_32;
float2 param_12=Globals.Surface_UVCoord0;
bool param_13=(int(SC_USE_UV_TRANSFORM_Tweak_N9_tmp)!=0);
float3x3 param_14=(*sc_set0.UserUniforms).Tweak_N9Transform;
int2 param_15=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9_tmp);
bool param_16=(int(SC_USE_UV_MIN_MAX_Tweak_N9_tmp)!=0);
float4 param_17=(*sc_set0.UserUniforms).Tweak_N9UvMinMax;
bool param_18=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N9_tmp)!=0);
float4 param_19=(*sc_set0.UserUniforms).Tweak_N9BorderColor;
float param_20=0.0;
bool l9_33=param_18&&(!param_16);
float l9_34=1.0;
float l9_35=param_12.x;
int l9_36=param_15.x;
if (l9_36==1)
{
l9_35=fract(l9_35);
}
...
param_12.x=l9_35;
float l9_40=param_12.y;
int l9_41=param_15.y;
if (l9_41==1)
{
l9_40=fract(l9_40);
}
...
float l9_47=param_12.x;
float l9_48=param_17.x;
float l9_49=param_17.z;
bool l9_50=l9_46;
float l9_51=l9_34;
...
float l9_56=param_12.y;
float l9_57=param_17.y;
float l9_58=param_17.w;
bool l9_59=l9_55;
float l9_60=l9_34;
...
float2 l9_63=param_12;
bool l9_64=param_13;
float3x3 l9_65=param_14;
if (l9_64)
{
...
float2 l9_68=l9_67;
param_12=l9_68;
float l9_69=param_12.x;
int l9_70=param_15.x;
bool l9_71=l9_33;
float l9_72=l9_34;
if ((l9_70==0)||(l9_70==3))
{
...
param_12.x=l9_69;
l9_34=l9_72;
float l9_80=param_12.y;
int l9_81=param_15.y;
bool l9_82=l9_33;
float l9_83=l9_34;
if ((l9_81==0)||(l9_81==3))
{
...
param_12.y=l9_80;
l9_34=l9_83;
float2 l9_91=param_12;
int l9_92=param_10;
int l9_93=param_11;
float l9_94=param_20;
float2 l9_95=l9_91;
int l9_96=l9_92;
int l9_97=l9_93;
...
float l9_102=l9_94;
float4 l9_103=sc_set0.Tweak_N9.sample(sc_set0.Tweak_N9SmpSC,l9_101,bias(l9_102));
float4 l9_104=l9_103;
float4 l9_105=l9_104;
if (param_18)
{
l9_105=mix(param_19,l9_105,float4(l9_34));
}
float4 l9_106=l9_105;
Output_N9=l9_106;
float4 Output_N10=float4(0.0);
Output_N10=float4(Output_N8)+Output_N9;
float4 Output_N12=float4(0.0);
Output_N12=Output_N10*Output_N9;
float4 Output_N11=float4(0.0);
float4 param_21=Output_N12;
float3 param_22=(*sc_set0.UserUniforms).Port_Red_N011;
float3 param_23=(*sc_set0.UserUniforms).Port_Green_N011;
float3 param_24=(*sc_set0.UserUniforms).Port_Blue_N011;
float3 l9_107=((param_22*param_21.x)+(param_23*param_21.y))+(param_24*param_21.z);
float4 param_25;
param_25=float4(l9_107.x,l9_107.y,l9_107.z,param_25.w);
param_25.w=param_21.w;
Output_N11=param_25;
float4 Output_N13=float4(0.0);
Output_N13=step(float4(Output_N16),Output_N11);
float4 Output_N19=float4(0.0);
Output_N19=float4(1.0)-Output_N13;
float4 Output_N20=float4(0.0);
Output_N20=Output_N14*Output_N19;
float4 Output_N24=float4(0.0);
float4 param_26=(*sc_set0.UserUniforms).Tweak_N24;
Output_N24=param_26;
float Output_N17=0.0;
float param_27=(*sc_set0.UserUniforms).Tweak_N17;
Output_N17=param_27;
float4 Output_N18=float4(0.0);
Output_N18=step(float4(Output_N17),Output_N11);
float4 Output_N21=float4(0.0);
Output_N21=Output_N24*Output_N18;
float4 Output_N22=float4(0.0);
Output_N22=Output_N20+Output_N21;
float4 Output_N0=float4(0.0);
float3 param_28=Output_N22.xyz;
float param_29=Output_N12.x;
float3 param_30=Output_N22.xyz;
float3 param_31=(*sc_set0.UserUniforms).Port_AO_N000;
ssGlobals param_33=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_33.BumpedNormal=param_33.VertexNormal_WorldSpace;
}
param_29=fast::clamp(param_29,0.0,1.0);
float l9_108=param_29;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_108<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float2 l9_110=floor(mod(l9_109.xy,float2(4.0)));
float l9_111=(mod(dot(l9_110,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_108<l9_111)
{
discard_fragment();
}
...
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_32=float4(param_28,param_29);
}
else
{
...
float4 l9_126=fast::max(param_34,float4(0.0));
float4 param_35=l9_126;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
float4 l9_135=param_36;
float4 l9_136=float4(0.0);
float4 l9_137=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_138=out.FragColor0;
float4 l9_139=l9_138;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_139.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_142=l9_141.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_147=l9_146;
int l9_148=l9_147;
float3 l9_149=float3(l9_143,0.0);
int l9_150=l9_145;
int l9_151=l9_148;
if (l9_150==1)
{
l9_149.y=((2.0*l9_149.y)+float(l9_151))-1.0;
}
float2 l9_152=l9_149.xy;
l9_144=l9_152;
}
else
{
...
int l9_169=sc_ScreenTextureLayout_tmp;
int l9_170=l9_165;
float l9_171=l9_166;
...
float l9_179=l9_171;
float4 l9_180=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_178,bias(l9_179));
float4 l9_181=l9_180;
l9_167=l9_181;
float4 l9_182=l9_167;
float4 l9_183=l9_182;
float4 l9_184=l9_183;
l9_137=l9_184;
}
float4 l9_185=l9_137;
float4 l9_186=l9_185;
float3 l9_187=l9_186.xyz;
float3 l9_188=l9_187;
float3 l9_189=l9_135.xyz;
...
l9_136=float4(l9_190.x,l9_190.y,l9_190.z,l9_136.w);
float3 l9_191=mix(l9_187,l9_136.xyz,float3(l9_135.w));
l9_136=float4(l9_191.x,l9_191.y,l9_191.z,l9_136.w);
l9_136.w=1.0;
float4 l9_192=l9_136;
param_36=l9_192;
}
else
{
float4 l9_193=param_36;
float4 l9_194=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_194=float4(mix(float3(1.0),l9_193.xyz,float3(l9_193.w)),l9_193.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_195=l9_193.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_195=fast::clamp(l9_195,0.0,1.0);
}
l9_194=float4(l9_193.xyz*l9_195,l9_195);
}
else
{
l9_194=l9_193;
...
float4 l9_196=l9_194;
param_36=l9_196;
}
}
}
float4 l9_197=param_36;
FinalColor=l9_197;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_198=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_198=float4(0.0);
...
float4 l9_200=param_39;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_200.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_200;
return out;
}
} // FRAGMENT SHADER
...
CoordsOut_N2=UVCoord_N1+((*sc_set0.UserUniforms).Port_Direction_N002*(Globals.gTimeElapsed*(*sc_set0.UserUniforms).Port_Speed_N002));
float Noise_N3=0.0;
float2 param=CoordsOut_N2;
float2 param_1=(*sc_set0.UserUniforms).Port_Scale_N003;
float param_2=(*sc_set0.UserUniforms).Port_Offset_N003;
float param_3;
if (SC_DEVICE_CLASS_tmp>=2)
{
param.x=floor(param.x*10000.0)*9.9999997e-05;
param.y=floor(param.y*10000.0)*9.9999997e-05;
float2 l9_0=floor(param*param_1);
float2 l9_1=fract(param*param_1);
float3 l9_2=float3(8.0,0.0,0.0);
int l9_3=-1;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_3<=1)
...
if (l9_4<=1)
{
float2 l9_5=float2(float(l9_4),float(l9_3));
float2 l9_6=l9_5+l9_0;
float l9_7=abs(param_2)+1000.0;
float2 l9_8=VoronoiHash2D(l9_6,l9_7);
float2 l9_9=l9_8;
float l9_10=distance(l9_5+l9_9,l9_1);
if (l9_10<l9_2.x)
{
l9_2=float3(l9_10,l9_9.x,l9_9.y);
param_3=l9_2.x;
...
float2 param_5=(*sc_set0.UserUniforms).Port_Scale_N007;
float param_6=(*sc_set0.UserUniforms).Port_Offset_N007;
float param_7;
if (SC_DEVICE_CLASS_tmp>=2)
{
param_4.x=floor(param_4.x*10000.0)*9.9999997e-05;
param_4.y=floor(param_4.y*10000.0)*9.9999997e-05;
float2 l9_11=floor(param_4*param_5);
float2 l9_12=fract(param_4*param_5);
float3 l9_13=float3(8.0,0.0,0.0);
int l9_14=-1;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_14<=1)
...
if (l9_15<=1)
{
float2 l9_16=float2(float(l9_15),float(l9_14));
float2 l9_17=l9_16+l9_11;
float l9_18=abs(param_6)+1000.0;
float2 l9_19=VoronoiHash2D(l9_17,l9_18);
float2 l9_20=l9_19;
float l9_21=distance(l9_16+l9_20,l9_12);
if (l9_21<l9_13.x)
{
l9_13=float3(l9_21,l9_20.x,l9_20.y);
param_7=l9_13.x;
...
int l9_27=l9_22;
int param_8=Tweak_N9Layout_tmp;
int param_9=l9_27;
float2 param_10=Globals.Surface_UVCoord0;
bool param_11=(int(SC_USE_UV_TRANSFORM_Tweak_N9_tmp)!=0);
float3x3 param_12=(*sc_set0.UserUniforms).Tweak_N9Transform;
int2 param_13=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9_tmp);
bool param_14=(int(SC_USE_UV_MIN_MAX_Tweak_N9_tmp)!=0);
float4 param_15=(*sc_set0.UserUniforms).Tweak_N9UvMinMax;
bool param_16=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N9_tmp)!=0);
float4 param_17=(*sc_set0.UserUniforms).Tweak_N9BorderColor;
float param_18=0.0;
bool l9_28=param_16&&(!param_14);
float l9_29=1.0;
float l9_30=param_10.x;
int l9_31=param_13.x;
if (l9_31==1)
{
l9_30=fract(l9_30);
}
...
param_10.x=l9_30;
float l9_35=param_10.y;
int l9_36=param_13.y;
if (l9_36==1)
{
l9_35=fract(l9_35);
}
...
float l9_43=param_15.x;
float l9_44=param_15.z;
bool l9_45=l9_41;
float l9_46=l9_29;
...
float l9_52=param_15.y;
float l9_53=param_15.w;
bool l9_54=l9_50;
float l9_55=l9_29;
...
float2 l9_58=param_10;
bool l9_59=param_11;
float3x3 l9_60=param_12;
if (l9_59)
{
...
float2 l9_63=l9_62;
param_10=l9_63;
float l9_64=param_10.x;
int l9_65=param_13.x;
bool l9_66=l9_28;
float l9_67=l9_29;
if ((l9_65==0)||(l9_65==3))
{
...
param_10.x=l9_64;
l9_29=l9_67;
float l9_75=param_10.y;
int l9_76=param_13.y;
bool l9_77=l9_28;
float l9_78=l9_29;
if ((l9_76==0)||(l9_76==3))
{
...
param_10.y=l9_75;
l9_29=l9_78;
float2 l9_86=param_10;
int l9_87=param_8;
int l9_88=param_9;
float l9_89=param_18;
float2 l9_90=l9_86;
int l9_91=l9_87;
int l9_92=l9_88;
...
float l9_97=l9_89;
float4 l9_98=sc_set0.Tweak_N9.sample(sc_set0.Tweak_N9SmpSC,l9_96,bias(l9_97));
float4 l9_99=l9_98;
float4 l9_100=l9_99;
if (param_16)
{
l9_100=mix(param_17,l9_100,float4(l9_29));
}
...
float4 Output_N12=float4(0.0);
Output_N12=Output_N10*Output_N9;
float param_19=Output_N12.x;
param_19=fast::clamp(param_19,0.0,1.0);
float l9_102=param_19;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
