...
//sampler sampler Tweak_N9SmpSC 0:25
...
//texture texture2D Tweak_N9 0:3:0:25
...
//texture texture2DArray Tweak_N9ArrSC 0:40:0:25
...
//spec_const bool sc_RayTracedShadowTextureHasSwappedViews 81 0
...
//spec_const bool sc_ShaderComplexityAnalyzer 85 0
//spec_const bool sc_TAAEnabled 86 0
//spec_const bool sc_UseFramebufferFetchMarker 87 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N9 91 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 92 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N9 93 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 94 -1
//spec_const int Tweak_N9Layout 95 0
...
//spec_const int sc_RayTracedShadowTextureLayout 115 0
...
//spec_const int sc_StereoViewID 122 0
//SG_REFLECTION_END
...
uniform sampler2DArray Tweak_N9ArrSC;
...
#endif
vec2 l9_0=varPackedTex.xy+(Port_Direction_N002*(sc_Time.x*Port_Speed_N002));
float l9_1;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
vec2 l9_2=vec2(floor(l9_0.x*10000.0)*9.9999997e-05,floor(l9_0.y*10000.0)*9.9999997e-05)*Port_Scale_N003;
float l9_3;
vec3 l9_4;
l9_3=0.0;
...
float l9_12=float(l9_7);
vec2 l9_13=vec2(l9_11,l9_12);
vec2 l9_14=VoronoiHash2D(l9_13+floor(l9_2),abs(Port_Offset_N003)+1000.0);
float l9_15=distance(l9_13+l9_14,fract(l9_2));
if (l9_15<l9_5.x)
{
l9_9=vec3(l9_15,0.0,0.0);
l9_8=floor(l9_15*10000.0)*9.9999997e-05;
}
else
{
l9_9=l9_5;
...
#endif
vec2 l9_16=varPackedTex.xy+(Port_Direction_N006*(sc_Time.x*Port_Speed_N006));
float l9_17;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
vec2 l9_18=vec2(floor(l9_16.x*10000.0)*9.9999997e-05,floor(l9_16.y*10000.0)*9.9999997e-05)*Port_Scale_N007;
float l9_19;
vec3 l9_20;
l9_19=0.0;
l9_20=vec3(8.0,0.0,0.0);
vec3 l9_21;
float l9_22;
int l9_23=-1;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
...
if (l9_26<=1)
{
float l9_27=float(l9_26);
float l9_28=float(l9_23);
vec2 l9_29=vec2(l9_27,l9_28);
vec2 l9_30=VoronoiHash2D(l9_29+floor(l9_18),abs(Port_Offset_N007)+1000.0);
float l9_31=distance(l9_29+l9_30,fract(l9_18));
if (l9_31<l9_21.x)
{
l9_25=vec3(l9_31,0.0,0.0);
l9_24=floor(l9_31*10000.0)*9.9999997e-05;
}
else
{
l9_25=l9_21;
...
#endif
float l9_32=l9_1*l9_17;
vec4 l9_33;
#if (Tweak_N9Layout==2)
{
bool l9_34=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N9)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N9)!=0));
float l9_35=varPackedTex.x;
sc_SoftwareWrapEarly(l9_35,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).x);
float l9_36=l9_35;
float l9_37=varPackedTex.y;
sc_SoftwareWrapEarly(l9_37,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).y);
float l9_38=l9_37;
vec2 l9_39;
float l9_40;
...
{
l9_41=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).x==3;
}
#else
{
l9_41=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N9)!=0);
}
#endif
float l9_42=l9_36;
float l9_43=1.0;
sc_ClampUV(l9_42,Tweak_N9UvMinMax.x,Tweak_N9UvMinMax.z,l9_41,l9_43);
float l9_44=l9_42;
float l9_45=l9_43;
bool l9_46;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N9)
{
l9_46=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).y==3;
}
#else
{
l9_46=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N9)!=0);
}
#endif
float l9_47=l9_38;
float l9_48=l9_45;
sc_ClampUV(l9_47,Tweak_N9UvMinMax.y,Tweak_N9UvMinMax.w,l9_46,l9_48);
l9_40=l9_48;
...
#endif
vec2 l9_49=sc_TransformUV(l9_39,(int(SC_USE_UV_TRANSFORM_Tweak_N9)!=0),Tweak_N9Transform);
float l9_50=l9_49.x;
float l9_51=l9_40;
sc_SoftwareWrapLate(l9_50,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).x,l9_34,l9_51);
float l9_52=l9_49.y;
float l9_53=l9_51;
sc_SoftwareWrapLate(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).y,l9_34,l9_53);
float l9_54=l9_53;
vec3 l9_55=sc_SamplingCoordsViewToGlobal(vec2(l9_50,l9_52),Tweak_N9Layout,Tweak_N9GetStereoViewIndex());
vec4 l9_56=texture(Tweak_N9ArrSC,l9_55,0.0);
vec4 l9_57;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N9)
{
l9_57=mix(Tweak_N9BorderColor,l9_56,vec4(l9_54));
}
#else
{
l9_57=l9_56;
...
#else
{
bool l9_58=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N9)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N9)!=0));
float l9_59=varPackedTex.x;
sc_SoftwareWrapEarly(l9_59,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).x);
float l9_60=l9_59;
float l9_61=varPackedTex.y;
sc_SoftwareWrapEarly(l9_61,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).y);
float l9_62=l9_61;
vec2 l9_63;
float l9_64;
#if (SC_USE_UV_MIN_MAX_Tweak_N9)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N9)
{
l9_65=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).x==3;
}
#else
{
l9_65=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N9)!=0);
}
#endif
float l9_66=l9_60;
float l9_67=1.0;
sc_ClampUV(l9_66,Tweak_N9UvMinMax.x,Tweak_N9UvMinMax.z,l9_65,l9_67);
float l9_68=l9_66;
float l9_69=l9_67;
bool l9_70;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N9)
{
l9_70=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).y==3;
}
#else
{
l9_70=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N9)!=0);
}
#endif
float l9_71=l9_62;
float l9_72=l9_69;
sc_ClampUV(l9_71,Tweak_N9UvMinMax.y,Tweak_N9UvMinMax.w,l9_70,l9_72);
l9_64=l9_72;
...
#endif
vec2 l9_73=sc_TransformUV(l9_63,(int(SC_USE_UV_TRANSFORM_Tweak_N9)!=0),Tweak_N9Transform);
float l9_74=l9_73.x;
float l9_75=l9_64;
sc_SoftwareWrapLate(l9_74,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).x,l9_58,l9_75);
float l9_76=l9_73.y;
float l9_77=l9_75;
sc_SoftwareWrapLate(l9_76,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).y,l9_58,l9_77);
float l9_78=l9_77;
vec3 l9_79=sc_SamplingCoordsViewToGlobal(vec2(l9_74,l9_76),Tweak_N9Layout,Tweak_N9GetStereoViewIndex());
vec4 l9_80=texture(Tweak_N9,l9_79.xy,0.0);
vec4 l9_81;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N9)
{
l9_81=mix(Tweak_N9BorderColor,l9_80,vec4(l9_78));
}
#else
{
l9_81=l9_80;
...
#endif
vec4 l9_82=vec4(l9_32)+l9_33;
vec4 l9_83=l9_82*l9_33;
float l9_84=clamp(l9_83.x,0.0,1.0);
...
vec2 l9_5=l9_0+(Port_Direction_N002*(sc_Time.x*Port_Speed_N002));
float l9_6;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
vec2 l9_7=vec2(floor(l9_5.x*10000.0)*9.9999997e-05,floor(l9_5.y*10000.0)*9.9999997e-05)*Port_Scale_N003;
float l9_8;
vec3 l9_9;
l9_8=0.0;
l9_9=vec3(8.0,0.0,0.0);
vec3 l9_10;
float l9_11;
int l9_12=-1;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
...
if (l9_15<=1)
{
float l9_16=float(l9_15);
float l9_17=float(l9_12);
vec2 l9_18=vec2(l9_16,l9_17);
vec2 l9_19=VoronoiHash2D(l9_18+floor(l9_7),abs(Port_Offset_N003)+1000.0);
float l9_20=distance(l9_18+l9_19,fract(l9_7));
if (l9_20<l9_10.x)
{
l9_14=vec3(l9_20,0.0,0.0);
l9_13=floor(l9_20*10000.0)*9.9999997e-05;
}
else
{
l9_14=l9_10;
...
#endif
vec2 l9_21=l9_0+(Port_Direction_N006*(sc_Time.x*Port_Speed_N006));
float l9_22;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
vec2 l9_23=vec2(floor(l9_21.x*10000.0)*9.9999997e-05,floor(l9_21.y*10000.0)*9.9999997e-05)*Port_Scale_N007;
float l9_24;
vec3 l9_25;
l9_24=0.0;
l9_25=vec3(8.0,0.0,0.0);
vec3 l9_26;
float l9_27;
int l9_28=-1;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
...
float l9_33=float(l9_28);
vec2 l9_34=vec2(l9_32,l9_33);
vec2 l9_35=VoronoiHash2D(l9_34+floor(l9_23),abs(Port_Offset_N007)+1000.0);
float l9_36=distance(l9_34+l9_35,fract(l9_23));
if (l9_36<l9_26.x)
{
l9_30=vec3(l9_36,0.0,0.0);
l9_29=floor(l9_36*10000.0)*9.9999997e-05;
}
else
{
l9_30=l9_26;
...
#endif
float l9_37=l9_6*l9_22;
vec4 l9_38;
#if (Tweak_N9Layout==2)
{
bool l9_39=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N9)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N9)!=0));
float l9_40=l9_0.x;
sc_SoftwareWrapEarly(l9_40,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).x);
float l9_41=l9_40;
float l9_42=l9_0.y;
sc_SoftwareWrapEarly(l9_42,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).y);
float l9_43=l9_42;
vec2 l9_44;
float l9_45;
#if (SC_USE_UV_MIN_MAX_Tweak_N9)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N9)
{
l9_46=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).x==3;
}
#else
{
l9_46=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N9)!=0);
...
float l9_47=l9_41;
float l9_48=1.0;
sc_ClampUV(l9_47,Tweak_N9UvMinMax.x,Tweak_N9UvMinMax.z,l9_46,l9_48);
float l9_49=l9_47;
float l9_50=l9_48;
bool l9_51;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N9)
{
l9_51=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).y==3;
}
#else
{
l9_51=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N9)!=0);
}
#endif
float l9_52=l9_43;
float l9_53=l9_50;
sc_ClampUV(l9_52,Tweak_N9UvMinMax.y,Tweak_N9UvMinMax.w,l9_51,l9_53);
l9_45=l9_53;
...
#endif
vec2 l9_54=sc_TransformUV(l9_44,(int(SC_USE_UV_TRANSFORM_Tweak_N9)!=0),Tweak_N9Transform);
float l9_55=l9_54.x;
float l9_56=l9_45;
sc_SoftwareWrapLate(l9_55,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).x,l9_39,l9_56);
float l9_57=l9_54.y;
float l9_58=l9_56;
sc_SoftwareWrapLate(l9_57,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).y,l9_39,l9_58);
float l9_59=l9_58;
vec3 l9_60=sc_SamplingCoordsViewToGlobal(vec2(l9_55,l9_57),Tweak_N9Layout,Tweak_N9GetStereoViewIndex());
vec4 l9_61=texture(Tweak_N9ArrSC,l9_60,0.0);
vec4 l9_62;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N9)
{
l9_62=mix(Tweak_N9BorderColor,l9_61,vec4(l9_59));
}
#else
{
l9_62=l9_61;
...
#else
{
bool l9_63=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N9)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N9)!=0));
float l9_64=l9_0.x;
sc_SoftwareWrapEarly(l9_64,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).x);
float l9_65=l9_64;
float l9_66=l9_0.y;
sc_SoftwareWrapEarly(l9_66,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).y);
float l9_67=l9_66;
vec2 l9_68;
float l9_69;
#if (SC_USE_UV_MIN_MAX_Tweak_N9)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N9)
{
l9_70=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).x==3;
}
#else
{
l9_70=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N9)!=0);
...
float l9_71=l9_65;
float l9_72=1.0;
sc_ClampUV(l9_71,Tweak_N9UvMinMax.x,Tweak_N9UvMinMax.z,l9_70,l9_72);
float l9_73=l9_71;
float l9_74=l9_72;
bool l9_75;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N9)
{
l9_75=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).y==3;
}
#else
{
l9_75=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N9)!=0);
}
#endif
float l9_76=l9_67;
float l9_77=l9_74;
sc_ClampUV(l9_76,Tweak_N9UvMinMax.y,Tweak_N9UvMinMax.w,l9_75,l9_77);
l9_69=l9_77;
...
#endif
vec2 l9_78=sc_TransformUV(l9_68,(int(SC_USE_UV_TRANSFORM_Tweak_N9)!=0),Tweak_N9Transform);
float l9_79=l9_78.x;
float l9_80=l9_69;
sc_SoftwareWrapLate(l9_79,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).x,l9_63,l9_80);
float l9_81=l9_78.y;
float l9_82=l9_80;
sc_SoftwareWrapLate(l9_81,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N9,SC_SOFTWARE_WRAP_MODE_V_Tweak_N9).y,l9_63,l9_82);
float l9_83=l9_82;
vec3 l9_84=sc_SamplingCoordsViewToGlobal(vec2(l9_79,l9_81),Tweak_N9Layout,Tweak_N9GetStereoViewIndex());
vec4 l9_85=texture(Tweak_N9,l9_84.xy,0.0);
vec4 l9_86;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N9)
{
l9_86=mix(Tweak_N9BorderColor,l9_85,vec4(l9_83));
}
#else
{
l9_86=l9_85;
...
#endif
vec4 l9_87=vec4(l9_37)+l9_38;
vec4 l9_88=l9_87*l9_38;
float l9_89=l9_88.x;
vec3 l9_90=((Port_Red_N011*l9_89)+(Port_Green_N011*l9_88.y))+(Port_Blue_N011*l9_88.z);
...
#endif
vec3 l9_94=max(((Tweak_N14*(vec4(1.0)-step(vec4(Tweak_N16),l9_91)))+(Tweak_N24*step(vec4(Tweak_N17),l9_91))).xyz,vec3(0.0));
vec4 l9_95;
#if (sc_ProjectiveShadowsCaster)
{
l9_95=vec4(l9_94,l9_93);
}
#else
{
l9_95=ngsCalculateLighting(l9_94,l9_93,l9_92,l9_2,l9_3,l9_94,0.0,1.0,Port_AO_N000,vec3(1.0));
}
#endif
vec4 l9_96=max(l9_95,vec4(0.0));
if (isProxyMode)
{
vec4 l9_97;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0Internal(max(l9_97,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_99;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_101=clamp(l9_96.w*2.0,0.0,1.0);
}
#else
{
float l9_102;
...
{
l9_102=clamp(dot(l9_96.xyz,vec3(l9_96.w)),0.0,1.0);
}
#else
{
float l9_103;
...
#if (sc_BlendMode_Multiply)
{
l9_104=(1.0-dot(l9_96.xyz,vec3(0.33333001)))*l9_96.w;
}
#else
{
float l9_105;
...
{
l9_105=(1.0-clamp(dot(l9_96.xyz,vec3(1.0)),0.0,1.0))*l9_96.w;
}
#else
{
float l9_106;
#if (sc_BlendMode_ColoredGlass)
{
l9_106=clamp(dot(l9_96.xyz,vec3(1.0)),0.0,1.0)*l9_96.w;
}
#else
{
float l9_107;
#if (sc_BlendMode_Add)
{
l9_107=clamp(dot(l9_96.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_108;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_108=clamp(dot(l9_96.xyz,vec3(1.0)),0.0,1.0)*l9_96.w;
}
#else
{
float l9_109;
...
{
l9_109=dot(l9_96.xyz,vec3(0.33333001))*l9_96.w;
}
#else
{
float l9_110;
#if (sc_BlendMode_Min)
{
l9_110=1.0-clamp(dot(l9_96.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_111;
#if (sc_BlendMode_Max)
{
l9_111=clamp(dot(l9_96.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_111=1.0;
...
#endif
l9_99=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_96.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_100);
}
#else
{
vec4 l9_112;
...
{
vec3 l9_114=sc_GetFramebufferColor().xyz;
vec3 l9_115=mix(l9_114,definedBlend(l9_114,l9_96.xyz).xyz,vec3(l9_96.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_118=l9_96.w;
l9_117=vec4(mix(vec3(1.0),l9_96.xyz,vec3(l9_118)),l9_118);
}
#else
{
vec4 l9_119;
...
{
float l9_120=l9_96.w;
float l9_121;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_121=clamp(l9_120,0.0,1.0);
}
#else
{
l9_121=l9_120;
...
#endif
l9_119=vec4(l9_96.xyz*l9_121,l9_121);
}
#else
{
l9_119=l9_96;
...
{
l9_124=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_124=vec4(0.0);
...
vec4 l9_126=outputMotionVectorsIfNeeded(varPos,max(l9_125,vec4(0.0)));
...
#endif
int l9_130=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_129).xy);
...
if (l9_147==0)
{
l9_150=texture(sc_OITAlpha0,l9_142);
l9_149=texture(sc_OITDepthLow0,l9_142);
l9_148=texture(sc_OITDepthHigh0,l9_142);
}
else
{
l9_150=vec4(0.0);
...
if (l9_147==1)
{
l9_153=texture(sc_OITAlpha1,l9_142);
l9_152=texture(sc_OITDepthLow1,l9_142);
l9_151=texture(sc_OITDepthHigh1,l9_142);
}
else
{
l9_153=l9_150;
...
vec4 l9_168=texture(sc_OITFilteredDepthBoundsTexture,l9_142);
