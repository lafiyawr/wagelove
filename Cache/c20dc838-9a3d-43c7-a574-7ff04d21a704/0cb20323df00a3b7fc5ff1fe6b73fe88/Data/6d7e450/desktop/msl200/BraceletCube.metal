...
//sampler sampler Tweak_N11SmpSC 0:27
//sampler sampler Tweak_N3SmpSC 0:28
...
//texture texture2D Tweak_N11 0:4:0:27
//texture texture2D Tweak_N3 0:5:0:28
...
//}
//ubo int UserUniforms 0:43:4992 {
...
//float3x3 Tweak_N3Transform 4608
//float4 Tweak_N3UvMinMax 4656
//float4 Tweak_N3BorderColor 4672
//float4 Tweak_N5 4688
//float4 Tweak_N1 4704
//float4 Tweak_N13 4720
//float3x3 Tweak_N11Transform 4784
//float4 Tweak_N11UvMinMax 4832
//float4 Tweak_N11BorderColor 4848
//float4 Port_Input1_N006 4864
//float Port_Opacity_N000 4880
//float3 Port_Emissive_N000 4912
//float Port_Metallic_N000 4928
//float Port_Roughness_N000 4932
//float3 Port_AO_N000 4944
//float3 Port_SpecularAO_N000 4960
//float depthRef 4976
//}
...
//spec_const bool sc_LightEstimation 64 0
...
//spec_const bool sc_RayTracedReflectionTextureHasSwappedViews 74 0
//spec_const bool sc_RayTracedShadowTextureHasSwappedViews 75 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N11 85 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N3 86 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 87 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N11 88 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N3 89 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 90 -1
//spec_const int Tweak_N11Layout 91 0
//spec_const int Tweak_N3Layout 92 0
...
//spec_const int sc_RayTracedAoTextureLayout 110 0
//spec_const int sc_RayTracedDiffIndTextureLayout 111 0
//spec_const int sc_RayTracedReflectionTextureLayout 112 0
//spec_const int sc_RayTracedShadowTextureLayout 113 0
...
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N11 [[function_constant(31)]];
constant bool SC_USE_CLAMP_TO_BORDER_Tweak_N11_tmp = is_function_constant_defined(SC_USE_CLAMP_TO_BORDER_Tweak_N11) ? SC_USE_CLAMP_TO_BORDER_Tweak_N11 : false;
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N11 [[function_constant(34)]];
constant bool SC_USE_UV_MIN_MAX_Tweak_N11_tmp = is_function_constant_defined(SC_USE_UV_MIN_MAX_Tweak_N11) ? SC_USE_UV_MIN_MAX_Tweak_N11 : false;
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N11 [[function_constant(37)]];
constant bool SC_USE_UV_TRANSFORM_Tweak_N11_tmp = is_function_constant_defined(SC_USE_UV_TRANSFORM_Tweak_N11) ? SC_USE_UV_TRANSFORM_Tweak_N11 : false;
...
constant bool Tweak_N11HasSwappedViews [[function_constant(40)]];
constant bool Tweak_N11HasSwappedViews_tmp = is_function_constant_defined(Tweak_N11HasSwappedViews) ? Tweak_N11HasSwappedViews : false;
...
constant bool sc_LightEstimation [[function_constant(64)]];
...
constant bool sc_RayTracedAoTextureHasSwappedViews [[function_constant(72)]];
...
constant bool sc_RayTracedDiffIndTextureHasSwappedViews [[function_constant(73)]];
...
constant bool sc_RayTracedReflectionTextureHasSwappedViews [[function_constant(74)]];
...
constant bool sc_RayTracedShadowTextureHasSwappedViews [[function_constant(75)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N11 [[function_constant(85)]];
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N11_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_U_Tweak_N11) ? SC_SOFTWARE_WRAP_MODE_U_Tweak_N11 : -1;
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N3 [[function_constant(86)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N11 [[function_constant(88)]];
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N11_tmp = is_function_constant_defined(SC_SOFTWARE_WRAP_MODE_V_Tweak_N11) ? SC_SOFTWARE_WRAP_MODE_V_Tweak_N11 : -1;
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N3 [[function_constant(89)]];
...
constant int Tweak_N11Layout [[function_constant(91)]];
constant int Tweak_N11Layout_tmp = is_function_constant_defined(Tweak_N11Layout) ? Tweak_N11Layout : 0;
constant int Tweak_N3Layout [[function_constant(92)]];
...
constant int sc_MaxTextureImageUnits [[function_constant(108)]];
...
constant int sc_RayTracedAoTextureLayout [[function_constant(110)]];
...
constant int sc_RayTracedDiffIndTextureLayout [[function_constant(111)]];
...
constant int sc_RayTracedReflectionTextureLayout [[function_constant(112)]];
...
constant int sc_RayTracedShadowTextureLayout [[function_constant(113)]];
...
float4 Tweak_N1;
float4 Tweak_N13;
float4 Tweak_N11Size;
float4 Tweak_N11Dims;
float4 Tweak_N11View;
float3x3 Tweak_N11Transform;
float4 Tweak_N11UvMinMax;
float4 Tweak_N11BorderColor;
float4 Port_Input1_N006;
float Port_Opacity_N000;
float3 Port_Normal_N000;
float3 Port_Emissive_N000;
float Port_Metallic_N000;
float Port_Roughness_N000;
float3 Port_AO_N000;
...
texture2d<float> Tweak_N11 [[id(4)]];
texture2d<float> Tweak_N3 [[id(5)]];
...
sampler Tweak_N11SmpSC [[id(27)]];
sampler Tweak_N3SmpSC [[id(28)]];
...
int l9_10=l9_5;
int param=Tweak_N3Layout_tmp;
int param_1=l9_10;
float2 param_2=Globals.Surface_UVCoord0;
bool param_3=(int(SC_USE_UV_TRANSFORM_Tweak_N3_tmp)!=0);
float3x3 param_4=(*sc_set0.UserUniforms).Tweak_N3Transform;
int2 param_5=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3_tmp);
bool param_6=(int(SC_USE_UV_MIN_MAX_Tweak_N3_tmp)!=0);
float4 param_7=(*sc_set0.UserUniforms).Tweak_N3UvMinMax;
bool param_8=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3_tmp)!=0);
float4 param_9=(*sc_set0.UserUniforms).Tweak_N3BorderColor;
float param_10=0.0;
...
Output_N6=mix(Output_N3,(*sc_set0.UserUniforms).Port_Input1_N006,Output_N5);
float4 Output_N1=float4(0.0);
float4 param_12=(*sc_set0.UserUniforms).Tweak_N1;
Output_N1=param_12;
float4 Output_N13=float4(0.0);
float4 param_13=(*sc_set0.UserUniforms).Tweak_N13;
Output_N13=param_13;
float2 UVCoord_N10=float2(0.0);
UVCoord_N10=Globals.Surface_UVCoord1;
float4 Color_N12=float4(0.0);
int l9_85=0;
if ((int(Tweak_N11HasSwappedViews_tmp)!=0))
{
int l9_86=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_90=l9_85;
int param_14=Tweak_N11Layout_tmp;
int param_15=l9_90;
float2 param_16=UVCoord_N10;
bool param_17=(int(SC_USE_UV_TRANSFORM_Tweak_N11_tmp)!=0);
float3x3 param_18=(*sc_set0.UserUniforms).Tweak_N11Transform;
int2 param_19=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N11_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N11_tmp);
bool param_20=(int(SC_USE_UV_MIN_MAX_Tweak_N11_tmp)!=0);
float4 param_21=(*sc_set0.UserUniforms).Tweak_N11UvMinMax;
bool param_22=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N11_tmp)!=0);
float4 param_23=(*sc_set0.UserUniforms).Tweak_N11BorderColor;
float param_24=0.0;
bool l9_91=param_22&&(!param_20);
float l9_92=1.0;
...
param_16.x=l9_93;
float l9_98=param_16.y;
int l9_99=param_19.y;
if (l9_99==1)
{
l9_98=fract(l9_98);
}
...
float l9_105=param_16.x;
float l9_106=param_21.x;
float l9_107=param_21.z;
bool l9_108=l9_104;
float l9_109=l9_92;
...
float l9_114=param_16.y;
float l9_115=param_21.y;
float l9_116=param_21.w;
bool l9_117=l9_113;
float l9_118=l9_92;
...
float2 l9_121=param_16;
bool l9_122=param_17;
float3x3 l9_123=param_18;
if (l9_122)
{
...
param_16=l9_126;
float l9_127=param_16.x;
int l9_128=param_19.x;
bool l9_129=l9_91;
float l9_130=l9_92;
...
param_16.x=l9_127;
l9_92=l9_130;
float l9_138=param_16.y;
int l9_139=param_19.y;
bool l9_140=l9_91;
float l9_141=l9_92;
...
param_16.y=l9_138;
l9_92=l9_141;
float2 l9_149=param_16;
int l9_150=param_14;
int l9_151=param_15;
float l9_152=param_24;
...
float l9_160=l9_152;
float4 l9_161=sc_set0.Tweak_N11.sample(sc_set0.Tweak_N11SmpSC,l9_159,bias(l9_160));
float4 l9_162=l9_161;
float4 l9_163=l9_162;
if (param_22)
{
l9_163=mix(param_23,l9_163,float4(l9_92));
}
float4 l9_164=l9_163;
Color_N12=l9_164;
float4 Output_N8=float4(0.0);
Output_N8=mix(Output_N1,Output_N13,Color_N12);
float4 Output_N0=float4(0.0);
float3 param_25=Output_N8.xyz;
float param_26=(*sc_set0.UserUniforms).Port_Opacity_N000;
float3 param_27=(*sc_set0.UserUniforms).Port_Emissive_N000;
float param_28=(*sc_set0.UserUniforms).Port_Metallic_N000;
float param_29=(*sc_set0.UserUniforms).Port_Roughness_N000;
float3 param_30=(*sc_set0.UserUniforms).Port_AO_N000;
float3 param_31=(*sc_set0.UserUniforms).Port_SpecularAO_N000;
ssGlobals param_33=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_33.BumpedNormal=param_33.VertexNormal_WorldSpace;
}
float l9_165=param_26;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_165<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float2 l9_167=floor(mod(l9_166.xy,float2(4.0)));
float l9_168=(mod(dot(l9_167,float2(4.0,1.0))*9.0,16.0)+1.0)/17.0;
if (l9_165<l9_168)
{
discard_fragment();
}
...
float4 l9_182=fast::max(param_37,float4(0.0));
float4 param_38=l9_182;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
float4 l9_191=param_39;
float4 l9_192=float4(0.0);
float4 l9_193=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_194=out.FragColor0;
float4 l9_195=l9_194;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_195.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
int l9_219=l9_217;
float2 l9_220=l9_218;
int l9_221=l9_219;
float l9_222=0.0;
float4 l9_223=float4(0.0);
float2 l9_224=l9_220;
int l9_225=sc_ScreenTextureLayout_tmp;
int l9_226=l9_221;
float l9_227=l9_222;
...
float l9_235=l9_227;
float4 l9_236=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_234,bias(l9_235));
float4 l9_237=l9_236;
l9_223=l9_237;
float4 l9_238=l9_223;
float4 l9_239=l9_238;
float4 l9_240=l9_239;
l9_193=l9_240;
}
float4 l9_241=l9_193;
float4 l9_242=l9_241;
float3 l9_243=l9_242.xyz;
float3 l9_244=l9_243;
float3 l9_245=l9_191.xyz;
float3 l9_246=definedBlend(l9_244,l9_245,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_192=float4(l9_246.x,l9_246.y,l9_246.z,l9_192.w);
float3 l9_247=mix(l9_243,l9_192.xyz,float3(l9_191.w));
l9_192=float4(l9_247.x,l9_247.y,l9_247.z,l9_192.w);
l9_192.w=1.0;
float4 l9_248=l9_192;
param_39=l9_248;
}
else
{
float4 l9_249=param_39;
float4 l9_250=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_250=float4(mix(float3(1.0),l9_249.xyz,float3(l9_249.w)),l9_249.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_251=l9_249.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_251=fast::clamp(l9_251,0.0,1.0);
}
l9_250=float4(l9_249.xyz*l9_251,l9_251);
}
else
{
l9_250=l9_249;
...
float4 l9_252=l9_250;
param_39=l9_252;
}
}
}
float4 l9_253=param_39;
FinalColor=l9_253;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_254=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_254=float4(0.0);
...
float4 l9_256=param_42;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_256.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_256;
return out;
}
} // FRAGMENT SHADER
...
float param_1=(*sc_set0.UserUniforms).Port_Roughness_N000;
...
float l9_6=param_1;
float3 l9_7=normalize((*sc_set0.UserUniforms).sc_Camera.position-l9_4);
if (dot(l9_7,l9_5)>=(-0.050000001))
{
uint3 l9_8=uint3(round((l9_4-(*sc_set0.UserUniforms).OriginNormalizationOffset)*(*sc_set0.UserUniforms).OriginNormalizationScale));
out.position_and_mask=uint4(l9_8.x,l9_8.y,l9_8.z,out.position_and_mask.w);
out.position_and_mask.w=uint((*sc_set0.UserUniforms).receiver_mask);
float3 l9_9=l9_5;
float l9_10=dot(abs(l9_9),float3(1.0));
l9_9/=float3(l9_10);
float l9_11=fast::clamp(-l9_9.z,0.0,1.0);
...
float2 l9_15=l9_12;
float2 l9_16=l9_15;
uint2 l9_17=uint2(as_type<uint>(half2(float2(l9_16.x,0.0))),as_type<uint>(half2(float2(l9_16.y,0.0))));
out.normal_and_more=uint4(l9_17.x,l9_17.y,out.normal_and_more.z,out.normal_and_more.w);
...
{
l9_18=uint(fast::clamp(l9_6,0.0,1.0)*1000.0);
}
uint l9_19=l9_18;
l9_19 |= uint(((*sc_set0.UserUniforms).receiverId%32)<<int(10u));
out.normal_and_more.w=l9_19;
}
else
{
