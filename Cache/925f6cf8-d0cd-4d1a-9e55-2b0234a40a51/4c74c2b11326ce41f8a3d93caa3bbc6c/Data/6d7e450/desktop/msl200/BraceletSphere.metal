...
//}
//ubo int UserUniforms 0:43:5008 {
...
//float3x3 Tweak_N1Transform 4752
//float4 Tweak_N1UvMinMax 4800
//float4 Tweak_N1BorderColor 4816
//float4 Port_Input1_N006 4832
//float Port_Input1_N008 4848
//float Port_Opacity_N000 4852
//float4 Port_Input0_N102 4880
//float Port_Import_N092 4912
//float4 Port_Input1_N094 4928
//float Port_Import_N095 4944
//float Port_Import_N100 4948
//float Port_Metallic_N000 4952
//float Port_Roughness_N000 4956
//float3 Port_AO_N000 4960
//float3 Port_SpecularAO_N000 4976
//float depthRef 4992
//}
...
constant bool SC_USE_UV_MIN_MAX_Tweak_N1 [[function_constant(34)]];
...
constant bool SC_USE_UV_TRANSFORM_Tweak_N1 [[function_constant(37)]];
...
constant bool Tweak_N1HasSwappedViews [[function_constant(40)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_Tweak_N1 [[function_constant(85)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_Tweak_N1 [[function_constant(88)]];
...
constant int Tweak_N1Layout [[function_constant(91)]];
...
float l9_549=param_9.x;
float l9_550=param_9.y;
float l9_551=param_9.z;
float3 l9_552=float3(linearToSrgb(l9_549),linearToSrgb(l9_550),linearToSrgb(l9_551));
Output=float4(l9_552.x,l9_552.y,l9_552.z,Output.w);
return Output;
}
...
float l9_85=fast::clamp(param_12,0.0,1.0);
Ratio_N14=l9_85;
float Output_N8=0.0;
Output_N8=Ratio_N14*(*sc_set0.UserUniforms).Port_Input1_N008;
...
int l9_91=l9_86;
int param_13=Tweak_N1Layout_tmp;
int param_14=l9_91;
float2 param_15=Globals.Surface_UVCoord0;
bool param_16=(int(SC_USE_UV_TRANSFORM_Tweak_N1_tmp)!=0);
float3x3 param_17=(*sc_set0.UserUniforms).Tweak_N1Transform;
int2 param_18=int2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1_tmp,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1_tmp);
bool param_19=(int(SC_USE_UV_MIN_MAX_Tweak_N1_tmp)!=0);
float4 param_20=(*sc_set0.UserUniforms).Tweak_N1UvMinMax;
bool param_21=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1_tmp)!=0);
float4 param_22=(*sc_set0.UserUniforms).Tweak_N1BorderColor;
float param_23=0.0;
bool l9_92=param_21&&(!param_19);
float l9_93=1.0;
float l9_94=param_15.x;
int l9_95=param_18.x;
if (l9_95==1)
{
l9_94=fract(l9_94);
}
...
param_15.x=l9_94;
float l9_99=param_15.y;
int l9_100=param_18.y;
if (l9_100==1)
{
l9_99=fract(l9_99);
}
...
float l9_106=param_15.x;
float l9_107=param_20.x;
float l9_108=param_20.z;
bool l9_109=l9_105;
float l9_110=l9_93;
...
float l9_115=param_15.y;
float l9_116=param_20.y;
float l9_117=param_20.w;
bool l9_118=l9_114;
float l9_119=l9_93;
...
float2 l9_122=param_15;
bool l9_123=param_16;
float3x3 l9_124=param_17;
if (l9_123)
{
...
param_15=l9_127;
float l9_128=param_15.x;
int l9_129=param_18.x;
bool l9_130=l9_92;
float l9_131=l9_93;
...
param_15.x=l9_128;
l9_93=l9_131;
float l9_139=param_15.y;
int l9_140=param_18.y;
bool l9_141=l9_92;
float l9_142=l9_93;
...
param_15.y=l9_139;
l9_93=l9_142;
float2 l9_150=param_15;
int l9_151=param_13;
int l9_152=param_14;
float l9_153=param_23;
...
float l9_161=l9_153;
float4 l9_162=sc_set0.Tweak_N1.sample(sc_set0.Tweak_N1SmpSC,l9_160,bias(l9_161));
float4 l9_163=l9_162;
float4 l9_164=l9_163;
if (param_21)
{
l9_164=mix(param_22,l9_164,float4(l9_93));
}
...
float3 param_24=float3(Output_N8);
float param_25=(*sc_set0.UserUniforms).Port_Opacity_N000;
float3 param_26=Export_N113.xyz;
float param_27=(*sc_set0.UserUniforms).Port_Metallic_N000;
float param_28=(*sc_set0.UserUniforms).Port_Roughness_N000;
float3 param_29=(*sc_set0.UserUniforms).Port_AO_N000;
float3 param_30=(*sc_set0.UserUniforms).Port_SpecularAO_N000;
ssGlobals param_32=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_32.BumpedNormal=param_32.VertexNormal_WorldSpace;
}
float l9_166=param_25;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_166<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
if ((int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_31=float4(param_24,param_25);
}
else
{
param_26=fast::max(param_26,float3(0.0));
float3 l9_170=param_24;
float l9_171=param_25;
float3 l9_172=param_32.BumpedNormal;
float3 l9_173=param_32.PositionWS;
float3 l9_174=param_32.ViewDirWS;
float3 l9_175=param_26;
float l9_176=param_27;
float l9_177=param_28;
float3 l9_178=param_29;
float3 l9_179=param_30;
param_31=ngsCalculateLighting(l9_170,l9_171,l9_172,l9_173,l9_174,l9_175,l9_176,l9_177,l9_178,l9_179,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.sc_EnvmapDiffuse,sc_set0.sc_EnvmapDiffuseSmpSC,sc_set0.sc_EnvmapSpecular,sc_set0.sc_EnvmapSpecularSmpSC,sc_set0.sc_ScreenTexture,sc_set0.sc_ScreenTextureSmpSC,sc_set0.sc_ShadowTexture,sc_set0.sc_ShadowTextureSmpSC,sc_set0.sc_SSAOTexture,sc_set0.sc_SSAOTextureSmpSC,sc_set0.sc_RayTracedReflectionTexture,sc_set0.sc_RayTracedReflectionTextureSmpSC,sc_set0.sc_RayTracedShadowTexture,sc_set0.sc_RayTracedShadowTextureSmpSC,sc_set0.sc_RayTracedDiffIndTexture,sc_set0.sc_RayTracedDiffIndTextureSmpSC,sc_set0.sc_RayTracedAoTexture,sc_set0.sc_RayTracedAoTextureSmpSC,gl_FragCoord,in.varShadowTex,out.FragColor0);
}
param_31=fast::max(param_31,float4(0.0));
Output_N0=param_31;
float4 Output_N7=float4(0.0);
float4 param_33=Output_N6;
float4 param_34=Output_N0;
float3 l9_180=param_34.xyz*param_33.xyz;
float4 param_35;
param_35=float4(l9_180.x,l9_180.y,l9_180.z,param_35.w);
float3 l9_181=mix(param_33.xyz,param_35.xyz,float3(param_34.w));
param_35=float4(l9_181.x,l9_181.y,l9_181.z,param_35.w);
param_35.w=param_33.w;
Output_N7=param_35;
...
float4 l9_183=fast::max(param_36,float4(0.0));
float4 param_37=l9_183;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_196.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_225=l9_221;
int l9_226=sc_ScreenTextureLayout_tmp;
int l9_227=l9_222;
float l9_228=l9_223;
...
float l9_236=l9_228;
float4 l9_237=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_235,bias(l9_236));
float4 l9_238=l9_237;
l9_224=l9_238;
float4 l9_239=l9_224;
float4 l9_240=l9_239;
float4 l9_241=l9_240;
l9_194=l9_241;
}
float4 l9_242=l9_194;
float4 l9_243=l9_242;
float3 l9_244=l9_243.xyz;
float3 l9_245=l9_244;
float3 l9_246=l9_192.xyz;
float3 l9_247=definedBlend(l9_245,l9_246,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_193=float4(l9_247.x,l9_247.y,l9_247.z,l9_193.w);
float3 l9_248=mix(l9_244,l9_193.xyz,float3(l9_192.w));
l9_193=float4(l9_248.x,l9_248.y,l9_248.z,l9_193.w);
l9_193.w=1.0;
float4 l9_249=l9_193;
param_38=l9_249;
}
else
{
float4 l9_250=param_38;
...
{
l9_255=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_255=float4(0.0);
