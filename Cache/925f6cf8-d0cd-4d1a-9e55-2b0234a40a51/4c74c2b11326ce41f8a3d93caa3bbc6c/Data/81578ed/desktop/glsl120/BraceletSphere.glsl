...
//sampler sampler Tweak_N3SmpSC 0:18
...
//texture texture2D Tweak_N3 0:1:0:18
...
//spec_const bool sc_CanUseStandardDerivatives 62 0
//spec_const bool sc_CanUseTextureLod 63 0
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N1 92 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N3 93 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 94 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N1 95 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N3 96 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 97 -1
//spec_const int Tweak_N1Layout 98 0
//spec_const int Tweak_N3Layout 99 0
...
//spec_const int sc_StereoViewID 123 0
//SG_REFLECTION_END
...
#endif
bool l9_3=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N3)!=0));
float l9_4=varPackedTex.x;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).x);
float l9_5=l9_4;
float l9_6=varPackedTex.y;
sc_SoftwareWrapEarly(l9_6,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).y);
float l9_7=l9_6;
vec2 l9_8;
float l9_9;
...
{
l9_10=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).x==3;
}
#else
{
l9_10=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0);
}
#endif
float l9_11=l9_5;
float l9_12=1.0;
sc_ClampUV(l9_11,Tweak_N3UvMinMax.x,Tweak_N3UvMinMax.z,l9_10,l9_12);
float l9_13=l9_11;
float l9_14=l9_12;
bool l9_15;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N3)
{
l9_15=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).y==3;
}
#else
{
l9_15=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0);
}
#endif
float l9_16=l9_7;
float l9_17=l9_14;
sc_ClampUV(l9_16,Tweak_N3UvMinMax.y,Tweak_N3UvMinMax.w,l9_15,l9_17);
l9_9=l9_17;
...
#endif
vec2 l9_18=sc_TransformUV(l9_8,(int(SC_USE_UV_TRANSFORM_Tweak_N3)!=0),Tweak_N3Transform);
float l9_19=l9_18.x;
float l9_20=l9_9;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).x,l9_3,l9_20);
float l9_21=l9_18.y;
float l9_22=l9_20;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3).y,l9_3,l9_22);
float l9_23=l9_22;
vec3 l9_24=sc_SamplingCoordsViewToGlobal(vec2(l9_19,l9_21),Tweak_N3Layout,l9_2);
vec4 l9_25=texture2D(Tweak_N3,l9_24.xy,0.0);
vec4 l9_26;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N3)
{
l9_26=mix(Tweak_N3BorderColor,l9_25,vec4(l9_23));
}
#else
{
l9_26=l9_25;
...
#endif
vec4 l9_27=mix(l9_26,Port_Input1_N006,Tweak_N5);
int l9_28;
...
#endif
bool l9_29=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0));
float l9_30=varPackedTex.x;
sc_SoftwareWrapEarly(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x);
float l9_31=l9_30;
float l9_32=varPackedTex.y;
sc_SoftwareWrapEarly(l9_32,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y);
float l9_33=l9_32;
vec2 l9_34;
float l9_35;
...
{
l9_36=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x==3;
}
#else
{
...
float l9_37=l9_31;
float l9_38=1.0;
sc_ClampUV(l9_37,Tweak_N1UvMinMax.x,Tweak_N1UvMinMax.z,l9_36,l9_38);
float l9_39=l9_37;
float l9_40=l9_38;
bool l9_41;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_41=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y==3;
}
#else
{
...
float l9_42=l9_33;
float l9_43=l9_40;
sc_ClampUV(l9_42,Tweak_N1UvMinMax.y,Tweak_N1UvMinMax.w,l9_41,l9_43);
l9_35=l9_43;
...
#endif
vec2 l9_44=sc_TransformUV(l9_34,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform);
float l9_45=l9_44.x;
float l9_46=l9_35;
sc_SoftwareWrapLate(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x,l9_29,l9_46);
float l9_47=l9_44.y;
float l9_48=l9_46;
sc_SoftwareWrapLate(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y,l9_29,l9_48);
float l9_49=l9_48;
vec3 l9_50=sc_SamplingCoordsViewToGlobal(vec2(l9_45,l9_47),Tweak_N1Layout,l9_28);
vec4 l9_51=texture2D(Tweak_N1,l9_50.xy,0.0);
vec4 l9_52;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_52=mix(Tweak_N1BorderColor,l9_51,vec4(l9_49));
}
#else
{
l9_52=l9_51;
...
#endif
vec4 l9_53=l9_52*vec4(clamp(Port_Import_N092,0.0,5.0));
vec3 l9_54;
...
#endif
vec3 l9_55=max(vec3(clamp(dot(l9_1,l9_0),0.0,1.0)*Port_Input1_N008),vec3(0.0));
vec4 l9_56;
#if (sc_ProjectiveShadowsCaster)
{
l9_56=vec4(l9_55,Port_Opacity_N000);
}
#else
{
vec3 l9_57=ssSRGB_to_Linear(l9_55);
vec3 l9_58=normalize(l9_54);
vec3 l9_59=ssSRGB_to_Linear(max(mix(Port_Input0_N102,mix(vec4(dot(l9_53,Port_Input1_N094)),l9_53,vec4(clamp(Port_Import_N095,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0))).xyz,vec3(0.0)));
vec3 l9_60;
#if (sc_SSAOEnabled)
{
l9_60=evaluateSSAO(varPos);
}
#else
{
l9_60=Port_AO_N000;
...
#endif
vec3 l9_61=vec3(Port_Metallic_N000);
vec3 l9_62=mix(vec3(0.039999999),l9_57*Port_Metallic_N000,l9_61);
vec3 l9_63=mix(l9_57*(1.0-Port_Metallic_N000),vec3(0.0),l9_61);
SurfaceProperties l9_64=SurfaceProperties(l9_63,Port_Opacity_N000,l9_58,varPos,l9_1,Port_Metallic_N000,Port_Roughness_N000,l9_59,l9_60,Port_SpecularAO_N000,vec3(1.0),l9_62);
vec4 l9_65=vec4(1.0);
vec3 l9_66;
vec3 l9_67;
vec3 l9_68;
...
l9_74=vec3(0.0);
l9_73=vec3(0.0);
LightingComponents l9_80;
LightProperties l9_81;
SurfaceProperties l9_82;
vec3 l9_83;
int l9_84=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_84<sc_DirectionalLightsCount)
{
LightingComponents l9_85=accumulateLight(LightingComponents(l9_73,l9_74,l9_79,l9_78,l9_76,l9_75),LightProperties(sc_DirectionalLights[l9_84].direction,sc_DirectionalLights[l9_84].color.xyz,sc_DirectionalLights[l9_84].color.w*l9_65[(l9_77<3) ? l9_77 : 3]),l9_64,l9_1);
l9_79=l9_85.indirectDiffuse;
l9_78=l9_85.indirectSpecular;
l9_77++;
l9_76=l9_85.emitted;
l9_75=l9_85.transmitted;
l9_74=l9_85.directSpecular;
l9_73=l9_85.directDiffuse;
l9_84++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_102<sc_PointLightsCount)
{
vec3 l9_104=sc_PointLights[l9_102].position-varPos;
vec3 l9_105=normalize(l9_104);
float l9_106=l9_65[(l9_103<3) ? l9_103 : 3];
float l9_107=clamp((dot(l9_105,sc_PointLights[l9_102].direction)*sc_PointLights[l9_102].angleScale)+sc_PointLights[l9_102].angleOffset,0.0,1.0);
float l9_108=(sc_PointLights[l9_102].color.w*l9_106)*(l9_107*l9_107);
float l9_109;
if (sc_PointLights[l9_102].falloffEnabled)
{
l9_109=l9_108*computeDistanceAttenuation(length(l9_104),sc_PointLights[l9_102].falloffEndDistance);
}
else
{
l9_109=l9_108;
...
l9_95=l9_103+1;
LightingComponents l9_110=accumulateLight(LightingComponents(l9_89,l9_90,l9_94,l9_93,l9_92,l9_91),LightProperties(l9_105,sc_PointLights[l9_102].color.xyz,l9_109),l9_64,l9_1);
l9_96=l9_110.directDiffuse;
l9_97=l9_110.directSpecular;
l9_98=l9_110.indirectDiffuse;
l9_99=l9_110.indirectSpecular;
l9_100=l9_110.emitted;
l9_101=l9_110.transmitted;
l9_94=l9_98;
l9_93=l9_99;
l9_103=l9_95;
l9_92=l9_100;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_114=abs(varShadowTex-vec2(0.5));
vec4 l9_115=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_114.x,l9_114.y),0.5);
l9_113=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_115.xyz,vec3(sc_ShadowColor.w)),vec3(l9_115.w*sc_ShadowDensity));
}
#else
{
l9_113=vec3(1.0);
...
{
vec2 l9_117=calcPanoramicTexCoordsFromDir(l9_58,sc_EnvmapRotation.y);
vec4 l9_118;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_119=calcSeamlessPanoramicUvsForSampling(l9_117,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_119=l9_117;
...
#endif
l9_118=sc_EnvmapSpecularSampleViewIndexBias(l9_119,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_120;
...
{
vec2 l9_121=calcSeamlessPanoramicUvsForSampling(l9_117,sc_EnvmapDiffuseSize.xy,0.0);
int l9_122;
...
#endif
l9_120=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_121,sc_EnvmapDiffuseLayout,l9_122).xy,-13.0);
}
#else
{
l9_120=sc_EnvmapSpecularSampleViewIndexBias(l9_117,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_118=l9_120;
}
#endif
l9_116=(l9_118.xyz*(1.0/l9_118.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_123;
...
float l9_126=l9_124.y;
float l9_127=l9_124.z;
l9_123=(((((((sc_Sh[8]*0.42904299)*((l9_125*l9_125)-(l9_126*l9_126)))+((sc_Sh[6]*0.74312502)*(l9_127*l9_127)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_125*l9_126))+(sc_Sh[7]*(l9_125*l9_127)))+(sc_Sh[5]*(l9_126*l9_127)))*0.85808599))+((((sc_Sh[3]*l9_125)+(sc_Sh[1]*l9_126))+(sc_Sh[2]*l9_127))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_123=vec3(0.0);
...
{
l9_129=l9_116+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_130=l9_116;
l9_130.x=l9_116.x+(1e-06*sc_AmbientLights[0].color.x);
l9_129=l9_130;
}
#endif
l9_128=l9_129;
...
{
l9_132=l9_128+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_133=l9_128;
l9_133.x=l9_128.x+(1e-06*sc_AmbientLights[1].color.x);
l9_132=l9_133;
}
#endif
l9_131=l9_132;
...
{
l9_135=l9_131+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_136=l9_131;
l9_136.x=l9_131.x+(1e-06*sc_AmbientLights[2].color.x);
l9_135=l9_136;
}
#endif
l9_134=l9_135;
...
{
vec3 l9_138;
l9_138=sc_LightEstimationData.ambientLight;
vec3 l9_139;
int l9_140=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
...
{
float l9_141=dot(sc_LightEstimationData.sg[l9_140].axis,l9_58);
float l9_142=exp(-sc_LightEstimationData.sg[l9_140].sharpness);
float l9_143=l9_142*l9_142;
float l9_144=1.0/sc_LightEstimationData.sg[l9_140].sharpness;
float l9_145=(1.0+(2.0*l9_143))-l9_144;
float l9_146=sqrt(1.0-l9_145);
float l9_147=0.36000001*l9_141;
float l9_148=(1.0/(4.0*0.36000001))*l9_146;
float l9_149=l9_147+l9_148;
float l9_150;
if (step(abs(l9_147),l9_148)>0.5)
{
l9_150=(l9_149*l9_149)/l9_146;
}
else
{
l9_150=clamp(l9_141,0.0,1.0);
}
l9_139=l9_138+((((sc_LightEstimationData.sg[l9_140].color/vec3(sc_LightEstimationData.sg[l9_140].sharpness))*6.2831855)*((l9_145*l9_150)+(((l9_142-l9_143)*l9_144)-l9_143)))/vec3(3.1415927));
l9_138=l9_139;
l9_140++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_152=clamp(pow(Port_Roughness_N000,0.66666669),0.0,1.0)*5.0;
vec2 l9_153=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_58,reflect(-l9_1,l9_58),Port_Roughness_N000),sc_EnvmapRotation.y);
vec4 l9_154;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_155=floor(l9_152);
float l9_156=ceil(l9_152);
l9_154=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_153,sc_EnvmapSpecularSize.xy,l9_155),sc_EnvmapSpecularGetStereoViewIndex(),l9_155),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_153,sc_EnvmapSpecularSize.xy,l9_156),sc_EnvmapSpecularGetStereoViewIndex(),l9_156),vec4(l9_152-l9_155));
}
#else
{
l9_154=sc_EnvmapSpecularSampleViewIndexLevel(l9_153,sc_EnvmapSpecularGetStereoViewIndex(),l9_152);
}
#endif
l9_151=vec3(0.0)+((((l9_154.xyz*(1.0/l9_154.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_64,abs(dot(l9_58,l9_1))));
}
#else
{
l9_151=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_158=clamp(Port_Roughness_N000*Port_Roughness_N000,0.0099999998,1.0);
vec3 l9_159;
l9_159=sc_LightEstimationData.ambientLight*l9_62;
int l9_160=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_160<sc_LightEstimationSGCount)
{
float l9_161=l9_158*l9_158;
vec3 l9_162=reflect(-l9_1,l9_58);
float l9_163=dot(l9_58,l9_1);
float l9_164=(2.0/l9_161)/(4.0*max(l9_163,9.9999997e-05));
float l9_165=length((l9_162*l9_164)+(sc_LightEstimationData.sg[l9_160].axis*sc_LightEstimationData.sg[l9_160].sharpness));
float l9_166=clamp(dot(l9_58,l9_162),0.0,1.0);
float l9_167=clamp(l9_163,0.0,1.0);
float l9_168=1.0-l9_161;
l9_159+=((((((((vec3(1.0/(3.1415927*l9_161))*exp((l9_165-l9_164)-sc_LightEstimationData.sg[l9_160].sharpness))*sc_LightEstimationData.sg[l9_160].color)*6.2831855)*(1.0-exp((-2.0)*l9_165)))/vec3(l9_165))*((1.0/(l9_166+sqrt(l9_161+((l9_168*l9_166)*l9_166))))*(1.0/(l9_167+sqrt(l9_161+((l9_168*l9_167)*l9_167))))))*(l9_62+((vec3(1.0)-l9_62)*pow(1.0-clamp(dot(l9_162,normalize(l9_162+l9_1)),0.0,1.0),5.0))))*l9_166);
l9_160++;
continue;
}
else
...
l9_172=vec3(0.0);
l9_171=vec3(0.0);
l9_170=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_63,vec3(Port_Opacity_N000));
l9_169=1.0;
}
#else
{
...
#endif
vec3 l9_174=l9_171*l9_60;
vec3 l9_175=l9_172+l9_174;
vec3 l9_176=l9_63*l9_175;
vec3 l9_177=l9_157*Port_SpecularAO_N000;
vec3 l9_178=l9_111+l9_177;
vec3 l9_179;
if (l9_173)
{
l9_179=l9_176*srgbToLinear(l9_169);
}
else
{
l9_179=l9_176;
}
vec3 l9_180=l9_179+l9_178;
vec3 l9_181=(l9_180+l9_59)+l9_170;
float l9_182=l9_181.x;
vec4 l9_183=vec4(l9_182,l9_181.yz,l9_169);
vec4 l9_184;
#if (sc_IsEditor)
{
vec4 l9_185=l9_183;
l9_185.x=l9_182+((l9_60.x*Port_SpecularAO_N000.x)*9.9999997e-06);
l9_184=l9_185;
}
#else
{
...
#endif
vec3 l9_186=vec3(linearToSrgb(l9_184.x),linearToSrgb(l9_184.y),linearToSrgb(l9_184.z));
l9_56=vec4(l9_186.x,l9_186.y,l9_186.z,l9_184.w);
}
#endif
vec4 l9_187=max(l9_56,vec4(0.0));
vec3 l9_188=l9_27.xyz;
vec3 l9_189=mix(l9_188,(l9_187.xyz*l9_188).xyz,vec3(l9_187.w));
float l9_190=l9_27.w;
vec4 l9_191=vec4(l9_189.x,l9_189.y,l9_189.z,vec4(0.0).w);
l9_191.w=l9_190;
vec4 l9_192;
#if (sc_ProjectiveShadowsCaster)
{
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_194=clamp(l9_190*2.0,0.0,1.0);
}
#else
{
float l9_195;
...
{
l9_195=clamp(dot(l9_191.xyz,vec3(l9_190)),0.0,1.0);
}
#else
{
float l9_196;
...
{
l9_197=(1.0-dot(l9_191.xyz,vec3(0.33333001)))*l9_190;
}
#else
{
float l9_198;
...
{
l9_198=(1.0-clamp(dot(l9_191.xyz,vec3(1.0)),0.0,1.0))*l9_190;
}
#else
{
float l9_199;
#if (sc_BlendMode_ColoredGlass)
{
l9_199=clamp(dot(l9_191.xyz,vec3(1.0)),0.0,1.0)*l9_190;
}
#else
{
float l9_200;
#if (sc_BlendMode_Add)
{
l9_200=clamp(dot(l9_191.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_201;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_201=clamp(dot(l9_191.xyz,vec3(1.0)),0.0,1.0)*l9_190;
}
#else
{
float l9_202;
...
{
l9_202=dot(l9_191.xyz,vec3(0.33333001))*l9_190;
}
#else
{
float l9_203;
#if (sc_BlendMode_Min)
{
l9_203=1.0-clamp(dot(l9_191.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_204;
#if (sc_BlendMode_Max)
{
l9_204=clamp(dot(l9_191.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_204=1.0;
...
#endif
l9_192=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_191.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_193);
}
#else
{
vec4 l9_205;
...
{
vec3 l9_207=sc_GetFramebufferColor().xyz;
vec3 l9_208=mix(l9_207,definedBlend(l9_207,l9_191.xyz).xyz,vec3(l9_190));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_210=vec4(mix(vec3(1.0),l9_191.xyz,vec3(l9_190)),l9_190);
}
#else
{
vec4 l9_211;
...
#endif
l9_211=vec4(l9_191.xyz*l9_212,l9_212);
}
#else
{
l9_211=l9_191;
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_220).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_221=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_220).xy);
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_233).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_238==0)
{
l9_241=texture2D(sc_OITAlpha0,l9_233);
l9_240=texture2D(sc_OITDepthLow0,l9_233);
l9_239=texture2D(sc_OITDepthHigh0,l9_233);
}
else
{
l9_241=vec4(0.0);
...
if (l9_238==1)
{
l9_244=texture2D(sc_OITAlpha1,l9_233);
l9_243=texture2D(sc_OITDepthLow1,l9_233);
l9_242=texture2D(sc_OITDepthHigh1,l9_233);
}
else
{
l9_244=l9_241;
...
vec4 l9_259=texture2D(sc_OITFilteredDepthBoundsTexture,l9_233);
