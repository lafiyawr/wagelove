...
//}
//ubo int UserUniforms 0:45:5072 {
...
//float Port_Opacity_N006 4968
//float3 Port_Emissive_N006 4976
//float4 Port_Input0_N102 4992
//float Port_Import_N092 5024
//float4 Port_Input1_N094 5040
//float Port_Import_N095 5056
...
float3 param_28=Output_N1.xyz;
float param_29=(*sc_set0.UserUniforms).Port_Opacity_N006;
float3 param_30=Output_N9.xyz;
float3 param_31=(*sc_set0.UserUniforms).Port_Emissive_N006;
float param_32=Value1_N3;
float param_33=Value2_N3;
float3 param_34=Export_N113.xyz;
float3 param_35=Export_N113.xyz;
ssGlobals param_37=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_37.BumpedNormal=float3x3(float3(param_37.VertexTangent_WorldSpace),float3(param_37.VertexBinormal_WorldSpace),float3(param_37.VertexNormal_WorldSpace))*param_30;
}
float l9_257=param_29;
...
float4 l9_272=fast::max(param_38,float4(0.0));
float4 param_39=l9_272;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
float l9_86=l9_78;
float4 l9_87=sc_set0.normalTex.sample(sc_set0.normalTexSmpSC,l9_85,bias(l9_86));
float4 l9_88=l9_87;
float4 l9_89=l9_88;
if (l9_14)
{
l9_89=mix(l9_15,l9_89,float4(l9_18));
}
float4 l9_90=l9_89;
float4 param_2=l9_90;
float3 l9_91=(param_2.xyz*1.9921875)-float3(1.0);
param_2=float4(l9_91.x,l9_91.y,l9_91.z,param_2.w);
Output_N9=param_2;
float4 Output_N2=float4(0.0);
int l9_92=0;
if ((int(materialParamsTexHasSwappedViews_tmp)!=0))
...
int l9_97=l9_92;
int param_3=materialParamsTexLayout_tmp;
int param_4=l9_97;
float2 param_5=CoordsOut_N16;
bool param_6=(int(SC_USE_UV_TRANSFORM_materialParamsTex_tmp)!=0);
float3x3 param_7=(*sc_set0.UserUniforms).materialParamsTexTransform;
int2 param_8=int2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex_tmp,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex_tmp);
bool param_9=(int(SC_USE_UV_MIN_MAX_materialParamsTex_tmp)!=0);
float4 param_10=(*sc_set0.UserUniforms).materialParamsTexUvMinMax;
bool param_11=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex_tmp)!=0);
float4 param_12=(*sc_set0.UserUniforms).materialParamsTexBorderColor;
float param_13=0.0;
bool l9_98=param_11&&(!param_9);
float l9_99=1.0;
float l9_100=param_5.x;
int l9_101=param_8.x;
if (l9_101==1)
{
l9_100=fract(l9_100);
}
...
param_5.x=l9_100;
float l9_105=param_5.y;
int l9_106=param_8.y;
if (l9_106==1)
{
l9_105=fract(l9_105);
}
...
float l9_112=param_5.x;
float l9_113=param_10.x;
float l9_114=param_10.z;
bool l9_115=l9_111;
float l9_116=l9_99;
...
float l9_121=param_5.y;
float l9_122=param_10.y;
float l9_123=param_10.w;
bool l9_124=l9_120;
float l9_125=l9_99;
...
float2 l9_128=param_5;
bool l9_129=param_6;
float3x3 l9_130=param_7;
if (l9_129)
{
...
param_5=l9_133;
float l9_134=param_5.x;
int l9_135=param_8.x;
bool l9_136=l9_98;
float l9_137=l9_99;
...
param_5.x=l9_134;
l9_99=l9_137;
float l9_145=param_5.y;
int l9_146=param_8.y;
bool l9_147=l9_98;
float l9_148=l9_99;
...
param_5.y=l9_145;
l9_99=l9_148;
float2 l9_156=param_5;
int l9_157=param_3;
int l9_158=param_4;
float l9_159=param_13;
...
float l9_167=l9_159;
float4 l9_168=sc_set0.materialParamsTex.sample(sc_set0.materialParamsTexSmpSC,l9_166,bias(l9_167));
float4 l9_169=l9_168;
float4 l9_170=l9_169;
if (param_11)
{
l9_170=mix(param_12,l9_170,float4(l9_99));
}
float4 l9_171=l9_170;
Output_N2=l9_171;
float Value2_N3=0.0;
float4 param_14=Output_N2;
float param_15=param_14.y;
Value2_N3=param_15;
float param_16=(*sc_set0.UserUniforms).Port_Opacity_N006;
float3 param_17=Output_N9.xyz;
float param_18=Value2_N3;
ssGlobals param_19=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_19.BumpedNormal=float3x3(float3(param_19.VertexTangent_WorldSpace),float3(param_19.VertexBinormal_WorldSpace),float3(param_19.VertexNormal_WorldSpace))*param_17;
}
float l9_172=param_16;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_172<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float3 l9_176=param_19.PositionWS;
float3 l9_177=param_19.BumpedNormal;
float l9_178=param_18;
float3 l9_179=normalize((*sc_set0.UserUniforms).sc_Camera.position-l9_176);
if (dot(l9_179,l9_177)>=(-0.050000001))
{
uint3 l9_180=uint3(round((l9_176-(*sc_set0.UserUniforms).OriginNormalizationOffset)*(*sc_set0.UserUniforms).OriginNormalizationScale));
out.position_and_mask=uint4(l9_180.x,l9_180.y,l9_180.z,out.position_and_mask.w);
out.position_and_mask.w=uint((*sc_set0.UserUniforms).receiver_mask);
float3 l9_181=l9_177;
float l9_182=dot(abs(l9_181),float3(1.0));
l9_181/=float3(l9_182);
float l9_183=fast::clamp(-l9_181.z,0.0,1.0);
...
uint2 l9_189=uint2(as_type<uint>(half2(float2(l9_188.x,0.0))),as_type<uint>(half2(float2(l9_188.y,0.0))));
out.normal_and_more=uint4(l9_189.x,l9_189.y,out.normal_and_more.z,out.normal_and_more.w);
...
{
l9_190=uint(fast::clamp(l9_178,0.0,1.0)*1000.0);
}
uint l9_191=l9_190;
l9_191 |= uint(((*sc_set0.UserUniforms).receiverId%32)<<int(10u));
out.normal_and_more.w=l9_191;
}
else
{
