...
#else
{
bool l9_23=(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_baseTex)!=0));
float l9_24=l9_2.x;
...
float l9_39=l9_38.x;
float l9_40=l9_29;
sc_SoftwareWrapLate(l9_39,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).x,l9_23,l9_40);
float l9_41=l9_38.y;
float l9_42=l9_40;
sc_SoftwareWrapLate(l9_41,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex).y,l9_23,l9_42);
}
#endif
vec4 l9_43;
#if (normalTexLayout==2)
{
bool l9_44=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_normalTex)!=0));
float l9_45=l9_2.x;
sc_SoftwareWrapEarly(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x);
float l9_46=l9_45;
float l9_47=l9_2.y;
sc_SoftwareWrapEarly(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y);
float l9_48=l9_47;
vec2 l9_49;
float l9_50;
...
{
l9_51=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x==3;
}
#else
{
l9_51=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_52=l9_46;
float l9_53=1.0;
sc_ClampUV(l9_52,normalTexUvMinMax.x,normalTexUvMinMax.z,l9_51,l9_53);
float l9_54=l9_52;
float l9_55=l9_53;
bool l9_56;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_56=ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y==3;
}
#else
{
l9_56=(int(SC_USE_CLAMP_TO_BORDER_normalTex)!=0);
}
#endif
float l9_57=l9_48;
float l9_58=l9_55;
sc_ClampUV(l9_57,normalTexUvMinMax.y,normalTexUvMinMax.w,l9_56,l9_58);
l9_50=l9_58;
...
#endif
vec2 l9_59=sc_TransformUV(l9_49,(int(SC_USE_UV_TRANSFORM_normalTex)!=0),normalTexTransform);
float l9_60=l9_59.x;
float l9_61=l9_50;
sc_SoftwareWrapLate(l9_60,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).x,l9_44,l9_61);
float l9_62=l9_59.y;
float l9_63=l9_61;
sc_SoftwareWrapLate(l9_62,ivec2(SC_SOFTWARE_WRAP_MODE_U_normalTex,SC_SOFTWARE_WRAP_MODE_V_normalTex).y,l9_44,l9_63);
float l9_64=l9_63;
vec3 l9_65=sc_SamplingCoordsViewToGlobal(vec2(l9_60,l9_62),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_66=texture(normalTexArrSC,l9_65,0.0);
vec4 l9_67;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
l9_67=mix(normalTexBorderColor,l9_66,vec4(l9_64));
}
#else
{
l9_67=l9_66;
...
float l9_88=l9_87;
vec3 l9_89=sc_SamplingCoordsViewToGlobal(vec2(l9_84,l9_86),normalTexLayout,normalTexGetStereoViewIndex());
vec4 l9_90=texture(normalTex,l9_89.xy,0.0);
vec4 l9_91;
#if (SC_USE_CLAMP_TO_BORDER_normalTex)
{
...
{
bool l9_93=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_94=l9_2.x;
sc_SoftwareWrapEarly(l9_94,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_95=l9_94;
float l9_96=l9_2.y;
sc_SoftwareWrapEarly(l9_96,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_97=l9_96;
vec2 l9_98;
float l9_99;
...
{
l9_100=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_100=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_101=l9_95;
float l9_102=1.0;
sc_ClampUV(l9_101,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_100,l9_102);
float l9_103=l9_101;
float l9_104=l9_102;
bool l9_105;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_105=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_105=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_106=l9_97;
float l9_107=l9_104;
sc_ClampUV(l9_106,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_105,l9_107);
l9_99=l9_107;
...
#endif
vec2 l9_108=sc_TransformUV(l9_98,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_109=l9_108.x;
float l9_110=l9_99;
sc_SoftwareWrapLate(l9_109,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_93,l9_110);
float l9_111=l9_108.y;
float l9_112=l9_110;
sc_SoftwareWrapLate(l9_111,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_93,l9_112);
float l9_113=l9_112;
vec3 l9_114=sc_SamplingCoordsViewToGlobal(vec2(l9_109,l9_111),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_115=texture(materialParamsTexArrSC,l9_114,0.0);
vec4 l9_116;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_116=mix(materialParamsTexBorderColor,l9_115,vec4(l9_113));
}
#else
{
l9_116=l9_115;
...
#else
{
bool l9_117=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_materialParamsTex)!=0));
float l9_118=l9_2.x;
sc_SoftwareWrapEarly(l9_118,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x);
float l9_119=l9_118;
float l9_120=l9_2.y;
sc_SoftwareWrapEarly(l9_120,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y);
float l9_121=l9_120;
vec2 l9_122;
float l9_123;
#if (SC_USE_UV_MIN_MAX_materialParamsTex)
...
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_124=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x==3;
}
#else
{
l9_124=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_125=l9_119;
float l9_126=1.0;
sc_ClampUV(l9_125,materialParamsTexUvMinMax.x,materialParamsTexUvMinMax.z,l9_124,l9_126);
float l9_127=l9_125;
float l9_128=l9_126;
bool l9_129;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_129=ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y==3;
}
#else
{
l9_129=(int(SC_USE_CLAMP_TO_BORDER_materialParamsTex)!=0);
}
#endif
float l9_130=l9_121;
float l9_131=l9_128;
sc_ClampUV(l9_130,materialParamsTexUvMinMax.y,materialParamsTexUvMinMax.w,l9_129,l9_131);
l9_123=l9_131;
...
#endif
vec2 l9_132=sc_TransformUV(l9_122,(int(SC_USE_UV_TRANSFORM_materialParamsTex)!=0),materialParamsTexTransform);
float l9_133=l9_132.x;
float l9_134=l9_123;
sc_SoftwareWrapLate(l9_133,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).x,l9_117,l9_134);
float l9_135=l9_132.y;
float l9_136=l9_134;
sc_SoftwareWrapLate(l9_135,ivec2(SC_SOFTWARE_WRAP_MODE_U_materialParamsTex,SC_SOFTWARE_WRAP_MODE_V_materialParamsTex).y,l9_117,l9_136);
float l9_137=l9_136;
vec3 l9_138=sc_SamplingCoordsViewToGlobal(vec2(l9_133,l9_135),materialParamsTexLayout,materialParamsTexGetStereoViewIndex());
vec4 l9_139=texture(materialParamsTex,l9_138.xy,0.0);
vec4 l9_140;
#if (SC_USE_CLAMP_TO_BORDER_materialParamsTex)
{
l9_140=mix(materialParamsTexBorderColor,l9_139,vec4(l9_137));
}
#else
{
l9_140=l9_139;
...
{
l9_141=mat3(l9_0,cross(l9_1,l9_0)*varTangent.w,l9_1)*((l9_43.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_141=vec3(0.0);
...
#endif
if (dot(normalize(sc_Camera.position-varPos),l9_141)>=(-0.050000001))
{
uvec3 l9_142=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_142.x,l9_142.y,l9_142.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_143=abs(l9_141);
vec3 l9_144=l9_141/vec3(dot(l9_143,vec3(1.0)));
float l9_145=clamp(-l9_144.z,0.0,1.0);
float l9_146=l9_144.x;
float l9_147;
if (l9_146>=0.0)
{
l9_147=l9_145;
...
uvec2 l9_151=uvec2(packHalf2x16(vec2(l9_148,0.0)),packHalf2x16(vec2(l9_149+l9_150,0.0)));
normal_and_more=uvec4(l9_151.x,l9_151.y,normal_and_more.z,normal_and_more.w);
...
{
l9_152=uint(clamp(l9_92.y,0.0,1.0)*1000.0);
}
normal_and_more.w=l9_152|uint((receiverId%32)<<int(10u));
}
else
{
...
vec2 l9_13=l9_0-Port_Center_N016;
...
#endif
vec4 l9_162=l9_1*vec4(clamp(Port_Import_N092,0.0,5.0));
vec3 l9_163;
#if (!sc_ProjectiveShadowsCaster)
{
l9_163=mat3(l9_4,l9_2,l9_3)*((l9_64.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_163=vec3(0.0);
...
#if (sc_ProjectiveShadowsCaster)
{
l9_165=vec4(l9_164,Port_Opacity_N006);
}
#else
{
vec3 l9_166=clamp(mix(Port_Input0_N102,mix(vec4(dot(l9_162,Port_Input1_N094)),l9_162,vec4(clamp(Port_Import_N095,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0))).xyz,vec3(0.0),vec3(1.0));
l9_165=ngsCalculateLighting(l9_164,Port_Opacity_N006,l9_163,l9_5,l9_6,Port_Emissive_N006,clamp(l9_113.x,0.0,1.0),clamp(l9_113.y,0.0,1.0),l9_166,l9_166);
}
#endif
vec4 l9_167=max(l9_165,vec4(0.0));
if (isProxyMode)
{
vec4 l9_168;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0Internal(max(l9_168,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_170;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_172=clamp(l9_167.w*2.0,0.0,1.0);
}
#else
{
float l9_173;
...
{
l9_173=clamp(dot(l9_167.xyz,vec3(l9_167.w)),0.0,1.0);
}
#else
{
float l9_174;
...
#if (sc_BlendMode_Multiply)
{
l9_175=(1.0-dot(l9_167.xyz,vec3(0.33333001)))*l9_167.w;
}
#else
{
float l9_176;
...
{
l9_176=(1.0-clamp(dot(l9_167.xyz,vec3(1.0)),0.0,1.0))*l9_167.w;
}
#else
{
float l9_177;
#if (sc_BlendMode_ColoredGlass)
{
l9_177=clamp(dot(l9_167.xyz,vec3(1.0)),0.0,1.0)*l9_167.w;
}
#else
{
float l9_178;
#if (sc_BlendMode_Add)
{
l9_178=clamp(dot(l9_167.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_179;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_179=clamp(dot(l9_167.xyz,vec3(1.0)),0.0,1.0)*l9_167.w;
}
#else
{
float l9_180;
...
{
l9_180=dot(l9_167.xyz,vec3(0.33333001))*l9_167.w;
}
#else
{
float l9_181;
#if (sc_BlendMode_Min)
{
l9_181=1.0-clamp(dot(l9_167.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_182;
#if (sc_BlendMode_Max)
{
l9_182=clamp(dot(l9_167.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_182=1.0;
...
#endif
l9_170=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_167.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_171);
}
#else
{
vec4 l9_183;
...
vec3 l9_186=mix(l9_185,definedBlend(l9_185,l9_167.xyz).xyz,vec3(l9_167.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_189=l9_167.w;
l9_188=vec4(mix(vec3(1.0),l9_167.xyz,vec3(l9_189)),l9_189);
}
#else
{
vec4 l9_190;
...
#endif
l9_190=vec4(l9_167.xyz*l9_192,l9_192);
}
#else
{
l9_190=l9_167;
