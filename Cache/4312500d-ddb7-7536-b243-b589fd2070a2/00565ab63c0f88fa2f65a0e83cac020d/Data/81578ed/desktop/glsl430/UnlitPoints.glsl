...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N42 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N42 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 83 -1
//spec_const int Tweak_N42Layout 84 0
...
#endif
vec4 l9_53=l9_4*vec4(clamp(Port_Import_N092,0.0,5.0));
vec4 l9_54=mix(Port_Input0_N102,mix(vec4(dot(l9_53,Port_Input1_N094)),l9_53,vec4(clamp(Tweak_N2,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0)))*baseColor;
...
{
l9_60=clamp(Tweak_N41*2.0,0.0,1.0);
}
#else
{
float l9_61;
...
{
l9_61=clamp(dot(l9_55.xyz,vec3(Tweak_N41)),0.0,1.0);
}
#else
{
float l9_62;
...
{
l9_63=(1.0-dot(l9_55.xyz,vec3(0.33333001)))*Tweak_N41;
}
#else
{
float l9_64;
...
{
l9_64=(1.0-clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0))*Tweak_N41;
}
#else
{
float l9_65;
...
{
l9_65=clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0)*Tweak_N41;
}
#else
{
float l9_66;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_67=clamp(dot(l9_55.xyz,vec3(1.0)),0.0,1.0)*Tweak_N41;
}
#else
{
float l9_68;
...
{
l9_68=dot(l9_55.xyz,vec3(0.33333001))*Tweak_N41;
}
#else
{
float l9_69;
...
#endif
vec3 l9_82=mix(l9_80.xyz,definedBlend(l9_80.xyz,l9_55.xyz).xyz,vec3(Tweak_N41));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_84=vec4(mix(vec3(1.0),l9_55.xyz,vec3(Tweak_N41)),Tweak_N41);
}
#else
{
vec4 l9_85;
...
#endif
l9_85=vec4(l9_55.xyz*l9_86,l9_86);
}
#else
{
l9_85=l9_55;
