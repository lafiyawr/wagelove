...
//spec_const bool sc_ShaderComplexityAnalyzer 127 0
//spec_const bool sc_TAAEnabled 128 0
//spec_const bool sc_UseFramebufferFetchMarker 129 0
...
//spec_const int sc_StereoViewID 190 0
//SG_REFLECTION_END
...
vec3 l9_285=clamp(l9_278,vec3(0.0),vec3(1.0));
vec3 l9_286=ssSRGB_to_Linear(l9_281);
vec3 l9_287=normalize(l9_279);
vec3 l9_288=ssSRGB_to_Linear(max(l9_245,vec3(0.0)));
vec3 l9_289;
#if (sc_SSAOEnabled)
{
l9_289=evaluateSSAO(varPos);
}
#else
{
l9_289=vec3(1.0);
...
#endif
vec3 l9_290=vec3(l9_283);
vec3 l9_291=mix(vec3(0.039999999),l9_286*l9_283,l9_290);
vec3 l9_292=mix(l9_286*(1.0-l9_283),vec3(0.0),l9_290);
SurfaceProperties l9_293=SurfaceProperties(l9_292,l9_280,l9_287,varPos,l9_3,l9_283,l9_284,l9_288,l9_289,l9_285,vec3(1.0),l9_291);
vec4 l9_294=vec4(1.0);
vec3 l9_295;
vec3 l9_296;
vec3 l9_297;
vec3 l9_298;
...
l9_303=vec3(0.0);
l9_302=vec3(0.0);
LightingComponents l9_309;
LightProperties l9_310;
SurfaceProperties l9_311;
vec3 l9_312;
int l9_313=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_313<sc_DirectionalLightsCount)
{
LightingComponents l9_314=accumulateLight(LightingComponents(l9_302,l9_303,l9_308,l9_307,l9_305,l9_304),LightProperties(sc_DirectionalLights[l9_313].direction,sc_DirectionalLights[l9_313].color.xyz,sc_DirectionalLights[l9_313].color.w*l9_294[(l9_306<3) ? l9_306 : 3]),l9_293,l9_3);
l9_308=l9_314.indirectDiffuse;
l9_307=l9_314.indirectSpecular;
l9_306++;
l9_305=l9_314.emitted;
l9_304=l9_314.transmitted;
l9_303=l9_314.directSpecular;
l9_302=l9_314.directDiffuse;
l9_313++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_330<sc_PointLightsCount)
{
vec3 l9_332=sc_PointLights[l9_330].position-varPos;
vec3 l9_333=normalize(l9_332);
float l9_334=l9_294[(l9_331<3) ? l9_331 : 3];
float l9_335=clamp((dot(l9_333,sc_PointLights[l9_330].direction)*sc_PointLights[l9_330].angleScale)+sc_PointLights[l9_330].angleOffset,0.0,1.0);
float l9_336=(sc_PointLights[l9_330].color.w*l9_334)*(l9_335*l9_335);
float l9_337;
if (sc_PointLights[l9_330].falloffEnabled)
{
l9_337=l9_336*computeDistanceAttenuation(length(l9_332),sc_PointLights[l9_330].falloffEndDistance);
}
else
{
l9_337=l9_336;
...
l9_323=l9_331+1;
LightingComponents l9_338=accumulateLight(LightingComponents(l9_317,l9_318,l9_322,l9_321,l9_320,l9_319),LightProperties(l9_333,sc_PointLights[l9_330].color.xyz,l9_337),l9_293,l9_3);
l9_324=l9_338.directDiffuse;
l9_325=l9_338.directSpecular;
l9_326=l9_338.indirectDiffuse;
l9_327=l9_338.indirectSpecular;
l9_328=l9_338.emitted;
l9_329=l9_338.transmitted;
l9_322=l9_326;
l9_321=l9_327;
l9_331=l9_323;
l9_320=l9_328;
...
{
vec3 l9_344=getSpecularDominantDir(l9_287,reflect(-l9_3,l9_287),l9_284);
float l9_345=clamp(pow(l9_284,0.66666669),0.0,1.0)*5.0;
float l9_346=-l9_344.z;
float l9_347=l9_344.x;
vec2 l9_348=vec2((((l9_347<0.0) ? (-1.0) : 1.0)*acos(clamp(l9_346/length(vec2(l9_347,l9_346)),-1.0,1.0)))-1.5707964,acos(l9_344.y))/vec2(6.2831855,3.1415927);
float l9_349=l9_348.x+(sc_EnvmapRotation.y/360.0);
vec2 l9_350=vec2(l9_349,1.0-l9_348.y);
l9_350.x=fract((l9_349+floor(l9_349))+1.0);
vec4 l9_351;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_352=floor(l9_345);
float l9_353=ceil(l9_345);
l9_351=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_350,sc_EnvmapSpecularSize.xy,l9_352),sc_EnvmapSpecularGetStereoViewIndex(),l9_352),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_350,sc_EnvmapSpecularSize.xy,l9_353),sc_EnvmapSpecularGetStereoViewIndex(),l9_353),vec4(l9_345-l9_352));
}
#else
{
l9_351=sc_EnvmapSpecularSampleViewIndexLevel(l9_350,sc_EnvmapSpecularGetStereoViewIndex(),l9_345);
}
#endif
l9_343=vec3(0.0)+((((l9_351.xyz*(1.0/l9_351.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_293,abs(dot(l9_287,l9_3))));
}
#else
{
l9_343=vec3(0.0);
...
{
float l9_355=clamp(l9_284*l9_284,0.0099999998,1.0);
vec3 l9_356;
l9_356=sc_LightEstimationData.ambientLight*l9_291;
int l9_357=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_357<sc_LightEstimationSGCount)
{
float l9_358=l9_355*l9_355;
vec3 l9_359=reflect(-l9_3,l9_287);
float l9_360=dot(l9_287,l9_3);
float l9_361=(2.0/l9_358)/(4.0*max(l9_360,9.9999997e-05));
float l9_362=length((l9_359*l9_361)+(sc_LightEstimationData.sg[l9_357].axis*sc_LightEstimationData.sg[l9_357].sharpness));
float l9_363=clamp(dot(l9_287,l9_359),0.0,1.0);
float l9_364=clamp(l9_360,0.0,1.0);
float l9_365=1.0-l9_358;
l9_356+=((((((((vec3(1.0/(3.1415927*l9_358))*exp((l9_362-l9_361)-sc_LightEstimationData.sg[l9_357].sharpness))*sc_LightEstimationData.sg[l9_357].color)*6.2831855)*(1.0-exp((-2.0)*l9_362)))/vec3(l9_362))*((1.0/(l9_363+sqrt(l9_358+((l9_365*l9_363)*l9_363))))*(1.0/(l9_364+sqrt(l9_358+((l9_365*l9_364)*l9_364))))))*(l9_291+((vec3(1.0)-l9_291)*pow(1.0-clamp(dot(l9_359,normalize(l9_359+l9_3)),0.0,1.0),5.0))))*l9_363);
l9_357++;
continue;
}
else
...
{
l9_367=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_292,vec3(l9_280));
l9_366=1.0;
}
#else
{
...
#endif
vec3 l9_369=vec3(0.0)*l9_289;
vec3 l9_370=l9_292*(vec3(0.0)+l9_369);
vec3 l9_371=l9_354*l9_285;
vec3 l9_372=l9_339+l9_371;
vec3 l9_373;
if (l9_368)
{
l9_373=l9_370*srgbToLinear(l9_366);
}
else
{
l9_373=l9_370;
}
vec3 l9_374=l9_373+l9_372;
vec3 l9_375=(l9_374+l9_288)+l9_367;
float l9_376=l9_375.x;
vec4 l9_377=vec4(l9_376,l9_375.yz,l9_366);
vec4 l9_378;
#if (sc_IsEditor)
{
vec4 l9_379=l9_377;
l9_379.x=l9_376+((l9_289.x*l9_285.x)*9.9999997e-06);
l9_378=l9_379;
}
#else
{
...
{
vec3 l9_381=l9_378.xyz*1.8;
vec3 l9_382=(l9_378.xyz*(l9_381+vec3(1.4)))/((l9_378.xyz*(l9_381+vec3(0.5)))+vec3(1.5));
l9_380=vec4(l9_382.x,l9_382.y,l9_382.z,l9_378.w);
}
#else
{
l9_380=l9_378;
...
#endif
vec3 l9_383=vec3(linearToSrgb(l9_380.x),linearToSrgb(l9_380.y),linearToSrgb(l9_380.z));
l9_282=vec4(l9_383.x,l9_383.y,l9_383.z,l9_380.w);
}
#endif
vec4 l9_384=max(l9_282,vec4(0.0));
vec4 l9_385;
#if (sc_ProjectiveShadowsCaster)
{
float l9_386;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_387=clamp(l9_384.w*2.0,0.0,1.0);
}
#else
{
float l9_388;
...
{
l9_388=clamp(dot(l9_384.xyz,vec3(l9_384.w)),0.0,1.0);
}
#else
{
float l9_389;
...
#if (sc_BlendMode_Multiply)
{
l9_390=(1.0-dot(l9_384.xyz,vec3(0.33333001)))*l9_384.w;
}
#else
{
float l9_391;
...
{
l9_391=(1.0-clamp(dot(l9_384.xyz,vec3(1.0)),0.0,1.0))*l9_384.w;
}
#else
{
float l9_392;
#if (sc_BlendMode_ColoredGlass)
{
l9_392=clamp(dot(l9_384.xyz,vec3(1.0)),0.0,1.0)*l9_384.w;
}
#else
{
float l9_393;
#if (sc_BlendMode_Add)
{
l9_393=clamp(dot(l9_384.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_394;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_394=clamp(dot(l9_384.xyz,vec3(1.0)),0.0,1.0)*l9_384.w;
}
#else
{
float l9_395;
...
{
l9_395=dot(l9_384.xyz,vec3(0.33333001))*l9_384.w;
}
#else
{
float l9_396;
#if (sc_BlendMode_Min)
{
l9_396=1.0-clamp(dot(l9_384.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_397;
#if (sc_BlendMode_Max)
{
l9_397=clamp(dot(l9_384.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_397=1.0;
...
#endif
l9_385=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_384.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_386);
}
#else
{
vec4 l9_398;
...
{
vec3 l9_400=sc_GetFramebufferColor().xyz;
vec3 l9_401=mix(l9_400,definedBlend(l9_400,l9_384.xyz).xyz,vec3(l9_384.w));
vec4 l9_402=vec4(l9_401.x,l9_401.y,l9_401.z,vec4(0.0).w);
l9_402.w=1.0;
l9_399=l9_402;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_404=l9_384.w;
l9_403=vec4(mix(vec3(1.0),l9_384.xyz,vec3(l9_404)),l9_404);
}
#else
{
vec4 l9_405;
...
{
float l9_406=l9_384.w;
float l9_407;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_407=clamp(l9_406,0.0,1.0);
}
#else
{
l9_407=l9_406;
...
#endif
l9_405=vec4(l9_384.xyz*l9_407,l9_407);
}
#else
{
l9_405=l9_384;
...
{
l9_410=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_410=vec4(0.0);
...
vec4 l9_412=outputMotionVectorsIfNeeded(varPos,max(l9_411,vec4(0.0)));
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_415=sc_ScreenCoordsGlobalToView(l9_2);
...
#if (sc_OITCompositingPass)
{
vec2 l9_428=sc_ScreenCoordsGlobalToView(l9_2);
#if (sc_OITMaxLayers4Plus1)
{
