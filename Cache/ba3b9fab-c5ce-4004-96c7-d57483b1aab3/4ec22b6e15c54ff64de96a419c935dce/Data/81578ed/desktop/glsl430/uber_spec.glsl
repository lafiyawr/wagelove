...
#else
{
l9_511=ngsCalculateLighting(l9_510,l9_509,l9_508,l9_7,l9_8,max(l9_450,vec3(0.0)),clamp(l9_452,0.0,1.0),clamp(l9_454,0.0,1.0),vec3(1.0),clamp(l9_507,vec3(0.0),vec3(1.0)));
}
#endif
