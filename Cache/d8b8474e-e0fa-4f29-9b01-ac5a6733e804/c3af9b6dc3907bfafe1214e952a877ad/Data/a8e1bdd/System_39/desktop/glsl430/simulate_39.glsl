...
vec3 l9_16=l9_15;
vec4 l9_17=ssGetParticleRandom(3,true,true,true,213.0,gParticle,1.0,sc_Time.x);
vec3 l9_18=mix(Port_Min_N213,Port_Max_N213,l9_17.xyz);
vec4 l9_19=ssGetParticleRandom(1,true,true,true,254.0,gParticle,1.0,sc_Time.x);
float l9_20=mix(Port_Min_N254,Port_Max_N254,l9_19.x);
float l9_21;
if (l9_20<=0.0)
{
l9_21=0.0;
...
bool l9_23=(float(isIdle)*1.0)!=0.0;
float l9_24;
if (l9_23)
{
l9_24=Port_Input1_N021;
}
else
{
float l9_25;
...
{
l9_25=Port_Input1_N067;
}
else
{
l9_25=Port_Input2_N067;
}
l9_24=l9_25;
}
gParticle.Position=l9_16+((((l9_18/vec3(length(l9_18)))*vec3(l9_22))*vec3(l9_24))*Port_Import_N212);
...
{
vec3 l9_27;
Node148_Conditional(1.0,vec3(0.0),vec3(0.0),l9_27,l9_12);
vec3 l9_28=l9_27;
vec3 l9_29=gParticle.Position;
vec3 l9_30=l9_28-l9_29;
...
l9_26=vec3(Port_Import_N058)*(l9_30*l9_32);
}
else
{
l9_26=Port_Input2_N060;
}
gParticle.Force+=l9_26;
...
float l9_33=float(isAttracting);
float l9_34=dot(Port_Import_N081,Port_Import_N081);
float l9_35;
if (l9_34>0.0)
{
...
vec3 l9_36=Port_Import_N081*l9_35;
float l9_37=l9_36.x;
float l9_38=l9_36.y;
float l9_39=l9_36.z;
vec3 l9_40=gParticle.Position;
float l9_41=(((length(l9_40)-Port_RangeMinA_N178)/((Port_RangeMaxA_N178-Port_RangeMinA_N178)+1e-06))*(Port_RangeMaxB_N178-Port_RangeMinB_N178))+Port_RangeMinB_N178;
float l9_42;
if (Port_RangeMaxB_N178>Port_RangeMinB_N178)
{
l9_42=clamp(l9_41,Port_RangeMinB_N178,Port_RangeMaxB_N178);
}
else
{
l9_42=clamp(l9_41,Port_RangeMaxB_N178,Port_RangeMinB_N178);
}
float l9_43=cos(l9_42);
float l9_44=1.0-l9_43;
float l9_45=(l9_37*l9_38)*l9_44;
float l9_46=sin(l9_42);
float l9_47=l9_39*l9_46;
float l9_48=(l9_39*l9_37)*l9_44;
float l9_49=l9_38*l9_46;
float l9_50=(l9_38*l9_39)*l9_44;
float l9_51=l9_37*l9_46;
float l9_52=gParticle.Age;
float l9_53=gParticle.Life;
bool l9_54=(float(isIdle)*1.0)!=0.0;
float l9_55;
if (l9_54)
{
l9_55=Port_Input1_N114;
}
else
{
l9_55=Port_Input2_N114;
}
float l9_56=Port_RangeMaxB_N133-l9_55;
float l9_57=(((clamp(l9_52/l9_53,0.0,1.0)-Port_RangeMinA_N133)/((Port_RangeMaxA_N133-Port_RangeMinA_N133)+1e-06))*l9_56)+l9_55;
if (l9_33!=0.0)
{
gParticle.Force=((mat3(vec4(((l9_37*l9_37)*l9_44)+l9_43,l9_45-l9_47,l9_48+l9_49,0.0).xyz,vec4(l9_45+l9_47,((l9_38*l9_38)*l9_44)+l9_43,l9_50-l9_51,0.0).xyz,vec4(l9_48-l9_49,l9_50+l9_51,((l9_39*l9_39)*l9_44)+l9_43,0.0).xyz)*l9_40)-l9_40)*vec3(l9_57);
}
float l9_58;
if (l9_54)
{
l9_58=Port_Input1_N018;
}
else
{
float l9_59;
if ((l9_33*1.0)!=0.0)
{
l9_59=Port_Input1_N066;
}
else
{
l9_59=Port_Input2_N066;
}
l9_58=l9_59;
}
float l9_60=gParticle.Mass;
...
gParticle.Force+=(vec3(l9_61)*(l9_64*l9_66));
float l9_67;
if (l9_54)
{
l9_67=Port_Input1_N237;
}
else
{
float l9_68;
if ((l9_33*1.0)!=0.0)
{
l9_68=Port_Input1_N201;
}
else
{
l9_68=Port_Input2_N201;
}
l9_67=l9_68;
}
vec3 l9_69=vec3(l9_67);
vec3 l9_70=gParticle.Position;
vec4 l9_71;
#if (sc_CanUseTextureLod)
{
l9_71=textureLod(noiseTex,(((l9_70+Port_Import_N205)+(Port_Import_N206*vec3(l9_4*Port_Multiplier_N207)))+Port_Import_N210)*(vec3(1.0)/(Port_Import_N210*vec3(Port_Input1_N222))),0.0);
}
#else
{
l9_71=vec4(0.0);
...
#endif
gParticle.Force+=(l9_69*((l9_71*vec4(Port_Input1_N229))-vec4(1.0)).xyz);
...
if ((l9_33*1.0)!=0.0)
{
l9_73=Port_Input1_N200;
}
else
{
l9_73=Port_Input2_N200;
}
l9_72=l9_73;
}
bool l9_74=(l9_33*1.0)!=0.0;
float l9_75;
if (l9_74)
{
l9_75=Port_Input1_N063;
}
else
{
l9_75=Port_Input2_N063;
}
gParticle.Size=mix(l9_72,l9_75,clamp(gParticle.Age/gParticle.Life,0.0,1.0));
vec4 l9_76;
if (l9_54)
{
l9_76=vec4(Port_Input1_N008);
}
else
{
vec4 l9_77;
if (l9_74)
{
l9_77=Port_Input1_N065;
}
else
{
vec4 l9_78=ssGetParticleRandom(1,false,true,true,19.0,gParticle,1.0,sc_Time.x);
float l9_79=mix(Port_Min_N019,Port_Max_N019,l9_78.x);
vec3 l9_80=gParticle.Position;
float l9_81=clamp(clamp(((l9_79*Port_Input1_N166)+((distance(influencePosition,l9_80)*Port_Input1_N164)*l9_79))+0.001,Port_Input1_N165+0.001,Port_Input2_N165+0.001)-0.001,0.0,1.0);
vec4 l9_82;
if (l9_81<Port_Position1_N172)
{
l9_82=mix(colorA,colorB,vec4(clamp(l9_81/Port_Position1_N172,0.0,1.0)));
}
else
{
vec4 l9_83;
if (l9_81<Port_Position2_N172)
{
l9_83=mix(colorB,colorC,vec4(clamp((l9_81-Port_Position1_N172)/(Port_Position2_N172-Port_Position1_N172),0.0,1.0)));
}
else
{
vec4 l9_84;
if (l9_81<Port_Position3_N172)
{
l9_84=mix(colorC,colorD,vec4(clamp((l9_81-Port_Position2_N172)/(Port_Position3_N172-Port_Position2_N172),0.0,1.0)));
}
else
{
l9_84=mix(colorD,colorE,vec4(clamp((l9_81-Port_Position3_N172)/(1.0-Port_Position3_N172),0.0,1.0)));
}
l9_83=l9_84;
}
l9_82=l9_83;
...
gParticle.Color=l9_76;
vec4 l9_85=gParticle.Color;
float l9_86=gParticle.Age;
float l9_87=gParticle.Life;
float l9_88=clamp(l9_86/l9_87,0.0,1.0);
float l9_89;
if (l9_74)
{
l9_89=Port_Input1_N266;
}
else
{
l9_89=Port_Input2_N266;
}
vec4 l9_90=vec4(l9_85.x,l9_85.y,l9_85.z,vec4(0.0).w);
l9_90.w=mix(Port_Import_N079,Port_Import_N091,(clamp((l9_88*(Port_Input0_N143/(l9_89/gParticle.Life)))+0.001,Port_Input1_N182+0.001,Port_Input2_N182+0.001)-0.001)*(clamp(((1.0-l9_88)*(Port_Input0_N193/(Port_Import_N188/gParticle.Life)))+0.001,Port_Input1_N236+0.001,Port_Input2_N236+0.001)-0.001));
gParticle.Color=l9_90;
...
{
l9_91=gParticle.Force.x;
}
gParticle.Force.x=l9_91;
float l9_92;
...
{
l9_92=gParticle.Force.y;
}
gParticle.Force.y=l9_92;
float l9_93;
...
{
l9_93=gParticle.Force.z;
}
gParticle.Force.z=l9_93;
...
{
l9_94=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_94;
float l9_95;
...
{
l9_95=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_95;
float l9_96;
...
{
l9_96=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_96;
gParticle.Position+=(gParticle.Velocity*l9_2);
vec2 l9_97=vec2(4.0,1.0)/vec2(2048.0,vfxTargetSizeWrite.y);
int l9_98=vfxOffsetInstancesWrite+sc_GetLocalInstanceID();
float l9_99;
if (texture0.x<0.5)
{
l9_99=0.0;
...
sc_SetClipPosition(vec4(((vec2(l9_99,l9_100)+(vec2(float(l9_98%512),float(l9_98/512))*l9_97))*2.0)-vec2(1.0),1.0,1.0));
