...
#if (sc_CanUseTextureLod)
{
l9_71=texture3DLod(noiseTex,(((l9_70+Port_Import_N205)+(Port_Import_N206*vec3(l9_4*Port_Multiplier_N207)))+Port_Import_N210)*(vec3(1.0)/(Port_Import_N210*vec3(Port_Input1_N222))),0.0);
}
#else
{
l9_71=vec4(0.0);
