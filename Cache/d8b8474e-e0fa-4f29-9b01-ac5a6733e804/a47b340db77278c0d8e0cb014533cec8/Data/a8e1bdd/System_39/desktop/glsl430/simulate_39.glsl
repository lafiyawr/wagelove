...
//texture texture2DArray renderTarget0ArrSC 0:34:0:22
//texture texture2DArray renderTarget1ArrSC 0:35:0:23
//texture texture2DArray renderTarget2ArrSC 0:36:0:24
//texture texture2DArray renderTarget3ArrSC 0:37:0:25
...
vec4 l9_12=renderTarget0SampleViewIndexBias(l9_11,renderTarget0GetStereoViewIndex(),0.0);
bool l9_13=dot(abs(l9_12),vec4(1.0))<9.9999997e-06;
bool l9_14;
if (!l9_13)
{
l9_14=!vfxBatchEnable[sc_GetLocalInstanceID()/1000];
}
else
{
l9_14=l9_13;
...
float l9_15=1000.0-(-1000.0);
float l9_16=0.99998999-0.0;
gParticle.Position.x=(-1000.0)+(((DecodeFloat32(l9_12,true)-0.0)*l9_15)/l9_16);
gParticle.Position.y=(-1000.0)+(((DecodeFloat32(renderTarget1SampleViewIndexBias(l9_11,renderTarget1GetStereoViewIndex(),0.0),true)-0.0)*l9_15)/l9_16);
gParticle.Position.z=(-1000.0)+(((DecodeFloat32(renderTarget2SampleViewIndexBias(l9_11,renderTarget2GetStereoViewIndex(),0.0),true)-0.0)*l9_15)/l9_16);
gParticle.Velocity.x=(-1000.0)+(((DecodeFloat32(renderTarget3SampleViewIndexBias(l9_11,renderTarget3GetStereoViewIndex(),0.0),true)-0.0)*l9_15)/l9_16);
vec2 l9_17=l9_10+vec2(0.00048828125,0.0);
gParticle.Velocity.y=(-1000.0)+(((DecodeFloat32(renderTarget0SampleViewIndexBias(l9_17,renderTarget0GetStereoViewIndex(),0.0),true)-0.0)*l9_15)/l9_16);
gParticle.Velocity.z=(-1000.0)+(((DecodeFloat32(renderTarget1SampleViewIndexBias(l9_17,renderTarget1GetStereoViewIndex(),0.0),true)-0.0)*l9_15)/l9_16);
float l9_18=8.0-0.0;
gParticle.Life=0.0+(((DecodeFloat32(renderTarget2SampleViewIndexBias(l9_17,renderTarget2GetStereoViewIndex(),0.0),true)-0.0)*l9_18)/l9_16);
gParticle.Age=0.0+(((DecodeFloat32(renderTarget3SampleViewIndexBias(l9_17,renderTarget3GetStereoViewIndex(),0.0),true)-0.0)*l9_18)/l9_16);
vec2 l9_19=l9_10+vec2(0.0009765625,0.0);
gParticle.Size=0.0+(((DecodeFloat32(renderTarget0SampleViewIndexBias(l9_19,renderTarget0GetStereoViewIndex(),0.0),true)-0.0)*(100.0-0.0))/l9_16);
float l9_20=1.00001-0.0;
gParticle.Color.x=0.0+(((DecodeFloat32(renderTarget1SampleViewIndexBias(l9_19,renderTarget1GetStereoViewIndex(),0.0),true)-0.0)*l9_20)/l9_16);
gParticle.Color.y=0.0+(((DecodeFloat32(renderTarget2SampleViewIndexBias(l9_19,renderTarget2GetStereoViewIndex(),0.0),true)-0.0)*l9_20)/l9_16);
gParticle.Color.z=0.0+(((DecodeFloat32(renderTarget3SampleViewIndexBias(l9_19,renderTarget3GetStereoViewIndex(),0.0),true)-0.0)*l9_20)/l9_16);
vec2 l9_21=l9_10+vec2(0.0014648438,0.0);
vec4 l9_22=renderTarget2SampleViewIndexBias(l9_21,renderTarget2GetStereoViewIndex(),0.0);
vec4 l9_23=renderTarget3SampleViewIndexBias(l9_21,renderTarget3GetStereoViewIndex(),0.0);
gParticle.Color.w=0.0+(((DecodeFloat32(renderTarget0SampleViewIndexBias(l9_21,renderTarget0GetStereoViewIndex(),0.0),true)-0.0)*l9_20)/l9_16);
gParticle.Mass=0.0+(((DecodeFloat32(renderTarget1SampleViewIndexBias(l9_21,renderTarget1GetStereoViewIndex(),0.0),true)-0.0)*(1000.0-0.0))/l9_16);
float l9_24=1.0-(-1.0);
gParticle.Quaternion.x=(-1.0)+(((DecodeFloat16(vec2(l9_22.xy),true)-0.0)*l9_24)/l9_16);
gParticle.Quaternion.y=(-1.0)+(((DecodeFloat16(vec2(l9_22.zw),true)-0.0)*l9_24)/l9_16);
gParticle.Quaternion.z=(-1.0)+(((DecodeFloat16(vec2(l9_23.xy),true)-0.0)*l9_24)/l9_16);
gParticle.Quaternion.w=(-1.0)+(((DecodeFloat16(vec2(l9_23.zw),true)-0.0)*l9_24)/l9_16);
vec4 l9_25=normalize(gParticle.Quaternion.yzwx);
float l9_26=l9_25.x;
...
float l9_32=l9_26*l9_30;
float l9_33=l9_26*l9_28;
float l9_34=l9_28*l9_30;
float l9_35=l9_25.w;
float l9_36=l9_35*l9_26;
float l9_37=l9_35*l9_28;
float l9_38=l9_35*l9_30;
gParticle.Matrix=mat3(vec3(1.0-(2.0*(l9_29+l9_31)),2.0*(l9_33+l9_38),2.0*(l9_32-l9_37)),vec3(2.0*(l9_33-l9_38),1.0-(2.0*(l9_27+l9_31)),2.0*(l9_34+l9_36)),vec3(2.0*(l9_32+l9_37),2.0*(l9_34-l9_36),1.0-(2.0*(l9_27+l9_29))));
...
int l9_1=sc_GetLocalInstanceID()/1000;
...
{
ssGlobals l9_5=ssGlobals(sc_Time.x,l9_2,l9_4,overrideTimeElapsed[l9_1]);
ssCalculateParticleSeed(gParticle,int(gParticle.CopyId));
float l9_7=floor(31.0);
gParticle.Position=(vec3(((floor(mod(gParticle.Index1DPerCopyF,l9_7))/31.0)*2.0)-1.0,((floor(gParticle.Index1DPerCopyF/l9_7)/31.0)*2.0)-1.0,0.0)*20.0)+vec3(1.0,1.0,0.0);
gParticle.Velocity=vec3(0.0);
...
gParticle.Quaternion=vec4(0.0,0.0,0.0,1.0);
vec3 l9_8;
Node148_Conditional(1.0,vec3(0.0),vec3(0.0),l9_8,l9_5);
vec3 l9_9=l9_8;
vec4 l9_10=ssGetParticleRandom(3,true,true,true,213.0,gParticle,1.0,sc_Time.x);
vec3 l9_11=mix(Port_Min_N213,Port_Max_N213,l9_10.xyz);
vec4 l9_12=ssGetParticleRandom(1,true,true,true,254.0,gParticle,1.0,sc_Time.x);
float l9_13=mix(Port_Min_N254,Port_Max_N254,l9_12.x);
float l9_14;
if (l9_13<=0.0)
{
l9_14=0.0;
...
bool l9_16=(float(isIdle)*1.0)!=0.0;
float l9_17;
if (l9_16)
{
l9_17=Port_Input1_N021;
}
else
{
float l9_18;
...
{
l9_18=Port_Input1_N067;
}
else
{
l9_18=Port_Input2_N067;
}
l9_17=l9_18;
}
gParticle.Position=l9_9+((((l9_11/vec3(length(l9_11)))*vec3(l9_15))*vec3(l9_17))*Port_Import_N212);
gParticle.Velocity+=mix(Port_Import_N075,Port_Import_N076,ssGetParticleRandom(3,true,true,true,77.0,gParticle,1.0,sc_Time.x).xyz);
vec3 l9_19;
if (l9_16)
{
vec3 l9_20;
Node148_Conditional(1.0,vec3(0.0),vec3(0.0),l9_20,l9_5);
vec3 l9_21=l9_20;
vec3 l9_22=gParticle.Position;
vec3 l9_23=l9_21-l9_22;
...
l9_19=vec3(Port_Import_N058)*(l9_23*l9_25);
}
else
{
l9_19=Port_Input2_N060;
}
gParticle.Force+=l9_19;
gParticle.Mass=mix(Port_Import_N099,Port_Import_N109,ssGetParticleRandom(1,true,true,true,110.0,gParticle,1.0,sc_Time.x).x);
...
float l9_26=float(isAttracting);
float l9_27=dot(Port_Import_N081,Port_Import_N081);
float l9_28;
if (l9_27>0.0)
{
...
vec3 l9_29=Port_Import_N081*l9_28;
float l9_30=l9_29.x;
float l9_31=l9_29.y;
float l9_32=l9_29.z;
vec3 l9_33=gParticle.Position;
float l9_34=(((length(l9_33)-Port_RangeMinA_N178)/((Port_RangeMaxA_N178-Port_RangeMinA_N178)+1e-06))*(Port_RangeMaxB_N178-Port_RangeMinB_N178))+Port_RangeMinB_N178;
float l9_35;
if (Port_RangeMaxB_N178>Port_RangeMinB_N178)
{
l9_35=clamp(l9_34,Port_RangeMinB_N178,Port_RangeMaxB_N178);
}
else
{
l9_35=clamp(l9_34,Port_RangeMaxB_N178,Port_RangeMinB_N178);
}
float l9_36=cos(l9_35);
float l9_37=1.0-l9_36;
float l9_38=(l9_30*l9_31)*l9_37;
float l9_39=sin(l9_35);
float l9_40=l9_32*l9_39;
float l9_41=(l9_32*l9_30)*l9_37;
float l9_42=l9_31*l9_39;
float l9_43=(l9_31*l9_32)*l9_37;
float l9_44=l9_30*l9_39;
float l9_45=gParticle.Age;
float l9_46=gParticle.Life;
bool l9_47=(float(isIdle)*1.0)!=0.0;
float l9_48;
if (l9_47)
{
l9_48=Port_Input1_N114;
}
else
{
l9_48=Port_Input2_N114;
}
float l9_49=Port_RangeMaxB_N133-l9_48;
float l9_50=(((clamp(l9_45/l9_46,0.0,1.0)-Port_RangeMinA_N133)/((Port_RangeMaxA_N133-Port_RangeMinA_N133)+1e-06))*l9_49)+l9_48;
if (l9_26!=0.0)
{
gParticle.Force=((mat3(vec4(((l9_30*l9_30)*l9_37)+l9_36,l9_38-l9_40,l9_41+l9_42,0.0).xyz,vec4(l9_38+l9_40,((l9_31*l9_31)*l9_37)+l9_36,l9_43-l9_44,0.0).xyz,vec4(l9_41-l9_42,l9_43+l9_44,((l9_32*l9_32)*l9_37)+l9_36,0.0).xyz)*l9_33)-l9_33)*vec3(l9_50);
}
float l9_51;
if (l9_47)
{
l9_51=Port_Input1_N018;
}
else
{
float l9_52;
if ((l9_26*1.0)!=0.0)
{
l9_52=Port_Input1_N066;
}
else
{
l9_52=Port_Input2_N066;
}
l9_51=l9_52;
}
float l9_53=gParticle.Mass;
float l9_54=l9_51*l9_53;
vec3 param_5;
Node148_Conditional(1.0,vec3(0.0),vec3(0.0),param_5,ssGlobals(sc_Time.x,l9_2,l9_4,overrideTimeElapsed[l9_1]));
vec3 l9_55=param_5;
vec3 l9_56=gParticle.Position;
vec3 l9_57=l9_55-l9_56;
...
gParticle.Force+=(vec3(l9_54)*(l9_57*l9_59));
float l9_60;
if (l9_47)
{
l9_60=Port_Input1_N237;
}
else
{
float l9_61;
if ((l9_26*1.0)!=0.0)
{
l9_61=Port_Input1_N201;
}
else
{
l9_61=Port_Input2_N201;
}
l9_60=l9_61;
}
vec3 l9_62=vec3(l9_60);
vec3 l9_63=gParticle.Position;
vec4 l9_64;
#if (sc_CanUseTextureLod)
{
l9_64=textureLod(noiseTex,(((l9_63+Port_Import_N205)+(Port_Import_N206*vec3(l9_4*Port_Multiplier_N207)))+Port_Import_N210)*(vec3(1.0)/(Port_Import_N210*vec3(Port_Input1_N222))),0.0);
}
#else
{
l9_64=vec4(0.0);
...
#endif
gParticle.Force+=(l9_62*((l9_64*vec4(Port_Input1_N229))-vec4(1.0)).xyz);
...
if ((l9_26*1.0)!=0.0)
{
l9_66=Port_Input1_N200;
}
else
{
l9_66=Port_Input2_N200;
}
l9_65=l9_66;
}
bool l9_67=(l9_26*1.0)!=0.0;
float l9_68;
if (l9_67)
{
l9_68=Port_Input1_N063;
}
else
{
l9_68=Port_Input2_N063;
}
gParticle.Size=mix(l9_65,l9_68,clamp(gParticle.Age/gParticle.Life,0.0,1.0));
vec4 l9_69;
if (l9_47)
{
l9_69=vec4(Port_Input1_N008);
}
else
{
vec4 l9_70;
if (l9_67)
{
l9_70=Port_Input1_N065;
}
else
{
vec4 l9_71=ssGetParticleRandom(1,false,true,true,19.0,gParticle,1.0,sc_Time.x);
float l9_72=mix(Port_Min_N019,Port_Max_N019,l9_71.x);
vec3 l9_73=gParticle.Position;
float l9_74=clamp(clamp(((l9_72*Port_Input1_N166)+((distance(influencePosition,l9_73)*Port_Input1_N164)*l9_72))+0.001,Port_Input1_N165+0.001,Port_Input2_N165+0.001)-0.001,0.0,1.0);
vec4 l9_75;
if (l9_74<Port_Position1_N172)
{
l9_75=mix(colorA,colorB,vec4(clamp(l9_74/Port_Position1_N172,0.0,1.0)));
}
else
{
vec4 l9_76;
if (l9_74<Port_Position2_N172)
{
l9_76=mix(colorB,colorC,vec4(clamp((l9_74-Port_Position1_N172)/(Port_Position2_N172-Port_Position1_N172),0.0,1.0)));
}
else
{
vec4 l9_77;
if (l9_74<Port_Position3_N172)
{
l9_77=mix(colorC,colorD,vec4(clamp((l9_74-Port_Position2_N172)/(Port_Position3_N172-Port_Position2_N172),0.0,1.0)));
}
else
{
l9_77=mix(colorD,colorE,vec4(clamp((l9_74-Port_Position3_N172)/(1.0-Port_Position3_N172),0.0,1.0)));
}
l9_76=l9_77;
}
l9_75=l9_76;
...
gParticle.Color=l9_69;
vec4 l9_78=gParticle.Color;
float l9_79=gParticle.Age;
float l9_80=gParticle.Life;
float l9_81=clamp(l9_79/l9_80,0.0,1.0);
float l9_82;
if (l9_67)
{
l9_82=Port_Input1_N266;
}
else
{
l9_82=Port_Input2_N266;
}
vec4 l9_83=vec4(l9_78.x,l9_78.y,l9_78.z,vec4(0.0).w);
l9_83.w=mix(Port_Import_N079,Port_Import_N091,(clamp((l9_81*(Port_Input0_N143/(l9_82/gParticle.Life)))+0.001,Port_Input1_N182+0.001,Port_Input2_N182+0.001)-0.001)*(clamp(((1.0-l9_81)*(Port_Input0_N193/(Port_Import_N188/gParticle.Life)))+0.001,Port_Input1_N236+0.001,Port_Input2_N236+0.001)-0.001));
...
{
l9_84=gParticle.Force.x;
}
gParticle.Force.x=l9_84;
float l9_85;
...
{
l9_85=gParticle.Force.y;
}
gParticle.Force.y=l9_85;
float l9_86;
...
{
l9_86=gParticle.Force.z;
}
gParticle.Force.z=l9_86;
...
{
l9_87=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_87;
float l9_88;
...
{
l9_88=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_88;
float l9_89;
...
{
l9_89=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_89;
gParticle.Position+=(gParticle.Velocity*l9_2);
vec2 l9_90=vec2(4.0,1.0)/vec2(2048.0,vfxTargetSizeWrite.y);
int l9_91=vfxOffsetInstancesWrite+sc_GetLocalInstanceID();
float l9_92;
if (texture0.x<0.5)
{
l9_92=0.0;
...
sc_SetClipPosition(vec4(((vec2(l9_92,l9_93)+(vec2(float(l9_91%512),float(l9_91/512))*l9_90))*2.0)-vec2(1.0),1.0,1.0));
