...
ivec2 l9_12=ivec2(l9_9%512,l9_9/512);
float l9_13=float(l9_9);
vec2 l9_14=vec2(l9_12);
float l9_15=l9_13/999.0;
gParticle=ssParticle(gParticle.Position,gParticle.Velocity,gParticle.Color,gParticle.Size,gParticle.Age,gParticle.Life,gParticle.Mass,gParticle.Matrix,false,gParticle.Quaternion,gParticle.SpawnIndex,gParticle.SpawnIndexRemainder,gParticle.NextBurstTime,0.0,(l9_15*0.97637898)+0.151235,(vec2(ivec2(l9_9%400,l9_9/400))+vec2(1.0))/vec2(399.0),0.0,l9_9,l9_10,l9_11,(1000*((l9_9/1000)+1))-1,(l9_13+0.5)/1000.0,l9_15,l9_11/999.0,l9_12,(l9_14+vec2(0.5))/vec2(512.0,2.0),l9_14/vec2(511.0,1.0),vec3(0.0),false,gParticle.CopyId,gParticle.SpawnAmount,gParticle.BurstAmount,gParticle.BurstPeriod);
float l9_16=gParticle.TimeShift;
ssGlobals l9_17=ssGlobals(sc_Time.x,l9_4,(sc_Time.x-(l9_16*l9_4))-0.0,vec3(0.0),l9_5,varPos,l9_6,l9_7,l9_8,varPackedTex.xy,overrideTimeElapsed[int(Interp_Particle_Index/1000.0)]);
vec4 l9_18;
...
l9_59.z=l9_58;
l9_27=max(ngsCalculateLighting(max(l9_36.xyz,vec3(0.0)),clamp(l9_51,0.0,1.0),mat3(l9_6,l9_8,l9_7)*mix(Port_Input0_N038,l9_59,vec3(float(distance(varPackedTex.xy,Port_Input1_N035)<Port_Input1_N036))),varPos,l9_5,Port_Emissive_N258,Port_Metallic_N258,Port_Roughness_N258,Port_AO_N258,Port_SpecularAO_N258),vec4(0.0));
}
l9_18=l9_27;
}
vec4 l9_60;
