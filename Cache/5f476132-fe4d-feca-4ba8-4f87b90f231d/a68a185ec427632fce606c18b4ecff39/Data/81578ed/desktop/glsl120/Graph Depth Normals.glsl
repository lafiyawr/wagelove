...
//sampler sampler depthTextureSmpSC 0:16
...
//texture texture2D depthTexture 0:0:0:16
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_depthTexture 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_depthTexture 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 82 -1
//spec_const int depthTextureLayout 83 0
...
#endif
bool l9_3=(int(SC_USE_CLAMP_TO_BORDER_depthTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_depthTexture)!=0));
float l9_4=l9_1.x;
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture).x);
float l9_5=l9_4;
float l9_6=l9_1.y;
sc_SoftwareWrapEarly(l9_6,ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture).y);
float l9_7=l9_6;
vec2 l9_8;
float l9_9;
...
{
l9_10=ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture).x==3;
}
#else
{
l9_10=(int(SC_USE_CLAMP_TO_BORDER_depthTexture)!=0);
}
#endif
float l9_11=l9_5;
float l9_12=1.0;
sc_ClampUV(l9_11,depthTextureUvMinMax.x,depthTextureUvMinMax.z,l9_10,l9_12);
float l9_13=l9_11;
float l9_14=l9_12;
bool l9_15;
#if (SC_USE_CLAMP_TO_BORDER_depthTexture)
{
l9_15=ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture).y==3;
}
#else
{
l9_15=(int(SC_USE_CLAMP_TO_BORDER_depthTexture)!=0);
}
#endif
float l9_16=l9_7;
float l9_17=l9_14;
sc_ClampUV(l9_16,depthTextureUvMinMax.y,depthTextureUvMinMax.w,l9_15,l9_17);
l9_9=l9_17;
...
#endif
vec2 l9_18=sc_TransformUV(l9_8,(int(SC_USE_UV_TRANSFORM_depthTexture)!=0),depthTextureTransform);
float l9_19=l9_18.x;
float l9_20=l9_9;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture).x,l9_3,l9_20);
float l9_21=l9_18.y;
float l9_22=l9_20;
sc_SoftwareWrapLate(l9_21,ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture).y,l9_3,l9_22);
float l9_23=l9_22;
vec3 l9_24=sc_SamplingCoordsViewToGlobal(vec2(l9_19,l9_21),depthTextureLayout,l9_2);
vec4 l9_25=texture2D(depthTexture,l9_24.xy,0.0);
vec4 l9_26;
#if (SC_USE_CLAMP_TO_BORDER_depthTexture)
{
l9_26=mix(depthTextureBorderColor,l9_25,vec4(l9_23));
}
#else
{
l9_26=l9_25;
...
#endif
float l9_27=(l9_26.x*2.0)-1.0;
float l9_28;
if (depthTextureProjectionMatrixTerms.z==0.0)
{
l9_28=(l9_27-depthTextureProjectionMatrixTerms.y)/depthTextureProjectionMatrixTerms.x;
}
else
{
l9_28=depthTextureProjectionMatrixTerms.y/((-l9_27)-depthTextureProjectionMatrixTerms.x);
}
vec2 l9_29=vec2(-l9_28)*(l9_1-Port_Input1_N160);
vec4 l9_30=vec4(l9_29.x,l9_29.y,vec4(0.0).z,vec4(0.0).w);
l9_30.z=l9_28;
vec4 l9_31=l9_30;
l9_31.w=Port_Value3_N163;
vec4 l9_32=sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()]*l9_31;
vec4 l9_33=dFdx(l9_32);
vec4 l9_34=dFdy(l9_32);
vec3 l9_35=cross(l9_33.xyz,l9_34.xyz);
...
vec4 l9_39=vec4((((l9_38-vec3(Port_RangeMinA_N006))/vec3((Port_RangeMaxA_N006-Port_RangeMinA_N006)+1e-06))*(Port_RangeMaxB_N006-Port_RangeMinB_N006))+vec3(Port_RangeMinB_N006),0.0);
...
{
l9_45=(1.0-dot(l9_39.xyz,vec3(0.33333001)))*0.0;
}
#else
{
float l9_46;
...
{
l9_46=(1.0-clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0))*0.0;
}
#else
{
float l9_47;
...
{
l9_47=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0)*0.0;
}
#else
{
float l9_48;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_49=clamp(dot(l9_39.xyz,vec3(1.0)),0.0,1.0)*0.0;
}
#else
{
float l9_50;
...
{
l9_50=dot(l9_39.xyz,vec3(0.33333001))*0.0;
}
#else
{
float l9_51;
...
#endif
vec4 l9_63=vec4(l9_61.x,l9_61.y,l9_61.z,vec4(0.0).w);
l9_63.w=1.0;
l9_54=l9_63;
}
#else
