...
//sampler sampler depthTextureSmpSC 0:21
...
//texture texture2D depthTexture 0:3:0:21
...
//texture texture2DArray depthTextureArrSC 0:32:0:21
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_depthTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_depthTexture 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 83 -1
//spec_const int depthTextureLayout 84 0
...
uniform vec2 Port_Input1_N160;
uniform float Port_Value3_N163;
...
{
bool l9_4=(int(SC_USE_CLAMP_TO_BORDER_depthTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_depthTexture)!=0));
float l9_5=l9_0.x;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture).x);
float l9_6=l9_5;
float l9_7=l9_0.y;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture).y);
float l9_8=l9_7;
vec2 l9_9;
float l9_10;
...
{
l9_11=ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture).x==3;
}
#else
{
l9_11=(int(SC_USE_CLAMP_TO_BORDER_depthTexture)!=0);
}
#endif
float l9_12=l9_6;
float l9_13=1.0;
sc_ClampUV(l9_12,depthTextureUvMinMax.x,depthTextureUvMinMax.z,l9_11,l9_13);
float l9_14=l9_12;
float l9_15=l9_13;
bool l9_16;
#if (SC_USE_CLAMP_TO_BORDER_depthTexture)
{
l9_16=ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture).y==3;
}
#else
{
l9_16=(int(SC_USE_CLAMP_TO_BORDER_depthTexture)!=0);
}
#endif
float l9_17=l9_8;
float l9_18=l9_15;
sc_ClampUV(l9_17,depthTextureUvMinMax.y,depthTextureUvMinMax.w,l9_16,l9_18);
l9_10=l9_18;
...
#endif
vec2 l9_19=sc_TransformUV(l9_9,(int(SC_USE_UV_TRANSFORM_depthTexture)!=0),depthTextureTransform);
float l9_20=l9_19.x;
float l9_21=l9_10;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture).x,l9_4,l9_21);
float l9_22=l9_19.y;
float l9_23=l9_21;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture).y,l9_4,l9_23);
float l9_24=l9_23;
vec3 l9_25=sc_SamplingCoordsViewToGlobal(vec2(l9_20,l9_22),depthTextureLayout,depthTextureGetStereoViewIndex());
vec4 l9_26=texture(depthTextureArrSC,l9_25,0.0);
vec4 l9_27;
#if (SC_USE_CLAMP_TO_BORDER_depthTexture)
{
l9_27=mix(depthTextureBorderColor,l9_26,vec4(l9_24));
}
#else
{
l9_27=l9_26;
...
#else
{
bool l9_28=(int(SC_USE_CLAMP_TO_BORDER_depthTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_depthTexture)!=0));
float l9_29=l9_0.x;
sc_SoftwareWrapEarly(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture).x);
float l9_30=l9_29;
float l9_31=l9_0.y;
sc_SoftwareWrapEarly(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture).y);
float l9_32=l9_31;
vec2 l9_33;
float l9_34;
#if (SC_USE_UV_MIN_MAX_depthTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_depthTexture)
{
l9_35=ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture).x==3;
}
#else
{
l9_35=(int(SC_USE_CLAMP_TO_BORDER_depthTexture)!=0);
}
#endif
float l9_36=l9_30;
float l9_37=1.0;
sc_ClampUV(l9_36,depthTextureUvMinMax.x,depthTextureUvMinMax.z,l9_35,l9_37);
float l9_38=l9_36;
float l9_39=l9_37;
bool l9_40;
#if (SC_USE_CLAMP_TO_BORDER_depthTexture)
{
l9_40=ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture).y==3;
}
#else
{
l9_40=(int(SC_USE_CLAMP_TO_BORDER_depthTexture)!=0);
}
#endif
float l9_41=l9_32;
float l9_42=l9_39;
sc_ClampUV(l9_41,depthTextureUvMinMax.y,depthTextureUvMinMax.w,l9_40,l9_42);
l9_34=l9_42;
...
#endif
vec2 l9_43=sc_TransformUV(l9_33,(int(SC_USE_UV_TRANSFORM_depthTexture)!=0),depthTextureTransform);
float l9_44=l9_43.x;
float l9_45=l9_34;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture).x,l9_28,l9_45);
float l9_46=l9_43.y;
float l9_47=l9_45;
sc_SoftwareWrapLate(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_depthTexture,SC_SOFTWARE_WRAP_MODE_V_depthTexture).y,l9_28,l9_47);
float l9_48=l9_47;
vec3 l9_49=sc_SamplingCoordsViewToGlobal(vec2(l9_44,l9_46),depthTextureLayout,depthTextureGetStereoViewIndex());
vec4 l9_50=texture(depthTexture,l9_49.xy,0.0);
vec4 l9_51;
#if (SC_USE_CLAMP_TO_BORDER_depthTexture)
{
l9_51=mix(depthTextureBorderColor,l9_50,vec4(l9_48));
}
#else
{
l9_51=l9_50;
...
#endif
float l9_52=(l9_3.x*2.0)-1.0;
float l9_53;
if (depthTextureProjectionMatrixTerms.z==0.0)
{
l9_53=(l9_52-depthTextureProjectionMatrixTerms.y)/depthTextureProjectionMatrixTerms.x;
}
else
{
l9_53=depthTextureProjectionMatrixTerms.y/((-l9_52)-depthTextureProjectionMatrixTerms.x);
}
vec2 l9_54=vec2(-l9_53)*(l9_0-Port_Input1_N160);
vec4 l9_55=vec4(l9_54.x,l9_54.y,vec4(0.0).z,vec4(0.0).w);
l9_55.z=l9_53;
vec4 l9_56=l9_55;
l9_56.w=Port_Value3_N163;
vec4 l9_57=sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()]*l9_56;
vec4 l9_58=dFdx(l9_57);
vec4 l9_59=dFdy(l9_57);
vec3 l9_60=cross(l9_58.xyz,l9_59.xyz);
...
vec4 l9_64=vec4((((l9_63-vec3(Port_RangeMinA_N006))/vec3((Port_RangeMaxA_N006-Port_RangeMinA_N006)+1e-06))*(Port_RangeMaxB_N006-Port_RangeMinB_N006))+vec3(Port_RangeMinB_N006),0.0);
...
{
l9_72=(1.0-dot(l9_64.xyz,vec3(0.33333001)))*0.0;
}
#else
{
float l9_73;
...
{
l9_73=(1.0-clamp(dot(l9_64.xyz,vec3(1.0)),0.0,1.0))*0.0;
}
#else
{
float l9_74;
...
{
l9_74=clamp(dot(l9_64.xyz,vec3(1.0)),0.0,1.0)*0.0;
}
#else
{
float l9_75;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_76=clamp(dot(l9_64.xyz,vec3(1.0)),0.0,1.0)*0.0;
}
#else
{
float l9_77;
...
{
l9_77=dot(l9_64.xyz,vec3(0.33333001))*0.0;
}
#else
{
float l9_78;
...
#endif
vec4 l9_91=vec4(l9_89.x,l9_89.y,l9_89.z,vec4(0.0).w);
l9_91.w=1.0;
l9_81=l9_91;
}
#else
