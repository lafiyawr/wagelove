...
uniform float Port_Min_N020;
uniform float Port_Max_N020;
...
uniform vec3 Port_Import_N026;
uniform vec3 Port_Import_N029;
uniform vec3 Port_Import_N030;
uniform float Port_Multiplier_N031;
uniform vec3 Port_Import_N143;
uniform float Port_Input1_N145;
uniform float Port_Input1_N149;
uniform float Port_Import_N161;
...
uniform float Port_Input0_N164;
...
if (!l9_14)
{
l9_15=!vfxBatchEnable[sc_GetLocalInstanceID()/140];
}
else
{
l9_15=l9_14;
...
void Node91_Particle_Random(vec3 Min,vec3 Max,out vec3 Random,ssGlobals Globals)
{
Random=mix(Min,Max,ssGetParticleRandom(3,true,true,true,91.0,gParticle,0.0,Globals.gTimeElapsed).xyz);
}
void Node94_Particle_Random(vec3 Min,vec3 Max,out vec3 Random,ssGlobals Globals)
{
Random=mix(Min,Max,ssGetParticleRandom(3,true,true,true,94.0,gParticle,0.0,Globals.gTimeElapsed).xyz);
}
...
void Node20_Particle_Random(float Min,float Max,out float Random,ssGlobals Globals)
{
Random=mix(Min,Max,ssGetParticleRandom(1,false,true,true,20.0,gParticle,0.0,Globals.gTimeElapsed).x);
}
void Node19_Particle_Random(float Min,float Max,out float Random,ssGlobals Globals)
{
Random=mix(Min,Max,ssGetParticleRandom(1,false,true,true,19.0,gParticle,0.0,Globals.gTimeElapsed).x);
}
...
if (!l9_10)
{
l9_11=mod(((max(sc_Time.x,0.1)-gParticle.SpawnOffset)-0.0)+0.0,2.0)<=l9_2;
}
else
{
l9_11=l9_10;
...
float l9_14=floor(11.0);
gParticle.Position=(vec3(((floor(mod(gParticle.Index1DPerCopyF,l9_14))/11.0)*2.0)-1.0,((floor(gParticle.Index1DPerCopyF/l9_14)/11.0)*2.0)-1.0,0.0)*20.0)+vec3(1.0,1.0,0.0);
gParticle.Velocity=vec3(0.0);
...
gParticle.Quaternion=vec4(0.0,0.0,0.0,1.0);
float l9_15;
if ((float(0.0==Port_Input1_N090)*1.0)!=0.0)
{
vec3 l9_16;
Node91_Particle_Random(Port_Min_N091,Port_Max_N091,l9_16,l9_12);
vec3 l9_17=l9_16;
float l9_18=1.0-clamp(Port_Import_N092,0.0,1.0);
float l9_19;
if (l9_18<=0.0)
{
l9_19=0.0;
...
{
l9_19=pow(l9_18,Port_Input1_N093);
}
vec3 l9_20;
Node94_Particle_Random(vec3(l9_19),Port_Max_N094,l9_20,l9_12);
vec3 l9_21=l9_20;
float l9_22;
if (l9_21.x<=0.0)
{
...
l9_15=abs(((((l9_17/(vec3(length(l9_17))+vec3(1.234e-06)))*vec3(l9_23,0.0,0.0))*vec3(Port_Import_N097))*Port_Import_N098).x);
}
else
{
vec3 l9_24;
Node91_Particle_Random(Port_Min_N091,Port_Max_N091,l9_24,l9_12);
vec3 l9_25=l9_24;
float l9_26=1.0-clamp(Port_Import_N092,0.0,1.0);
float l9_27;
if (l9_26<=0.0)
{
l9_27=0.0;
...
{
l9_27=pow(l9_26,Port_Input1_N093);
}
vec3 l9_28;
Node94_Particle_Random(vec3(l9_27),Port_Max_N094,l9_28,l9_12);
vec3 l9_29=l9_28;
float l9_30;
if (l9_29.x<=0.0)
{
...
l9_15=((((l9_25/(vec3(length(l9_25))+vec3(1.234e-06)))*vec3(l9_31,0.0,0.0))*vec3(Port_Import_N097))*Port_Import_N098).x;
}
float l9_32;
if ((float(0.0==Port_Input1_N102)*1.0)!=0.0)
{
vec3 l9_33;
Node91_Particle_Random(Port_Min_N091,Port_Max_N091,l9_33,l9_12);
vec3 l9_34=l9_33;
float l9_35=1.0-clamp(Port_Import_N092,0.0,1.0);
float l9_36;
if (l9_35<=0.0)
{
l9_36=0.0;
...
{
l9_36=pow(l9_35,Port_Input1_N093);
}
vec3 l9_37;
Node94_Particle_Random(vec3(l9_36),Port_Max_N094,l9_37,l9_12);
vec3 l9_38=l9_37;
float l9_39;
if (l9_38.y<=0.0)
{
...
l9_32=abs(((((l9_34/(vec3(length(l9_34))+vec3(1.234e-06)))*vec3(0.0,l9_40,0.0))*vec3(Port_Import_N097))*Port_Import_N098).y);
}
else
{
vec3 l9_41;
Node91_Particle_Random(Port_Min_N091,Port_Max_N091,l9_41,l9_12);
vec3 l9_42=l9_41;
float l9_43=1.0-clamp(Port_Import_N092,0.0,1.0);
float l9_44;
if (l9_43<=0.0)
{
l9_44=0.0;
...
{
l9_44=pow(l9_43,Port_Input1_N093);
}
vec3 l9_45;
Node94_Particle_Random(vec3(l9_44),Port_Max_N094,l9_45,l9_12);
vec3 l9_46=l9_45;
float l9_47;
if (l9_46.y<=0.0)
{
...
l9_32=((((l9_42/(vec3(length(l9_42))+vec3(1.234e-06)))*vec3(0.0,l9_48,0.0))*vec3(Port_Import_N097))*Port_Import_N098).y;
}
float l9_49;
if ((float(0.0==Port_Input1_N105)*1.0)!=0.0)
{
vec3 l9_50;
Node91_Particle_Random(Port_Min_N091,Port_Max_N091,l9_50,l9_12);
vec3 l9_51=l9_50;
float l9_52=1.0-clamp(Port_Import_N092,0.0,1.0);
float l9_53;
if (l9_52<=0.0)
{
l9_53=0.0;
...
{
l9_53=pow(l9_52,Port_Input1_N093);
}
vec3 l9_54;
Node94_Particle_Random(vec3(l9_53),Port_Max_N094,l9_54,l9_12);
vec3 l9_55=l9_54;
float l9_56;
if (l9_55.z<=0.0)
{
...
l9_49=abs(((((l9_51/(vec3(length(l9_51))+vec3(1.234e-06)))*vec3(0.0,0.0,l9_57))*vec3(Port_Import_N097))*Port_Import_N098).z);
}
else
{
vec3 l9_58;
Node91_Particle_Random(Port_Min_N091,Port_Max_N091,l9_58,l9_12);
vec3 l9_59=l9_58;
float l9_60=1.0-clamp(Port_Import_N092,0.0,1.0);
float l9_61;
if (l9_60<=0.0)
{
l9_61=0.0;
...
{
l9_61=pow(l9_60,Port_Input1_N093);
}
vec3 l9_62;
Node94_Particle_Random(vec3(l9_61),Port_Max_N094,l9_62,l9_12);
vec3 l9_63=l9_62;
float l9_64;
if (l9_63.z<=0.0)
{
...
l9_49=((((l9_59/(vec3(length(l9_59))+vec3(1.234e-06)))*vec3(0.0,0.0,l9_65))*vec3(Port_Import_N097))*Port_Import_N098).z;
}
gParticle.Position=spawnPosition+vec3(l9_15,l9_32,l9_49);
vec4 l9_66=ssGetParticleRandom(1,true,true,true,8.0,gParticle,0.0,sc_Time.x);
vec3 l9_67=gParticle.Position;
vec3 l9_68=directionPosition-l9_67;
...
gParticle.Force+=(vec3(mix(Port_Min_N008,Port_Max_N008,l9_66.x))*(l9_68*l9_70));
gParticle.Life=mix(Port_Import_N116,Port_Import_N117,ssGetParticleRandom(1,true,true,true,118.0,gParticle,1.0,sc_Time.x).x);
gParticle.Life=clamp(gParticle.Life,0.1,2.0);
if ((float(pauseSpawn)*1.0)!=0.0)
{
gParticle.Dead=true;
}
gParticle.Velocity+=((gParticle.Force/vec3(gParticle.Mass))*0.033330001);
gParticle.Force=vec3(0.0);
gParticle.Position=(vfxModelMatrix[sc_GetLocalInstanceID()/140]*vec4(gParticle.Position,1.0)).xyz;
int l9_71=sc_GetLocalInstanceID()/140;
gParticle.Velocity=mat3(vfxModelMatrix[l9_71][0].xyz,vfxModelMatrix[l9_71][1].xyz,vfxModelMatrix[l9_71][2].xyz)*gParticle.Velocity;
int l9_72=sc_GetLocalInstanceID()/140;
gParticle.Force=mat3(vfxModelMatrix[l9_72][0].xyz,vfxModelMatrix[l9_72][1].xyz,vfxModelMatrix[l9_72][2].xyz)*gParticle.Force;
gParticle.Size=max(length(vfxModelMatrix[sc_GetLocalInstanceID()/140][0].xyz),max(length(vfxModelMatrix[sc_GetLocalInstanceID()/140][1].xyz),length(vfxModelMatrix[sc_GetLocalInstanceID()/140][2].xyz)))*gParticle.Size;
int l9_73=sc_GetLocalInstanceID()/140;
gParticle.Matrix=mat3(vfxModelMatrix[l9_73][0].xyz,vfxModelMatrix[l9_73][1].xyz,vfxModelMatrix[l9_73][2].xyz)*gParticle.Matrix;
...
vec3 l9_74=abs(gParticle.Velocity*vec3(gParticle.Mass))/vec3(l9_2*Port_Multiplier_N272);
gParticle.Force+=clamp((((vec3(Port_Import_N126)*vec3(Port_Import_N127))*vec3(Port_Import_N128))*((-gParticle.Velocity)*vec3(length(gParticle.Velocity))))*vec3(Port_Input4_N137),-l9_74,l9_74);
vec3 l9_75=gParticle.Position;
vec4 l9_76;
#if (sc_CanUseTextureLod)
{
l9_76=textureLod(noiseTex,(((l9_75+Port_Import_N029)+(Port_Import_N030*vec3(l9_4*Port_Multiplier_N031)))+Port_Import_N143)*(vec3(1.0)/(Port_Import_N143*vec3(Port_Input1_N145))),0.0);
}
#else
{
l9_76=vec4(0.0);
...
#endif
gParticle.Force+=(Port_Import_N026*((l9_76*vec4(Port_Input1_N149))-vec4(1.0)).xyz);
ssGlobals l9_77=ssGlobals(sc_Time.x,l9_2,l9_4,overrideTimeElapsed[l9_1]);
float l9_78;
if ((0.0*1.0)!=0.0)
{
float l9_79;
Node20_Particle_Random(Port_Min_N020,Port_Max_N020,l9_79,l9_77);
float l9_80;
Node19_Particle_Random(Port_Min_N019,Port_Max_N019,l9_80,l9_77);
l9_78=mix(l9_79,l9_80,clamp(gParticle.Age/gParticle.Life,0.0,1.0))/(length(vfxLocalAabbMax-vfxLocalAabbMin)+1.234e-06);
}
else
{
float l9_81;
Node20_Particle_Random(Port_Min_N020,Port_Max_N020,l9_81,l9_77);
float l9_82;
Node19_Particle_Random(Port_Min_N019,Port_Max_N019,l9_82,l9_77);
l9_78=mix(l9_81,l9_82,clamp(gParticle.Age/gParticle.Life,0.0,1.0));
}
gParticle.Size=l9_78;
float l9_83=clamp(gParticle.Age/gParticle.Life,0.0,1.0);
float l9_84=gParticle.Life+1.234e-06;
vec4 l9_85=vec4(gParticle.Color.x,gParticle.Color.y,gParticle.Color.z,vec4(0.0).w);
l9_85.w=mix(Port_Import_N161,Port_Import_N162,(clamp((l9_83*(Port_Input0_N214/((Port_Import_N185/l9_84)+1.234e-06)))+0.001,Port_Input1_N227+0.001,Port_Input2_N227+0.001)-0.001)*(clamp(((1.0-l9_83)*(Port_Input0_N164/((Port_Import_N188/l9_84)+1.234e-06)))+0.001,Port_Input1_N236+0.001,Port_Input2_N236+0.001)-0.001));
gParticle.Color=l9_85;
...
{
l9_86=gParticle.Force.x;
}
gParticle.Force.x=l9_86;
float l9_87;
...
{
l9_87=gParticle.Force.y;
}
gParticle.Force.y=l9_87;
float l9_88;
...
{
l9_88=gParticle.Force.z;
}
gParticle.Force.z=l9_88;
...
{
l9_89=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_89;
float l9_90;
...
{
l9_90=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_90;
float l9_91;
...
{
l9_91=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_91;
gParticle.Position+=(gParticle.Velocity*l9_2);
vec2 l9_92=vec2(4.0,1.0)/vec2(2048.0,vfxTargetSizeWrite.y);
int l9_93=vfxOffsetInstancesWrite+sc_GetLocalInstanceID();
float l9_94;
if (texture0.x<0.5)
{
l9_94=0.0;
...
sc_SetClipPosition(vec4(((vec2(l9_94,l9_95)+(vec2(float(l9_93%512),float(l9_93/512))*l9_92))*2.0)-vec2(1.0),1.0,1.0));
