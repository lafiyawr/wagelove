...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_flipbookTex 58 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 59 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_flipbookTex 60 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 61 -1
//spec_const int flipbookTexLayout 62 0
...
gParticle=ssParticle(gParticle.Position,gParticle.Velocity,gParticle.Color,gParticle.Size,gParticle.Age,gParticle.Life,gParticle.Mass,gParticle.Matrix,false,gParticle.Quaternion,gParticle.SpawnIndex,gParticle.SpawnIndexRemainder,gParticle.NextBurstTime,l9_8,fract(abs(((l9_7*0.97637898)+0.151235)+(floor(((((l9_9-l9_8)-0.0)+0.0)+4.0)/2.0)*4.32723))),(vec2(ivec2(l9_0%400,l9_0/400))+vec2(1.0))/vec2(399.0),float(((l9_0*((l9_0*1471343)+101146501))+1559861749)&2147483647)*4.6566129e-10,l9_0,l9_2,l9_3,(140*(l9_1+1))-1,(l9_5+0.5)/140.0,l9_7,l9_3/139.0,l9_4,(l9_6+vec2(0.5))/vec2(140.0,1.0),l9_6/vec2(139.0,1.0),vec3(0.0),false,gParticle.CopyId,gParticle.SpawnAmount,gParticle.BurstAmount,gParticle.BurstPeriod);
...
if (!l9_16)
{
l9_17=!vfxBatchEnable[sc_GetLocalInstanceID()/140];
}
else
{
l9_17=l9_16;
...
bool l9_3=l9_2>=(140*(vfxNumCopies+1));
bool l9_4;
if (!l9_3)
{
l9_4=vfxBatchEnable[sc_GetLocalInstanceID()/140]==false;
}
else
{
l9_4=l9_3;
...
vec3 l9_12;
if ((l9_11<0.029999999)||(Port_Import_N081<9.9999997e-05))
{
l9_12=sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz;
}
else
{
...
uniform float Port_Min_N084;
uniform float Port_Max_N084;
uniform float Port_Input1_N086;
uniform float Port_Min_N087;
uniform float Port_Max_N087;
uniform float Port_Rotation_N159;
uniform vec2 Port_Center_N159;
uniform vec2 Port_SpriteCount_N156;
uniform float Port_MaxFrames_N156;
...
#endif
int l9_4=Interp_Particle_Index/140;
int l9_5=Interp_Particle_Index%140;
float l9_6=float(l9_5);
ivec2 l9_7=ivec2(l9_5,l9_4);
float l9_8=float(Interp_Particle_Index);
vec2 l9_9=vec2(l9_7);
float l9_10=l9_8/139.0;
float l9_11=l9_10*2.0;
float l9_12;
if (overrideTimeEnabled==1)
{
l9_12=overrideTimeElapsed[l9_4];
}
else
{
l9_12=sc_Time.x;
}
float l9_13=l9_12-l9_11;
float l9_14=radians(Port_Rotation_N159);
float l9_15=sin(l9_14);
float l9_16=cos(l9_14);
vec2 l9_17=varPackedTex.xy-Port_Center_N159;
vec2 l9_18=vec2(dot(vec2(l9_16,l9_15),l9_17),dot(vec2(-l9_15,l9_16),l9_17))+Port_Center_N159;
float l9_19=floor(Port_SpriteCount_N156.x);
float l9_20=floor(Port_SpriteCount_N156.y);
float l9_21=1.0/l9_19;
float l9_22=1.0/l9_20;
float l9_23=floor(mod(floor(l9_6),min(l9_19*l9_20,floor(Port_MaxFrames_N156))));
float l9_24=(l9_21*l9_18.x)+(mod(l9_23,l9_19)*l9_21);
float l9_25=((1.0-l9_22)-(floor(l9_23/l9_19)*l9_22))+(l9_22*l9_18.y);
vec4 l9_26;
#if (flipbookTexLayout==2)
{
bool l9_27=(int(SC_USE_CLAMP_TO_BORDER_flipbookTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_flipbookTex)!=0));
float l9_28=l9_24;
sc_SoftwareWrapEarly(l9_28,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).x);
float l9_29=l9_28;
float l9_30=l9_25;
sc_SoftwareWrapEarly(l9_30,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).y);
float l9_31=l9_30;
vec2 l9_32;
float l9_33;
...
{
l9_34=ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).x==3;
}
#else
{
l9_34=(int(SC_USE_CLAMP_TO_BORDER_flipbookTex)!=0);
}
#endif
float l9_35=l9_29;
float l9_36=1.0;
sc_ClampUV(l9_35,flipbookTexUvMinMax.x,flipbookTexUvMinMax.z,l9_34,l9_36);
float l9_37=l9_35;
float l9_38=l9_36;
bool l9_39;
#if (SC_USE_CLAMP_TO_BORDER_flipbookTex)
{
l9_39=ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).y==3;
}
#else
{
l9_39=(int(SC_USE_CLAMP_TO_BORDER_flipbookTex)!=0);
}
#endif
float l9_40=l9_31;
float l9_41=l9_38;
sc_ClampUV(l9_40,flipbookTexUvMinMax.y,flipbookTexUvMinMax.w,l9_39,l9_41);
l9_33=l9_41;
...
#endif
vec2 l9_42=sc_TransformUV(l9_32,(int(SC_USE_UV_TRANSFORM_flipbookTex)!=0),flipbookTexTransform);
float l9_43=l9_42.x;
float l9_44=l9_33;
sc_SoftwareWrapLate(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).x,l9_27,l9_44);
float l9_45=l9_42.y;
float l9_46=l9_44;
sc_SoftwareWrapLate(l9_45,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).y,l9_27,l9_46);
float l9_47=l9_46;
vec3 l9_48=sc_SamplingCoordsViewToGlobal(vec2(l9_43,l9_45),flipbookTexLayout,flipbookTexGetStereoViewIndex());
vec4 l9_49=texture(flipbookTexArrSC,l9_48,0.0);
vec4 l9_50;
#if (SC_USE_CLAMP_TO_BORDER_flipbookTex)
{
l9_50=mix(flipbookTexBorderColor,l9_49,vec4(l9_47));
}
#else
{
l9_50=l9_49;
...
#else
{
bool l9_51=(int(SC_USE_CLAMP_TO_BORDER_flipbookTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_flipbookTex)!=0));
float l9_52=l9_24;
sc_SoftwareWrapEarly(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).x);
float l9_53=l9_52;
float l9_54=l9_25;
sc_SoftwareWrapEarly(l9_54,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).y);
float l9_55=l9_54;
vec2 l9_56;
float l9_57;
#if (SC_USE_UV_MIN_MAX_flipbookTex)
...
#if (SC_USE_CLAMP_TO_BORDER_flipbookTex)
{
l9_58=ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).x==3;
}
#else
{
l9_58=(int(SC_USE_CLAMP_TO_BORDER_flipbookTex)!=0);
}
#endif
float l9_59=l9_53;
float l9_60=1.0;
sc_ClampUV(l9_59,flipbookTexUvMinMax.x,flipbookTexUvMinMax.z,l9_58,l9_60);
float l9_61=l9_59;
float l9_62=l9_60;
bool l9_63;
#if (SC_USE_CLAMP_TO_BORDER_flipbookTex)
{
l9_63=ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).y==3;
}
#else
{
l9_63=(int(SC_USE_CLAMP_TO_BORDER_flipbookTex)!=0);
}
#endif
float l9_64=l9_55;
float l9_65=l9_62;
sc_ClampUV(l9_64,flipbookTexUvMinMax.y,flipbookTexUvMinMax.w,l9_63,l9_65);
l9_57=l9_65;
...
#endif
vec2 l9_66=sc_TransformUV(l9_56,(int(SC_USE_UV_TRANSFORM_flipbookTex)!=0),flipbookTexTransform);
float l9_67=l9_66.x;
float l9_68=l9_57;
sc_SoftwareWrapLate(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).x,l9_51,l9_68);
float l9_69=l9_66.y;
float l9_70=l9_68;
sc_SoftwareWrapLate(l9_69,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).y,l9_51,l9_70);
float l9_71=l9_70;
vec3 l9_72=sc_SamplingCoordsViewToGlobal(vec2(l9_67,l9_69),flipbookTexLayout,flipbookTexGetStereoViewIndex());
vec4 l9_73=texture(flipbookTex,l9_72.xy,0.0);
vec4 l9_74;
#if (SC_USE_CLAMP_TO_BORDER_flipbookTex)
{
l9_74=mix(flipbookTexBorderColor,l9_73,vec4(l9_71));
}
#else
{
l9_74=l9_73;
...
#endif
vec4 l9_75=l9_26*Interp_Particle_Color;
vec3 l9_76=clamp(l9_75.xyz,vec3(0.0),vec3(1.0));
float l9_77=l9_76.x;
float l9_78=l9_76.y;
float l9_79=l9_76.z;
float l9_80=max(max(l9_77,l9_78),l9_79);
float l9_81=l9_80-min(min(l9_77,l9_78),l9_79);
vec3 l9_82=vec3(0.0,0.33333334,0.66666669)+(((l9_76.yzx-l9_76.zxy)*0.16666667)/vec3(l9_81));
vec2 l9_83;
if (l9_81==0.0)
{
l9_83=vec2(0.0);
...
l9_83=vec2(l9_84,l9_81/l9_80);
}
float l9_86=l9_75.w;
ssParticle l9_87=ssParticle(Interp_Particle_Position,Interp_Particle_Velocity,Interp_Particle_Color,Interp_Particle_Size,Interp_Particle_Age,Interp_Particle_Life,0.0,mat3(0.0),false,Interp_Particle_Quaternion,0.0,0.0,0.0,l9_11,fract(abs(((l9_10*0.97637898)+0.151235)+(floor((((l9_13-0.0)+0.0)+4.0)/2.0)*4.32723))),(vec2(ivec2(Interp_Particle_Index%400,Interp_Particle_Index/400))+vec2(1.0))/vec2(399.0),float(((Interp_Particle_Index*((Interp_Particle_Index*1471343)+101146501))+1559861749)&2147483647)*4.6566129e-10,Interp_Particle_Index,l9_5,l9_6,(140*(l9_4+1))-1,(l9_8+0.5)/140.0,l9_10,l9_6/139.0,l9_7,(l9_9+vec2(0.5))/vec2(140.0,1.0),l9_9/vec2(139.0,1.0),vec3(0.0),false,0.0,0.0,0.0,0.0);
float l9_88;
if ((float(mix(Port_Min_N084,Port_Max_N084,ssGetParticleRandom(1,false,true,true,84.0,l9_87,0.0,sc_Time.x).x)>Port_Input1_N086)*1.0)!=0.0)
{
l9_88=Port_Value1_N088;
}
else
{
l9_88=mix(Port_Min_N087,Port_Max_N087,ssGetParticleRandom(1,false,true,true,87.0,l9_87,0.0,sc_Time.x).x);
}
float l9_89=l9_83.x+l9_88;
float l9_90=l9_83.y+Port_Input1_N166;
vec4 l9_91=vec4(l9_89,l9_90,l9_80,l9_86);
float l9_92=3.0*fract(l9_89+0.16666667);
float l9_93=2.0*fract(l9_92);
vec2 l9_94=l9_91.zz-((vec2(1.0,l9_93)-vec2(max(0.0,l9_93-1.0)))*(l9_80*clamp(l9_90,0.0,1.0)));
vec3 l9_95=vec3(l9_91.z,l9_94.x,l9_94.y);
vec3 l9_96;
if (l9_92>=1.0)
{
l9_96=l9_95.zxy;
...
#else
{
vec2 l9_105=gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw;
vec2 l9_106;
#if (sc_StereoRenderingMode==1)
{
vec3 l9_107=vec3(l9_105,0.0);
l9_107.y=((2.0*l9_105.y)+float(sc_GetStereoViewIndex()))-1.0;
l9_106=l9_107.xy;
}
#else
{
...
{
l9_109=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_106,sc_ScreenTextureLayout,l9_108),0.0);
}
#else
{
l9_109=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_106,sc_ScreenTextureLayout,l9_108).xy,0.0);
}
#endif
l9_101=l9_109;
}
...
{
vec4 l9_111=l9_101;
l9_111.x=l9_101.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_110=l9_111;
}
#else
{
...
#endif
vec3 l9_112=mix(l9_110.xyz,definedBlend(l9_110.xyz,l9_98.xyz).xyz,vec3(l9_86));
...
{
l9_114=vec4(mix(vec3(1.0),l9_98.xyz,vec3(l9_86)),l9_86);
}
#else
{
vec4 l9_115;
...
#endif
l9_115=vec4(l9_98.xyz*l9_116,l9_116);
}
#else
{
l9_115=l9_98;
