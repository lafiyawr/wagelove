...
ivec2 l9_8=ivec2(l9_6,l9_5);
float l9_9=float(l9_4);
vec2 l9_10=vec2(l9_8);
float l9_11=l9_9/139.0;
float l9_12=l9_11*2.0;
float l9_13;
if (overrideTimeEnabled==1)
{
l9_13=overrideTimeElapsed[l9_5];
}
else
{
l9_13=sc_Time.x;
...
vec2 l9_18=varPackedTex.xy-Port_Center_N159;
vec2 l9_19=vec2(dot(vec2(l9_17,l9_16),l9_18),dot(vec2(-l9_16,l9_17),l9_18))+Port_Center_N159;
float l9_20=floor(Port_SpriteCount_N156.x);
float l9_21=floor(Port_SpriteCount_N156.y);
float l9_22=1.0/l9_20;
float l9_23=1.0/l9_21;
float l9_24=floor(mod(floor(l9_7),min(l9_20*l9_21,floor(Port_MaxFrames_N156))));
int l9_25;
...
#endif
bool l9_26=(int(SC_USE_CLAMP_TO_BORDER_flipbookTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_flipbookTex)!=0));
float l9_27=(l9_22*l9_19.x)+(mod(l9_24,l9_20)*l9_22);
sc_SoftwareWrapEarly(l9_27,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).x);
float l9_28=l9_27;
float l9_29=((1.0-l9_23)-(floor(l9_24/l9_20)*l9_23))+(l9_23*l9_19.y);
sc_SoftwareWrapEarly(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).y);
float l9_30=l9_29;
vec2 l9_31;
float l9_32;
...
{
l9_33=ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).x==3;
}
#else
{
l9_33=(int(SC_USE_CLAMP_TO_BORDER_flipbookTex)!=0);
}
#endif
float l9_34=l9_28;
float l9_35=1.0;
sc_ClampUV(l9_34,flipbookTexUvMinMax.x,flipbookTexUvMinMax.z,l9_33,l9_35);
float l9_36=l9_34;
float l9_37=l9_35;
bool l9_38;
#if (SC_USE_CLAMP_TO_BORDER_flipbookTex)
{
l9_38=ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).y==3;
}
#else
{
l9_38=(int(SC_USE_CLAMP_TO_BORDER_flipbookTex)!=0);
}
#endif
float l9_39=l9_30;
float l9_40=l9_37;
sc_ClampUV(l9_39,flipbookTexUvMinMax.y,flipbookTexUvMinMax.w,l9_38,l9_40);
l9_32=l9_40;
...
#endif
vec2 l9_41=sc_TransformUV(l9_31,(int(SC_USE_UV_TRANSFORM_flipbookTex)!=0),flipbookTexTransform);
float l9_42=l9_41.x;
float l9_43=l9_32;
sc_SoftwareWrapLate(l9_42,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).x,l9_26,l9_43);
float l9_44=l9_41.y;
float l9_45=l9_43;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex,SC_SOFTWARE_WRAP_MODE_V_flipbookTex).y,l9_26,l9_45);
float l9_46=l9_45;
vec3 l9_47=sc_SamplingCoordsViewToGlobal(vec2(l9_42,l9_44),flipbookTexLayout,l9_25);
vec4 l9_48=texture2D(flipbookTex,l9_47.xy,0.0);
vec4 l9_49;
#if (SC_USE_CLAMP_TO_BORDER_flipbookTex)
{
l9_49=mix(flipbookTexBorderColor,l9_48,vec4(l9_46));
}
#else
{
l9_49=l9_48;
...
#endif
vec4 l9_50=l9_49*Interp_Particle_Color;
vec3 l9_51=clamp(l9_50.xyz,vec3(0.0),vec3(1.0));
float l9_52=l9_51.x;
float l9_53=l9_51.y;
float l9_54=l9_51.z;
...
float l9_61=l9_50.w;
ssParticle l9_62=ssParticle(Interp_Particle_Position,Interp_Particle_Velocity,Interp_Particle_Color,Interp_Particle_Size,Interp_Particle_Age,Interp_Particle_Life,0.0,mat3(0.0),false,Interp_Particle_Quaternion,0.0,0.0,0.0,l9_12,fract(abs(((l9_11*0.97637898)+0.151235)+(floor((((l9_14-0.0)+0.0)+4.0)/2.0)*4.32723))),(vec2(ivec2(l9_4%400,l9_4/400))+vec2(1.0))/vec2(399.0),float(((l9_4*((l9_4*1471343)+101146501))+1559861749)&2147483647)*4.6566129e-10,l9_4,l9_6,l9_7,(140*(l9_5+1))-1,(l9_9+0.5)/140.0,l9_11,l9_7/139.0,l9_8,(l9_10+vec2(0.5))/vec2(140.0,1.0),l9_10/vec2(139.0,1.0),vec3(0.0),false,0.0,0.0,0.0,0.0);
float l9_63;
if ((float(mix(Port_Min_N084,Port_Max_N084,ssGetParticleRandom(1,false,true,true,84.0,l9_62,0.0,sc_Time.x).x)>Port_Input1_N086)*1.0)!=0.0)
{
l9_63=Port_Value1_N088;
}
else
{
l9_63=mix(Port_Min_N087,Port_Max_N087,ssGetParticleRandom(1,false,true,true,87.0,l9_62,0.0,sc_Time.x).x);
}
float l9_64=l9_58.x+l9_63;
float l9_65=l9_58.y+Port_Input1_N166;
vec4 l9_66=vec4(l9_64,l9_65,l9_55,l9_61);
float l9_67=3.0*fract(l9_64+0.16666667);
float l9_68=2.0*fract(l9_67);
vec2 l9_69=l9_66.zz-((vec2(1.0,l9_68)-vec2(max(0.0,l9_68-1.0)))*(l9_55*clamp(l9_65,0.0,1.0)));
vec3 l9_70=vec3(l9_66.z,l9_69.x,l9_69.y);
vec3 l9_71;
if (l9_67>=1.0)
{
l9_71=l9_70.zxy;
...
#endif
l9_76=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_81,sc_ScreenTextureLayout,l9_83).xy,0.0);
}
#endif
vec4 l9_84;
...
{
vec4 l9_85=l9_76;
l9_85.x=l9_76.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_84=l9_85;
}
#else
{
...
#endif
vec3 l9_86=mix(l9_84.xyz,definedBlend(l9_84.xyz,l9_73.xyz).xyz,vec3(l9_61));
...
{
l9_88=vec4(mix(vec3(1.0),l9_73.xyz,vec3(l9_61)),l9_61);
}
#else
{
vec4 l9_89;
...
#endif
l9_89=vec4(l9_73.xyz*l9_90,l9_90);
}
#else
{
l9_89=l9_73;
