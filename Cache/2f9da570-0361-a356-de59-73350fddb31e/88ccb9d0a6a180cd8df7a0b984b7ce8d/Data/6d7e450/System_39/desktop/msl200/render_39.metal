...
//ubo int UserUniforms 0:33:7392 {
//float4 sc_Time 1376
...
//float3x3 flipbookTexTransform 7200
//float4 flipbookTexUvMinMax 7248
//float4 flipbookTexBorderColor 7264
//float Port_Import_N081 7280
//float2 Port_Import_N083 7288
//float2 Port_SpriteCount_N156 7304
//float Port_MaxFrames_N156 7312
//float Port_Rotation_N159 7316
//float2 Port_Center_N159 7320
//float Port_Min_N084 7360
//float Port_Max_N084 7364
//float Port_Input1_N086 7368
//float Port_Value1_N088 7372
//float Port_Min_N087 7376
//float Port_Max_N087 7380
//float Port_Input1_N166 7388
//}
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_flipbookTex 52 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 53 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_flipbookTex 54 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 55 -1
//spec_const int flipbookTexLayout 56 0
...
constant int SC_SOFTWARE_WRAP_MODE_U_flipbookTex [[function_constant(52)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_flipbookTex [[function_constant(54)]];
...
constant int flipbookTexLayout [[function_constant(56)]];
...
float2 Port_SpriteCount_N156;
float Port_MaxFrames_N156;
float Port_Rotation_N159;
float2 Port_Center_N159;
float Port_Speed_N156;
float Port_SecondOffset_N156;
float4 Port_Import_N064;
float Port_Min_N084;
float Port_Max_N084;
float Port_Input1_N086;
float Port_Value1_N088;
float Port_Min_N087;
float Port_Max_N087;
...
gParticle.CopyId=float(InstanceID/140);
...
l9_61=!(UserUniforms.vfxBatchEnable[l9_62/140]!=0);
}
else
{
l9_61=l9_60;
...
{
main_vert_out out={};
int N121_FacingMode=0;
int N121_Alignment=0;
float N121_VelocityStretchAmount=0.0;
float2 N121_PivotPoint=float2(0.0);
sc_Vertex_t l9_0;
...
int InstanceID=l9_2;
int l9_3=InstanceID;
bool l9_4=l9_3>=(140*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
int l9_6=gl_InstanceIndex;
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[l9_6/140]!=0)==false;
}
else
{
l9_5=l9_4;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_17/140];
...
Value_N83=fast::clamp((*sc_set0.UserUniforms).Port_Import_N083,float2(-0.5),float2(0.5));
float param_5=Value_N75;
float param_6=Value_N76;
float param_7=Value_N81;
float2 param_8=Value_N83;
ssGlobals param_9=Globals;
ssGlobals tempGlobals=param_9;
N121_FacingMode=int(param_5);
N121_Alignment=int(param_6);
N121_VelocityStretchAmount=param_7;
N121_PivotPoint=param_8;
float l9_36=0.029999999;
float3 l9_37=float3(0.0,1.0,0.0);
float3 l9_38=gParticle.Velocity;
float l9_39=length(l9_38);
float l9_40=fast::max(l9_39*N121_VelocityStretchAmount,1.0);
if ((l9_39<l9_36)||(N121_VelocityStretchAmount<9.9999997e-05))
{
if (N121_Alignment==1)
{
int l9_41=0;
...
float2 l9_54=(l9_53-float2(0.5))+N121_PivotPoint;
...
int l9_64=l9_63;
float4 clipPosition=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_64]*float4(out.varPos,1.0);
...
int l9_73=gl_InstanceIndex;
out.Interp_Particle_Index=l9_73;
...
ssGlobals Globals;
Globals.gTimeElapsed=(*sc_set0.UserUniforms).sc_Time.x;
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/140];
Globals.gTimeDelta=fast::min((*sc_set0.UserUniforms).overrideTimeDelta,0.5);
Globals.gTimeElapsedShifted=(Globals.gTimeElapsed-(gParticle.TimeShift*Globals.gTimeDelta))-0.0;
...
float2 UVCoord_N160=float2(0.0);
UVCoord_N160=Globals.Surface_UVCoord0;
float2 CoordsOut_N159=float2(0.0);
float2 param_2=UVCoord_N160;
float param_3=(*sc_set0.UserUniforms).Port_Rotation_N159;
float2 param_4=(*sc_set0.UserUniforms).Port_Center_N159;
float l9_24=sin(radians(param_3));
float l9_25=cos(radians(param_3));
float2 param_5=param_2-param_4;
param_5=float2(dot(float2(l9_25,l9_24),param_5),dot(float2(-l9_24,l9_25),param_5))+param_4;
CoordsOut_N159=param_5;
float Value_N155=0.0;
Value_N155=gParticle.Index1DPerCopyF;
float4 Color_N156=float4(0.0);
float2 param_6=(*sc_set0.UserUniforms).Port_SpriteCount_N156;
float param_7=(*sc_set0.UserUniforms).Port_MaxFrames_N156;
float2 param_8=CoordsOut_N159;
float param_9=Value_N155;
float2 l9_26=float2(0.0);
float l9_27=floor(param_6.x);
float l9_28=floor(param_6.y);
float l9_29=1.0/l9_27;
float l9_30=1.0/l9_28;
float l9_31=fast::min(l9_27*l9_28,floor(param_7));
float l9_32=floor(mod(floor(param_9),l9_31));
float l9_33=floor(l9_32/l9_27);
float l9_34=mod(l9_32,l9_27);
l9_26=float2((l9_29*param_8.x)+(l9_34*l9_29),((1.0-l9_30)-(l9_33*l9_30))+(l9_30*param_8.y));
int l9_35=0;
...
int l9_40=l9_35;
int l9_41=flipbookTexLayout_tmp;
int l9_42=l9_40;
float2 l9_43=l9_26;
bool l9_44=(int(SC_USE_UV_TRANSFORM_flipbookTex_tmp)!=0);
float3x3 l9_45=(*sc_set0.UserUniforms).flipbookTexTransform;
int2 l9_46=int2(SC_SOFTWARE_WRAP_MODE_U_flipbookTex_tmp,SC_SOFTWARE_WRAP_MODE_V_flipbookTex_tmp);
bool l9_47=(int(SC_USE_UV_MIN_MAX_flipbookTex_tmp)!=0);
float4 l9_48=(*sc_set0.UserUniforms).flipbookTexUvMinMax;
bool l9_49=(int(SC_USE_CLAMP_TO_BORDER_flipbookTex_tmp)!=0);
float4 l9_50=(*sc_set0.UserUniforms).flipbookTexBorderColor;
float l9_51=0.0;
...
float l9_121=l9_113;
float4 l9_122=sc_set0.flipbookTex.sample(sc_set0.flipbookTexSmpSC,l9_120,bias(l9_121));
float4 l9_123=l9_122;
float4 l9_124=l9_123;
if (l9_49)
{
l9_124=mix(l9_50,l9_124,float4(l9_53));
}
float4 l9_125=l9_124;
float4 param_10=l9_125;
Color_N156=param_10;
float4 Value_N79=float4(0.0);
Value_N79=gParticle.Color;
float4 Output_N82=float4(0.0);
Output_N82=Color_N156*Value_N79;
float4 Value_N64=float4(0.0);
Value_N64=Output_N82;
float4 HSV_N9=float4(0.0);
float3 param_11=Value_N64.xyz;
float3 l9_126=float3(0.0);
param_11=fast::clamp(param_11,float3(0.0),float3(1.0));
float l9_127=fast::max(fast::max(param_11.x,param_11.y),param_11.z);
l9_126.z=l9_127;
float l9_128=l9_127-fast::min(fast::min(param_11.x,param_11.y),param_11.z);
float3 l9_129=float3(0.0,0.33333334,0.66666669)+(((param_11.yzx-param_11.zxy)*0.16666667)/float3(l9_128));
float2 l9_130;
if (l9_128==0.0)
{
l9_130=float2(0.0);
...
l9_130=float2(l9_131,l9_128/l9_127);
}
l9_126=float3(l9_130.x,l9_130.y,l9_126.z);
float3 l9_133=l9_126;
HSV_N9=float4(l9_133,Value_N64.w);
float Value1_N11=0.0;
float Value2_N11=0.0;
float Value3_N11=0.0;
float Value4_N11=0.0;
float4 param_12=HSV_N9;
float param_13=param_12.x;
float param_14=param_12.y;
float param_15=param_12.z;
float param_16=param_12.w;
Value1_N11=param_13;
Value2_N11=param_14;
Value3_N11=param_15;
Value4_N11=param_16;
float Result_N88=0.0;
float param_17=0.0;
float param_18=(*sc_set0.UserUniforms).Port_Value1_N088;
float param_19=0.0;
ssGlobals param_21=Globals;
float l9_134=0.0;
float l9_135=(*sc_set0.UserUniforms).Port_Min_N084;
float l9_136=(*sc_set0.UserUniforms).Port_Max_N084;
ssGlobals l9_137=param_21;
int l9_138=1;
bool l9_139=false;
bool l9_140=true;
bool l9_141=true;
float l9_142=84.0;
ssParticle l9_143=gParticle;
float l9_144=0.0;
float l9_145=l9_137.gTimeElapsed;
float4 l9_146=float4(0.0);
float4 l9_147=float4(0.0);
if (l9_139)
{
l9_147.x=floor(fract(l9_145)*1000.0);
}
if (l9_141)
{
l9_147.y=float(l9_143.Index1D^((l9_143.Index1D*15299)+l9_143.Index1D));
}
if (l9_140)
{
l9_147.z=l9_142;
}
l9_147.w=l9_144*1000.0;
int l9_148=int(l9_147.x);
int l9_149=int(l9_147.y);
int l9_150=int(l9_147.z);
int l9_151=int(l9_147.w);
int l9_152=(((l9_148*15299)^(l9_149*30133))^(l9_150*17539))^(l9_151*12113);
int l9_153=l9_152;
if (l9_138==1)
{
int l9_154=l9_153;
...
float2 l9_171=float2(l9_168,l9_170);
l9_146=float4(l9_171.x,l9_171.y,l9_146.z,l9_146.w);
}
else
{
if (l9_138==3)
...
float3 l9_188=float3(l9_183,l9_185,l9_187);
l9_146=float4(l9_188.x,l9_188.y,l9_188.z,l9_146.w);
}
else
{
int l9_189=l9_153;
int l9_190=l9_189;
int l9_191=((l9_190*((l9_190*1471343)+101146501))+1559861749)&2147483647;
int l9_192=l9_191;
int l9_193=l9_189*1399;
int l9_194=((l9_193*((l9_193*1471343)+101146501))+1559861749)&2147483647;
int l9_195=l9_194;
int l9_196=l9_189*7177;
int l9_197=((l9_196*((l9_196*1471343)+101146501))+1559861749)&2147483647;
int l9_198=l9_197;
int l9_199=l9_189*18919;
...
float4 l9_210=float4(l9_203,l9_205,l9_207,l9_209);
l9_146=l9_210;
}
}
}
float4 l9_211=l9_146;
float4 l9_212=l9_211;
float l9_213=mix(l9_135,l9_136,l9_212.x);
l9_134=l9_213;
float l9_214=0.0;
l9_214=float(l9_134>(*sc_set0.UserUniforms).Port_Input1_N086);
param_17=l9_214;
float param_20;
if ((param_17*1.0)!=0.0)
{
...
{
float l9_215=0.0;
float l9_216=(*sc_set0.UserUniforms).Port_Min_N087;
float l9_217=(*sc_set0.UserUniforms).Port_Max_N087;
ssGlobals l9_218=param_21;
int l9_219=1;
bool l9_220=false;
bool l9_221=true;
bool l9_222=true;
...
float l9_294=mix(l9_216,l9_217,l9_293.x);
l9_215=l9_294;
param_19=l9_215;
param_20=param_19;
}
Result_N88=param_20;
float Value_N65=0.0;
Value_N65=Result_N88;
float Output_N12=0.0;
Output_N12=Value1_N11+Value_N65;
float Output_N166=0.0;
Output_N166=Value2_N11+(*sc_set0.UserUniforms).Port_Input1_N166;
float4 Value_N63=float4(0.0);
Value_N63.x=Output_N12;
Value_N63.y=Output_N166;
Value_N63.z=Value3_N11;
Value_N63.w=Value4_N11;
float4 RGB_N10=float4(0.0);
float3 param_22=Value_N63.xyz;
float3 l9_295=param_22.zzz;
float l9_296=3.0*fract(param_22.x+0.16666667);
float l9_297=2.0*fract(l9_296);
float2 l9_298=l9_295.yz-((float2(1.0,l9_297)-float2(fast::max(0.0,l9_297-1.0)))*(param_22.z*fast::clamp(param_22.y,0.0,1.0)));
l9_295=float3(l9_295.x,l9_298.x,l9_298.y);
if (l9_296>=1.0)
{
l9_295=l9_295.zxy;
}
...
float3 l9_299=l9_295;
RGB_N10=float4(l9_299,Value_N63.w);
float4 Export_N74=float4(0.0);
Export_N74=RGB_N10;
float4 param_23=Export_N74;
Output_Color0=param_23;
float4 param_24=Output_Color0;
...
{
l9_304.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
{
float4 l9_306=gl_FragCoord;
float2 l9_307=l9_306.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
int l9_312=l9_311;
int l9_313=l9_312;
float3 l9_314=float3(l9_308,0.0);
int l9_315=l9_310;
int l9_316=l9_313;
if (l9_315==1)
{
l9_314.y=((2.0*l9_314.y)+float(l9_316))-1.0;
}
float2 l9_317=l9_314.xy;
l9_309=l9_317;
}
else
{
...
float l9_344=l9_336;
float4 l9_345=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_343,bias(l9_344));
...
float4 l9_350=l9_302;
float4 l9_351=l9_350;
float3 l9_352=l9_351.xyz;
float3 l9_353=l9_352;
float3 l9_354=l9_300.xyz;
float3 l9_355=definedBlend(l9_353,l9_354,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_301=float4(l9_355.x,l9_355.y,l9_355.z,l9_301.w);
float3 l9_356=mix(l9_352,l9_301.xyz,float3(l9_300.w));
l9_301=float4(l9_356.x,l9_356.y,l9_356.z,l9_301.w);
l9_301.w=1.0;
float4 l9_357=l9_301;
param_24=l9_357;
}
else
{
...
{
l9_359=float4(mix(float3(1.0),l9_358.xyz,float3(l9_358.w)),l9_358.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_360=l9_358.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_360=fast::clamp(l9_360,0.0,1.0);
}
l9_359=float4(l9_358.xyz*l9_360,l9_360);
}
else
{
l9_359=l9_358;
...
float4 l9_361=l9_359;
param_24=l9_361;
}
}
float4 l9_362=param_24;
Output_Color0=l9_362;
float4 l9_363=float4(0.0);
if ((int(sc_ShaderComplexityAnalyzer_tmp)!=0))
{
l9_363=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_363=float4(0.0);
