...
#if (sc_CanUseTextureLod)
{
l9_76=texture3DLod(noiseTex,(((l9_75+Port_Import_N029)+(Port_Import_N030*vec3(l9_4*Port_Multiplier_N031)))+Port_Import_N143)*(vec3(1.0)/(Port_Import_N143*vec3(Port_Input1_N145))),0.0);
}
#else
{
l9_76=vec4(0.0);
