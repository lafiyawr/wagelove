...
uniform float Port_VelocityStretchAmount_N002;
uniform vec2 Port_PivotPoint_N002;
...
if (!l9_16)
{
l9_17=!vfxBatchEnable[sc_GetLocalInstanceID()/10001];
}
else
{
l9_17=l9_16;
...
bool l9_3=l9_2>=(10001*(vfxNumCopies+1));
bool l9_4;
if (!l9_3)
{
l9_4=vfxBatchEnable[sc_GetLocalInstanceID()/10001]==false;
}
else
{
l9_4=l9_3;
...
vec3 l9_12;
if ((l9_11>0.029999999)&&(Port_VelocityStretchAmount_N002>9.9999997e-05))
{
l9_12=normalize(gParticle.Velocity);
}
else
{
l9_12=normalize(sc_ViewMatrixInverseArray[sc_GetStereoViewIndex()][1].xyz);
}
...
vec2 l9_16=mat2(vec2(gParticle.Matrix[0].x,gParticle.Matrix[0].y),vec2(gParticle.Matrix[1].x,gParticle.Matrix[1].y))*(texture0-(vec2(0.5)+Port_PivotPoint_N002));
varPos=gParticle.Position;
varPos+=((-l9_14)*(gParticle.Size*l9_16.x));
varPos+=(l9_15*((gParticle.Size*l9_16.y)*max(l9_11*Port_VelocityStretchAmount_N002,1.0)));
varNormal=l9_13;
...
#endif
float l9_4=1.0-(distance(varPackedTex.xy,Port_Input1_N137)*Port_Input1_N138);
float l9_5;
if (l9_4<=0.0)
{
l9_5=0.0;
...
{
l9_5=pow(l9_4,Port_Import_N140);
}
float l9_6=l9_5*Port_Import_N142;
float l9_7=clamp(l9_6+0.001,Port_Input1_N144+0.001,Port_Input2_N144+0.001)-0.001;
vec4 l9_8=vec4(l9_7);
vec4 l9_9;
...
#else
{
vec2 l9_15=gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw;
vec2 l9_16;
#if (sc_StereoRenderingMode==1)
{
vec3 l9_17=vec3(l9_15,0.0);
l9_17.y=((2.0*l9_15.y)+float(sc_GetStereoViewIndex()))-1.0;
l9_16=l9_17.xy;
}
#else
{
...
{
l9_19=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_16,sc_ScreenTextureLayout,l9_18),0.0);
}
#else
{
l9_19=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_16,sc_ScreenTextureLayout,l9_18).xy,0.0);
}
#endif
l9_11=l9_19;
}
...
{
vec4 l9_21=l9_11;
l9_21.x=l9_11.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_20=l9_21;
}
#else
{
...
#endif
vec3 l9_22=mix(l9_20.xyz,definedBlend(l9_20.xyz,l9_8.xyz).xyz,vec3(l9_7));
...
{
l9_24=vec4(mix(vec3(1.0),l9_8.xyz,vec3(l9_7)),l9_7);
}
#else
{
vec4 l9_25;
...
#endif
l9_25=vec4(l9_8.xyz*l9_26,l9_26);
}
#else
{
l9_25=l9_8;
