...
//float Port_VelocityStretchAmount_N002 7140
//float2 Port_PivotPoint_N002 7144
//float2 Port_Input1_N137 7160
//float Port_Input1_N138 7168
//float Port_Import_N140 7172
//float Port_Import_N142 7176
//float Port_Input1_N144 7180
//float Port_Input2_N144 7184
//}
...
int vfxTargetWidth;
float Port_VelocityStretchAmount_N002;
float2 Port_PivotPoint_N002;
...
int InstanceID=l9_2;
int l9_3=InstanceID;
bool l9_4=l9_3>=(10001*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
int l9_6=gl_InstanceIndex;
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[l9_6/10001]!=0)==false;
}
else
{
l9_5=l9_4;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_17/10001];
...
float param_5=(*sc_set0.UserUniforms).Port_VelocityStretchAmount_N002;
float2 param_6=(*sc_set0.UserUniforms).Port_PivotPoint_N002;
...
int l9_37=l9_36;
float3 l9_38=normalize((*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_37][1].xyz);
float l9_39=length(gParticle.Velocity);
float l9_40=fast::max(l9_39*param_5,1.0);
if ((l9_39>0.029999999)&&(param_5>9.9999997e-05))
{
l9_38=normalize(gParticle.Velocity);
}
int l9_41=0;
if (sc_StereoRenderingMode_tmp==0)
{
...
int l9_42=l9_41;
float3 l9_43=-normalize(-(*sc_set0.UserUniforms).sc_ViewMatrixInverseArray[l9_42][2].xyz);
float3 l9_44=normalize(cross(l9_43,l9_38));
float3 l9_45=normalize(cross(l9_44,l9_43));
float2 l9_46=float2(0.5)+param_6;
float2 l9_47=param_7.Surface_UVCoord0-l9_46;
float2x2 l9_48=float2x2(float2(gParticle.Matrix[0].x,gParticle.Matrix[0].y),float2(gParticle.Matrix[1].x,gParticle.Matrix[1].y));
l9_47=l9_48*l9_47;
out.varPos=gParticle.Position;
out.varPos+=((-l9_44)*(gParticle.Size*l9_47.x));
out.varPos+=(l9_45*((gParticle.Size*l9_47.y)*l9_40));
out.varNormal=l9_43;
out.varTangent=float4(l9_45.x,l9_45.y,l9_45.z,out.varTangent.w);
int l9_49=0;
if (sc_StereoRenderingMode_tmp==0)
{
l9_49=0;
...
int l9_50=l9_49;
float4 clipPosition=(*sc_set0.UserUniforms).sc_ViewProjectionMatrixArray[l9_50]*float4(out.varPos,1.0);
...
int l9_52=l9_51;
if ((*sc_set0.UserUniforms).sc_ProjectionMatrixArray[l9_52][2].w!=0.0)
{
float l9_53=2.0/log2((*sc_set0.UserUniforms).sc_Camera.clipPlanes.y+1.0);
param_8.z=((log2(fast::max((*sc_set0.UserUniforms).sc_Camera.clipPlanes.x,1.0+param_8.w))*l9_53)-1.0)*param_8.w;
}
}
float4 l9_54=param_8;
clipPosition=l9_54;
...
float4 l9_55=param_9;
if (sc_StereoRenderingMode_tmp==1)
{
float l9_56=dot(l9_55,(*sc_set0.UserUniforms).sc_StereoClipPlanes[gl_InstanceIndex%2]);
float l9_57=l9_56;
if (sc_StereoRendering_IsClipDistanceEnabled_tmp==1)
{
}
...
{
out.varClipDistance=l9_57;
}
}
float4 l9_58=float4(param_9.x,-param_9.y,(param_9.z*0.5)+(param_9.w*0.5),param_9.w);
out.gl_Position=l9_58;
int l9_59=gl_InstanceIndex;
out.Interp_Particle_Index=l9_59;
...
ssGlobals Globals;
Globals.gTimeElapsed=(*sc_set0.UserUniforms).sc_Time.x;
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/10001];
Globals.gTimeDelta=fast::min((*sc_set0.UserUniforms).overrideTimeDelta,0.5);
Globals.gTimeElapsedShifted=(Globals.gTimeElapsed-(gParticle.TimeShift*Globals.gTimeDelta))-0.0;
...
float4 param_2=float4(Export_N145);
...
{
float4 l9_28=out.FragColor0;
float4 l9_29=l9_28;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_29.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_30=l9_29;
l9_27=l9_30;
}
...
float3 l9_66=l9_65;
float3 l9_67=l9_66;
float2 l9_68=l9_67.xy;
float l9_69=l9_61;
float4 l9_70=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_68,bias(l9_69));
float4 l9_71=l9_70;
l9_57=l9_71;
float4 l9_72=l9_57;
float4 l9_73=l9_72;
...
l9_26=float4(l9_80.x,l9_80.y,l9_80.z,l9_26.w);
float3 l9_81=mix(l9_77,l9_26.xyz,float3(l9_25.w));
l9_26=float4(l9_81.x,l9_81.y,l9_81.z,l9_26.w);
l9_26.w=1.0;
float4 l9_82=l9_26;
param_3=l9_82;
}
...
float4 l9_87=param_3;
Output_Color0=l9_87;
float4 l9_88=float4(0.0);
if ((int(sc_ShaderComplexityAnalyzer_tmp)!=0))
{
l9_88=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_88=float4(0.0);
