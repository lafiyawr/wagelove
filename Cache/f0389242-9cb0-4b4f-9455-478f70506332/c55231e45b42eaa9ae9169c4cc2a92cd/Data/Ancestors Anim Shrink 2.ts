...
export class Ancestors extends BaseScriptComponent {
  ...
  onAwake() {
    ...
    const tween1 = LSTween.scaleToLocal(a1, targetScale, 7000)
      .easing(Easing.Circular.InOut)
      .delay(0);

    const tween2 = LSTween.scaleToLocal(a2, targetScale, 7000)
      .easing(Easing.Circular.InOut)
      .delay(200);

    const tween3 = LSTween.scaleToLocal(a3, targetScale, 7000)
      .easing(Easing.Circular.InOut)
      .delay(400);
