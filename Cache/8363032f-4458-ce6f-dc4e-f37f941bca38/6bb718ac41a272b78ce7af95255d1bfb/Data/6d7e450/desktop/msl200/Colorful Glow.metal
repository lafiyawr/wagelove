...
//float Port_Multiplier_N006 4272
//float2 Port_Scale_N000 4280
//float Port_Offset_N000 4288
//float Port_Import_N026 4292
//float Port_Import_N025 4296
//float Port_Value3_N003 4300
//float Port_Value_N013 4304
//float depthRef 4308
//}
...
float Noise_N0=0.0;
float2 param=Output_N1.xy;
float2 param_1=(*sc_set0.UserUniforms).Port_Scale_N000;
float param_2=(*sc_set0.UserUniforms).Port_Offset_N000;
float param_3;
if (SC_DEVICE_CLASS_tmp>=2)
{
param.x=floor(param.x*10000.0)*9.9999997e-05;
param.y=floor(param.y*10000.0)*9.9999997e-05;
float2 l9_5=floor(param*param_1);
float2 l9_6=fract(param*param_1);
...
float l9_12=abs(param_2)+1000.0;
...
float3 param_4=float4(Value_N3,0.0).xyz;
float3 l9_16=param_4.zzz;
float l9_17=3.0*fract(param_4.x+0.16666667);
float l9_18=2.0*fract(l9_17);
float l9_19=param_4.y;
float l9_20=fast::clamp(l9_19,0.0,1.0);
float2 l9_21=l9_16.yz-((float2(1.0,l9_18)-float2(fast::max(0.0,l9_18-1.0)))*(param_4.z*l9_20));
l9_16=float3(l9_16.x,l9_21.x,l9_21.y);
if (l9_17>=1.0)
{
l9_16=l9_16.zxy;
}
...
float3 l9_22=l9_16;
RGB_N2=float4(l9_22,float4(Value_N3,0.0).w);
...
float2 param_6=Output_N1_1.xy;
float2 param_7=(*sc_set0.UserUniforms).Port_Scale_N000;
float param_8=(*sc_set0.UserUniforms).Port_Offset_N000;
float param_9;
if (SC_DEVICE_CLASS_tmp>=2)
{
param_6.x=floor(param_6.x*10000.0)*9.9999997e-05;
param_6.y=floor(param_6.y*10000.0)*9.9999997e-05;
float2 l9_26=floor(param_6*param_7);
float2 l9_27=fract(param_6*param_7);
float3 l9_28=float3(8.0,0.0,0.0);
int l9_29=-1;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_29<=1)
...
if (l9_30<=1)
{
float2 l9_31=float2(float(l9_30),float(l9_29));
float2 l9_32=l9_31+l9_26;
float l9_33=abs(param_8)+1000.0;
float2 l9_34=VoronoiHash2D(l9_32,l9_33);
float2 l9_35=l9_34;
float l9_36=distance(l9_31+l9_35,l9_27);
if (l9_36<l9_28.x)
{
l9_28=float3(l9_36,l9_35.x,l9_35.y);
param_9=l9_28.x;
...
float3 param_10=float4(Value_N3_1,0.0).xyz;
float3 l9_37=param_10.zzz;
float l9_38=3.0*fract(param_10.x+0.16666667);
float l9_39=2.0*fract(l9_38);
float l9_40=param_10.y;
float l9_41=fast::clamp(l9_40,0.0,1.0);
float2 l9_42=l9_37.yz-((float2(1.0,l9_39)-float2(fast::max(0.0,l9_39-1.0)))*(param_10.z*l9_41));
...
float3 l9_43=l9_37;
RGB_N2_1=float4(l9_43,float4(Value_N3_1,0.0).w);
...
float param_11=(*sc_set0.UserUniforms).Port_Value_N013;
...
bool l9_44=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_44)
{
...
float4 l9_45=fast::max(param_13,float4(0.0));
float4 param_14=l9_45;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
{
l9_48=fast::clamp(l9_47.w*2.0,0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
{
l9_48=fast::clamp(dot(l9_47.xyz,float3(l9_47.w)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
...
{
l9_48=(1.0-dot(l9_47.xyz,float3(0.33333001)))*l9_47.w;
}
else
{
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_48=(1.0-fast::clamp(dot(l9_47.xyz,float3(1.0)),0.0,1.0))*l9_47.w;
}
else
{
if ((int(sc_BlendMode_ColoredGlass_tmp)!=0))
{
l9_48=fast::clamp(dot(l9_47.xyz,float3(1.0)),0.0,1.0)*l9_47.w;
}
else
{
if ((int(sc_BlendMode_Add_tmp)!=0))
{
l9_48=fast::clamp(dot(l9_47.xyz,float3(1.0)),0.0,1.0);
}
else
{
if ((int(sc_BlendMode_AddWithAlphaFactor_tmp)!=0))
...
{
l9_48=dot(l9_47.xyz,float3(0.33333001))*l9_47.w;
}
else
{
if ((int(sc_BlendMode_Min_tmp)!=0))
{
l9_48=1.0-fast::clamp(dot(l9_47.xyz,float3(1.0)),0.0,1.0);
}
else
{
...
float l9_49=l9_48;
float l9_50=l9_49;
float l9_51=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_50;
float3 l9_52=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_46.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
float4 l9_53=float4(l9_52.x,l9_52.y,l9_52.z,l9_51);
param_15=l9_53;
}
else
{
...
{
float4 l9_54=param_15;
float4 l9_55=float4(0.0);
float4 l9_56=float4(0.0);
if ((int(sc_FramebufferFetch_tmp)!=0))
{
float4 l9_57=out.FragColor0;
float4 l9_58=l9_57;
if ((int(sc_UseFramebufferFetchMarker_tmp)!=0))
{
l9_58.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_59=l9_58;
l9_56=l9_59;
}
...
float l9_98=l9_90;
float4 l9_99=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_97,bias(l9_98));
float4 l9_100=l9_99;
l9_86=l9_100;
float4 l9_101=l9_86;
...
float3 l9_108=l9_54.xyz;
float3 l9_109=definedBlend(l9_107,l9_108,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_55=float4(l9_109.x,l9_109.y,l9_109.z,l9_55.w);
float3 l9_110=mix(l9_106,l9_55.xyz,float3(l9_54.w));
l9_55=float4(l9_110.x,l9_110.y,l9_110.z,l9_55.w);
l9_55.w=1.0;
float4 l9_111=l9_55;
param_15=l9_111;
}
...
{
float4 l9_112=param_15;
float4 l9_113=float4(0.0);
if ((int(sc_BlendMode_MultiplyOriginal_tmp)!=0))
{
l9_113=float4(mix(float3(1.0),l9_112.xyz,float3(l9_112.w)),l9_112.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_114=l9_112.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_114=fast::clamp(l9_114,0.0,1.0);
}
l9_113=float4(l9_112.xyz*l9_114,l9_114);
}
else
{
l9_113=l9_112;
...
float4 l9_115=l9_113;
param_15=l9_115;
}
}
}
float4 l9_116=param_15;
FinalColor=l9_116;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
if (PreviewInfo.Saved)
...
{
l9_117=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_117=float4(0.0);
...
float4 param_16=FinalColor1;
out.FragColor1=param_16;
...
float4 l9_119=param_19;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_119.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
out.FragColor0=l9_119;
return out;
}
} // FRAGMENT SHADER
