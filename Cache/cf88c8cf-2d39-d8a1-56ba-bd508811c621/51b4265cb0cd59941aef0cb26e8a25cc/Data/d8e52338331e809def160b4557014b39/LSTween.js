...
const RotationInterpolationType_1 = require("../LSTween/RotationInterpolationType");
const Tween_1 = require("../LSTween/TweenJS/Tween");
const mainGroup_1 = require("../LSTween/TweenJS/mainGroup");
const Now_1 = require("../LSTween/TweenJS/Now");
class LSTween {
    constructor() {
