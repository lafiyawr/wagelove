...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_Tweak_N1 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 83 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_Tweak_N1 84 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 85 -1
//spec_const int Tweak_N1Layout 86 0
...
#if (Tweak_N1Layout==2)
{
bool l9_25=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0));
float l9_26=l9_23.x;
...
float l9_41=l9_40.x;
float l9_42=l9_31;
sc_SoftwareWrapLate(l9_41,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x,l9_25,l9_42);
float l9_43=l9_40.y;
float l9_44=l9_42;
sc_SoftwareWrapLate(l9_43,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y,l9_25,l9_44);
float l9_45=l9_44;
vec3 l9_46=sc_SamplingCoordsViewToGlobal(vec2(l9_41,l9_43),Tweak_N1Layout,Tweak_N1GetStereoViewIndex());
vec4 l9_47=texture(Tweak_N1ArrSC,l9_46,0.0);
vec4 l9_48;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
...
#else
{
bool l9_49=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_Tweak_N1)!=0));
float l9_50=l9_23.x;
sc_SoftwareWrapEarly(l9_50,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x);
float l9_51=l9_50;
float l9_52=l9_23.y;
sc_SoftwareWrapEarly(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y);
float l9_53=l9_52;
vec2 l9_54;
float l9_55;
#if (SC_USE_UV_MIN_MAX_Tweak_N1)
...
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_56=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x==3;
}
#else
{
l9_56=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_57=l9_51;
float l9_58=1.0;
sc_ClampUV(l9_57,Tweak_N1UvMinMax.x,Tweak_N1UvMinMax.z,l9_56,l9_58);
float l9_59=l9_57;
float l9_60=l9_58;
bool l9_61;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_61=ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y==3;
}
#else
{
l9_61=(int(SC_USE_CLAMP_TO_BORDER_Tweak_N1)!=0);
}
#endif
float l9_62=l9_53;
float l9_63=l9_60;
sc_ClampUV(l9_62,Tweak_N1UvMinMax.y,Tweak_N1UvMinMax.w,l9_61,l9_63);
l9_55=l9_63;
...
#endif
vec2 l9_64=sc_TransformUV(l9_54,(int(SC_USE_UV_TRANSFORM_Tweak_N1)!=0),Tweak_N1Transform);
float l9_65=l9_64.x;
float l9_66=l9_55;
sc_SoftwareWrapLate(l9_65,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).x,l9_49,l9_66);
float l9_67=l9_64.y;
float l9_68=l9_66;
sc_SoftwareWrapLate(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N1,SC_SOFTWARE_WRAP_MODE_V_Tweak_N1).y,l9_49,l9_68);
float l9_69=l9_68;
vec3 l9_70=sc_SamplingCoordsViewToGlobal(vec2(l9_65,l9_67),Tweak_N1Layout,Tweak_N1GetStereoViewIndex());
vec4 l9_71=texture(Tweak_N1,l9_70.xy,0.0);
vec4 l9_72;
#if (SC_USE_CLAMP_TO_BORDER_Tweak_N1)
{
l9_72=mix(Tweak_N1BorderColor,l9_71,vec4(l9_69));
}
#else
{
l9_72=l9_71;
...
#endif
vec3 l9_74=vec3(Port_Import_N062)*l9_73.xyz;
vec3 l9_75;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
#endif
vec3 l9_76=mix(baseColor.xyz,min(baseColor.xyz+l9_75.xyz,vec3(1.0)).xyz,vec3(Port_Value2_N003));
...
{
l9_82=clamp(baseColor.w*2.0,0.0,1.0);
}
#else
{
float l9_83;
...
{
l9_83=clamp(dot(l9_77.xyz,vec3(baseColor.w)),0.0,1.0);
}
#else
{
float l9_84;
...
{
l9_85=(1.0-dot(l9_77.xyz,vec3(0.33333001)))*baseColor.w;
}
#else
{
float l9_86;
...
{
l9_86=(1.0-clamp(dot(l9_77.xyz,vec3(1.0)),0.0,1.0))*baseColor.w;
}
#else
{
float l9_87;
...
{
l9_87=clamp(dot(l9_77.xyz,vec3(1.0)),0.0,1.0)*baseColor.w;
}
#else
{
float l9_88;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_89=clamp(dot(l9_77.xyz,vec3(1.0)),0.0,1.0)*baseColor.w;
}
#else
{
float l9_90;
...
{
l9_90=dot(l9_77.xyz,vec3(0.33333001))*baseColor.w;
}
#else
{
float l9_91;
...
#if (sc_FramebufferFetch)
{
vec4 l9_96=sc_readFragData0_Platform();
vec4 l9_97;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_98=l9_96;
l9_98.x=l9_96.x+_sc_framebufferFetchMarker;
l9_97=l9_98;
}
#else
{
...
{
l9_101=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_99,sc_ScreenTextureLayout,l9_100),0.0);
}
#else
{
l9_101=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_99,sc_ScreenTextureLayout,l9_100).xy,0.0);
}
#endif
l9_95=l9_101;
}
...
{
vec4 l9_103=l9_95;
l9_103.x=l9_95.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_102=l9_103;
}
#else
{
...
#endif
vec3 l9_104=mix(l9_102.xyz,definedBlend(l9_102.xyz,l9_77.xyz).xyz,vec3(baseColor.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_106=vec4(mix(vec3(1.0),l9_77.xyz,vec3(baseColor.w)),baseColor.w);
}
#else
{
vec4 l9_107;
...
{
l9_108=clamp(baseColor.w,0.0,1.0);
}
#else
{
l9_108=baseColor.w;
...
#endif
l9_107=vec4(l9_77.xyz*l9_108,l9_108);
}
#else
{
l9_107=l9_77;
