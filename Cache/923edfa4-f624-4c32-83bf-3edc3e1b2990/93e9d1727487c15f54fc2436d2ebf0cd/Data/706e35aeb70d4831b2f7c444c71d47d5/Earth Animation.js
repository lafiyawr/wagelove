...
let EarthScaleAndRotate = class EarthScaleAndRotate extends BaseScriptComponent {
    onAwake() {
        ...
        const rotationTween = LSTween_1.LSTween.rotateOffset(transform, quat.angleAxis(MathUtils.DegToRad * 45, vec3.up()), 50000, RotationInterpolationType_1.RotationInterpolationType.LERP).repeat(Infinity);
