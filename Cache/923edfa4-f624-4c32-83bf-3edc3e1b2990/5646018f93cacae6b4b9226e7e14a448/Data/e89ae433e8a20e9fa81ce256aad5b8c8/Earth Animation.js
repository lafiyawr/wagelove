...
let EarthScaleAndRotate = class EarthScaleAndRotate extends BaseScriptComponent {
    onAwake() {
        ...
        const rotationTween = LSTween_1.LSTween.rotateOffset(transform, quat.angleAxis(MathUtils.DegToRad * 360, vec3.up()), 5000, RotationInterpolationType_1.RotationInterpolationType.LERP).repeat(Infinity);
