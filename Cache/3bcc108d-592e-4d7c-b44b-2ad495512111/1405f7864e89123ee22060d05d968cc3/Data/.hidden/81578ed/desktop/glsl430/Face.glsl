...
float l9_3=radians(grainRotation.z);
float l9_4=sin(l9_3);
float l9_5=cos(l9_3);
vec2 l9_6=vec2(l9_2.xz)-Port_Center_N013;
vec2 l9_7=vec2(dot(vec2(l9_5,l9_4),l9_6),dot(vec2(-l9_4,l9_5),l9_6))+Port_Center_N013;
float l9_8=radians(grainRotation.x);
float l9_9=sin(l9_8);
float l9_10=cos(l9_8);
vec2 l9_11=vec2(l9_7.x,l9_2.y)-Port_Center_N016;
vec2 l9_12=vec2(dot(vec2(l9_10,l9_9),l9_11),dot(vec2(-l9_9,l9_10),l9_11))+Port_Center_N016;
float l9_13=l9_12.x;
float l9_14=radians(grainRotation.y);
float l9_15=sin(l9_14);
float l9_16=cos(l9_14);
vec2 l9_17=vec2(l9_7.y,l9_12.y)-Port_Center_N020;
vec2 l9_18=vec2(dot(vec2(l9_16,l9_15),l9_17),dot(vec2(-l9_15,l9_16),l9_17))+Port_Center_N020;
float l9_19=l9_18.y;
vec3 l9_20=vec3(Port_Value1_N001,knottyness,Port_Value3_N001);
...
vec2 l9_24=(vec2(l9_13,l9_19)*vec2(l9_23.yz))+vec2(Port_Import_N059.yz);
float l9_25=snoise(vec2(floor(l9_24.x*10000.0)*9.9999997e-05,floor(l9_24.y*10000.0)*9.9999997e-05)*(Port_Scale_N081*0.5));
vec2 l9_26=(vec2(l9_19,l9_18.x)*vec2(l9_23.zx))+vec2(Port_Import_N059.zx);
float l9_27=snoise(vec2(floor(l9_26.x*10000.0)*9.9999997e-05,floor(l9_26.y*10000.0)*9.9999997e-05)*(Port_Scale_N089*0.5));
vec2 l9_28=(vec2(l9_18.x,l9_13)*vec2(l9_23.xy))+vec2(Port_Import_N059.xy);
float l9_29=snoise(vec2(floor(l9_28.x*10000.0)*9.9999997e-05,floor(l9_28.y*10000.0)*9.9999997e-05)*(Port_Scale_N094*0.5));
float l9_30=(1.0-smoothstep(Port_Input0_N167,(Port_Import_N153*Port_Input1_N154)+Port_Import_N153,abs(sin(sin((((Port_Input0_N151*((((floor(((l9_25*0.5)+0.5)*10000.0)*9.9999997e-05)+(floor(((l9_27*0.5)+0.5)*10000.0)*9.9999997e-05))+(floor(((l9_29*0.5)+0.5)*10000.0)*9.9999997e-05))*Port_Input1_N096))*scale)*Port_Input1_N157)*3.1415927)+(Port_Input0_N162*Port_Import_N153)))*Port_Input1_N166))+roughness;
vec3 l9_31;
#if (!sc_ProjectiveShadowsCaster)
{
l9_31=mat3(l9_0,cross(l9_1,l9_0)*varTangent.w,l9_1)*vec3(l9_30);
}
#else
{
l9_31=vec3(0.0);
...
#endif
if (dot(normalize(sc_Camera.position-varPos),l9_31)>=(-0.050000001))
{
uvec3 l9_32=uvec3(round((varPos-OriginNormalizationOffset)*OriginNormalizationScale));
position_and_mask=uvec4(l9_32.x,l9_32.y,l9_32.z,position_and_mask.w);
position_and_mask.w=uint(receiver_mask);
vec3 l9_33=abs(l9_31);
vec3 l9_34=l9_31/vec3(dot(l9_33,vec3(1.0)));
float l9_35=clamp(-l9_34.z,0.0,1.0);
float l9_36=l9_34.x;
float l9_37;
if (l9_36>=0.0)
{
...
uvec2 l9_41=uvec2(packHalf2x16(vec2(l9_38,0.0)),packHalf2x16(vec2(l9_39+l9_40,0.0)));
normal_and_more=uvec4(l9_41.x,l9_41.y,normal_and_more.z,normal_and_more.w);
...
{
l9_42=uint(clamp(l9_30,0.0,1.0)*1000.0);
}
normal_and_more.w=l9_42|uint((receiverId%32)<<int(10u));
}
else
{
...
vec3 l9_8=l9_6.normalWS;
vec4 l9_9=l9_6.tangentWS;
if (noEarlyZ)
{
...
l9_3=l9_10;
l9_2=l9_8;
l9_1=cross(l9_8,l9_10)*l9_9.w;
l9_0=(sc_ModelMatrixInverse*vec4(l9_7,1.0)).xyz;
}
else
{
...
l9_3=l9_11;
l9_2=l9_12;
l9_1=cross(l9_12,l9_11)*varTangent.w;
l9_0=(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz;
}
float l9_13=radians(grainRotation.z);
float l9_14=sin(l9_13);
float l9_15=cos(l9_13);
vec2 l9_16=vec2(l9_0.xz)-Port_Center_N013;
vec2 l9_17=vec2(dot(vec2(l9_15,l9_14),l9_16),dot(vec2(-l9_14,l9_15),l9_16))+Port_Center_N013;
float l9_18=radians(grainRotation.x);
float l9_19=sin(l9_18);
float l9_20=cos(l9_18);
vec2 l9_21=vec2(l9_17.x,l9_0.y)-Port_Center_N016;
vec2 l9_22=vec2(dot(vec2(l9_20,l9_19),l9_21),dot(vec2(-l9_19,l9_20),l9_21))+Port_Center_N016;
float l9_23=l9_22.x;
float l9_24=radians(grainRotation.y);
float l9_25=sin(l9_24);
float l9_26=cos(l9_24);
vec2 l9_27=vec2(l9_17.y,l9_22.y)-Port_Center_N020;
vec2 l9_28=vec2(dot(vec2(l9_26,l9_25),l9_27),dot(vec2(-l9_25,l9_26),l9_27))+Port_Center_N020;
float l9_29=l9_28.y;
vec3 l9_30=vec3(Port_Value1_N001,knottyness,Port_Value3_N001);
...
vec2 l9_34=(vec2(l9_23,l9_29)*vec2(l9_33.yz))+vec2(Port_Import_N059.yz);
float l9_35=snoise(vec2(floor(l9_34.x*10000.0)*9.9999997e-05,floor(l9_34.y*10000.0)*9.9999997e-05)*(Port_Scale_N081*0.5));
vec2 l9_36=(vec2(l9_29,l9_28.x)*vec2(l9_33.zx))+vec2(Port_Import_N059.zx);
float l9_37=snoise(vec2(floor(l9_36.x*10000.0)*9.9999997e-05,floor(l9_36.y*10000.0)*9.9999997e-05)*(Port_Scale_N089*0.5));
vec2 l9_38=(vec2(l9_28.x,l9_23)*vec2(l9_33.xy))+vec2(Port_Import_N059.xy);
float l9_39=snoise(vec2(floor(l9_38.x*10000.0)*9.9999997e-05,floor(l9_38.y*10000.0)*9.9999997e-05)*(Port_Scale_N094*0.5));
float l9_40=smoothstep(Port_Input0_N167,(Port_Import_N153*Port_Input1_N154)+Port_Import_N153,abs(sin(sin((((Port_Input0_N151*((((floor(((l9_35*0.5)+0.5)*10000.0)*9.9999997e-05)+(floor(((l9_37*0.5)+0.5)*10000.0)*9.9999997e-05))+(floor(((l9_39*0.5)+0.5)*10000.0)*9.9999997e-05))*Port_Input1_N096))*scale)*Port_Input1_N157)*3.1415927)+(Port_Input0_N162*Port_Import_N153)))*Port_Input1_N166);
float l9_41=1.0-l9_40;
float l9_42=l9_41+roughness;
vec3 l9_43;
#if (!sc_ProjectiveShadowsCaster)
{
l9_43=mat3(l9_3,l9_1,l9_2)*vec3(l9_42);
}
#else
{
l9_43=vec3(0.0);
...
#endif
vec3 l9_44=max(((baseColor*vec4(l9_40))+(lineColor*vec4(l9_41))).xyz,vec3(0.0));
vec4 l9_45;
#if (sc_ProjectiveShadowsCaster)
{
l9_45=vec4(l9_44,Port_Opacity_N176);
}
#else
{
l9_45=ngsCalculateLighting(l9_44,Port_Opacity_N176,l9_43,l9_4,l9_5,Port_Emissive_N176,Port_Metallic_N176,clamp(l9_42,0.0,1.0),Port_AO_N176,Port_SpecularAO_N176);
}
#endif
vec4 l9_46=max(l9_45,vec4(0.0));
if (isProxyMode)
{
vec4 l9_47;
#if (sc_ProxyAlphaOne)
...
#endif
sc_writeFragData0Internal(max(l9_47,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_49;
#if (sc_ProjectiveShadowsCaster)
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_51=clamp(l9_46.w*2.0,0.0,1.0);
}
#else
{
float l9_52;
...
{
l9_52=clamp(dot(l9_46.xyz,vec3(l9_46.w)),0.0,1.0);
}
#else
{
float l9_53;
...
#if (sc_BlendMode_Multiply)
{
l9_54=(1.0-dot(l9_46.xyz,vec3(0.33333001)))*l9_46.w;
}
#else
{
float l9_55;
...
{
l9_55=(1.0-clamp(dot(l9_46.xyz,vec3(1.0)),0.0,1.0))*l9_46.w;
}
#else
{
float l9_56;
#if (sc_BlendMode_ColoredGlass)
{
l9_56=clamp(dot(l9_46.xyz,vec3(1.0)),0.0,1.0)*l9_46.w;
}
#else
{
float l9_57;
#if (sc_BlendMode_Add)
{
l9_57=clamp(dot(l9_46.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_58;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_58=clamp(dot(l9_46.xyz,vec3(1.0)),0.0,1.0)*l9_46.w;
}
#else
{
float l9_59;
...
{
l9_59=dot(l9_46.xyz,vec3(0.33333001))*l9_46.w;
}
#else
{
float l9_60;
#if (sc_BlendMode_Min)
{
l9_60=1.0-clamp(dot(l9_46.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_61;
#if (sc_BlendMode_Max)
{
l9_61=clamp(dot(l9_46.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_61=1.0;
...
#endif
l9_49=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_46.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_50);
}
#else
{
vec4 l9_62;
...
vec3 l9_65=mix(l9_64,definedBlend(l9_64,l9_46.xyz).xyz,vec3(l9_46.w));
...
{
float l9_68=l9_46.w;
l9_67=vec4(mix(vec3(1.0),l9_46.xyz,vec3(l9_68)),l9_68);
}
#else
{
vec4 l9_69;
...
#endif
l9_69=vec4(l9_46.xyz*l9_71,l9_71);
}
#else
{
l9_69=l9_46;
