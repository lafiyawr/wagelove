...
#else
{
l9_7=ngsCalculateLighting(Port_Albedo_N006,Port_Opacity_N006,l9_6,l9_2,l9_3,Port_Emissive_N006,clamp(Tweak_N1,0.0,1.0),clamp(Tweak_N2,0.0,1.0),clamp(mix(Port_Input0_N102,mix(vec4(dot(l9_5,Port_Input1_N094)),l9_5,vec4(clamp(Port_Import_N095,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0))).xyz,vec3(0.0),vec3(1.0)),Port_SpecularAO_N006);
}
#endif
