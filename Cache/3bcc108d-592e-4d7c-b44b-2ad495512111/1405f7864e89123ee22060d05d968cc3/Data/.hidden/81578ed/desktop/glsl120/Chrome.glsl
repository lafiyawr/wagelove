...
#endif
vec3 l9_3=max(Tweak_N7.xyz,vec3(0.0));
vec4 l9_4;
#if (sc_ProjectiveShadowsCaster)
{
l9_4=vec4(l9_3,Port_Opacity_N006);
}
#else
{
float l9_5=clamp(Tweak_N1,0.0,1.0);
float l9_6=clamp(Tweak_N2,0.0,1.0);
vec3 l9_7=clamp(mix(Port_Input0_N102,mix(vec4(dot(l9_1,Port_Input1_N094)),l9_1,vec4(clamp(Port_Import_N095,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0))).xyz,vec3(0.0),vec3(1.0));
vec3 l9_8=ssSRGB_to_Linear(l9_3);
vec3 l9_9=normalize(l9_2);
vec3 l9_10=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_11;
#if (sc_SSAOEnabled)
{
...
#endif
vec3 l9_12=vec3(l9_5);
vec3 l9_13=mix(vec3(0.039999999),l9_8*l9_5,l9_12);
vec3 l9_14=mix(l9_8*(1.0-l9_5),vec3(0.0),l9_12);
SurfaceProperties l9_15=SurfaceProperties(l9_14,Port_Opacity_N006,l9_9,varPos,l9_0,l9_5,l9_6,l9_10,l9_11,l9_7,vec3(1.0),l9_13);
vec4 l9_16=vec4(1.0);
vec3 l9_17;
vec3 l9_18;
vec3 l9_19;
...
#endif
l9_71=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_72,sc_EnvmapDiffuseLayout,l9_73).xy,-13.0);
}
#else
{
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_103=clamp(pow(l9_6,0.66666669),0.0,1.0)*5.0;
vec2 l9_104=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_9,reflect(-l9_0,l9_9),l9_6),sc_EnvmapRotation.y);
vec4 l9_105;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
#if (sc_LightEstimation)
{
float l9_109=clamp(l9_6*l9_6,0.0099999998,1.0);
vec3 l9_110;
...
l9_123=vec3(0.0);
l9_122=vec3(0.0);
l9_121=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_14,vec3(Port_Opacity_N006));
l9_120=1.0;
}
#else
{
...
{
vec4 l9_136=l9_134;
l9_136.x=l9_133+((l9_11.x*l9_7.x)*9.9999997e-06);
l9_135=l9_136;
}
#else
{
...
l9_4=vec4(l9_140.x,l9_140.y,l9_140.z,l9_137.w);
}
#endif
vec4 l9_141=max(l9_4,vec4(0.0));
vec4 l9_142;
#if (sc_ProjectiveShadowsCaster)
{
float l9_143;
