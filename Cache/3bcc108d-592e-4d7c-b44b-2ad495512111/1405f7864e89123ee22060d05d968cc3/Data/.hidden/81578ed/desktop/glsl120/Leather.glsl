...
#endif
vec4 l9_81=varColor*vec4(clamp(Port_Import_N092,0.0,5.0));
vec3 l9_82;
#if (!sc_ProjectiveShadowsCaster)
{
l9_82=mat3(l9_1,cross(l9_2,l9_1)*varTangent.w,l9_2)*((l9_55.xyz*1.9921875)-vec3(1.0)).xyz;
}
#else
{
l9_82=vec3(0.0);
...
#if (sc_ProjectiveShadowsCaster)
{
l9_84=vec4(l9_83,Port_Opacity_N006);
}
#else
{
float l9_85=clamp(l9_80.x,0.0,1.0);
float l9_86=clamp(l9_80.y,0.0,1.0);
vec3 l9_87=clamp(mix(Port_Input0_N102,mix(vec4(dot(l9_81,Port_Input1_N094)),l9_81,vec4(clamp(Port_Import_N095,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0))).xyz,vec3(0.0),vec3(1.0));
vec3 l9_88=ssSRGB_to_Linear(l9_83);
vec3 l9_89=normalize(l9_82);
vec3 l9_90=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_91;
#if (sc_SSAOEnabled)
{
...
#endif
vec3 l9_92=vec3(l9_85);
vec3 l9_93=mix(vec3(0.039999999),l9_88*l9_85,l9_92);
vec3 l9_94=mix(l9_88*(1.0-l9_85),vec3(0.0),l9_92);
SurfaceProperties l9_95=SurfaceProperties(l9_94,Port_Opacity_N006,l9_89,varPos,l9_0,l9_85,l9_86,l9_90,l9_91,l9_87,vec3(1.0),l9_93);
vec4 l9_96=vec4(1.0);
vec3 l9_97;
vec3 l9_98;
vec3 l9_99;
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_183=clamp(pow(l9_86,0.66666669),0.0,1.0)*5.0;
vec2 l9_184=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_89,reflect(-l9_0,l9_89),l9_86),sc_EnvmapRotation.y);
vec4 l9_185;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
#if (sc_LightEstimation)
{
float l9_189=clamp(l9_86*l9_86,0.0099999998,1.0);
vec3 l9_190;
...
l9_203=vec3(0.0);
l9_202=vec3(0.0);
l9_201=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_94,vec3(Port_Opacity_N006));
l9_200=1.0;
}
#else
{
...
{
vec4 l9_216=l9_214;
l9_216.x=l9_213+((l9_91.x*l9_87.x)*9.9999997e-06);
l9_215=l9_216;
}
#else
{
...
l9_84=vec4(l9_220.x,l9_220.y,l9_220.z,l9_217.w);
}
#endif
vec4 l9_221=max(l9_84,vec4(0.0));
vec4 l9_222;
#if (sc_ProjectiveShadowsCaster)
{
float l9_223;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_251-0.0039215689)),min(1.0,l9_251+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
sc_writeFragData0Internal(vec4(packValue(l9_253),packValue(l9_253),packValue(l9_253),packValue(l9_253)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
sc_writeFragData0Internal(l9_295,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
