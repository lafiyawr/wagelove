...
vec4 l9_1=varColor*vec4(clamp(Port_Import_N092,0.0,5.0));
vec3 l9_2;
...
#else
{
float l9_4=clamp(Tweak_N1,0.0,1.0);
float l9_5=clamp(Tweak_N2,0.0,1.0);
vec3 l9_6=ssSRGB_to_Linear(Port_Albedo_N006);
vec3 l9_7=normalize(l9_2);
vec3 l9_8=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_9;
#if (sc_SSAOEnabled)
{
l9_9=evaluateSSAO(varPos);
}
#else
{
l9_9=clamp(mix(Port_Input0_N102,mix(vec4(dot(l9_1,Port_Input1_N094)),l9_1,vec4(clamp(Port_Import_N095,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0))).xyz,vec3(0.0),vec3(1.0));
}
#endif
vec3 l9_10=vec3(l9_4);
vec3 l9_11=mix(vec3(0.039999999),l9_6*l9_4,l9_10);
vec3 l9_12=mix(l9_6*(1.0-l9_4),vec3(0.0),l9_10);
SurfaceProperties l9_13=SurfaceProperties(l9_12,Port_Opacity_N006,l9_7,varPos,l9_0,l9_4,l9_5,l9_8,l9_9,Port_SpecularAO_N006,vec3(1.0),l9_11);
vec4 l9_14=vec4(1.0);
vec3 l9_15;
vec3 l9_16;
vec3 l9_17;
...
l9_23=vec3(0.0);
l9_22=vec3(0.0);
LightingComponents l9_29;
LightProperties l9_30;
SurfaceProperties l9_31;
vec3 l9_32;
int l9_33=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_33<sc_DirectionalLightsCount)
{
LightingComponents l9_34=accumulateLight(LightingComponents(l9_22,l9_23,l9_28,l9_27,l9_25,l9_24),LightProperties(sc_DirectionalLights[l9_33].direction,sc_DirectionalLights[l9_33].color.xyz,sc_DirectionalLights[l9_33].color.w*l9_14[(l9_26<3) ? l9_26 : 3]),l9_13,l9_0);
l9_28=l9_34.indirectDiffuse;
l9_27=l9_34.indirectSpecular;
l9_26++;
l9_25=l9_34.emitted;
l9_24=l9_34.transmitted;
l9_23=l9_34.directSpecular;
l9_22=l9_34.directDiffuse;
l9_33++;
continue;
}
else
...
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_51<sc_PointLightsCount)
{
vec3 l9_53=sc_PointLights[l9_51].position-varPos;
vec3 l9_54=normalize(l9_53);
float l9_55=l9_14[(l9_52<3) ? l9_52 : 3];
float l9_56=clamp((dot(l9_54,sc_PointLights[l9_51].direction)*sc_PointLights[l9_51].angleScale)+sc_PointLights[l9_51].angleOffset,0.0,1.0);
float l9_57=(sc_PointLights[l9_51].color.w*l9_55)*(l9_56*l9_56);
float l9_58;
if (sc_PointLights[l9_51].falloffEnabled)
{
l9_58=l9_57*computeDistanceAttenuation(length(l9_53),sc_PointLights[l9_51].falloffEndDistance);
}
else
{
l9_58=l9_57;
...
l9_44=l9_52+1;
LightingComponents l9_59=accumulateLight(LightingComponents(l9_38,l9_39,l9_43,l9_42,l9_41,l9_40),LightProperties(l9_54,sc_PointLights[l9_51].color.xyz,l9_58),l9_13,l9_0);
l9_45=l9_59.directDiffuse;
l9_46=l9_59.directSpecular;
l9_47=l9_59.indirectDiffuse;
l9_48=l9_59.indirectSpecular;
l9_49=l9_59.emitted;
l9_50=l9_59.transmitted;
l9_43=l9_47;
l9_42=l9_48;
l9_52=l9_44;
l9_41=l9_49;
...
vec4 l9_64=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_63.x,l9_63.y),0.5);
...
{
vec2 l9_66=calcPanoramicTexCoordsFromDir(l9_7,sc_EnvmapRotation.y);
vec4 l9_67;
...
{
float l9_90=dot(sc_LightEstimationData.sg[l9_89].axis,l9_7);
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_101=clamp(pow(l9_5,0.66666669),0.0,1.0)*5.0;
vec2 l9_102=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_7,reflect(-l9_0,l9_7),l9_5),sc_EnvmapRotation.y);
vec4 l9_103;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
#endif
l9_100=vec3(0.0)+((((l9_103.xyz*(1.0/l9_103.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_13,abs(dot(l9_7,l9_0))));
}
#else
{
l9_100=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_107=clamp(l9_5*l9_5,0.0099999998,1.0);
vec3 l9_108;
l9_108=sc_LightEstimationData.ambientLight*l9_11;
int l9_109=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
...
vec3 l9_111=reflect(-l9_0,l9_7);
float l9_112=dot(l9_7,l9_0);
...
l9_121=vec3(0.0);
l9_120=vec3(0.0);
l9_119=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_12,vec3(Port_Opacity_N006));
l9_118=1.0;
}
#else
{
...
#endif
vec3 l9_123=l9_120*l9_9;
vec3 l9_124=l9_121+l9_123;
vec3 l9_125=l9_12*l9_124;
vec3 l9_126=l9_106*Port_SpecularAO_N006;
vec3 l9_127=l9_60+l9_126;
vec3 l9_128;
if (l9_122)
{
...
vec3 l9_130=(l9_129+l9_8)+l9_119;
...
{
vec4 l9_134=l9_132;
l9_134.x=l9_131+((l9_9.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_133=l9_134;
}
#else
{
...
#endif
vec3 l9_138=vec3(linearToSrgb(l9_135.x),linearToSrgb(l9_135.y),linearToSrgb(l9_135.z));
l9_3=vec4(l9_138.x,l9_138.y,l9_138.z,l9_135.w);
}
#endif
vec4 l9_139=max(l9_3,vec4(0.0));
vec4 l9_140;
#if (sc_ProjectiveShadowsCaster)
{
float l9_141;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_142=clamp(l9_139.w*2.0,0.0,1.0);
}
#else
{
float l9_143;
...
{
l9_143=clamp(dot(l9_139.xyz,vec3(l9_139.w)),0.0,1.0);
}
#else
{
float l9_144;
...
#if (sc_BlendMode_Multiply)
{
l9_145=(1.0-dot(l9_139.xyz,vec3(0.33333001)))*l9_139.w;
}
#else
{
float l9_146;
...
{
l9_146=(1.0-clamp(dot(l9_139.xyz,vec3(1.0)),0.0,1.0))*l9_139.w;
}
#else
{
float l9_147;
#if (sc_BlendMode_ColoredGlass)
{
l9_147=clamp(dot(l9_139.xyz,vec3(1.0)),0.0,1.0)*l9_139.w;
}
#else
{
float l9_148;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_149=clamp(dot(l9_139.xyz,vec3(1.0)),0.0,1.0)*l9_139.w;
}
#else
{
float l9_150;
...
{
l9_150=dot(l9_139.xyz,vec3(0.33333001))*l9_139.w;
}
#else
{
float l9_151;
...
vec3 l9_156=mix(l9_155,definedBlend(l9_155,l9_139.xyz).xyz,vec3(l9_139.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_159=l9_139.w;
l9_158=vec4(mix(vec3(1.0),l9_139.xyz,vec3(l9_159)),l9_159);
}
#else
{
vec4 l9_160;
...
#endif
l9_160=vec4(l9_139.xyz*l9_162,l9_162);
}
#else
{
l9_160=l9_139;
