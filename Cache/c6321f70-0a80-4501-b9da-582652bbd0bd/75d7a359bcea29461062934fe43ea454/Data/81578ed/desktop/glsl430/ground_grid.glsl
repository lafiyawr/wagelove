...
#endif
vec3 l9_53=l9_4.xyz*baseColor;
vec2 l9_54=l9_1-Port_Center_N085;
vec2 l9_55=(((l9_54*(vec2(Port_Input0_N020)/clamp(Port_Import_N091,vec2(0.0),vec2(10.0))))+Port_Center_N085)*vec2(Port_Input1_N021))-vec2(Port_Input1_N022);
float l9_56=atan(l9_55.y*Port_Input1_N024,l9_55.x);
float l9_57=(Port_Input0_N027*3.1415927)/clamp(floor(Port_Import_N028),Port_Input1_N030,Port_Input2_N030);
float l9_58=((((1.0-(cos((floor((l9_56/l9_57)+Port_Input1_N033)*l9_57)-l9_56)*length(l9_55)))-Port_RangeMinA_N039)/((clamp(Port_Import_N025,0.0,1.0)-Port_RangeMinA_N039)+1e-06))*(Port_RangeMaxB_N039-Port_RangeMinB_N039))+Port_RangeMinB_N039;
vec4 l9_59=vec4(l9_53.x,l9_53.y,l9_53.z,vec4(0.0).w);
l9_59.w=l9_58;
...
#endif
vec3 l9_86=mix(l9_84.xyz,definedBlend(l9_84.xyz,l9_59.xyz).xyz,vec3(l9_58));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_88=vec4(mix(vec3(1.0),l9_59.xyz,vec3(l9_58)),l9_58);
}
#else
{
vec4 l9_89;
...
#endif
l9_89=vec4(l9_59.xyz*l9_90,l9_90);
}
#else
{
l9_89=l9_59;
