...
//float uvScale 4400
//float3 baseColor 4416
//float2 Port_Input1_N015 4432
//float Port_Input0_N020 4440
//float2 Port_Import_N091 4448
//float2 Port_Center_N085 4456
//float Port_Input1_N021 4464
//float Port_Input1_N022 4468
//float Port_Input1_N024 4472
//float Port_Input0_N027 4476
//float Port_Import_N028 4480
//float Port_Input1_N030 4484
//float Port_Input2_N030 4488
//float Port_Input1_N033 4492
//float Port_RangeMinA_N039 4496
//float Port_Import_N025 4500
//float Port_RangeMinB_N039 4504
//float Port_RangeMaxB_N039 4508
//float depthRef 4512
//}
...
Output_N15=(Output_N1*(*sc_set0.UserUniforms).Port_Input1_N015)*float2(Output_N2);
...
float3 param_12=(*sc_set0.UserUniforms).baseColor;
Output_N16=param_12;
...
Output_N20=float2((*sc_set0.UserUniforms).Port_Input0_N020)/Value_N91;
float2 CoordsOut_N85=float2(0.0);
CoordsOut_N85=((UVCoord_N19-(*sc_set0.UserUniforms).Port_Center_N085)*Output_N20)+(*sc_set0.UserUniforms).Port_Center_N085;
float2 Output_N21=float2(0.0);
Output_N21=CoordsOut_N85*float2((*sc_set0.UserUniforms).Port_Input1_N021);
float2 Output_N22=float2(0.0);
Output_N22=Output_N21-float2((*sc_set0.UserUniforms).Port_Input1_N022);
float Output_N79=0.0;
Output_N79=Output_N22.x;
float Output_N23=0.0;
Output_N23=Output_N22.y;
float Output_N24=0.0;
Output_N24=Output_N23*(*sc_set0.UserUniforms).Port_Input1_N024;
float Output_N26=0.0;
Output_N26=atan2(Output_N24,Output_N79);
float Output_N45=0.0;
Output_N45=3.1415927;
float Output_N27=0.0;
Output_N27=(*sc_set0.UserUniforms).Port_Input0_N027*Output_N45;
float Value_N28=0.0;
Value_N28=(*sc_set0.UserUniforms).Port_Import_N028;
float Output_N29=0.0;
Output_N29=floor(Value_N28);
float Output_N30=0.0;
Output_N30=fast::clamp(Output_N29,(*sc_set0.UserUniforms).Port_Input1_N030,(*sc_set0.UserUniforms).Port_Input2_N030);
...
Output_N33=Output_N32+(*sc_set0.UserUniforms).Port_Input1_N033;
...
ValueOut_N39=(((Output_N74-(*sc_set0.UserUniforms).Port_RangeMinA_N039)/((Value_N25-(*sc_set0.UserUniforms).Port_RangeMinA_N039)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N039-(*sc_set0.UserUniforms).Port_RangeMinB_N039))+(*sc_set0.UserUniforms).Port_RangeMinB_N039;
