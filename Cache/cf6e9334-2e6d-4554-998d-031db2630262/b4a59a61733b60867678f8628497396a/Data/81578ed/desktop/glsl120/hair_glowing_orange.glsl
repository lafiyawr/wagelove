...
float l9_24=l9_23;
vec3 l9_25=sc_SamplingCoordsViewToGlobal(vec2(l9_20,l9_22),hairTexLayout,l9_3);
vec4 l9_26=texture2D(hairTex,l9_25.xy,0.0);
vec4 l9_27;
#if (SC_USE_CLAMP_TO_BORDER_hairTex)
{
...
#endif
if ((float(l9_27.w<alphaTestThresh)*1.0)!=0.0)
{
discard;
}
...
vec3 l9_28=vec3(l9_27.xyz);
vec3 l9_29=vec3(hairRootsColor.xyz);
float l9_30=mixSize*Port_Input1_N057;
vec3 l9_31=mix(mix(l9_0,l9_28*l9_0,vec3(hairTipsColor.w)),mix(l9_29,l9_28*l9_29,vec3(hairRootsColor.w)),vec3(smoothstep(mixEdge-l9_30,mixEdge+l9_30,Globals.Surface_UVCoord0.y)));
float l9_32=cos(litRotation);
float l9_33=sin(litRotation);
int l9_34;
...
#endif
bool l9_35=(int(SC_USE_CLAMP_TO_BORDER_LitLookup)!=0)&&(!(int(SC_USE_UV_MIN_MAX_LitLookup)!=0));
float l9_36=(Globals.VertexTangent_ViewSpace.y*l9_32)-(Globals.VertexTangent_ViewSpace.x*l9_33);
sc_SoftwareWrapEarly(l9_36,ivec2(SC_SOFTWARE_WRAP_MODE_U_LitLookup,SC_SOFTWARE_WRAP_MODE_V_LitLookup).x);
float l9_37=l9_36;
float l9_38=((Globals.VertexTangent_ViewSpace.y*l9_33)+(Globals.VertexTangent_ViewSpace.x*l9_32))+litOffset;
sc_SoftwareWrapEarly(l9_38,ivec2(SC_SOFTWARE_WRAP_MODE_U_LitLookup,SC_SOFTWARE_WRAP_MODE_V_LitLookup).y);
float l9_39=l9_38;
vec2 l9_40;
float l9_41;
...
{
l9_42=ivec2(SC_SOFTWARE_WRAP_MODE_U_LitLookup,SC_SOFTWARE_WRAP_MODE_V_LitLookup).x==3;
}
#else
{
l9_42=(int(SC_USE_CLAMP_TO_BORDER_LitLookup)!=0);
}
#endif
float l9_43=l9_37;
float l9_44=1.0;
sc_ClampUV(l9_43,LitLookupUvMinMax.x,LitLookupUvMinMax.z,l9_42,l9_44);
float l9_45=l9_43;
float l9_46=l9_44;
bool l9_47;
#if (SC_USE_CLAMP_TO_BORDER_LitLookup)
{
l9_47=ivec2(SC_SOFTWARE_WRAP_MODE_U_LitLookup,SC_SOFTWARE_WRAP_MODE_V_LitLookup).y==3;
}
#else
{
l9_47=(int(SC_USE_CLAMP_TO_BORDER_LitLookup)!=0);
}
#endif
float l9_48=l9_39;
float l9_49=l9_46;
sc_ClampUV(l9_48,LitLookupUvMinMax.y,LitLookupUvMinMax.w,l9_47,l9_49);
l9_41=l9_49;
...
#endif
vec2 l9_50=sc_TransformUV(l9_40,(int(SC_USE_UV_TRANSFORM_LitLookup)!=0),LitLookupTransform);
float l9_51=l9_50.x;
float l9_52=l9_41;
sc_SoftwareWrapLate(l9_51,ivec2(SC_SOFTWARE_WRAP_MODE_U_LitLookup,SC_SOFTWARE_WRAP_MODE_V_LitLookup).x,l9_35,l9_52);
float l9_53=l9_50.y;
float l9_54=l9_52;
sc_SoftwareWrapLate(l9_53,ivec2(SC_SOFTWARE_WRAP_MODE_U_LitLookup,SC_SOFTWARE_WRAP_MODE_V_LitLookup).y,l9_35,l9_54);
float l9_55=l9_54;
vec3 l9_56=sc_SamplingCoordsViewToGlobal(vec2(l9_51,l9_53),LitLookupLayout,l9_34);
vec4 l9_57=texture2D(LitLookup,l9_56.xy,0.0);
vec4 l9_58;
#if (SC_USE_CLAMP_TO_BORDER_LitLookup)
{
l9_58=mix(LitLookupBorderColor,l9_57,vec4(l9_55));
}
#else
{
l9_58=l9_57;
...
#endif
Default=vec4(mix(l9_31,(l9_31*vec3(diffuseLightColor.xyz))*vec3(l9_58.x),vec3(diffuseLightColor.w))+((vec3(specularLightColor.xyz)*vec3(l9_58.y))*vec3(specularLightColor.w)),0.0);
Result=Default;
}
}
...
#endif
vec3 l9_26=mix(l9_24.xyz,definedBlend(l9_24.xyz,l9_2.xyz).xyz,vec3(Port_Value2_N120));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_28=vec4(mix(vec3(1.0),l9_2.xyz,vec3(Port_Value2_N120)),Port_Value2_N120);
}
#else
{
vec4 l9_29;
...
{
l9_30=clamp(Port_Value2_N120,0.0,1.0);
}
#else
{
l9_30=Port_Value2_N120;
}
#endif
...
vec4 l9_35=max(vec4((l9_1.xy*Port_Input1_N134)+Port_Input1_N135,Port_Value3_N132,blurMultiplier),vec4(0.0));
sc_writeFragData1(l9_35);
vec4 l9_36=outputMotionVectorsIfNeeded(varPos,max(l9_34,vec4(0.0))+(l9_35*1e-06));
