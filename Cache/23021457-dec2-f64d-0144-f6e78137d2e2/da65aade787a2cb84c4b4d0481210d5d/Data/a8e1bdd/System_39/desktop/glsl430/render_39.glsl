...
if (!l9_16)
{
l9_17=!vfxBatchEnable[sc_GetLocalInstanceID()/52500];
}
else
{
l9_17=l9_16;
...
bool l9_3=l9_2>=(52500*(vfxNumCopies+1));
bool l9_4;
if (!l9_3)
{
l9_4=vfxBatchEnable[sc_GetLocalInstanceID()/52500]==false;
}
else
{
l9_4=l9_3;
...
vec3 l9_12;
if ((l9_11<0.029999999)||(Port_Import_N049<9.9999997e-05))
{
...
uniform float Port_Input2_N159;
...
#endif
float l9_4=1.0-(distance(varPackedTex.xy,Port_Input1_N088)*Port_Input1_N153);
float l9_5;
if (l9_4<=0.0)
{
l9_5=0.0;
...
{
l9_5=pow(l9_4,Port_Import_N155);
}
if ((float((clamp((l9_5*Port_Import_N157)+0.001,Port_Input1_N159+0.001,Port_Input2_N159+0.001)-0.001)<Port_Input1_N161)*1.0)!=0.0)
{
discard;
}
vec4 l9_6;
