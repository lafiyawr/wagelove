...
uniform vec3 Port_Min_N048;
uniform vec3 Port_Max_N048;
uniform float Port_Import_N052;
uniform float Port_Input1_N054;
uniform vec3 Port_Max_N055;
...
uniform float Port_Import_N144;
...
uniform float Port_RangeMinA_N151;
uniform float Port_RangeMaxA_N151;
uniform float Port_RangeMaxB_N151;
uniform float Port_RangeMinB_N151;
...
uniform float Port_Input4_N270;
uniform float Port_Multiplier_N272;
uniform float Port_Import_N177;
uniform float Port_Import_N178;
uniform float Port_Import_N185;
uniform float Port_Input0_N181;
uniform float Port_Input1_N227;
uniform float Port_Input2_N227;
uniform float Port_Import_N188;
uniform float Port_Input0_N192;
uniform float Port_Input1_N236;
uniform float Port_Input2_N236;
uniform float Port_RangeMinA_N140;
uniform float Port_RangeMaxA_N140;
uniform float Port_RangeMinB_N140;
uniform float Port_RangeMaxB_N140;
uniform float Port_Input1_N148;
uniform float Port_Input2_N148;
uniform float Port_Position1_N137;
uniform float Port_Position2_N137;
uniform float Port_Position3_N137;
...
if (!l9_14)
{
l9_15=!vfxBatchEnable[sc_GetLocalInstanceID()/52500];
}
else
{
l9_15=l9_14;
...
void Node48_Particle_Random(vec3 Min,vec3 Max,out vec3 Random,ssGlobals Globals)
{
Random=mix(Min,Max,ssGetParticleRandom(3,true,true,true,48.0,gParticle,0.0,Globals.gTimeElapsed).xyz);
}
void Node55_Particle_Random(vec3 Min,vec3 Max,out vec3 Random,ssGlobals Globals)
{
Random=mix(Min,Max,ssGetParticleRandom(3,true,true,true,55.0,gParticle,0.0,Globals.gTimeElapsed).xyz);
}
void Node28_Particle_Random(float Min,float Max,out float Random,ssGlobals Globals)
{
Random=mix(Min,Max,ssGetParticleRandom(1,false,true,true,28.0,gParticle,0.0,Globals.gTimeElapsed).x);
}
...
gParticle.Age=mod((l9_3-gParticle.SpawnOffset)+0.0,15.0);
float l9_4=gParticle.SpawnOffset;
bool l9_5=(sc_Time.x-l9_4)<(0.0-0.0);
bool l9_6;
if (!l9_5)
{
l9_6=gParticle.Age>15.0;
}
else
{
l9_6=l9_5;
...
if (!l9_9)
{
l9_10=mod(((max(sc_Time.x,0.1)-gParticle.SpawnOffset)-0.0)+0.0,15.0)<=l9_1;
}
else
{
l9_10=l9_9;
...
if (l9_1!=0.0)
{
ssGlobals l9_11=ssGlobals(sc_Time.x,l9_1,l9_3,overrideTimeElapsed[sc_GetLocalInstanceID()/52500]);
ssCalculateParticleSeed(gParticle,int(gParticle.CopyId));
float l9_13=floor(229.0);
gParticle.Position=(vec3(((floor(mod(gParticle.Index1DPerCopyF,l9_13))/229.0)*2.0)-1.0,((floor(gParticle.Index1DPerCopyF/l9_13)/229.0)*2.0)-1.0,0.0)*20.0)+vec3(1.0,1.0,0.0);
gParticle.Velocity=vec3(0.0);
...
float l9_14;
if ((float(0.0==Port_Input1_N047)*1.0)!=0.0)
{
vec3 l9_15;
Node48_Particle_Random(Port_Min_N048,Port_Max_N048,l9_15,l9_11);
vec3 l9_16=l9_15;
float l9_17=1.0-clamp(Port_Import_N052,0.0,1.0);
float l9_18;
if (l9_17<=0.0)
{
l9_18=0.0;
...
{
l9_18=pow(l9_17,Port_Input1_N054);
}
vec3 l9_19;
Node55_Particle_Random(vec3(l9_18),Port_Max_N055,l9_19,l9_11);
vec3 l9_20=l9_19;
float l9_21;
if (l9_20.x<=0.0)
{
...
l9_14=abs(((((l9_16/(vec3(length(l9_16))+vec3(1.234e-06)))*vec3(l9_22,0.0,0.0))*vec3(Port_Import_N058))*Port_Import_N059).x);
}
else
{
vec3 l9_23;
Node48_Particle_Random(Port_Min_N048,Port_Max_N048,l9_23,l9_11);
vec3 l9_24=l9_23;
float l9_25=1.0-clamp(Port_Import_N052,0.0,1.0);
float l9_26;
if (l9_25<=0.0)
{
l9_26=0.0;
...
{
l9_26=pow(l9_25,Port_Input1_N054);
}
vec3 l9_27;
Node55_Particle_Random(vec3(l9_26),Port_Max_N055,l9_27,l9_11);
vec3 l9_28=l9_27;
float l9_29;
if (l9_28.x<=0.0)
{
...
l9_14=((((l9_24/(vec3(length(l9_24))+vec3(1.234e-06)))*vec3(l9_30,0.0,0.0))*vec3(Port_Import_N058))*Port_Import_N059).x;
}
float l9_31;
if ((float(0.0==Port_Input1_N079)*1.0)!=0.0)
{
vec3 l9_32;
Node48_Particle_Random(Port_Min_N048,Port_Max_N048,l9_32,l9_11);
vec3 l9_33=l9_32;
float l9_34=1.0-clamp(Port_Import_N052,0.0,1.0);
float l9_35;
if (l9_34<=0.0)
{
l9_35=0.0;
...
{
l9_35=pow(l9_34,Port_Input1_N054);
}
vec3 l9_36;
Node55_Particle_Random(vec3(l9_35),Port_Max_N055,l9_36,l9_11);
vec3 l9_37=l9_36;
float l9_38;
if (l9_37.y<=0.0)
{
...
l9_31=abs(((((l9_33/(vec3(length(l9_33))+vec3(1.234e-06)))*vec3(0.0,l9_39,0.0))*vec3(Port_Import_N058))*Port_Import_N059).y);
}
else
{
vec3 l9_40;
Node48_Particle_Random(Port_Min_N048,Port_Max_N048,l9_40,l9_11);
vec3 l9_41=l9_40;
float l9_42=1.0-clamp(Port_Import_N052,0.0,1.0);
float l9_43;
if (l9_42<=0.0)
{
l9_43=0.0;
...
{
l9_43=pow(l9_42,Port_Input1_N054);
}
vec3 l9_44;
Node55_Particle_Random(vec3(l9_43),Port_Max_N055,l9_44,l9_11);
vec3 l9_45=l9_44;
float l9_46;
if (l9_45.y<=0.0)
{
...
l9_31=((((l9_41/(vec3(length(l9_41))+vec3(1.234e-06)))*vec3(0.0,l9_47,0.0))*vec3(Port_Import_N058))*Port_Import_N059).y;
}
float l9_48;
if ((float(0.0==Port_Input1_N149)*1.0)!=0.0)
{
vec3 l9_49;
Node48_Particle_Random(Port_Min_N048,Port_Max_N048,l9_49,l9_11);
vec3 l9_50=l9_49;
float l9_51=1.0-clamp(Port_Import_N052,0.0,1.0);
float l9_52;
if (l9_51<=0.0)
{
l9_52=0.0;
...
{
l9_52=pow(l9_51,Port_Input1_N054);
}
vec3 l9_53;
Node55_Particle_Random(vec3(l9_52),Port_Max_N055,l9_53,l9_11);
vec3 l9_54=l9_53;
float l9_55;
if (l9_54.z<=0.0)
{
...
l9_48=abs(((((l9_50/(vec3(length(l9_50))+vec3(1.234e-06)))*vec3(0.0,0.0,l9_56))*vec3(Port_Import_N058))*Port_Import_N059).z);
}
else
{
vec3 l9_57;
Node48_Particle_Random(Port_Min_N048,Port_Max_N048,l9_57,l9_11);
vec3 l9_58=l9_57;
float l9_59=1.0-clamp(Port_Import_N052,0.0,1.0);
float l9_60;
if (l9_59<=0.0)
{
l9_60=0.0;
...
{
l9_60=pow(l9_59,Port_Input1_N054);
}
vec3 l9_61;
Node55_Particle_Random(vec3(l9_60),Port_Max_N055,l9_61,l9_11);
vec3 l9_62=l9_61;
float l9_63;
if (l9_62.z<=0.0)
{
...
l9_48=((((l9_58/(vec3(length(l9_58))+vec3(1.234e-06)))*vec3(0.0,0.0,l9_64))*vec3(Port_Import_N058))*Port_Import_N059).z;
}
gParticle.Position=Port_Import_N216+vec3(l9_14,l9_31,l9_48);
gParticle.Color=Port_Value_N011;
gParticle.Mass=mix(Port_Import_N143,Port_Import_N144,ssGetParticleRandom(1,true,true,true,145.0,gParticle,0.0,sc_Time.x).x);
gParticle.Mass=max(9.9999997e-06,gParticle.Mass);
float l9_65;
if ((0.0*1.0)!=0.0)
{
float l9_66;
Node28_Particle_Random(Port_Import_N027,Port_Import_N038,l9_66,l9_11);
l9_65=l9_66/(length(vfxLocalAabbMax-vfxLocalAabbMin)+1.234e-06);
}
else
{
float l9_67;
Node28_Particle_Random(Port_Import_N027,Port_Import_N038,l9_67,l9_11);
l9_65=l9_67;
}
gParticle.Size=l9_65;
gParticle.Velocity+=((gParticle.Force/vec3(gParticle.Mass))*0.033330001);
gParticle.Force=vec3(0.0);
gParticle.Position=(vfxModelMatrix[sc_GetLocalInstanceID()/52500]*vec4(gParticle.Position,1.0)).xyz;
int l9_68=sc_GetLocalInstanceID()/52500;
gParticle.Velocity=mat3(vfxModelMatrix[l9_68][0].xyz,vfxModelMatrix[l9_68][1].xyz,vfxModelMatrix[l9_68][2].xyz)*gParticle.Velocity;
int l9_69=sc_GetLocalInstanceID()/52500;
gParticle.Force=mat3(vfxModelMatrix[l9_69][0].xyz,vfxModelMatrix[l9_69][1].xyz,vfxModelMatrix[l9_69][2].xyz)*gParticle.Force;
gParticle.Size=max(length(vfxModelMatrix[sc_GetLocalInstanceID()/52500][0].xyz),max(length(vfxModelMatrix[sc_GetLocalInstanceID()/52500][1].xyz),length(vfxModelMatrix[sc_GetLocalInstanceID()/52500][2].xyz)))*gParticle.Size;
int l9_70=sc_GetLocalInstanceID()/52500;
gParticle.Matrix=mat3(vfxModelMatrix[l9_70][0].xyz,vfxModelMatrix[l9_70][1].xyz,vfxModelMatrix[l9_70][2].xyz)*gParticle.Matrix;
...
if ((float(isIdle)*1.0)!=0.0)
{
l9_71=Port_Input1_N007;
}
else
{
l9_71=distance(inputPos,gParticle.Position);
}
float l9_72=l9_71-Port_RangeMinA_N051;
float l9_73=((l9_72/((Port_RangeMaxA_N051-Port_RangeMinA_N051)+1e-06))*(Port_RangeMaxB_N051-Port_RangeMinB_N051))+Port_RangeMinB_N051;
float l9_74;
if (Port_RangeMaxB_N051>Port_RangeMinB_N051)
{
l9_74=clamp(l9_73,Port_RangeMinB_N051,Port_RangeMaxB_N051);
}
else
{
l9_74=clamp(l9_73,Port_RangeMaxB_N051,Port_RangeMinB_N051);
}
float l9_75;
if (l9_74<=0.0)
{
...
{
l9_75=pow(l9_74,Port_Input1_N002);
}
gParticle.Force+=((velocity*vec3(Port_Input1_N050))*vec3(l9_75));
float l9_76=l9_75-Port_RangeMinA_N044;
vec3 l9_77=gParticle.Position;
vec3 l9_78=inputPos-l9_77;
...
gParticle.Force+=(vec3(((l9_76/((Port_RangeMaxA_N044-Port_RangeMinA_N044)+1e-06))*(Port_RangeMaxB_N044-Port_RangeMinB_N044))+Port_RangeMinB_N044)*(l9_78*l9_80));
vec3 l9_81=((gParticle.Position+Port_Import_N075)+(Port_Import_N318*vec3(l9_3*Port_Multiplier_N319)))*(vec3(1.0)/vec3((((l9_74-Port_RangeMinA_N152)/((Port_RangeMaxA_N152-Port_RangeMinA_N152)+1e-06))*(Port_RangeMaxB_N152-Port_RangeMinB_N152))+Port_RangeMinB_N152));
vec2 l9_82=vec2(l9_81.xy)+Port_Input1_N326;
vec2 l9_83=vec2(l9_81.yz)+Port_Input1_N329;
vec2 l9_84=vec2(l9_81.zx)+Port_Input1_N332;
gParticle.Force+=(vec3((((l9_74-Port_RangeMinA_N151)/((Port_RangeMaxA_N151-Port_RangeMinA_N151)+1e-06))*(Port_RangeMaxB_N151-Port_RangeMinB_N151))+Port_RangeMinB_N151)*((vec3(floor(((snoise(vec2(floor(l9_82.x*10000.0)*9.9999997e-05,floor(l9_82.y*10000.0)*9.9999997e-05)*(Port_Scale_N327*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05,floor(((snoise(vec2(floor(l9_83.x*10000.0)*9.9999997e-05,floor(l9_83.y*10000.0)*9.9999997e-05)*(Port_Scale_N330*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05,floor(((snoise(vec2(floor(l9_84.x*10000.0)*9.9999997e-05,floor(l9_84.y*10000.0)*9.9999997e-05)*(Port_Scale_N333*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05)*Port_Input1_N335)-vec3(1.0)));
vec3 l9_85=abs(gParticle.Velocity*vec3(gParticle.Mass))/(vec3(l9_1*Port_Multiplier_N272)+vec3(1.234e-06));
gParticle.Force+=clamp((((vec3(Port_Import_N267)*vec3(Port_Import_N268))*vec3(Port_Import_N269))*((-gParticle.Velocity)*vec3(length(gParticle.Velocity))))*vec3(Port_Input4_N270),-l9_85,l9_85);
float l9_86=clamp(gParticle.Age/gParticle.Life,0.0,1.0);
float l9_87=gParticle.Life+1.234e-06;
vec4 l9_88=vec4(gParticle.Color.x,gParticle.Color.y,gParticle.Color.z,vec4(0.0).w);
l9_88.w=mix(Port_Import_N177,Port_Import_N178,(clamp((l9_86*(Port_Input0_N181/((Port_Import_N185/l9_87)+1.234e-06)))+0.001,Port_Input1_N227+0.001,Port_Input2_N227+0.001)-0.001)*(clamp(((1.0-l9_86)*(Port_Input0_N192/((Port_Import_N188/l9_87)+1.234e-06)))+0.001,Port_Input1_N236+0.001,Port_Input2_N236+0.001)-0.001));
gParticle.Color=l9_88;
vec3 l9_89=gParticle.Velocity;
float l9_90=(((length(l9_89)-Port_RangeMinA_N140)/((Port_RangeMaxA_N140-Port_RangeMinA_N140)+1e-06))*(Port_RangeMaxB_N140-Port_RangeMinB_N140))+Port_RangeMinB_N140;
float l9_91;
if (Port_RangeMaxB_N140>Port_RangeMinB_N140)
{
l9_91=clamp(l9_90,Port_RangeMinB_N140,Port_RangeMaxB_N140);
}
else
{
l9_91=clamp(l9_90,Port_RangeMaxB_N140,Port_RangeMinB_N140);
}
float l9_92=clamp(l9_91,Port_Input1_N148,Port_Input2_N148);
float l9_93=clamp(l9_92,0.0,1.0);
vec4 l9_94;
if (l9_93<Port_Position1_N137)
{
l9_94=mix(colorA,colorB,vec4(clamp(l9_93/Port_Position1_N137,0.0,1.0)));
}
else
{
vec4 l9_95;
if (l9_93<Port_Position2_N137)
{
l9_95=mix(colorB,colorC,vec4(clamp((l9_93-Port_Position1_N137)/(Port_Position2_N137-Port_Position1_N137),0.0,1.0)));
}
else
{
vec4 l9_96;
if (l9_93<Port_Position3_N137)
{
l9_96=mix(colorC,colorD,vec4(clamp((l9_93-Port_Position2_N137)/(Port_Position3_N137-Port_Position2_N137),0.0,1.0)));
}
else
{
l9_96=mix(colorD,colorE,vec4(clamp((l9_93-Port_Position3_N137)/(1.0-Port_Position3_N137),0.0,1.0)));
}
l9_95=l9_96;
}
l9_94=l9_95;
}
gParticle.Color=vec4(1.0,1.0,1.0,gParticle.Color.w)*l9_94;
...
vec2 l9_103=vec2(4.0,1.0)/vec2(2048.0,vfxTargetSizeWrite.y);
int l9_104=vfxOffsetInstancesWrite+sc_GetLocalInstanceID();
float l9_105;
if (texture0.x<0.5)
{
l9_105=0.0;
...
sc_SetClipPosition(vec4(((vec2(l9_105,l9_106)+(vec2(float(l9_104%512),float(l9_104/512))*l9_103))*2.0)-vec2(1.0),1.0,1.0));
...
vec4 l9_43=ssEncodeFloat32(Interp_Particle_Life,0.0,15.0,0.99998999);
vec4 l9_44=ssEncodeFloat32(Interp_Particle_Age,0.0,15.0,0.99998999);
l9_40=l9_44.w;
l9_39=l9_44.z;
l9_38=l9_44.y;
l9_37=l9_44.x;
