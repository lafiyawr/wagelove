...
//float Port_Import_N049 7140
//float2 Port_Import_N060 7144
//float2 Port_Input1_N088 7160
//float Port_Input1_N153 7168
//float Port_Import_N155 7172
//float Port_Import_N157 7176
//float Port_Input1_N159 7180
//float Port_Input2_N159 7184
//float Port_Input1_N161 7188
//}
...
float Port_Input1_N159;
float Port_Input2_N159;
...
{
main_vert_out out={};
int N62_FacingMode=0;
int N62_Alignment=0;
float N62_VelocityStretchAmount=0.0;
float2 N62_PivotPoint=float2(0.0);
sc_Vertex_t l9_0;
...
int InstanceID=l9_2;
int l9_3=InstanceID;
bool l9_4=l9_3>=(52500*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
int l9_6=gl_InstanceIndex;
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[l9_6/52500]!=0)==false;
}
else
{
l9_5=l9_4;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_17/52500];
...
Value_N60=fast::clamp((*sc_set0.UserUniforms).Port_Import_N060,float2(-0.5),float2(0.5));
float param_5=Value_N10;
float param_6=Value_N66;
float param_7=Value_N49;
float2 param_8=Value_N60;
ssGlobals param_9=Globals;
ssGlobals tempGlobals=param_9;
N62_FacingMode=int(param_5);
N62_Alignment=int(param_6);
N62_VelocityStretchAmount=param_7;
N62_PivotPoint=param_8;
float l9_36=0.029999999;
float3 l9_37=float3(0.0,1.0,0.0);
float3 l9_38=gParticle.Velocity;
float l9_39=length(l9_38);
float l9_40=fast::max(l9_39*N62_VelocityStretchAmount,1.0);
if ((l9_39<l9_36)||(N62_VelocityStretchAmount<9.9999997e-05))
{
if (N62_Alignment==1)
{
int l9_41=0;
...
float2 l9_54=(l9_53-float2(0.5))+N62_PivotPoint;
...
ssGlobals Globals;
Globals.gTimeElapsed=(*sc_set0.UserUniforms).sc_Time.x;
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/52500];
Globals.gTimeDelta=fast::min((*sc_set0.UserUniforms).overrideTimeDelta,0.5);
Globals.gTimeElapsedShifted=(Globals.gTimeElapsed-(gParticle.TimeShift*Globals.gTimeDelta))-0.0;
...
Value_N46=gParticle.Color;
float2 UVCoord_N76=float2(0.0);
UVCoord_N76=Globals.Surface_UVCoord0;
float Output_N88=0.0;
Output_N88=distance(UVCoord_N76,(*sc_set0.UserUniforms).Port_Input1_N088);
float Output_N153=0.0;
Output_N153=Output_N88*(*sc_set0.UserUniforms).Port_Input1_N153;
float Output_N154=0.0;
Output_N154=1.0-Output_N153;
float Value_N155=0.0;
Value_N155=(*sc_set0.UserUniforms).Port_Import_N155;
...
{
l9_24=pow(Output_N154,Value_N155);
}
Output_N156=l9_24;
float Value_N157=0.0;
Value_N157=(*sc_set0.UserUniforms).Port_Import_N157;
float Output_N158=0.0;
Output_N158=Output_N156*Value_N157;
float Output_N159=0.0;
Output_N159=fast::clamp(Output_N158+0.001,(*sc_set0.UserUniforms).Port_Input1_N159+0.001,(*sc_set0.UserUniforms).Port_Input2_N159+0.001)-0.001;
float Export_N160=0.0;
Export_N160=Output_N159;
float Output_N161=0.0;
Output_N161=float(Export_N160<(*sc_set0.UserUniforms).Port_Input1_N161);
float4 Output_N22=float4(0.0);
float4 param_2=Value_N46;
float param_3=Output_N161;
