...
//ubo int UserUniforms 0:31:7360 {
//float4 sc_Time 1376
...
//float4 Tweak_N33 7152
//float Port_Import_N163 7168
//float2 Port_Import_N164 7176
//float Port_RangeMinA_N016 7188
//float Port_RangeMaxA_N016 7192
//float Port_RangeMinB_N016 7196
//float Port_RangeMaxB_N016 7200
//float Port_Input1_N089 7204
//float4 Port_Value1_N144 7216
//float Port_Input1_N142 7232
//float Port_Input1_N018 7236
//float Port_Input1_N143 7240
//float4 Port_Value3_N144 7248
//float4 Port_Default_N144 7264
//float Port_Input0_N151 7280
//float Port_Input1_N151 7284
//float2 Port_Center_N152 7288
//float Port_RangeMinA_N017 7296
//float Port_RangeMaxA_N017 7300
//float Port_RangeMinB_N017 7304
//float Port_RangeMaxB_N017 7308
//float Port_Input1_N029 7312
//float4 Port_Default_N147 7328
//float Port_Input1_N030 7344
//}
...
float4 Port_Value1_N144;
float Port_Input1_N142;
float Port_Input1_N018;
float Port_Input1_N143;
float4 Port_Value3_N144;
float4 Port_Default_N144;
float Port_Input0_N151;
float Port_Input1_N151;
float2 Port_Center_N152;
...
{
main_vert_out out={};
int N165_FacingMode=0;
int N165_Alignment=0;
float N165_VelocityStretchAmount=0.0;
float2 N165_PivotPoint=float2(0.0);
sc_Vertex_t l9_0;
...
int InstanceID=l9_2;
int l9_3=InstanceID;
bool l9_4=l9_3>=(25*((*sc_set0.UserUniforms).vfxNumCopies+1));
ssParticle gParticle;
bool l9_5;
if (!l9_4)
{
int l9_6=gl_InstanceIndex;
l9_5=((*sc_set0.UserUniforms).vfxBatchEnable[l9_6/25]!=0)==false;
}
else
{
l9_5=l9_4;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_17/25];
...
Value_N164=fast::clamp((*sc_set0.UserUniforms).Port_Import_N164,float2(-0.5),float2(0.5));
float param_5=Value_N161;
float param_6=Value_N162;
float param_7=Value_N163;
float2 param_8=Value_N164;
ssGlobals param_9=Globals;
ssGlobals tempGlobals=param_9;
N165_FacingMode=int(param_5);
N165_Alignment=int(param_6);
N165_VelocityStretchAmount=param_7;
N165_PivotPoint=param_8;
float l9_36=0.029999999;
float3 l9_37=float3(0.0,1.0,0.0);
float3 l9_38=gParticle.Velocity;
float l9_39=length(l9_38);
float l9_40=fast::max(l9_39*N165_VelocityStretchAmount,1.0);
if ((l9_39<l9_36)||(N165_VelocityStretchAmount<9.9999997e-05))
{
if (N165_Alignment==1)
{
int l9_41=0;
...
float2 l9_54=(l9_53-float2(0.5))+N165_PivotPoint;
...
ssGlobals Globals;
Globals.gTimeElapsed=(*sc_set0.UserUniforms).sc_Time.x;
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[in.Interp_Particle_Index/25];
Globals.gTimeDelta=fast::min((*sc_set0.UserUniforms).overrideTimeDelta,0.5);
Globals.gTimeElapsedShifted=(Globals.gTimeElapsed-(gParticle.TimeShift*Globals.gTimeDelta))-0.0;
...
float4 param_2=(*sc_set0.UserUniforms).Tweak_N33;
Output_N33=param_2;
float4 Result_N144=float4(0.0);
float param_3=0.0;
float4 param_4=(*sc_set0.UserUniforms).Port_Value1_N144;
float param_5=0.0;
float4 param_6=float4(0.0,0.0,0.0,1.0);
float param_7=0.0;
float4 param_8=(*sc_set0.UserUniforms).Port_Value3_N144;
float4 param_9=(*sc_set0.UserUniforms).Port_Default_N144;
ssGlobals param_11=Globals;
float2 l9_24=float2(0.0);
l9_24=param_11.Surface_UVCoord0;
float2 l9_25=float2(0.0);
l9_25=(((l9_24-float2((*sc_set0.UserUniforms).Port_RangeMinA_N016))/float2(((*sc_set0.UserUniforms).Port_RangeMaxA_N016-(*sc_set0.UserUniforms).Port_RangeMinA_N016)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N016-(*sc_set0.UserUniforms).Port_RangeMinB_N016))+float2((*sc_set0.UserUniforms).Port_RangeMinB_N016);
float l9_26=0.0;
l9_26=length(l9_25);
float l9_27=0.0;
l9_27=float(l9_26==(*sc_set0.UserUniforms).Port_Input1_N089);
param_3=l9_27;
float2 l9_28=float2(0.0);
l9_28=param_11.Surface_UVCoord0;
float2 l9_29=float2(0.0);
l9_29=(((l9_28-float2((*sc_set0.UserUniforms).Port_RangeMinA_N016))/float2(((*sc_set0.UserUniforms).Port_RangeMaxA_N016-(*sc_set0.UserUniforms).Port_RangeMinA_N016)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N016-(*sc_set0.UserUniforms).Port_RangeMinB_N016))+float2((*sc_set0.UserUniforms).Port_RangeMinB_N016);
float l9_30=0.0;
l9_30=length(l9_29);
float l9_31=0.0;
l9_31=float(l9_30<(*sc_set0.UserUniforms).Port_Input1_N142);
param_5=l9_31;
float2 l9_32=float2(0.0);
l9_32=param_11.Surface_UVCoord0;
float2 l9_33=float2(0.0);
l9_33=(((l9_32-float2((*sc_set0.UserUniforms).Port_RangeMinA_N016))/float2(((*sc_set0.UserUniforms).Port_RangeMaxA_N016-(*sc_set0.UserUniforms).Port_RangeMinA_N016)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N016-(*sc_set0.UserUniforms).Port_RangeMinB_N016))+float2((*sc_set0.UserUniforms).Port_RangeMinB_N016);
float l9_34=0.0;
l9_34=length(l9_33);
float l9_35=0.0;
l9_35=float(l9_34<(*sc_set0.UserUniforms).Port_Input1_N143);
param_7=l9_35;
float4 param_10;
if ((param_3*1.0)!=0.0)
{
...
l9_36=param_11.Surface_UVCoord0;
float2 l9_37=float2(0.0);
l9_37=(((l9_36-float2((*sc_set0.UserUniforms).Port_RangeMinA_N016))/float2(((*sc_set0.UserUniforms).Port_RangeMaxA_N016-(*sc_set0.UserUniforms).Port_RangeMinA_N016)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N016-(*sc_set0.UserUniforms).Port_RangeMinB_N016))+float2((*sc_set0.UserUniforms).Port_RangeMinB_N016);
float l9_38=0.0;
l9_38=length(l9_37);
float l9_39=0.0;
l9_39=l9_38*(*sc_set0.UserUniforms).Port_Input1_N018;
param_6=float4(l9_39);
param_10=param_6;
}
else
{
...
Result_N144=param_10;
float4 Result_N147=float4(0.0);
float param_12=0.0;
float4 param_13=float4(0.0,0.0,0.0,1.0);
float4 param_14=(*sc_set0.UserUniforms).Port_Default_N147;
ssGlobals param_16=Globals;
float2 l9_40=float2(0.0);
l9_40=param_16.Surface_UVCoord0;
float l9_41=0.0;
l9_41=(*sc_set0.UserUniforms).Port_Input0_N151/((*sc_set0.UserUniforms).Port_Input1_N151+1.234e-06);
float2 l9_42=float2(0.0);
l9_42=((l9_40-(*sc_set0.UserUniforms).Port_Center_N152)*float2(l9_41))+(*sc_set0.UserUniforms).Port_Center_N152;
float2 l9_43=float2(0.0);
l9_43=(((l9_42-float2((*sc_set0.UserUniforms).Port_RangeMinA_N017))/float2(((*sc_set0.UserUniforms).Port_RangeMaxA_N017-(*sc_set0.UserUniforms).Port_RangeMinA_N017)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N017-(*sc_set0.UserUniforms).Port_RangeMinB_N017))+float2((*sc_set0.UserUniforms).Port_RangeMinB_N017);
float l9_44=0.0;
l9_44=length(l9_43);
float l9_45=0.0;
l9_45=float(l9_44<(*sc_set0.UserUniforms).Port_Input1_N029);
param_12=l9_45;
float4 param_15;
if ((param_12*1.0)!=0.0)
{
float2 l9_46=float2(0.0);
l9_46=param_16.Surface_UVCoord0;
float l9_47=0.0;
l9_47=(*sc_set0.UserUniforms).Port_Input0_N151/((*sc_set0.UserUniforms).Port_Input1_N151+1.234e-06);
float2 l9_48=float2(0.0);
l9_48=((l9_46-(*sc_set0.UserUniforms).Port_Center_N152)*float2(l9_47))+(*sc_set0.UserUniforms).Port_Center_N152;
float2 l9_49=float2(0.0);
l9_49=(((l9_48-float2((*sc_set0.UserUniforms).Port_RangeMinA_N017))/float2(((*sc_set0.UserUniforms).Port_RangeMaxA_N017-(*sc_set0.UserUniforms).Port_RangeMinA_N017)+1e-06))*((*sc_set0.UserUniforms).Port_RangeMaxB_N017-(*sc_set0.UserUniforms).Port_RangeMinB_N017))+float2((*sc_set0.UserUniforms).Port_RangeMinB_N017);
float l9_50=0.0;
l9_50=length(l9_49);
float l9_51=0.0;
l9_51=1.0-l9_50;
param_13=float4(l9_51);
param_15=param_13;
}
else
{
...
Result_N147=param_15;
float4 Output_N30=float4(0.0);
Output_N30=Result_N147*float4((*sc_set0.UserUniforms).Port_Input1_N030);
float4 Output_N148=float4(0.0);
Output_N148=Result_N144+Output_N30;
float4 Export_N145=float4(0.0);
Export_N145=Output_N148;
float4 Output_N32=float4(0.0);
Output_N32=Output_N33*Export_N145;
float4 param_17=Output_N32;
Output_Color0=param_17;
float4 param_18=Output_Color0;
...
{
l9_56.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_57=l9_56;
l9_54=l9_57;
}
...
float2 l9_59=l9_58.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
float2 l9_60=l9_59;
...
int l9_64=l9_63;
int l9_65=l9_64;
float3 l9_66=float3(l9_60,0.0);
int l9_67=l9_62;
int l9_68=l9_65;
if (l9_67==1)
{
l9_66.y=((2.0*l9_66.y)+float(l9_68))-1.0;
}
...
float2 l9_85=l9_81;
int l9_86=sc_ScreenTextureLayout_tmp;
int l9_87=l9_82;
float l9_88=l9_83;
float2 l9_89=l9_85;
int l9_90=l9_86;
...
float l9_96=l9_88;
float4 l9_97=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_95,bias(l9_96));
float4 l9_98=l9_97;
l9_84=l9_98;
float4 l9_99=l9_84;
float4 l9_100=l9_99;
...
float3 l9_104=l9_103.xyz;
float3 l9_105=l9_104;
float3 l9_106=l9_52.xyz;
float3 l9_107=definedBlend(l9_105,l9_106,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_53=float4(l9_107.x,l9_107.y,l9_107.z,l9_53.w);
float3 l9_108=mix(l9_104,l9_53.xyz,float3(l9_52.w));
l9_53=float4(l9_108.x,l9_108.y,l9_108.z,l9_53.w);
l9_53.w=1.0;
float4 l9_109=l9_53;
param_18=l9_109;
}
...
{
l9_111=float4(mix(float3(1.0),l9_110.xyz,float3(l9_110.w)),l9_110.w);
}
else
{
if ((int(sc_BlendMode_Screen_tmp)!=0)||(int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
float l9_112=l9_110.w;
if ((int(sc_BlendMode_PremultipliedAlphaAuto_tmp)!=0))
{
l9_112=fast::clamp(l9_112,0.0,1.0);
}
l9_111=float4(l9_110.xyz*l9_112,l9_112);
}
else
{
l9_111=l9_110;
...
float4 l9_113=l9_111;
param_18=l9_113;
}
}
float4 l9_114=param_18;
Output_Color0=l9_114;
float4 l9_115=float4(0.0);
if ((int(sc_ShaderComplexityAnalyzer_tmp)!=0))
{
l9_115=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_115=float4(0.0);
