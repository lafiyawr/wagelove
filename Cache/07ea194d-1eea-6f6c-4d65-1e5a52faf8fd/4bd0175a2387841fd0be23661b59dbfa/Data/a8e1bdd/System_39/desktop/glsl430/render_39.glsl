...
if (!l9_16)
{
l9_17=!vfxBatchEnable[sc_GetLocalInstanceID()/25];
}
else
{
l9_17=l9_16;
...
bool l9_3=l9_2>=(25*(vfxNumCopies+1));
bool l9_4;
if (!l9_3)
{
l9_4=vfxBatchEnable[sc_GetLocalInstanceID()/25]==false;
}
else
{
l9_4=l9_3;
...
vec3 l9_12;
if ((l9_11<0.029999999)||(Port_Import_N163<9.9999997e-05))
{
...
uniform vec4 Port_Value1_N144;
uniform vec4 Port_Value3_N144;
uniform vec4 Port_Default_N144;
uniform vec4 Port_Default_N147;
...
#endif
float l9_4=length((((varPackedTex.xy-vec2(Port_RangeMinA_N016))/vec2((Port_RangeMaxA_N016-Port_RangeMinA_N016)+1e-06))*(Port_RangeMaxB_N016-Port_RangeMinB_N016))+vec2(Port_RangeMinB_N016));
vec4 l9_5;
if ((float(l9_4==Port_Input1_N089)*1.0)!=0.0)
{
l9_5=Port_Value1_N144;
}
else
{
vec4 l9_6;
if ((float(l9_4<Port_Input1_N142)*1.0)!=0.0)
{
l9_6=vec4(l9_4*Port_Input1_N018);
}
else
{
vec4 l9_7;
if ((float(l9_4<Port_Input1_N143)*1.0)!=0.0)
{
l9_7=Port_Value3_N144;
}
else
{
l9_7=Port_Default_N144;
}
l9_6=l9_7;
}
l9_5=l9_6;
}
float l9_8=length(((((((varPackedTex.xy-Port_Center_N152)*vec2(Port_Input0_N151/(Port_Input1_N151+1.234e-06)))+Port_Center_N152)-vec2(Port_RangeMinA_N017))/vec2((Port_RangeMaxA_N017-Port_RangeMinA_N017)+1e-06))*(Port_RangeMaxB_N017-Port_RangeMinB_N017))+vec2(Port_RangeMinB_N017));
vec4 l9_9;
if ((float(l9_8<Port_Input1_N029)*1.0)!=0.0)
{
l9_9=vec4(1.0-l9_8);
}
else
{
l9_9=Port_Default_N147;
}
vec4 l9_10=l9_9*vec4(Port_Input1_N030);
vec4 l9_11=l9_5+l9_10;
vec4 l9_12=Tweak_N33*l9_11;
vec4 l9_13;
...
#else
{
vec2 l9_19=gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw;
vec2 l9_20;
#if (sc_StereoRenderingMode==1)
{
...
{
l9_23=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_20,sc_ScreenTextureLayout,l9_22),0.0);
}
#else
{
l9_23=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_20,sc_ScreenTextureLayout,l9_22).xy,0.0);
}
#endif
l9_15=l9_23;
}
...
{
vec4 l9_25=l9_15;
l9_25.x=l9_15.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_24=l9_25;
}
#else
{
...
#endif
vec3 l9_26=mix(l9_24.xyz,definedBlend(l9_24.xyz,l9_12.xyz).xyz,vec3(l9_12.w));
...
{
float l9_29=l9_12.w;
l9_28=vec4(mix(vec3(1.0),l9_12.xyz,vec3(l9_29)),l9_29);
}
#else
{
vec4 l9_30;
...
#endif
l9_30=vec4(l9_12.xyz*l9_32,l9_32);
}
#else
{
l9_30=l9_12;
