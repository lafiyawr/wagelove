...
if (!l9_14)
{
l9_15=!vfxBatchEnable[sc_GetLocalInstanceID()/25];
}
else
{
l9_15=l9_14;
...
void Node117_Particle_Random(vec2 Min,vec2 Max,out vec2 Random,ssGlobals Globals)
{
Random=mix(Min,Max,ssGetParticleRandom(2,true,true,true,117.0,gParticle,0.0,Globals.gTimeElapsed).xy);
}
void Node131_Particle_Random(float Min,float Max,out float Random,ssGlobals Globals)
{
Random=mix(Min,Max,ssGetParticleRandom(1,true,true,true,131.0,gParticle,0.0,Globals.gTimeElapsed).x);
}
...
if (l9_1!=0.0)
{
ssGlobals l9_11=ssGlobals(sc_Time.x,l9_1,l9_3,overrideTimeElapsed[sc_GetLocalInstanceID()/25]);
ssCalculateParticleSeed(gParticle,int(gParticle.CopyId));
float l9_13=floor(5.0);
gParticle.Position=(vec3(((floor(mod(gParticle.Index1DPerCopyF,l9_13))/5.0)*2.0)-1.0,((floor(gParticle.Index1DPerCopyF/l9_13)/5.0)*2.0)-1.0,0.0)*20.0)+vec3(1.0,1.0,0.0);
gParticle.Velocity=vec3(0.0);
...
gParticle.Matrix=mat3(vec3(1.0,0.0,0.0),vec3(0.0,1.0,0.0),vec3(0.0,0.0,1.0));
gParticle.Quaternion=vec4(0.0,0.0,0.0,1.0);
float l9_14=floor(1.0);
vec3 l9_15;
if (l9_14==0.0)
{
vec2 l9_16;
Node117_Particle_Random(Port_Min_N117,Port_Max_N117,l9_16,l9_11);
vec2 l9_17=l9_16;
float l9_18=1.0-clamp(Port_Import_N120,0.0,1.0);
float l9_19;
if (l9_18<=0.0)
{
l9_19=0.0;
...
{
l9_19=pow(l9_18,Port_Input1_N122);
}
float l9_20;
Node131_Particle_Random(l9_19,Port_Max_N131,l9_20,l9_11);
float l9_21=l9_20;
float l9_22;
if (l9_21<=0.0)
{
...
l9_15=vec3(((l9_17/(vec2(length(l9_17))+vec2(1.234e-06)))*vec2(l9_22))*vec2(Port_Import_N146),0.0);
}
else
{
vec3 l9_23;
...
{
vec2 l9_24;
Node117_Particle_Random(Port_Min_N117,Port_Max_N117,l9_24,l9_11);
vec2 l9_25=l9_24;
float l9_26=1.0-clamp(Port_Import_N120,0.0,1.0);
float l9_27;
if (l9_26<=0.0)
{
l9_27=0.0;
...
{
l9_27=pow(l9_26,Port_Input1_N122);
}
float l9_28;
Node131_Particle_Random(l9_27,Port_Max_N131,l9_28,l9_11);
float l9_29=l9_28;
float l9_30;
if (l9_29<=0.0)
{
...
vec2 l9_31=((l9_25/(vec2(length(l9_25))+vec2(1.234e-06)))*vec2(l9_30))*vec2(Port_Import_N146);
l9_23=vec3(l9_31.y,0.0,l9_31.x);
}
else
{
vec3 l9_32;
...
{
vec2 l9_33;
Node117_Particle_Random(Port_Min_N117,Port_Max_N117,l9_33,l9_11);
vec2 l9_34=l9_33;
float l9_35=1.0-clamp(Port_Import_N120,0.0,1.0);
float l9_36;
if (l9_35<=0.0)
{
l9_36=0.0;
...
{
l9_36=pow(l9_35,Port_Input1_N122);
}
float l9_37;
Node131_Particle_Random(l9_36,Port_Max_N131,l9_37,l9_11);
float l9_38=l9_37;
float l9_39;
if (l9_38<=0.0)
{
...
l9_32=vec3(0.0,(((l9_34/(vec2(length(l9_34))+vec2(1.234e-06)))*vec2(l9_39))*vec2(Port_Import_N146)).yx);
}
else
{
vec2 l9_40;
Node117_Particle_Random(Port_Min_N117,Port_Max_N117,l9_40,l9_11);
vec2 l9_41=l9_40;
float l9_42=1.0-clamp(Port_Import_N120,0.0,1.0);
float l9_43;
if (l9_42<=0.0)
{
l9_43=0.0;
...
{
l9_43=pow(l9_42,Port_Input1_N122);
}
float l9_44;
Node131_Particle_Random(l9_43,Port_Max_N131,l9_44,l9_11);
float l9_45=l9_44;
float l9_46;
if (l9_45<=0.0)
{
...
l9_32=vec3(((l9_41/(vec2(length(l9_41))+vec2(1.234e-06)))*vec2(l9_46))*vec2(Port_Import_N146),0.0);
}
l9_23=l9_32;
}
l9_15=l9_23;
}
gParticle.Position=(Port_Import_N069+l9_15)*Port_Import_N156;
gParticle.Velocity+=((gParticle.Force/vec3(gParticle.Mass))*0.033330001);
gParticle.Force=vec3(0.0);
gParticle.Position=(vfxModelMatrix[sc_GetLocalInstanceID()/25]*vec4(gParticle.Position,1.0)).xyz;
int l9_47=sc_GetLocalInstanceID()/25;
gParticle.Velocity=mat3(vfxModelMatrix[l9_47][0].xyz,vfxModelMatrix[l9_47][1].xyz,vfxModelMatrix[l9_47][2].xyz)*gParticle.Velocity;
int l9_48=sc_GetLocalInstanceID()/25;
gParticle.Force=mat3(vfxModelMatrix[l9_48][0].xyz,vfxModelMatrix[l9_48][1].xyz,vfxModelMatrix[l9_48][2].xyz)*gParticle.Force;
gParticle.Size=max(length(vfxModelMatrix[sc_GetLocalInstanceID()/25][0].xyz),max(length(vfxModelMatrix[sc_GetLocalInstanceID()/25][1].xyz),length(vfxModelMatrix[sc_GetLocalInstanceID()/25][2].xyz)))*gParticle.Size;
int l9_49=sc_GetLocalInstanceID()/25;
gParticle.Matrix=mat3(vfxModelMatrix[l9_49][0].xyz,vfxModelMatrix[l9_49][1].xyz,vfxModelMatrix[l9_49][2].xyz)*gParticle.Matrix;
...
vec3 l9_50=((gParticle.Position+Port_Import_N073)+(Port_Import_N318*vec3(l9_3*Port_Multiplier_N319)))*(vec3(1.0)/Port_Import_N322);
vec2 l9_51=vec2(l9_50.xy)+Port_Input1_N326;
vec2 l9_52=vec2(l9_50.yz)+Port_Input1_N329;
vec2 l9_53=vec2(l9_50.zx)+Port_Input1_N332;
gParticle.Force+=(Port_Import_N071*((vec3(floor(((snoise(vec2(floor(l9_51.x*10000.0)*9.9999997e-05,floor(l9_51.y*10000.0)*9.9999997e-05)*(Port_Scale_N327*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05,floor(((snoise(vec2(floor(l9_52.x*10000.0)*9.9999997e-05,floor(l9_52.y*10000.0)*9.9999997e-05)*(Port_Scale_N330*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05,floor(((snoise(vec2(floor(l9_53.x*10000.0)*9.9999997e-05,floor(l9_53.y*10000.0)*9.9999997e-05)*(Port_Scale_N333*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05)*Port_Input1_N335)-vec3(1.0)));
gParticle.Force+=vec3(0.0,(Port_Import_N134*gParticle.Mass)*Port_Input2_N136,0.0);
float l9_54=clamp(gParticle.Age/gParticle.Life,0.0,1.0);
float l9_55=gParticle.Life+1.234e-06;
vec4 l9_56=vec4(gParticle.Color.x,gParticle.Color.y,gParticle.Color.z,vec4(0.0).w);
l9_56.w=mix(Port_Import_N009,Port_Import_N010,(clamp((l9_54*(Port_Input0_N214/((Port_Import_N012/l9_55)+1.234e-06)))+0.001,Port_Input1_N076+0.001,Port_Input2_N076+0.001)-0.001)*(clamp(((1.0-l9_54)*(Port_Input0_N079/((Port_Import_N064/l9_55)+1.234e-06)))+0.001,Port_Input1_N081+0.001,Port_Input2_N081+0.001)-0.001));
gParticle.Color=l9_56;
vec3 l9_57=abs(gParticle.Velocity*vec3(gParticle.Mass))/vec3(l9_1*Port_Multiplier_N272);
gParticle.Force+=clamp((((vec3(Port_Import_N126)*vec3(Port_Import_N127))*vec3(Port_Import_N128))*((-gParticle.Velocity)*vec3(length(gParticle.Velocity))))*vec3(Port_Input4_N137),-l9_57,l9_57);
float l9_58;
if ((0.0*1.0)!=0.0)
{
l9_58=mix(Port_Import_N047,Port_Import_N048,clamp(gParticle.Age/gParticle.Life,0.0,1.0))/(length(vfxLocalAabbMax-vfxLocalAabbMin)+1.234e-06);
}
else
{
l9_58=mix(Port_Import_N047,Port_Import_N048,clamp(gParticle.Age/gParticle.Life,0.0,1.0));
}
gParticle.Size=l9_58;
...
{
l9_59=gParticle.Force.x;
}
gParticle.Force.x=l9_59;
float l9_60;
...
{
l9_60=gParticle.Force.y;
}
gParticle.Force.y=l9_60;
float l9_61;
...
{
l9_61=gParticle.Force.z;
}
gParticle.Force.z=l9_61;
...
{
l9_62=gParticle.Velocity.x;
}
gParticle.Velocity.x=l9_62;
float l9_63;
...
{
l9_63=gParticle.Velocity.y;
}
gParticle.Velocity.y=l9_63;
float l9_64;
...
{
l9_64=gParticle.Velocity.z;
}
gParticle.Velocity.z=l9_64;
gParticle.Position+=(gParticle.Velocity*l9_1);
vec2 l9_65=vec2(4.0,1.0)/vec2(2048.0,vfxTargetSizeWrite.y);
int l9_66=vfxOffsetInstancesWrite+sc_GetLocalInstanceID();
float l9_67;
if (texture0.x<0.5)
{
l9_67=0.0;
...
sc_SetClipPosition(vec4(((vec2(l9_67,l9_68)+(vec2(float(l9_66%512),float(l9_66/512))*l9_65))*2.0)-vec2(1.0),1.0,1.0));
