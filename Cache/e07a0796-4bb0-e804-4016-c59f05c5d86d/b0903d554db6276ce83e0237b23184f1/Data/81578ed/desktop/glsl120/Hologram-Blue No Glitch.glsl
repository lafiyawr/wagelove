...
#endif
vec4 l9_0=(Port_Input0_N022+Port_Input1_N022)+(vec4(1.0-clamp(dot(normalize(sc_Camera.position-varPos),normalize(varNormal)),0.0,1.0))*rimTint);
...
{
l9_4=clamp(Opacity*2.0,0.0,1.0);
}
#else
{
float l9_5;
...
{
l9_5=clamp(dot(l9_1.xyz,vec3(Opacity)),0.0,1.0);
}
#else
{
float l9_6;
...
{
l9_7=(1.0-dot(l9_1.xyz,vec3(0.33333001)))*Opacity;
}
#else
{
float l9_8;
...
{
l9_8=(1.0-clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0))*Opacity;
}
#else
{
float l9_9;
...
{
l9_9=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*Opacity;
}
#else
{
float l9_10;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_11=clamp(dot(l9_1.xyz,vec3(1.0)),0.0,1.0)*Opacity;
}
#else
{
float l9_12;
...
{
l9_12=dot(l9_1.xyz,vec3(0.33333001))*Opacity;
}
#else
{
float l9_13;
...
#endif
vec3 l9_25=mix(l9_23.xyz,definedBlend(l9_23.xyz,l9_1.xyz).xyz,vec3(Opacity));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_27=vec4(mix(vec3(1.0),l9_1.xyz,vec3(Opacity)),Opacity);
}
#else
{
vec4 l9_28;
