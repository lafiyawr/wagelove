...
#endif
vec2 l9_0=(vec2(varPos.xz)*Port_Input1_N015)*vec2(uvScale);
int l9_1;
...
vec2 l9_27=((((varPackedTex.xy-Port_Center_N085)*(vec2(Port_Input0_N020)/clamp(Port_Import_N091,vec2(0.0),vec2(10.0))))+Port_Center_N085)*vec2(Port_Input1_N021))-vec2(Port_Input1_N022);
