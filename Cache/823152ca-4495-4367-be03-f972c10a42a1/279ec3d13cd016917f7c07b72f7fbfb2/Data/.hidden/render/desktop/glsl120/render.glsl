...
uniform vec2 Port_Input1_N131;
uniform float Port_Input1_N153;
uniform float Port_Import_N286;
uniform float Port_Import_N288;
uniform float Port_Input1_N290;
uniform float Port_Input2_N290;
...
int l9_0=InstanceID;
ivec2 l9_1=ivec2(l9_0%60,l9_0/60);
float l9_2=float(l9_0);
vec2 l9_3=vec2(l9_1);
float l9_4=float(l9_0/30)*6.66667;
float l9_5;
...
gParticle=ssParticle(gParticle.Position,gParticle.Velocity,gParticle.Color,gParticle.Size,gParticle.Age,gParticle.Life,gParticle.Mass,gParticle.Matrix,gParticle.Quaternion,gParticle.Dead,gParticle.collisionCount_N134,l9_4,fract(abs(((l9_2*0.0165488)+0.151235)+(floor(((l9_5-l9_4)+26.6666)*0.0750002)*4.32723))),(vec2(ivec2(l9_0%400,l9_0/400))+vec2(1.0))*vec2(0.00250627),0.0,l9_0,(l9_2+0.5)*0.0166667,l9_2*0.0169492,l9_1,(l9_3+vec2(0.5))*vec2(0.0166667,1.0),l9_3*vec2(0.0169492,1.0),vec3(0.0),false);
...
vec4 l9_12=sc_SampleTextureLevel(renderTarget2Dims.xy,renderTarget2Layout,renderTarget2GetStereoViewIndex(),l9_11,(int(SC_USE_UV_TRANSFORM_renderTarget2)!=0),renderTarget2Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget2,SC_SOFTWARE_WRAP_MODE_V_renderTarget2),(int(SC_USE_UV_MIN_MAX_renderTarget2)!=0),renderTarget2UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget2)!=0),renderTarget2BorderColor,0.0,renderTarget2);
...
gParticle.collisionCount_N134=DecodeFloat8(l9_12.x,true)*255.0;
gParticle.Dead=DecodeFloat8(l9_12.y,true)*255.0;
...
vec3 l9_14;
if ((l9_13<0.03)||(Port_Import_N004<0.0001))
{
...
vec4 l9_18=mat4(vec4(gParticle.Matrix[0],gParticle.Position.x),vec4(gParticle.Matrix[1],gParticle.Position.y),vec4(gParticle.Matrix[2],gParticle.Position.z),vec4(0.0,0.0,0.0,1.0))*vec4((l9_2-vec2(0.5))+clamp(Port_Import_N006,vec2(-0.5),vec2(0.5)),0.0,1.0);
varPos=(gParticle.Position+((-l9_16)*(gParticle.Size*l9_18.x)))+(l9_17*((gParticle.Size*l9_18.y)*max(l9_13*Port_Import_N004,1.0)));
...
float l9_8=distance(l9_7,Port_Input1_N131);
float l9_9=1.0-(l9_8*Port_Input1_N153);
float l9_10;
if (l9_9<=0.0)
{
l9_10=0.0;
...
{
l9_10=pow(l9_9,Port_Import_N286);
}
if (float((clamp((l9_10*Port_Import_N288)+0.001,Port_Input1_N290+0.001,Port_Input2_N290+0.001)-0.001)<Port_Input1_N294)!=0.0)
{
discard;
}
vec4 l9_11=ngsPixelShader(Interp_Particle_Color);
vec4 l9_12;
#if (sc_ShaderComplexityAnalyzer)
{
l9_12=vec4(shaderComplexityValue*0.00392157,0.0,0.0,1.0);
}
#else
{
l9_12=vec4(0.0);
...
#if (sc_OITDepthBoundsPass)
{
float l9_15=clamp(viewSpaceDepth()*0.001,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.00392-l9_15),min(1.0,l9_15+0.00392157),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_16=sc_ScreenCoordsGlobalToView((gl_FragCoord.xy*sc_WindowToViewportTransform.xy)+sc_WindowToViewportTransform.zw);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_16).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_17=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_16).xy);
float l9_18=packValue(l9_17);
vec4 l9_19=vec4(0.0);
l9_19.x=l9_18;
vec4 l9_21=l9_19;
l9_21.y=packValue(l9_17);
vec4 l9_23=l9_21;
l9_23.z=packValue(l9_17);
vec4 l9_25=l9_23;
l9_25.w=packValue(l9_17);
vec4 l9_27=vec4(0.0);
l9_27.x=packValue(l9_17);
vec4 l9_29=l9_27;
l9_29.y=packValue(l9_17);
vec4 l9_31=l9_29;
l9_31.z=packValue(l9_17);
vec4 l9_32=l9_31;
l9_32.w=packValue(l9_17);
int l9_33=int(l9_14.w*255.0);
float l9_34=packValue(l9_33);
vec4 l9_35=vec4(0.0);
l9_35.x=l9_34;
vec4 l9_37=l9_35;
l9_37.y=packValue(l9_33);
vec4 l9_39=l9_37;
l9_39.z=packValue(l9_33);
vec4 l9_40=l9_39;
l9_40.w=packValue(l9_33);
sc_writeFragData0(l9_32);
sc_writeFragData1(l9_25);
sc_writeFragData2(l9_40);
...
if (l9_52==0)
{
l9_55=texture2D(sc_OITAlpha0,l9_41);
l9_54=texture2D(sc_OITDepthLow0,l9_41);
l9_53=texture2D(sc_OITDepthHigh0,l9_41);
}
else
{
l9_55=l9_48;
...
if (l9_52==1)
{
l9_51=texture2D(sc_OITAlpha1,l9_41);
l9_50=texture2D(sc_OITDepthLow1,l9_41);
l9_49=texture2D(sc_OITDepthHigh1,l9_41);
}
else
{
l9_51=l9_55;
...
if (any(notEqual(l9_49,vec4(0.0)))||any(notEqual(l9_50,vec4(0.0))))
{
int l9_56[8]=l9_42;
unpackValues(l9_49.w,l9_52,l9_56);
unpackValues(l9_49.z,l9_52,l9_56);
unpackValues(l9_49.y,l9_52,l9_56);
unpackValues(l9_49.x,l9_52,l9_56);
unpackValues(l9_50.w,l9_52,l9_56);
unpackValues(l9_50.z,l9_52,l9_56);
unpackValues(l9_50.y,l9_52,l9_56);
unpackValues(l9_50.x,l9_52,l9_56);
int l9_65[8]=l9_43;
unpackValues(l9_51.w,l9_52,l9_65);
unpackValues(l9_51.z,l9_52,l9_65);
unpackValues(l9_51.y,l9_52,l9_65);
unpackValues(l9_51.x,l9_52,l9_65);
}
l9_48=l9_51;
l9_47=l9_50;
l9_46=l9_49;
...
vec4 l9_70=texture2D(sc_OITFilteredDepthBoundsTexture,l9_41);
vec2 l9_71=l9_70.xy;
int l9_72;
#if (sc_SkinBonesCount>0)
{
...
#endif
l9_72=encodeDepth(((1.0-l9_70.x)*1000.0)+l9_73,l9_71);
}
#else
{
l9_72=0;
...
#endif
int l9_74=encodeDepth(viewSpaceDepth(),l9_71);
vec4 l9_75;
l9_75=l9_14*l9_14.w;
vec4 l9_76;
int l9_77=0;
...
if (l9_77<8)
{
int l9_78=l9_42[l9_77];
int l9_79=l9_74-l9_72;
...
if (l9_81)
{
vec3 l9_82=l9_75.xyz*(1.0-(float(l9_43[l9_77])*0.00392157));
