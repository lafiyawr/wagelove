...
//float Opacity 4272
//float4 Port_Input0_N022 4288
//float4 Port_Input1_N022 4304
//float Port_Multiplier_N134 4320
//float2 Port_Scale_N136 4328
//float Port_Offset_N136 4336
//float Port_Import_N137 4340
//float Port_Import_N139 4344
//float Port_Value3_N142 4348
//float depthRef 4352
//}
...
float Port_Multiplier_N134;
float2 Port_Scale_N136;
float Port_Offset_N136;
float Port_Import_N137;
float Port_Import_N139;
float Port_Value3_N142;
float depthRef;
};
struct sc_Bone_t
{
...
float Ratio_N23=0.0;
float param=dot(Globals.ViewDirWS,Globals.VertexNormal_WorldSpace);
float l9_5=fast::clamp(param,0.0,1.0);
Ratio_N23=1.0-l9_5;
float3 Position_N133=float3(0.0);
Position_N133=Globals.SurfacePosition_ObjectSpace;
float Time_N134=0.0;
Time_N134=Globals.gTimeElapsed*(*sc_set0.UserUniforms).Port_Multiplier_N134;
float3 Output_N135=float3(0.0);
Output_N135=Position_N133+float3(Time_N134);
float Noise_N136=0.0;
float2 param_1=Output_N135.xy;
float2 param_2=(*sc_set0.UserUniforms).Port_Scale_N136;
float param_3=(*sc_set0.UserUniforms).Port_Offset_N136;
float param_4;
if (SC_DEVICE_CLASS_tmp>=2)
{
param_1.x=floor(param_1.x*10000.0)*9.9999997e-05;
param_1.y=floor(param_1.y*10000.0)*9.9999997e-05;
float2 l9_6=floor(param_1*param_2);
float2 l9_7=fract(param_1*param_2);
float3 l9_8=float3(8.0,0.0,0.0);
int l9_9=-1;
...
if (l9_10<=1)
{
float2 l9_11=float2(float(l9_10),float(l9_9));
float2 l9_12=l9_11+l9_6;
float l9_13=abs(param_3)+1000.0;
float2 l9_14=VoronoiHash2D(l9_12,l9_13);
float2 l9_15=l9_14;
float l9_16=distance(l9_11+l9_15,l9_7);
if (l9_16<l9_8.x)
{
l9_8=float3(l9_16,l9_15.x,l9_15.y);
param_4=l9_8.x;
...
Value_N137=fast::clamp((*sc_set0.UserUniforms).Port_Import_N137,0.0,3.0);
float Output_N138=0.0;
Output_N138=Noise_N136*Value_N137;
float Value_N139=0.0;
Value_N139=fast::clamp((*sc_set0.UserUniforms).Port_Import_N139,0.0,1.0);
float3 Value_N142=float3(0.0);
Value_N142.x=Output_N138;
Value_N142.y=Value_N139;
Value_N142.z=(*sc_set0.UserUniforms).Port_Value3_N142;
float4 RGB_N146=float4(0.0);
float3 param_5=float4(Value_N142,0.0).xyz;
float3 l9_17=param_5.zzz;
float l9_18=3.0*fract(param_5.x+0.16666667);
float l9_19=2.0*fract(l9_18);
float l9_20=param_5.y;
float l9_21=fast::clamp(l9_20,0.0,1.0);
float2 l9_22=l9_17.yz-((float2(1.0,l9_19)-float2(fast::max(0.0,l9_19-1.0)))*(param_5.z*l9_21));
l9_17=float3(l9_17.x,l9_22.x,l9_22.y);
if (l9_18>=1.0)
{
l9_17=l9_17.zxy;
}
...
float3 l9_23=l9_17;
RGB_N146=float4(l9_23,float4(Value_N142,0.0).w);
float4 Output_N147=float4(0.0);
Output_N147=float4(RGB_N146.x,RGB_N146.y,RGB_N146.z,1.0);
float4 Export_N148=float4(0.0);
Export_N148=Output_N147;
float4 Output_N24=float4(0.0);
Output_N24=float4(Ratio_N23)*Export_N148;
float4 Output_N22=float4(0.0);
Output_N22=((*sc_set0.UserUniforms).Port_Input0_N022+(*sc_set0.UserUniforms).Port_Input1_N022)+Output_N24;
float Output_N8=0.0;
...
float4 l9_28=fast::max(param_8,float4(0.0));
float4 param_9=l9_28;
if (sc_ShaderCacheConstant_tmp!=0)
{
