...
uniform sc_Camera_t sc_Camera;
uniform float Port_Multiplier_N134;
uniform vec2 Port_Scale_N136;
uniform float Port_Offset_N136;
uniform float Port_Import_N137;
uniform float Port_Import_N139;
uniform float Port_Value3_N142;
...
float l9_4=dot(l9_0,l9_1);
vec3 l9_5=l9_2+vec3(sc_Time.x*Port_Multiplier_N134);
float l9_6;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
vec2 l9_7=vec2(floor(l9_5.x*10000.0)*9.9999997e-05,floor(l9_5.y*10000.0)*9.9999997e-05)*Port_Scale_N136;
float l9_8;
vec3 l9_9;
l9_8=0.0;
...
vec2 l9_19=VoronoiHash2D(l9_18+floor(l9_7),abs(Port_Offset_N136)+1000.0);
...
#endif
float l9_21=l9_6*clamp(Port_Import_N137,0.0,3.0);
float l9_22=clamp(Port_Import_N139,0.0,1.0);
vec4 l9_23=vec4(l9_21,l9_22,Port_Value3_N142,0.0);
float l9_24=3.0*fract(l9_21+0.16666667);
float l9_25=2.0*fract(l9_24);
vec2 l9_26=l9_23.zz-((vec2(1.0,l9_25)-vec2(max(0.0,l9_25-1.0)))*(Port_Value3_N142*clamp(l9_22,0.0,1.0)));
vec3 l9_27=vec3(l9_23.z,l9_26.x,l9_26.y);
vec3 l9_28;
if (l9_24>=1.0)
{
l9_28=l9_27.zxy;
...
vec4 l9_30=(Port_Input0_N022+Port_Input1_N022)+(vec4(1.0-clamp(l9_4,0.0,1.0))*vec4(l9_29,1.0));
...
#endif
sc_writeFragData0Internal(max(l9_32,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_34;
...
{
l9_36=clamp(Opacity*2.0,0.0,1.0);
}
#else
{
float l9_37;
...
{
l9_37=clamp(dot(l9_31.xyz,vec3(Opacity)),0.0,1.0);
}
#else
{
float l9_38;
...
{
l9_39=(1.0-dot(l9_31.xyz,vec3(0.33333001)))*Opacity;
}
#else
{
float l9_40;
...
{
l9_40=(1.0-clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0))*Opacity;
}
#else
{
float l9_41;
...
{
l9_41=clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0)*Opacity;
}
#else
{
float l9_42;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_43=clamp(dot(l9_31.xyz,vec3(1.0)),0.0,1.0)*Opacity;
}
#else
{
float l9_44;
...
{
l9_44=dot(l9_31.xyz,vec3(0.33333001))*Opacity;
}
#else
{
float l9_45;
...
#endif
vec3 l9_58=mix(l9_56.xyz,definedBlend(l9_56.xyz,l9_31.xyz).xyz,vec3(Opacity));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_60=vec4(mix(vec3(1.0),l9_31.xyz,vec3(Opacity)),Opacity);
}
#else
{
vec4 l9_61;
