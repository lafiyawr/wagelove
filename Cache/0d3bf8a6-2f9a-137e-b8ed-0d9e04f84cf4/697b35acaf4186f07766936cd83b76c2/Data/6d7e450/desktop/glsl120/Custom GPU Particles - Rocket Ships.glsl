...
//spec_const bool sizeRampTextureHasSwappedViews 149 0
//spec_const bool trailColorRampTexHasSwappedViews 150 0
//spec_const bool trailSizeRampTexHasSwappedViews 151 0
//spec_const bool trailTexHasSwappedViews 152 0
//spec_const bool velRampTextureHasSwappedViews 153 0
//spec_const int MESHTYPE 154 0
//spec_const int SC_DEVICE_CLASS 155 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_colorRampTexture 156 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 157 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_mainTexture 158 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_normalTex 159 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_sizeRampTexture 160 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_trailColorRampTex 161 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_trailSizeRampTex 162 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_trailTex 163 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_velRampTexture 164 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_colorRampTexture 165 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 166 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_mainTexture 167 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_normalTex 168 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_sizeRampTexture 169 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_trailColorRampTex 170 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_trailSizeRampTex 171 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_trailTex 172 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_velRampTexture 173 -1
//spec_const int TRAILBEHAVIOR 174 0
//spec_const int colorRampTextureLayout 175 0
//spec_const int intensityTextureLayout 176 0
//spec_const int mainTextureLayout 177 0
//spec_const int normalTexLayout 178 0
//spec_const int rotationSpace 179 0
//spec_const int sc_AmbientLightMode0 180 0
//spec_const int sc_AmbientLightMode1 181 0
//spec_const int sc_AmbientLightMode2 182 0
//spec_const int sc_AmbientLightMode_Constant 183 0
//spec_const int sc_AmbientLightMode_EnvironmentMap 184 0
//spec_const int sc_AmbientLightMode_FromCamera 185 0
//spec_const int sc_AmbientLightMode_SphericalHarmonics 186 0
//spec_const int sc_AmbientLightsCount 187 0
//spec_const int sc_DepthBufferMode 188 0
//spec_const int sc_DirectionalLightsCount 189 0
//spec_const int sc_EnvLightMode 190 0
//spec_const int sc_EnvmapDiffuseLayout 191 0
//spec_const int sc_EnvmapSpecularLayout 192 0
//spec_const int sc_LightEstimationSGCount 193 0
//spec_const int sc_MaxTextureImageUnits 194 0
//spec_const int sc_PointLightsCount 195 0
...
#endif
l9_79=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_80,sc_EnvmapDiffuseLayout,l9_81).xy,-13.0);
}
#else
{
...
vec2 l9_112=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_17,reflect(-Globals.ViewDirWS,l9_17),l9_15),sc_EnvmapRotation.y);
vec4 l9_113;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
#endif
l9_110=vec3(0.0)+((((l9_113.xyz*(1.0/l9_113.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_23,abs(dot(l9_17,Globals.ViewDirWS))));
}
#else
{
l9_110=vec3(0.0);
...
vec3 l9_121=reflect(-Globals.ViewDirWS,l9_17);
float l9_122=dot(l9_17,Globals.ViewDirWS);
...
l9_118+=((((((((vec3(1.0/(3.1415927*l9_120))*exp((l9_124-l9_123)-sc_LightEstimationData.sg[l9_119].sharpness))*sc_LightEstimationData.sg[l9_119].color)*6.2831855)*(1.0-exp((-2.0)*l9_124)))/vec3(l9_124))*((1.0/(l9_125+sqrt(l9_120+((l9_127*l9_125)*l9_125))))*(1.0/(l9_126+sqrt(l9_120+((l9_127*l9_126)*l9_126))))))*(l9_21+((vec3(1.0)-l9_21)*pow(1.0-clamp(dot(l9_121,normalize(l9_121+Globals.ViewDirWS)),0.0,1.0),5.0))))*l9_125);
l9_119++;
continue;
}
else
...
vec3 l9_136=l9_116*Port_SpecularAO_N014;
...
{
vec4 l9_144=l9_142;
l9_144.x=l9_141+((l9_19.x*Port_SpecularAO_N014.x)*9.9999997e-06);
l9_143=l9_144;
}
#else
{
...
float l9_149=param_95;
vec4 l9_150=Globals.VertexColor;
bool l9_151=(l9_149*1.0)!=0.0;
bool l9_152;
if (l9_151)
{
l9_152=(l9_150.x*1.0)!=0.0;
}
else
{
l9_152=l9_151;
