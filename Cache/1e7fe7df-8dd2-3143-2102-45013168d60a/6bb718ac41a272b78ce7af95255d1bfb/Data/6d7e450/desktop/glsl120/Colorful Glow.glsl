...
#endif
vec3 l9_0=(sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz;
vec2 l9_1=(l9_0+vec3(sc_Time.x*Port_Multiplier_N006)).xy;
ssGlobals l9_2=ssGlobals(sc_Time.x,sc_Time.y,0.0,l9_0);
float param_3;
float param_4;
Node0_Voronoi_Noise(l9_1,Port_Scale_N000,Port_Offset_N000,param_3,param_4,l9_2);
float l9_3=clamp(Port_Import_N026,0.0,3.0);
float l9_4=clamp(Port_Import_N025,0.0,1.0);
vec3 l9_5=ssHSV_to_RGB(vec4(param_3*l9_3,l9_4,Port_Value3_N003,0.0).xyz);
vec4 l9_6=vec4(l9_5,1.0);
...
float param_10;
float param_11;
Node0_Voronoi_Noise(l9_1,Port_Scale_N000,Port_Offset_N000,param_10,param_11,l9_2);
vec3 l9_7=ssHSV_to_RGB(vec4(param_10*l9_3,l9_4,Port_Value3_N003,0.0).xyz);
vec4 l9_8;
...
{
l9_11=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_12;
...
{
l9_13=(1.0-dot(l9_6.xyz,vec3(0.33333001)))*1.0;
}
#else
{
float l9_14;
...
{
l9_14=(1.0-clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0))*1.0;
}
#else
{
float l9_15;
...
{
l9_15=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_16;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_17=clamp(dot(l9_6.xyz,vec3(1.0)),0.0,1.0)*1.0;
}
#else
{
float l9_18;
...
{
l9_18=dot(l9_6.xyz,vec3(0.33333001))*1.0;
}
#else
{
float l9_19;
...
#endif
vec3 l9_31=definedBlend(l9_29.xyz,l9_6.xyz);
...
vec4 l9_39=max(vec4(l9_7,1.0)*vec4((Port_Value_N013+0.001)-0.001),vec4(0.0));
