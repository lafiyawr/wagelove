...
//}
//ubo int UserUniforms 0:39:4704 {
...
//float4 Tweak_N7 4560
//float Tweak_N1 4576
//float Tweak_N2 4580
//float Port_Opacity_N006 4584
//float3 Port_Emissive_N006 4608
//float4 Port_Input0_N102 4624
//float Port_Import_N092 4656
//float4 Port_Input1_N094 4672
//float Port_Import_N095 4688
//float Port_Import_N100 4692
//float depthRef 4696
//}
...
float4 param=(*sc_set0.UserUniforms).Tweak_N7;
Output_N7=param;
float Output_N1=0.0;
float param_1=(*sc_set0.UserUniforms).Tweak_N1;
Output_N1=param_1;
float Output_N2=0.0;
float param_2=(*sc_set0.UserUniforms).Tweak_N2;
Output_N2=param_2;
...
float3 param_3=Output_N7.xyz;
float param_4=(*sc_set0.UserUniforms).Port_Opacity_N006;
float3 param_5=(*sc_set0.UserUniforms).Port_Emissive_N006;
float param_6=Output_N1;
float param_7=Output_N2;
float3 param_8=Export_N113.xyz;
float3 param_9=Export_N113.xyz;
ssGlobals param_11=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_11.BumpedNormal=param_11.VertexNormal_WorldSpace;
}
float l9_5=param_4;
...
float4 l9_20=fast::max(param_12,float4(0.0));
float4 param_13=l9_20;
if (sc_ShaderCacheConstant_tmp!=0)
{
