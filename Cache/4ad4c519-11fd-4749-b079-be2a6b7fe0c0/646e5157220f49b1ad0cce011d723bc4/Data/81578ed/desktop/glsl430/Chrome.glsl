...
{
l9_11=uint(clamp(Tweak_N2,0.0,1.0)*1000.0);
}
...
vec4 l9_5=l9_0*vec4(clamp(Port_Import_N092,0.0,5.0));
vec3 l9_6;
#if (!sc_ProjectiveShadowsCaster)
{
l9_6=l9_1;
...
#endif
vec3 l9_7=max(Tweak_N7.xyz,vec3(0.0));
vec4 l9_8;
#if (sc_ProjectiveShadowsCaster)
{
l9_8=vec4(l9_7,Port_Opacity_N006);
}
#else
{
vec3 l9_9=clamp(mix(Port_Input0_N102,mix(vec4(dot(l9_5,Port_Input1_N094)),l9_5,vec4(clamp(Port_Import_N095,0.0,2.0))),vec4(clamp(Port_Import_N100,0.0,2.0))).xyz,vec3(0.0),vec3(1.0));
l9_8=ngsCalculateLighting(l9_7,Port_Opacity_N006,l9_6,l9_2,l9_3,Port_Emissive_N006,clamp(Tweak_N1,0.0,1.0),clamp(Tweak_N2,0.0,1.0),l9_9,l9_9);
}
#endif
vec4 l9_10=max(l9_8,vec4(0.0));
if (isProxyMode)
{
vec4 l9_11;
#if (sc_ProxyAlphaOne)
