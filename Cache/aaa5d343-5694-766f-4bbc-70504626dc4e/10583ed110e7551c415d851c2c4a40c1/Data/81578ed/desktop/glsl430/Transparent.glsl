...
#if (sc_ProjectiveShadowsCaster)
{
l9_5=vec4(Port_Albedo_N006,Port_Opacity_N006);
}
#else
{
l9_5=ngsCalculateLighting(Port_Albedo_N006,Port_Opacity_N006,l9_4,l9_1,l9_2,Port_Emissive_N006,Port_Metallic_N006,Port_Roughness_N006,Port_AO_N006,Port_SpecularAO_N006);
}
#endif
...
#endif
sc_writeFragData0Internal(max(l9_7,vec4(0.0)),sc_UniformConstants.x,sc_ShaderCacheConstant);
return;
}
vec4 l9_9;
#if (sc_ProjectiveShadowsCaster)
...
vec3 l9_25=mix(l9_24,definedBlend(l9_24,l9_6.xyz).xyz,vec3(l9_6.w));
...
{
float l9_28=l9_6.w;
l9_27=vec4(mix(vec3(1.0),l9_6.xyz,vec3(l9_28)),l9_28);
}
#else
{
vec4 l9_29;
...
#endif
l9_29=vec4(l9_6.xyz*l9_31,l9_31);
}
#else
{
l9_29=l9_6;
