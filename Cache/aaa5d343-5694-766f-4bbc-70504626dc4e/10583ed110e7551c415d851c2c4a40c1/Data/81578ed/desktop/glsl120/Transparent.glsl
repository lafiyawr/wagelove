...
#if (sc_ProjectiveShadowsCaster)
{
l9_2=vec4(Port_Albedo_N006,Port_Opacity_N006);
}
#else
{
vec3 l9_3=ssSRGB_to_Linear(Port_Albedo_N006);
vec3 l9_4=normalize(l9_1);
vec3 l9_5=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_6;
#if (sc_SSAOEnabled)
{
l9_6=evaluateSSAO(varPos);
}
#else
{
l9_6=Port_AO_N006;
...
#endif
vec3 l9_7=vec3(Port_Metallic_N006);
vec3 l9_8=mix(vec3(0.039999999),l9_3*Port_Metallic_N006,l9_7);
vec3 l9_9=mix(l9_3*(1.0-Port_Metallic_N006),vec3(0.0),l9_7);
SurfaceProperties l9_10=SurfaceProperties(l9_9,Port_Opacity_N006,l9_4,varPos,l9_0,Port_Metallic_N006,Port_Roughness_N006,l9_5,l9_6,Port_SpecularAO_N006,vec3(1.0),l9_8);
vec4 l9_11=vec4(1.0);
vec3 l9_12;
vec3 l9_13;
vec3 l9_14;
...
{
LightingComponents l9_31=accumulateLight(LightingComponents(l9_19,l9_20,l9_25,l9_24,l9_22,l9_21),LightProperties(sc_DirectionalLights[l9_30].direction,sc_DirectionalLights[l9_30].color.xyz,sc_DirectionalLights[l9_30].color.w*l9_11[(l9_23<3) ? l9_23 : 3]),l9_10,l9_0);
l9_25=l9_31.indirectDiffuse;
l9_24=l9_31.indirectSpecular;
l9_23++;
l9_22=l9_31.emitted;
...
#if (sc_ProjectiveShadowsReceiver)
{
vec2 l9_60=abs(varShadowTex-vec2(0.5));
vec4 l9_61=texture2D(sc_ShadowTexture,varShadowTex)*step(max(l9_60.x,l9_60.y),0.5);
l9_59=mix(vec3(1.0),mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_61.xyz,vec3(sc_ShadowColor.w)),vec3(l9_61.w*sc_ShadowDensity));
}
#else
{
l9_59=vec3(1.0);
...
{
vec2 l9_63=calcPanoramicTexCoordsFromDir(l9_4,sc_EnvmapRotation.y);
vec4 l9_64;
...
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
l9_65=calcSeamlessPanoramicUvsForSampling(l9_63,sc_EnvmapSpecularSize.xy,5.0);
}
#else
{
l9_65=l9_63;
...
#endif
l9_64=sc_EnvmapSpecularSampleViewIndexBias(l9_65,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#else
{
vec4 l9_66;
...
{
vec2 l9_67=calcSeamlessPanoramicUvsForSampling(l9_63,sc_EnvmapDiffuseSize.xy,0.0);
int l9_68;
...
#endif
l9_66=texture2D(sc_EnvmapDiffuse,sc_SamplingCoordsViewToGlobal(l9_67,sc_EnvmapDiffuseLayout,l9_68).xy,-13.0);
}
#else
{
l9_66=sc_EnvmapSpecularSampleViewIndexBias(l9_63,sc_EnvmapSpecularGetStereoViewIndex(),13.0);
}
#endif
l9_64=l9_66;
}
#endif
l9_62=(l9_64.xyz*(1.0/l9_64.w))*sc_EnvmapExposure;
}
#else
{
vec3 l9_69;
...
float l9_72=l9_70.y;
float l9_73=l9_70.z;
l9_69=(((((((sc_Sh[8]*0.42904299)*((l9_71*l9_71)-(l9_72*l9_72)))+((sc_Sh[6]*0.74312502)*(l9_73*l9_73)))+(sc_Sh[0]*0.88622701))-(sc_Sh[6]*0.24770799))+((((sc_Sh[4]*(l9_71*l9_72))+(sc_Sh[7]*(l9_71*l9_73)))+(sc_Sh[5]*(l9_72*l9_73)))*0.85808599))+((((sc_Sh[3]*l9_71)+(sc_Sh[1]*l9_72))+(sc_Sh[2]*l9_73))*1.0233279))*sc_ShIntensity;
}
#else
{
l9_69=vec3(0.0);
...
{
l9_75=l9_62+(sc_AmbientLights[0].color*sc_AmbientLights[0].intensity);
}
#else
{
vec3 l9_76=l9_62;
l9_76.x=l9_62.x+(1e-06*sc_AmbientLights[0].color.x);
l9_75=l9_76;
}
#endif
l9_74=l9_75;
...
{
l9_78=l9_74+(sc_AmbientLights[1].color*sc_AmbientLights[1].intensity);
}
#else
{
vec3 l9_79=l9_74;
l9_79.x=l9_74.x+(1e-06*sc_AmbientLights[1].color.x);
l9_78=l9_79;
}
#endif
l9_77=l9_78;
...
{
l9_81=l9_77+(sc_AmbientLights[2].color*sc_AmbientLights[2].intensity);
}
#else
{
vec3 l9_82=l9_77;
l9_82.x=l9_77.x+(1e-06*sc_AmbientLights[2].color.x);
l9_81=l9_82;
}
#endif
l9_80=l9_81;
...
{
vec3 l9_84;
l9_84=sc_LightEstimationData.ambientLight;
vec3 l9_85;
int l9_86=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
...
{
float l9_87=dot(sc_LightEstimationData.sg[l9_86].axis,l9_4);
float l9_88=exp(-sc_LightEstimationData.sg[l9_86].sharpness);
float l9_89=l9_88*l9_88;
float l9_90=1.0/sc_LightEstimationData.sg[l9_86].sharpness;
float l9_91=(1.0+(2.0*l9_89))-l9_90;
float l9_92=sqrt(1.0-l9_91);
float l9_93=0.36000001*l9_87;
float l9_94=(1.0/(4.0*0.36000001))*l9_92;
float l9_95=l9_93+l9_94;
float l9_96;
if (step(abs(l9_93),l9_94)>0.5)
{
l9_96=(l9_95*l9_95)/l9_92;
}
else
{
l9_96=clamp(l9_87,0.0,1.0);
}
l9_85=l9_84+((((sc_LightEstimationData.sg[l9_86].color/vec3(sc_LightEstimationData.sg[l9_86].sharpness))*6.2831855)*((l9_91*l9_96)+(((l9_88-l9_89)*l9_90)-l9_89)))/vec3(3.1415927));
l9_84=l9_85;
l9_86++;
continue;
}
...
#if ((sc_EnvLightMode==sc_AmbientLightMode_EnvironmentMap)||(sc_EnvLightMode==sc_AmbientLightMode_FromCamera))
{
float l9_98=clamp(pow(Port_Roughness_N006,0.66666669),0.0,1.0)*5.0;
vec2 l9_99=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_4,reflect(-l9_0,l9_4),Port_Roughness_N006),sc_EnvmapRotation.y);
vec4 l9_100;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
float l9_101=floor(l9_98);
float l9_102=ceil(l9_98);
l9_100=mix(sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_99,sc_EnvmapSpecularSize.xy,l9_101),sc_EnvmapSpecularGetStereoViewIndex(),l9_101),sc_EnvmapSpecularSampleViewIndexLevel(calcSeamlessPanoramicUvsForSampling(l9_99,sc_EnvmapSpecularSize.xy,l9_102),sc_EnvmapSpecularGetStereoViewIndex(),l9_102),vec4(l9_98-l9_101));
}
#else
{
l9_100=sc_EnvmapSpecularSampleViewIndexLevel(l9_99,sc_EnvmapSpecularGetStereoViewIndex(),l9_98);
}
#endif
l9_97=vec3(0.0)+((((l9_100.xyz*(1.0/l9_100.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_10,abs(dot(l9_4,l9_0))));
}
#else
{
l9_97=vec3(0.0);
...
#if (sc_LightEstimation)
{
float l9_104=clamp(Port_Roughness_N006*Port_Roughness_N006,0.0099999998,1.0);
vec3 l9_105;
l9_105=sc_LightEstimationData.ambientLight*l9_8;
int l9_106=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_106<sc_LightEstimationSGCount)
{
float l9_107=l9_104*l9_104;
vec3 l9_108=reflect(-l9_0,l9_4);
float l9_109=dot(l9_4,l9_0);
float l9_110=(2.0/l9_107)/(4.0*max(l9_109,9.9999997e-05));
float l9_111=length((l9_108*l9_110)+(sc_LightEstimationData.sg[l9_106].axis*sc_LightEstimationData.sg[l9_106].sharpness));
float l9_112=clamp(dot(l9_4,l9_108),0.0,1.0);
float l9_113=clamp(l9_109,0.0,1.0);
float l9_114=1.0-l9_107;
l9_105+=((((((((vec3(1.0/(3.1415927*l9_107))*exp((l9_111-l9_110)-sc_LightEstimationData.sg[l9_106].sharpness))*sc_LightEstimationData.sg[l9_106].color)*6.2831855)*(1.0-exp((-2.0)*l9_111)))/vec3(l9_111))*((1.0/(l9_112+sqrt(l9_107+((l9_114*l9_112)*l9_112))))*(1.0/(l9_113+sqrt(l9_107+((l9_114*l9_113)*l9_113))))))*(l9_8+((vec3(1.0)-l9_8)*pow(1.0-clamp(dot(l9_108,normalize(l9_108+l9_0)),0.0,1.0),5.0))))*l9_112);
l9_106++;
continue;
}
else
...
l9_118=vec3(0.0);
l9_117=vec3(0.0);
l9_116=ssSRGB_to_Linear(sc_GetFramebufferColor().xyz)*mix(vec3(1.0),l9_9,vec3(Port_Opacity_N006));
l9_115=1.0;
}
#else
{
...
#endif
vec3 l9_120=l9_117*l9_6;
vec3 l9_121=l9_118+l9_120;
vec3 l9_122=l9_9*l9_121;
vec3 l9_123=l9_103*Port_SpecularAO_N006;
vec3 l9_124=l9_57+l9_123;
vec3 l9_125;
if (l9_119)
{
l9_125=l9_122*srgbToLinear(l9_115);
}
else
{
l9_125=l9_122;
}
vec3 l9_126=l9_125+l9_124;
vec3 l9_127=(l9_126+l9_5)+l9_116;
float l9_128=l9_127.x;
vec4 l9_129=vec4(l9_128,l9_127.yz,l9_115);
vec4 l9_130;
#if (sc_IsEditor)
{
vec4 l9_131=l9_129;
l9_131.x=l9_128+((l9_6.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_130=l9_131;
}
#else
{
...
{
vec3 l9_133=l9_130.xyz*1.8;
vec3 l9_134=(l9_130.xyz*(l9_133+vec3(1.4)))/((l9_130.xyz*(l9_133+vec3(0.5)))+vec3(1.5));
l9_132=vec4(l9_134.x,l9_134.y,l9_134.z,l9_130.w);
}
#else
{
l9_132=l9_130;
...
#endif
vec3 l9_135=vec3(linearToSrgb(l9_132.x),linearToSrgb(l9_132.y),linearToSrgb(l9_132.z));
l9_2=vec4(l9_135.x,l9_135.y,l9_135.z,l9_132.w);
}
#endif
vec4 l9_136=max(l9_2,vec4(0.0));
vec4 l9_137;
#if (sc_ProjectiveShadowsCaster)
{
float l9_138;
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_139=clamp(l9_136.w*2.0,0.0,1.0);
}
#else
{
float l9_140;
...
{
l9_140=clamp(dot(l9_136.xyz,vec3(l9_136.w)),0.0,1.0);
}
#else
{
float l9_141;
...
#if (sc_BlendMode_Multiply)
{
l9_142=(1.0-dot(l9_136.xyz,vec3(0.33333001)))*l9_136.w;
}
#else
{
float l9_143;
...
{
l9_143=(1.0-clamp(dot(l9_136.xyz,vec3(1.0)),0.0,1.0))*l9_136.w;
}
#else
{
float l9_144;
#if (sc_BlendMode_ColoredGlass)
{
l9_144=clamp(dot(l9_136.xyz,vec3(1.0)),0.0,1.0)*l9_136.w;
}
#else
{
float l9_145;
#if (sc_BlendMode_Add)
{
l9_145=clamp(dot(l9_136.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_146;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_146=clamp(dot(l9_136.xyz,vec3(1.0)),0.0,1.0)*l9_136.w;
}
#else
{
float l9_147;
...
{
l9_147=dot(l9_136.xyz,vec3(0.33333001))*l9_136.w;
}
#else
{
float l9_148;
#if (sc_BlendMode_Min)
{
l9_148=1.0-clamp(dot(l9_136.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_149;
#if (sc_BlendMode_Max)
{
l9_149=clamp(dot(l9_136.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_149=1.0;
...
#endif
l9_137=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_136.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_138);
}
#else
{
vec4 l9_150;
...
vec3 l9_153=mix(l9_152,definedBlend(l9_152,l9_136.xyz).xyz,vec3(l9_136.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
float l9_156=l9_136.w;
l9_155=vec4(mix(vec3(1.0),l9_136.xyz,vec3(l9_156)),l9_156);
}
#else
{
vec4 l9_157;
...
{
float l9_158=l9_136.w;
float l9_159;
#if (sc_BlendMode_PremultipliedAlphaAuto)
{
l9_159=clamp(l9_158,0.0,1.0);
}
#else
{
l9_159=l9_158;
...
#endif
l9_157=vec4(l9_136.xyz*l9_159,l9_159);
}
#else
{
l9_157=l9_136;
...
{
l9_162=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_162=vec4(0.0);
...
vec4 l9_164=outputMotionVectorsIfNeeded(varPos,max(l9_163,vec4(0.0)));
