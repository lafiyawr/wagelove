...
#endif
float l9_25=(l9_24.x*2.0)-1.0;
float l9_26;
if (baseTexProjectionMatrixTerms.z==0.0)
{
l9_26=(l9_25-baseTexProjectionMatrixTerms.y)/baseTexProjectionMatrixTerms.x;
}
else
{
l9_26=baseTexProjectionMatrixTerms.y/((-l9_25)-baseTexProjectionMatrixTerms.x);
}
float l9_27=l9_26/((((Port_Value_N002+0.001)-0.001)-((Port_Value_N006+0.001)-0.001))+1.234e-06);
float l9_28=1.0-((l9_27*Port_Input1_N011)+Port_Input1_N017);
vec4 l9_29=vec4(l9_28);
