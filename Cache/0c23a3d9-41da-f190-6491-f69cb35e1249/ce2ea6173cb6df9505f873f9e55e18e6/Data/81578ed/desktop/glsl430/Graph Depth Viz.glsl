...
uniform vec4 baseTexProjectionMatrixTerms;
...
#endif
float l9_51=(l9_2.x*2.0)-1.0;
float l9_52;
if (baseTexProjectionMatrixTerms.z==0.0)
{
l9_52=(l9_51-baseTexProjectionMatrixTerms.y)/baseTexProjectionMatrixTerms.x;
}
else
{
l9_52=baseTexProjectionMatrixTerms.y/((-l9_51)-baseTexProjectionMatrixTerms.x);
}
float l9_53=l9_52/((((Port_Value_N002+0.001)-0.001)-((Port_Value_N006+0.001)-0.001))+1.234e-06);
float l9_54=1.0-((l9_53*Port_Input1_N011)+Port_Input1_N017);
vec4 l9_55=vec4(l9_54);
...
#endif
vec3 l9_82=mix(l9_80.xyz,definedBlend(l9_80.xyz,l9_55.xyz).xyz,vec3(l9_54));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_84=vec4(mix(vec3(1.0),l9_55.xyz,vec3(l9_54)),l9_54);
}
#else
{
vec4 l9_85;
