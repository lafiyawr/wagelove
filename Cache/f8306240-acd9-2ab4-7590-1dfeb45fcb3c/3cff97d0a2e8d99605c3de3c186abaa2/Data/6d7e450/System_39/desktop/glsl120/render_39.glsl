...
float l9_6=1.0/l9_4;
float l9_7=1.0/l9_5;
float l9_8=floor(mod(floor(float(int(Interp_Particle_Index)%40)),min(l9_4*l9_5,floor(Port_MaxFrames_N156))));
int l9_9;
...
#else
{
vec2 l9_41=gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw;
vec2 l9_42;
#if (sc_StereoRenderingMode==1)
{
vec3 l9_43=vec3(l9_41,0.0);
l9_43.y=((2.0*l9_41.y)+float(sc_GetStereoViewIndex()))-1.0;
l9_42=l9_43.xy;
}
#else
{
...
#endif
l9_37=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_42,sc_ScreenTextureLayout,l9_44).xy,0.0);
}
#endif
vec4 l9_45;
...
{
vec4 l9_46=l9_37;
l9_46.x=l9_37.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_45=l9_46;
}
#else
{
...
#endif
vec3 l9_47=mix(l9_45.xyz,definedBlend(l9_45.xyz,l9_34.xyz).xyz,vec3(l9_34.w));
...
{
float l9_50=l9_34.w;
l9_49=vec4(mix(vec3(1.0),l9_34.xyz,vec3(l9_50)),l9_50);
}
#else
{
vec4 l9_51;
...
#endif
l9_51=vec4(l9_34.xyz*l9_53,l9_53);
}
#else
{
l9_51=l9_34;
