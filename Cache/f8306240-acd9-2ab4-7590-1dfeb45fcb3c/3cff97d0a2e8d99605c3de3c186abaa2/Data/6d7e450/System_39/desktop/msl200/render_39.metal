...
//float Port_Import_N171 7280
//float2 Port_Import_N172 7288
...
{
main_vert_out out={};
int N173_FacingMode=0;
int N173_Alignment=0;
float N173_VelocityStretchAmount=0.0;
float2 N173_PivotPoint=float2(0.0);
sc_Vertex_t l9_0;
...
Globals.gComponentTime=(*sc_set0.UserUniforms).overrideTimeElapsed[l9_17/40];
...
float Value_N169=0.0;
Value_N169=1.0;
float Value_N170=0.0;
Value_N170=1.0;
float Value_N171=0.0;
Value_N171=(*sc_set0.UserUniforms).Port_Import_N171;
float2 Value_N172=float2(0.0);
Value_N172=fast::clamp((*sc_set0.UserUniforms).Port_Import_N172,float2(-0.5),float2(0.5));
float param_5=Value_N169;
float param_6=Value_N170;
float param_7=Value_N171;
float2 param_8=Value_N172;
ssGlobals param_9=Globals;
ssGlobals tempGlobals=param_9;
N173_FacingMode=int(param_5);
N173_Alignment=int(param_6);
N173_VelocityStretchAmount=param_7;
N173_PivotPoint=param_8;
float l9_36=0.029999999;
float3 l9_37=float3(0.0,1.0,0.0);
float3 l9_38=gParticle.Velocity;
float l9_39=length(l9_38);
float l9_40=fast::max(l9_39*N173_VelocityStretchAmount,1.0);
if ((l9_39<l9_36)||(N173_VelocityStretchAmount<9.9999997e-05))
{
if (N173_Alignment==1)
{
int l9_41=0;
...
float2 l9_54=(l9_53-float2(0.5))+N173_PivotPoint;
...
float2 param_2=(*sc_set0.UserUniforms).Port_SpriteCount_N156;
float param_3=(*sc_set0.UserUniforms).Port_MaxFrames_N156;
float2 param_4=UVCoord_N160;
float param_5=Value_N155;
...
float l9_30=floor(mod(floor(param_5),l9_29));
float l9_31=floor(l9_30/l9_25);
float l9_32=mod(l9_30,l9_25);
l9_24=float2((l9_27*param_4.x)+(l9_32*l9_27),((1.0-l9_28)-(l9_31*l9_28))+(l9_28*param_4.y));
int l9_33=0;
...
float4 param_6=l9_123;
Color_N156=param_6;
float4 Value_N12=float4(0.0);
Value_N12=gParticle.Color;
float4 Output_N157=float4(0.0);
Output_N157=Color_N156*Value_N12;
float4 param_7=Output_N157;
