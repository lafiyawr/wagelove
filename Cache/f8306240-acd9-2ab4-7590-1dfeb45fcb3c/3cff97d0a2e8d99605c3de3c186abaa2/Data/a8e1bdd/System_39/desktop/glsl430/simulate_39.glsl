...
void Node76_Particle_Random(vec3 Min,vec3 Max,out vec3 Random,ssGlobals Globals)
{
Random=mix(Min,Max,ssGetParticleRandom(3,true,true,true,76.0,gParticle,0.0,Globals.gTimeElapsed).xyz);
}
void Node88_Particle_Random(vec3 Min,vec3 Max,out vec3 Random,ssGlobals Globals)
{
Random=mix(Min,Max,ssGetParticleRandom(3,true,true,true,88.0,gParticle,0.0,Globals.gTimeElapsed).xyz);
}
...
int l9_1=sc_GetLocalInstanceID()/40;
...
gParticle.Quaternion=vec4(0.0,0.0,0.0,1.0);
float l9_15;
if ((float(0.0==Port_Input1_N014)*1.0)!=0.0)
{
vec3 l9_16;
Node76_Particle_Random(Port_Min_N076,Port_Max_N076,l9_16,l9_12);
vec3 l9_17=l9_16;
float l9_18=1.0-clamp(Port_Import_N084,0.0,1.0);
float l9_19;
if (l9_18<=0.0)
{
l9_19=0.0;
...
{
l9_19=pow(l9_18,Port_Input1_N087);
}
vec3 l9_20;
Node88_Particle_Random(vec3(l9_19),Port_Max_N088,l9_20,l9_12);
vec3 l9_21=l9_20;
float l9_22;
if (l9_21.x<=0.0)
{
...
l9_15=abs(((((l9_17/(vec3(length(l9_17))+vec3(1.234e-06)))*vec3(l9_23,0.0,0.0))*vec3(Port_Import_N131))*Port_Import_N132).x);
}
else
{
vec3 l9_24;
Node76_Particle_Random(Port_Min_N076,Port_Max_N076,l9_24,l9_12);
vec3 l9_25=l9_24;
float l9_26=1.0-clamp(Port_Import_N084,0.0,1.0);
float l9_27;
if (l9_26<=0.0)
{
l9_27=0.0;
...
{
l9_27=pow(l9_26,Port_Input1_N087);
}
vec3 l9_28;
Node88_Particle_Random(vec3(l9_27),Port_Max_N088,l9_28,l9_12);
vec3 l9_29=l9_28;
float l9_30;
if (l9_29.x<=0.0)
{
...
l9_15=((((l9_25/(vec3(length(l9_25))+vec3(1.234e-06)))*vec3(l9_31,0.0,0.0))*vec3(Port_Import_N131))*Port_Import_N132).x;
}
float l9_32;
if ((float(0.0==Port_Input1_N158)*1.0)!=0.0)
{
vec3 l9_33;
Node76_Particle_Random(Port_Min_N076,Port_Max_N076,l9_33,l9_12);
vec3 l9_34=l9_33;
float l9_35=1.0-clamp(Port_Import_N084,0.0,1.0);
float l9_36;
if (l9_35<=0.0)
{
l9_36=0.0;
...
{
l9_36=pow(l9_35,Port_Input1_N087);
}
vec3 l9_37;
Node88_Particle_Random(vec3(l9_36),Port_Max_N088,l9_37,l9_12);
vec3 l9_38=l9_37;
float l9_39;
if (l9_38.y<=0.0)
{
...
l9_32=abs(((((l9_34/(vec3(length(l9_34))+vec3(1.234e-06)))*vec3(0.0,l9_40,0.0))*vec3(Port_Import_N131))*Port_Import_N132).y);
}
else
{
vec3 l9_41;
Node76_Particle_Random(Port_Min_N076,Port_Max_N076,l9_41,l9_12);
vec3 l9_42=l9_41;
float l9_43=1.0-clamp(Port_Import_N084,0.0,1.0);
float l9_44;
if (l9_43<=0.0)
{
l9_44=0.0;
...
{
l9_44=pow(l9_43,Port_Input1_N087);
}
vec3 l9_45;
Node88_Particle_Random(vec3(l9_44),Port_Max_N088,l9_45,l9_12);
vec3 l9_46=l9_45;
float l9_47;
if (l9_46.y<=0.0)
{
...
l9_32=((((l9_42/(vec3(length(l9_42))+vec3(1.234e-06)))*vec3(0.0,l9_48,0.0))*vec3(Port_Import_N131))*Port_Import_N132).y;
}
float l9_49;
if ((float(0.0==Port_Input1_N162)*1.0)!=0.0)
{
vec3 l9_50;
Node76_Particle_Random(Port_Min_N076,Port_Max_N076,l9_50,l9_12);
vec3 l9_51=l9_50;
float l9_52=1.0-clamp(Port_Import_N084,0.0,1.0);
float l9_53;
if (l9_52<=0.0)
{
l9_53=0.0;
...
{
l9_53=pow(l9_52,Port_Input1_N087);
}
vec3 l9_54;
Node88_Particle_Random(vec3(l9_53),Port_Max_N088,l9_54,l9_12);
vec3 l9_55=l9_54;
float l9_56;
if (l9_55.z<=0.0)
{
...
l9_49=abs(((((l9_51/(vec3(length(l9_51))+vec3(1.234e-06)))*vec3(0.0,0.0,l9_57))*vec3(Port_Import_N131))*Port_Import_N132).z);
}
else
{
vec3 l9_58;
Node76_Particle_Random(Port_Min_N076,Port_Max_N076,l9_58,l9_12);
vec3 l9_59=l9_58;
float l9_60=1.0-clamp(Port_Import_N084,0.0,1.0);
float l9_61;
if (l9_60<=0.0)
{
l9_61=0.0;
...
{
l9_61=pow(l9_60,Port_Input1_N087);
}
vec3 l9_62;
Node88_Particle_Random(vec3(l9_61),Port_Max_N088,l9_62,l9_12);
vec3 l9_63=l9_62;
float l9_64;
if (l9_63.z<=0.0)
{
...
l9_49=((((l9_59/(vec3(length(l9_59))+vec3(1.234e-06)))*vec3(0.0,0.0,l9_65))*vec3(Port_Import_N131))*Port_Import_N132).z;
}
gParticle.Position=spawnPosition+vec3(l9_15,l9_32,l9_49);
vec4 l9_66=ssGetParticleRandom(1,false,true,true,8.0,gParticle,0.0,sc_Time.x);
...
int l9_71=sc_GetLocalInstanceID()/40;
...
int l9_72=sc_GetLocalInstanceID()/40;
...
int l9_73=sc_GetLocalInstanceID()/40;
...
l9_85.w=mix(Port_Import_N065,Port_Import_N074,(clamp((l9_83*(Port_Input0_N214/((Port_Import_N185/l9_84)+1.234e-06)))+0.001,Port_Input1_N227+0.001,Port_Input2_N227+0.001)-0.001)*(clamp(((1.0-l9_83)*(Port_Input0_N009/((Port_Import_N188/l9_84)+1.234e-06)))+0.001,Port_Input1_N236+0.001,Port_Input2_N236+0.001)-0.001));
