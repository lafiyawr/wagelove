...
vec3 l9_12;
if ((l9_11<0.029999999)||(Port_Import_N171<9.9999997e-05))
{
...
#endif
float l9_4=floor(Port_SpriteCount_N156.x);
float l9_5=floor(Port_SpriteCount_N156.y);
float l9_6=1.0/l9_4;
float l9_7=1.0/l9_5;
float l9_8=floor(mod(floor(float(Interp_Particle_Index%40)),min(l9_4*l9_5,floor(Port_MaxFrames_N156))));
...
#if (sc_StereoRenderingMode==1)
{
vec3 l9_69=vec3(l9_67,0.0);
l9_69.y=((2.0*l9_67.y)+float(sc_GetStereoViewIndex()))-1.0;
l9_68=l9_69.xy;
}
#else
{
...
{
l9_71=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_68,sc_ScreenTextureLayout,l9_70),0.0);
}
#else
{
l9_71=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_68,sc_ScreenTextureLayout,l9_70).xy,0.0);
}
#endif
l9_63=l9_71;
}
...
{
vec4 l9_73=l9_63;
l9_73.x=l9_63.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_72=l9_73;
}
#else
{
...
#endif
vec3 l9_74=mix(l9_72.xyz,definedBlend(l9_72.xyz,l9_60.xyz).xyz,vec3(l9_60.w));
...
{
float l9_77=l9_60.w;
l9_76=vec4(mix(vec3(1.0),l9_60.xyz,vec3(l9_77)),l9_77);
}
#else
{
vec4 l9_78;
...
#endif
l9_78=vec4(l9_60.xyz*l9_80,l9_80);
}
#else
{
l9_78=l9_60;
