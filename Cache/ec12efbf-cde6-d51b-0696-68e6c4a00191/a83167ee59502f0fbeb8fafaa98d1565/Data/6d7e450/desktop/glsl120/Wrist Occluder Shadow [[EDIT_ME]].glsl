...
//sampler sampler shadowTextureSmpSC 0:24
...
//texture texture2D shadowTexture 0:15:0:24
...
//spec_const bool shadowTextureHasSwappedViews 78 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 79 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_shadowTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_shadowTexture 82 -1
...
//spec_const int shadowTextureLayout 92 0
//SG_REFLECTION_END
...
#endif
bool l9_1=(int(SC_USE_CLAMP_TO_BORDER_shadowTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_shadowTexture)!=0));
float l9_2=varPackedTex.x;
sc_SoftwareWrapEarly(l9_2,ivec2(SC_SOFTWARE_WRAP_MODE_U_shadowTexture,SC_SOFTWARE_WRAP_MODE_V_shadowTexture).x);
float l9_3=l9_2;
float l9_4=varPackedTex.y+((shadowPosition*Port_Input1_N009)-Port_Input1_N010);
sc_SoftwareWrapEarly(l9_4,ivec2(SC_SOFTWARE_WRAP_MODE_U_shadowTexture,SC_SOFTWARE_WRAP_MODE_V_shadowTexture).y);
float l9_5=l9_4;
vec2 l9_6;
float l9_7;
...
{
l9_8=ivec2(SC_SOFTWARE_WRAP_MODE_U_shadowTexture,SC_SOFTWARE_WRAP_MODE_V_shadowTexture).x==3;
}
#else
{
l9_8=(int(SC_USE_CLAMP_TO_BORDER_shadowTexture)!=0);
}
#endif
float l9_9=l9_3;
float l9_10=1.0;
sc_ClampUV(l9_9,shadowTextureUvMinMax.x,shadowTextureUvMinMax.z,l9_8,l9_10);
float l9_11=l9_9;
float l9_12=l9_10;
bool l9_13;
#if (SC_USE_CLAMP_TO_BORDER_shadowTexture)
{
l9_13=ivec2(SC_SOFTWARE_WRAP_MODE_U_shadowTexture,SC_SOFTWARE_WRAP_MODE_V_shadowTexture).y==3;
}
#else
{
l9_13=(int(SC_USE_CLAMP_TO_BORDER_shadowTexture)!=0);
}
#endif
float l9_14=l9_5;
float l9_15=l9_12;
sc_ClampUV(l9_14,shadowTextureUvMinMax.y,shadowTextureUvMinMax.w,l9_13,l9_15);
l9_7=l9_15;
...
#endif
vec2 l9_16=sc_TransformUV(l9_6,(int(SC_USE_UV_TRANSFORM_shadowTexture)!=0),shadowTextureTransform);
float l9_17=l9_16.x;
float l9_18=l9_7;
sc_SoftwareWrapLate(l9_17,ivec2(SC_SOFTWARE_WRAP_MODE_U_shadowTexture,SC_SOFTWARE_WRAP_MODE_V_shadowTexture).x,l9_1,l9_18);
float l9_19=l9_16.y;
float l9_20=l9_18;
sc_SoftwareWrapLate(l9_19,ivec2(SC_SOFTWARE_WRAP_MODE_U_shadowTexture,SC_SOFTWARE_WRAP_MODE_V_shadowTexture).y,l9_1,l9_20);
float l9_21=l9_20;
vec3 l9_22=sc_SamplingCoordsViewToGlobal(vec2(l9_17,l9_19),shadowTextureLayout,l9_0);
vec4 l9_23=texture2D(shadowTexture,l9_22.xy,0.0);
vec4 l9_24;
#if (SC_USE_CLAMP_TO_BORDER_shadowTexture)
{
l9_24=mix(shadowTextureBorderColor,l9_23,vec4(l9_21));
}
#else
{
l9_24=l9_23;
...
{
l9_28=clamp(shadowOpacity*2.0,0.0,1.0);
}
#else
{
float l9_29;
...
{
l9_29=clamp(dot(l9_25.xyz,vec3(shadowOpacity)),0.0,1.0);
}
#else
{
float l9_30;
...
{
l9_31=(1.0-dot(l9_25.xyz,vec3(0.33333001)))*shadowOpacity;
}
#else
{
float l9_32;
...
{
l9_32=(1.0-clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0))*shadowOpacity;
}
#else
{
float l9_33;
...
{
l9_33=clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0)*shadowOpacity;
}
#else
{
float l9_34;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_35=clamp(dot(l9_25.xyz,vec3(1.0)),0.0,1.0)*shadowOpacity;
}
#else
{
float l9_36;
...
{
l9_36=dot(l9_25.xyz,vec3(0.33333001))*shadowOpacity;
}
#else
{
float l9_37;
...
#endif
vec3 l9_49=mix(l9_47.xyz,definedBlend(l9_47.xyz,l9_25.xyz).xyz,vec3(shadowOpacity));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_51=vec4(mix(vec3(1.0),l9_25.xyz,vec3(shadowOpacity)),shadowOpacity);
}
#else
{
vec4 l9_52;
...
{
l9_53=clamp(shadowOpacity,0.0,1.0);
}
#else
{
l9_53=shadowOpacity;
