...
//sampler sampler shadowTextureSmpSC 0:29
...
//texture texture2D shadowTexture 0:18:0:29
...
//texture texture2DArray shadowTextureArrSC 0:36:0:29
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_shadowTexture 33 0
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 34 0
//spec_const bool SC_USE_UV_MIN_MAX_shadowTexture 35 0
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 36 0
//spec_const bool SC_USE_UV_TRANSFORM_shadowTexture 37 0
...
//spec_const bool shadowTextureHasSwappedViews 79 0
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 80 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_U_shadowTexture 81 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 82 -1
//spec_const int SC_SOFTWARE_WRAP_MODE_V_shadowTexture 83 -1
...
//spec_const int shadowTextureLayout 93 0
//SG_REFLECTION_END
...
#endif
#ifndef shadowTextureHasSwappedViews
#define shadowTextureHasSwappedViews 0
#elif shadowTextureHasSwappedViews==1
#undef shadowTextureHasSwappedViews
#define shadowTextureHasSwappedViews 1
#endif
#ifndef shadowTextureLayout
#define shadowTextureLayout 0
#endif
#ifndef sc_DepthOnly
...
#endif
#ifndef SC_USE_UV_TRANSFORM_shadowTexture
#define SC_USE_UV_TRANSFORM_shadowTexture 0
#elif SC_USE_UV_TRANSFORM_shadowTexture==1
#undef SC_USE_UV_TRANSFORM_shadowTexture
#define SC_USE_UV_TRANSFORM_shadowTexture 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_shadowTexture
#define SC_SOFTWARE_WRAP_MODE_U_shadowTexture -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_shadowTexture
#define SC_SOFTWARE_WRAP_MODE_V_shadowTexture -1
#endif
#ifndef SC_USE_UV_MIN_MAX_shadowTexture
#define SC_USE_UV_MIN_MAX_shadowTexture 0
#elif SC_USE_UV_MIN_MAX_shadowTexture==1
#undef SC_USE_UV_MIN_MAX_shadowTexture
#define SC_USE_UV_MIN_MAX_shadowTexture 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_shadowTexture
#define SC_USE_CLAMP_TO_BORDER_shadowTexture 0
#elif SC_USE_CLAMP_TO_BORDER_shadowTexture==1
#undef SC_USE_CLAMP_TO_BORDER_shadowTexture
#define SC_USE_CLAMP_TO_BORDER_shadowTexture 1
#endif
layout(binding=1,std430) readonly buffer layoutVertices
{
float _Vertices[];
...
uniform float shadowPosition;
uniform float shadowOpacity;
uniform float Port_Input1_N009;
uniform float Port_Input1_N010;
uniform mat3 shadowTextureTransform;
uniform vec4 shadowTextureUvMinMax;
uniform vec4 shadowTextureBorderColor;
uniform int PreviewEnabled;
uniform usampler2D z_hitIdAndBarycentric;
uniform sampler2D z_rayDirections;
uniform sampler2D shadowTexture;
uniform sampler2DArray shadowTextureArrSC;
...
int shadowTextureGetStereoViewIndex()
{
int l9_0;
#if (shadowTextureHasSwappedViews)
{
...
float l9_2=l9_0.y+((shadowPosition*Port_Input1_N009)-Port_Input1_N010);
vec4 l9_3;
#if (shadowTextureLayout==2)
{
bool l9_4=(int(SC_USE_CLAMP_TO_BORDER_shadowTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_shadowTexture)!=0));
float l9_5=l9_0.x;
sc_SoftwareWrapEarly(l9_5,ivec2(SC_SOFTWARE_WRAP_MODE_U_shadowTexture,SC_SOFTWARE_WRAP_MODE_V_shadowTexture).x);
float l9_6=l9_5;
float l9_7=l9_2;
sc_SoftwareWrapEarly(l9_7,ivec2(SC_SOFTWARE_WRAP_MODE_U_shadowTexture,SC_SOFTWARE_WRAP_MODE_V_shadowTexture).y);
float l9_8=l9_7;
vec2 l9_9;
float l9_10;
#if (SC_USE_UV_MIN_MAX_shadowTexture)
{
bool l9_11;
#if (SC_USE_CLAMP_TO_BORDER_shadowTexture)
{
l9_11=ivec2(SC_SOFTWARE_WRAP_MODE_U_shadowTexture,SC_SOFTWARE_WRAP_MODE_V_shadowTexture).x==3;
}
#else
{
l9_11=(int(SC_USE_CLAMP_TO_BORDER_shadowTexture)!=0);
}
#endif
float l9_12=l9_6;
float l9_13=1.0;
sc_ClampUV(l9_12,shadowTextureUvMinMax.x,shadowTextureUvMinMax.z,l9_11,l9_13);
float l9_14=l9_12;
float l9_15=l9_13;
bool l9_16;
#if (SC_USE_CLAMP_TO_BORDER_shadowTexture)
{
l9_16=ivec2(SC_SOFTWARE_WRAP_MODE_U_shadowTexture,SC_SOFTWARE_WRAP_MODE_V_shadowTexture).y==3;
}
#else
{
l9_16=(int(SC_USE_CLAMP_TO_BORDER_shadowTexture)!=0);
}
#endif
float l9_17=l9_8;
float l9_18=l9_15;
sc_ClampUV(l9_17,shadowTextureUvMinMax.y,shadowTextureUvMinMax.w,l9_16,l9_18);
l9_10=l9_18;
...
#endif
vec2 l9_19=sc_TransformUV(l9_9,(int(SC_USE_UV_TRANSFORM_shadowTexture)!=0),shadowTextureTransform);
float l9_20=l9_19.x;
float l9_21=l9_10;
sc_SoftwareWrapLate(l9_20,ivec2(SC_SOFTWARE_WRAP_MODE_U_shadowTexture,SC_SOFTWARE_WRAP_MODE_V_shadowTexture).x,l9_4,l9_21);
float l9_22=l9_19.y;
float l9_23=l9_21;
sc_SoftwareWrapLate(l9_22,ivec2(SC_SOFTWARE_WRAP_MODE_U_shadowTexture,SC_SOFTWARE_WRAP_MODE_V_shadowTexture).y,l9_4,l9_23);
float l9_24=l9_23;
vec3 l9_25=sc_SamplingCoordsViewToGlobal(vec2(l9_20,l9_22),shadowTextureLayout,shadowTextureGetStereoViewIndex());
vec4 l9_26=texture(shadowTextureArrSC,l9_25,0.0);
vec4 l9_27;
#if (SC_USE_CLAMP_TO_BORDER_shadowTexture)
{
l9_27=mix(shadowTextureBorderColor,l9_26,vec4(l9_24));
}
#else
{
l9_27=l9_26;
...
#else
{
bool l9_28=(int(SC_USE_CLAMP_TO_BORDER_shadowTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_shadowTexture)!=0));
float l9_29=l9_0.x;
sc_SoftwareWrapEarly(l9_29,ivec2(SC_SOFTWARE_WRAP_MODE_U_shadowTexture,SC_SOFTWARE_WRAP_MODE_V_shadowTexture).x);
float l9_30=l9_29;
float l9_31=l9_2;
sc_SoftwareWrapEarly(l9_31,ivec2(SC_SOFTWARE_WRAP_MODE_U_shadowTexture,SC_SOFTWARE_WRAP_MODE_V_shadowTexture).y);
float l9_32=l9_31;
vec2 l9_33;
float l9_34;
#if (SC_USE_UV_MIN_MAX_shadowTexture)
...
#if (SC_USE_CLAMP_TO_BORDER_shadowTexture)
{
l9_35=ivec2(SC_SOFTWARE_WRAP_MODE_U_shadowTexture,SC_SOFTWARE_WRAP_MODE_V_shadowTexture).x==3;
}
#else
{
l9_35=(int(SC_USE_CLAMP_TO_BORDER_shadowTexture)!=0);
}
#endif
float l9_36=l9_30;
float l9_37=1.0;
sc_ClampUV(l9_36,shadowTextureUvMinMax.x,shadowTextureUvMinMax.z,l9_35,l9_37);
float l9_38=l9_36;
float l9_39=l9_37;
bool l9_40;
#if (SC_USE_CLAMP_TO_BORDER_shadowTexture)
{
l9_40=ivec2(SC_SOFTWARE_WRAP_MODE_U_shadowTexture,SC_SOFTWARE_WRAP_MODE_V_shadowTexture).y==3;
}
#else
{
l9_40=(int(SC_USE_CLAMP_TO_BORDER_shadowTexture)!=0);
}
#endif
float l9_41=l9_32;
float l9_42=l9_39;
sc_ClampUV(l9_41,shadowTextureUvMinMax.y,shadowTextureUvMinMax.w,l9_40,l9_42);
l9_34=l9_42;
...
#endif
vec2 l9_43=sc_TransformUV(l9_33,(int(SC_USE_UV_TRANSFORM_shadowTexture)!=0),shadowTextureTransform);
float l9_44=l9_43.x;
float l9_45=l9_34;
sc_SoftwareWrapLate(l9_44,ivec2(SC_SOFTWARE_WRAP_MODE_U_shadowTexture,SC_SOFTWARE_WRAP_MODE_V_shadowTexture).x,l9_28,l9_45);
float l9_46=l9_43.y;
float l9_47=l9_45;
sc_SoftwareWrapLate(l9_46,ivec2(SC_SOFTWARE_WRAP_MODE_U_shadowTexture,SC_SOFTWARE_WRAP_MODE_V_shadowTexture).y,l9_28,l9_47);
float l9_48=l9_47;
vec3 l9_49=sc_SamplingCoordsViewToGlobal(vec2(l9_44,l9_46),shadowTextureLayout,shadowTextureGetStereoViewIndex());
vec4 l9_50=texture(shadowTexture,l9_49.xy,0.0);
vec4 l9_51;
#if (SC_USE_CLAMP_TO_BORDER_shadowTexture)
{
l9_51=mix(shadowTextureBorderColor,l9_50,vec4(l9_48));
}
#else
{
l9_51=l9_50;
...
#endif
vec4 l9_52=vec4(l9_3.x,l9_3.y,l9_3.z,vec4(0.0).w);
l9_52.w=shadowOpacity;
#if (sc_BlendMode_AlphaTest)
{
if (shadowOpacity<alphaTestThreshold)
{
discard;
}
}
...
{
if (shadowOpacity<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_57=clamp(shadowOpacity*2.0,0.0,1.0);
}
#else
{
float l9_58;
...
{
l9_58=clamp(dot(l9_52.xyz,vec3(shadowOpacity)),0.0,1.0);
}
#else
{
float l9_59;
...
{
l9_60=(1.0-dot(l9_52.xyz,vec3(0.33333001)))*shadowOpacity;
}
#else
{
float l9_61;
...
{
l9_61=(1.0-clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0))*shadowOpacity;
}
#else
{
float l9_62;
...
{
l9_62=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0)*shadowOpacity;
}
#else
{
float l9_63;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_64=clamp(dot(l9_52.xyz,vec3(1.0)),0.0,1.0)*shadowOpacity;
}
#else
{
float l9_65;
...
{
l9_65=dot(l9_52.xyz,vec3(0.33333001))*shadowOpacity;
}
#else
{
float l9_66;
...
#endif
vec3 l9_79=mix(l9_77.xyz,definedBlend(l9_77.xyz,l9_52.xyz).xyz,vec3(shadowOpacity));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_81=vec4(mix(vec3(1.0),l9_52.xyz,vec3(shadowOpacity)),shadowOpacity);
}
#else
{
vec4 l9_82;
...
{
l9_83=clamp(shadowOpacity,0.0,1.0);
}
#else
{
l9_83=shadowOpacity;
