...
#if (sc_FramebufferFetch)
{
vec4 l9_225=sc_readFragData0_Platform();
vec4 l9_226;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_227=l9_225;
l9_227.x=l9_225.x+_sc_framebufferFetchMarker;
l9_226=l9_227;
}
#else
{
...
#else
{
vec2 l9_228=sc_ScreenCoordsGlobalToView(l9_0);
int l9_229;
#if (sc_ScreenTextureHasSwappedViews)
{
l9_229=1-sc_GetStereoViewIndex();
}
#else
{
l9_229=sc_GetStereoViewIndex();
}
#endif
vec4 l9_230;
#if (sc_ScreenTextureLayout==2)
{
l9_230=texture(sc_ScreenTextureArrSC,sc_SamplingCoordsViewToGlobal(l9_228,sc_ScreenTextureLayout,l9_229),0.0);
}
#else
{
l9_230=texture(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_228,sc_ScreenTextureLayout,l9_229).xy,0.0);
}
#endif
l9_224=l9_230;
}
...
{
vec4 l9_232=l9_224;
l9_232.x=l9_224.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_231=l9_232;
}
#else
{
...
#endif
vec3 l9_233=mix(l9_231.xyz,definedBlend(l9_231.xyz,l9_3.xyz).xyz,vec3(l9_3.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_235=vec4(mix(vec3(1.0),l9_3.xyz,vec3(l9_3.w)),l9_3.w);
}
#else
{
vec4 l9_236;
...
#endif
l9_236=vec4(l9_3.xyz*l9_237,l9_237);
}
#else
{
l9_236=l9_3;
...
sc_writeFragData0Internal(vec4(max(0.0,1.0-(l9_244-0.0039215689)),min(1.0,l9_244+0.0039215689),0.0,0.0),sc_UniformConstants.x,sc_ShaderCacheConstant);
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_245=sc_ScreenCoordsGlobalToView(l9_0);
...
#endif
int l9_246=encodeDepth(viewSpaceDepth(),texture(sc_OITFilteredDepthBoundsTexture,l9_245).xy);
float l9_247=packValue(l9_246);
int l9_254=int(l9_243.w*255.0);
float l9_255=packValue(l9_254);
sc_writeFragData0Internal(vec4(packValue(l9_246),packValue(l9_246),packValue(l9_246),packValue(l9_246)),sc_UniformConstants.x,sc_ShaderCacheConstant);
...
#if (sc_OITCompositingPass)
{
vec2 l9_258=sc_ScreenCoordsGlobalToView(l9_0);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture(sc_OITFrontDepthTexture,l9_258).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_263==0)
{
l9_266=texture(sc_OITAlpha0,l9_258);
l9_265=texture(sc_OITDepthLow0,l9_258);
l9_264=texture(sc_OITDepthHigh0,l9_258);
}
else
{
l9_266=vec4(0.0);
...
if (l9_263==1)
{
l9_269=texture(sc_OITAlpha1,l9_258);
l9_268=texture(sc_OITDepthLow1,l9_258);
l9_267=texture(sc_OITDepthHigh1,l9_258);
}
else
{
l9_269=l9_266;
...
vec4 l9_284=texture(sc_OITFilteredDepthBoundsTexture,l9_258);
...
sc_writeFragData0Internal(l9_288,sc_UniformConstants.x,sc_ShaderCacheConstant);
#if (sc_OITMaxLayersVisualizeLayerCount)
{
discard;
}
